...
public final class UdeStringUtils {
	...
	private static final String HEAD_TAIL_SPACE = "(^" + All_Space + "|"
			+ All_Space + "$)";
	 ...
	 */
	@FunctionCode("字碼陣列轉換")
	public static String toString(final int[] codePointArray, final int offset,
			final int length) {
		return new String(codePointArray, offset, length);
	}
	 ...
	 */
	@FunctionCode("搜尋")
	private static int indexOf(final String string, final int[] ch,
			final int startPos) {
	 ...
	 */
	@FunctionCode("反向搜尋")
	public static int lastIndexOf(final String string, final int toFind,
			final int startPos) {
