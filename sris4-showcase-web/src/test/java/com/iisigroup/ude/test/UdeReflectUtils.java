...
public final class UdeReflectUtils {
	...
	public static <T> T diff(final T oldObj, final T newObj) throws InstantiationException, IllegalAccessException {
	...
	public static void copyFields(final Object source, final Object target, final String... ignoreFields) {

		final List<Field> sourceFields = FieldUtils.getAllFieldsList(source.getClass()); // 包含繼承父類別
		final List<Field> targetFields = FieldUtils.getAllFieldsList(target.getClass());
