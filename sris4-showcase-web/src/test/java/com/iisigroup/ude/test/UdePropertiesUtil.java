...
import com.iisigroup.ude.util.properties.UdeProperties;
...
public final class UdePropertiesUtil {
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static UdeProperties load(File file, String encoding) throws IOException {
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static UdeProperties load(Resource resource, String encoding) throws IOException {
