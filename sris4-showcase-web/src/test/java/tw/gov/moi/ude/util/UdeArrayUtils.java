...
public class UdeArrayUtils {
	...
	/** Logger Object. */
	private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(UdeArrayUtils.class);
	...
	public static int lastIndexOf(int[] array, int[] toFind, int lastStartPos) {
		...
		// 只看 0~maxRange 間的元素
		final int maxRange = Math.min(lastStartPos + toFind.length, array.length);
	 ...
	 * @return
	 */
	private static int innerBasicMatching(int[] array, int[] toFind, int fromIndex) {
