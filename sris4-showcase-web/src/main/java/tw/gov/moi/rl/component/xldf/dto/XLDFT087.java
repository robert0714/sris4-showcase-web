...
import tw.gov.moi.domain.Xldft087Type;
import tw.gov.moi.domain.Rldft087Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft087Type.class ,
        entityDsName = "rldft087ByKey" ,
        xldfEntityClass = Xldft087Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft087Query", xldfDsByTrans = "xldft087MaxSerialNo",  xldfDsBySerialNo = "xldft087BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT087", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT087")
public class XLDFT087 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT087(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft087Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft087Type domainObj;
     ...
     */
    public Xldft087Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft087Type domainObj) {
