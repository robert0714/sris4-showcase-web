...
import tw.gov.moi.domain.Xldfw036Type;
import tw.gov.moi.domain.Rldfw036Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw036Type.class ,
        entityDsName = "rldfw036ByKey" ,
        xldfEntityClass = Xldfw036Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw036Query", xldfDsByTrans = "xldfw036MaxSerialNo",  xldfDsBySerialNo = "xldfw036BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW036", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW036")
public class XLDFW036 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW036(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw036Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw036Type domainObj;
     ...
     */
    public Xldfw036Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw036Type domainObj) {
