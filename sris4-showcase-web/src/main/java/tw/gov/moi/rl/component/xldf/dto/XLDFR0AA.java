...
import tw.gov.moi.domain.Xldfr0aaType;
import tw.gov.moi.domain.Rldfr0aaType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0aaType.class ,
        entityDsName = "rldfr0aaByKey" ,
        xldfEntityClass = Xldfr0aaType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0aaQuery", xldfDsByTrans = "xldfr0aaMaxSerialNo",  xldfDsBySerialNo = "xldfr0aaBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0AA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0AA")
public class XLDFR0AA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0AA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0aaType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0aaType domainObj;
     ...
     */
    public Xldfr0aaType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0aaType domainObj) {
