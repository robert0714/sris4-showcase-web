...
@XmlType(name = "rl01340MoveOutNoteDTO", propOrder = { "Note", "Selected" })
@XmlRootElement(name = "Rl01340MoveOutNoteDTO")
public class Rl01340MoveOutNoteDTO implements Serializable {
    /**
     * 
     */
    ...
    public String toString() {
        return "Rl01340MoveOutNoteDTO [note=" + note + ", selected=" + selected + "]";
    }
