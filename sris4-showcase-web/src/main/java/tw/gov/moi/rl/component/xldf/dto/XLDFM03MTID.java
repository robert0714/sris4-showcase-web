...
@XmlType(name = "XLDFM03MT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM03MT") 
public class XLDFM03MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM03MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM03MTID(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ) {
        super();
