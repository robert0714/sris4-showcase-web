...
@XmlType(name = "XLDFY061H", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY061H") 
public class XLDFY061HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY061H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY061HID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
