 ...
 */
@RldfMappingEntity(
        value = Rldf002dType.class ,
        entityDsName = "rldf002dByKey" ,
        xldfEntityClass = Xldf002dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf002dQuery", xldfDsByTrans = "xldf002dMaxSerialNo",  xldfDsBySerialNo = "xldf002dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF002D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF002D")
public class XLDF002D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF002D(String personId ,String siteId ,String applyYyymmdd ,String applyHhmmss ) {
        super();
        this.domainObj = new Xldf002dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf002dType domainObj;
     ...
     */
    public Xldf002dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf002dType domainObj) {
