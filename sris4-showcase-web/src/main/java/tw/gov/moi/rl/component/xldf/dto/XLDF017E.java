...
import tw.gov.moi.domain.Xldf017eType;
import tw.gov.moi.domain.Rldf017eType;
 ...
 */
@RldfMappingEntity(
        value = Rldf017eType.class ,
        entityDsName = "rldf017eByKey" ,
        xldfEntityClass = Xldf017eType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "delYyymmdd" , length = 7),
            @XldfKeyMapping( name = "delHhmmss" , length = 6),
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf017eQuery", xldfDsByTrans = "xldf017eMaxSerialNo",  xldfDsBySerialNo = "xldf017eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF017E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF017E")
public class XLDF017E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF017E(String delYyymmdd ,String delHhmmss ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf017eType();
        getDomainObj().setDelYyymmdd(delYyymmdd); 
        getDomainObj().setDelHhmmss(delHhmmss); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf017eType domainObj;
     ...
     */
    public Xldf017eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf017eType domainObj) {
