...
import tw.gov.moi.domain.Xldfx0a8hType;
import tw.gov.moi.domain.Rldfx0a8hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0a8hType.class ,
        entityDsName = "rldfx0a8hByKey" ,
        xldfEntityClass = Xldfx0a8hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0a8hQuery", xldfDsByTrans = "xldfx0a8hMaxSerialNo",  xldfDsBySerialNo = "xldfx0a8hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0A8H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0A8H")
public class XLDFX0A8H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0A8H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0a8hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0a8hType domainObj;
     ...
     */
    public Xldfx0a8hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0a8hType domainObj) {
