...
import tw.gov.moi.domain.Xldfr002Type;
import tw.gov.moi.domain.Rldfr002Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr002Type.class ,
        entityDsName = "rldfr002ByKey" ,
        xldfEntityClass = Xldfr002Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr002Query", xldfDsByTrans = "xldfr002MaxSerialNo",  xldfDsBySerialNo = "xldfr002BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR002", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR002")
public class XLDFR002 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR002(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr002Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr002Type domainObj;
     ...
     */
    public Xldfr002Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr002Type domainObj) {
