...
import tw.gov.moi.domain.Xldfw0bbType;
import tw.gov.moi.domain.Rldfw0bbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0bbType.class ,
        entityDsName = "rldfw0bbByKey" ,
        xldfEntityClass = Xldfw0bbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0bbQuery", xldfDsByTrans = "xldfw0bbMaxSerialNo",  xldfDsBySerialNo = "xldfw0bbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0BB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0BB")
public class XLDFW0BB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0BB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0bbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0bbType domainObj;
     ...
     */
    public Xldfw0bbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0bbType domainObj) {
