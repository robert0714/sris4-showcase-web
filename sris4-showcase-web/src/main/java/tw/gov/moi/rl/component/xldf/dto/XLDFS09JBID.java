...
@XmlType(name = "XLDFS09JB", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS09JB") 
public class XLDFS09JBID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS09JB.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS09JBID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
