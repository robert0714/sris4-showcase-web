...
import tw.gov.moi.domain.Xldfw0a8Type;
import tw.gov.moi.domain.Rldfw0a8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a8Type.class ,
        entityDsName = "rldfw0a8ByKey" ,
        xldfEntityClass = Xldfw0a8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a8Query", xldfDsByTrans = "xldfw0a8MaxSerialNo",  xldfDsBySerialNo = "xldfw0a8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A8")
public class XLDFW0A8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a8Type domainObj;
     ...
     */
    public Xldfw0a8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a8Type domainObj) {
