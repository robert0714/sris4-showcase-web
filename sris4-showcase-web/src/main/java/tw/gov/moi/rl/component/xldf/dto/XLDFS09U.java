...
import tw.gov.moi.domain.Xldfs09uType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09uType.class ,
        entityDsName = "rldfs09uByKey" ,
        xldfEntityClass = Xldfs09uType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09uQuery", xldfDsByTrans = "xldfs09uMaxSerialNo",  xldfDsBySerialNo = "xldfs09uBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09U", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09U")
public class XLDFS09U implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09U(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09uType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09uType domainObj;
     ...
     */
    public Xldfs09uType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09uType domainObj) {
