...
import tw.gov.moi.domain.Rldfs0caType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0caType.class ,
        entityDsName = "rldfs0caByKey" ,
        xldfEntityClass = Xldfs0caType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0caQuery", xldfDsByTrans = "xldfs0caMaxSerialNo",  xldfDsBySerialNo = "xldfs0caBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0CA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0CA")
public class XLDFS0CA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0CA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0caType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0caType domainObj;
     ...
     */
    public Xldfs0caType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0caType domainObj) {
