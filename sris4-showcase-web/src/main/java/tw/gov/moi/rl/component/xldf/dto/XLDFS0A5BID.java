...
public class XLDFS0A5BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS0A5B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS0A5BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(certificateCode, StringUtils.EMPTY)));
