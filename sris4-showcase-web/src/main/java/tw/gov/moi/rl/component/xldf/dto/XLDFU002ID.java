...
@XmlType(name = "XLDFU002", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFU002") 
public class XLDFU002ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFU002.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFU002ID(String serialNumber ,String siteId ) {
        super();
