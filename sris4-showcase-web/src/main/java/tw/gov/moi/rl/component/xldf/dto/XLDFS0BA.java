...
import tw.gov.moi.domain.Xldfs0baType;
import tw.gov.moi.domain.Rldfs0baType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0baType.class ,
        entityDsName = "rldfs0baByKey" ,
        xldfEntityClass = Xldfs0baType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0baQuery", xldfDsByTrans = "xldfs0baMaxSerialNo",  xldfDsBySerialNo = "xldfs0baBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BA")
public class XLDFS0BA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0baType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0baType domainObj;
     ...
     */
    public Xldfs0baType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0baType domainObj) {
