...
import tw.gov.moi.domain.Xldfs042Type;
import tw.gov.moi.domain.Rldfs042Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs042Type.class ,
        entityDsName = "rldfs042ByKey" ,
        xldfEntityClass = Xldfs042Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs042Query", xldfDsByTrans = "xldfs042MaxSerialNo",  xldfDsBySerialNo = "xldfs042BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS042", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS042")
public class XLDFS042 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS042(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs042Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs042Type domainObj;
     ...
     */
    public Xldfs042Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs042Type domainObj) {
