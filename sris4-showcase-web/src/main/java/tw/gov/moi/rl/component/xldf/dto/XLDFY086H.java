...
import tw.gov.moi.domain.Xldfy086hType;
import tw.gov.moi.domain.Rldfy086hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy086hType.class ,
        entityDsName = "rldfy086hByKey" ,
        xldfEntityClass = Xldfy086hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy086hQuery", xldfDsByTrans = "xldfy086hMaxSerialNo",  xldfDsBySerialNo = "xldfy086hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY086H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY086H")
public class XLDFY086H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY086H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy086hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy086hType domainObj;
     ...
     */
    public Xldfy086hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy086hType domainObj) {
