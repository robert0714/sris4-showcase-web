...
import tw.gov.moi.domain.Xldft0a6Type;
import tw.gov.moi.domain.Rldft0a6Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a6Type.class ,
        entityDsName = "rldft0a6ByKey" ,
        xldfEntityClass = Xldft0a6Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a6Query", xldfDsByTrans = "xldft0a6MaxSerialNo",  xldfDsBySerialNo = "xldft0a6BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A6", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A6")
public class XLDFT0A6 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A6(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a6Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a6Type domainObj;
     ...
     */
    public Xldft0a6Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a6Type domainObj) {
