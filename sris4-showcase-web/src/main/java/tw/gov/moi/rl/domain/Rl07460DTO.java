...
public class Rl07460DTO implements Serializable {
    ...
    @XmlElement(name = "siteIdAdd")
    @FieldName("siteIdAdd")
    private String siteIdAdd;
    ...
    @XmlElement(name = "siteIdChs")
    @FieldName("異地辦理中文")
    private String siteIdChs;
    
    @XmlElement(name = "addRldf004m")
    @FieldName("新增驗證的Rldf004m")
    private List<Rldf004mType> addRldf004m;
    ...
    public List<Rldf004mType> getAddRldf004m() {
        return addRldf004m;
    }

    public void setAddRldf004m(List<Rldf004mType> addRldf004m) {
        this.addRldf004m = addRldf004m;
    }

    public String getSiteIdChs() {
        return siteIdChs;
    }

    public void setSiteIdChs(String siteIdChs) {
        this.siteIdChs = siteIdChs;
    }
    ...
    public String getSiteIdAdd() {
        return siteIdAdd;
    }

    public void setSiteIdAdd(String siteIdAdd) {
        this.siteIdAdd = siteIdAdd;
    }
