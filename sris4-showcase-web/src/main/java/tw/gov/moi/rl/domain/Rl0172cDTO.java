...
@XmlType(name = "rl0172cDTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl0172cAppDataDTO",
        "personNoteList", "xldfPersonData", "xldfHouseholdHeadPersonData", "xldfHouseholdData", "applicant1",
        "applicant2", "delegatedPerson", "xldfefaplcType", "verification" })
@XmlRootElement(name = "Rl0172cDTO")
public class Rl0172cDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -4097902751794541202L;
    ...
    /** 出生別變更登記AppDataDTO. */
    @XmlElement(name = "Rl0172cAppDataDTO")
    @FieldName("出生別變更登記AppDataDTO")
    private Rl0172cAppDataDTO rl0172cAppDataDTO = new Rl0172cAppDataDTO();
    ...
    /**
     * Gets the rl0172c app data dto.
     * 
     * @return the rl0172c app data dto
     */
    public Rl0172cAppDataDTO getRl0172cAppDataDTO() {
        return rl0172cAppDataDTO;
    }

    /**
     * Sets the rl0172c app data dto.
     * 
     * @param rl0172cAppDataDTO
     *            the new rl0172c app data dto
     */
    public void setRl0172cAppDataDTO(final Rl0172cAppDataDTO rl0172cAppDataDTO) {
        this.rl0172cAppDataDTO = rl0172cAppDataDTO;
    }
}
