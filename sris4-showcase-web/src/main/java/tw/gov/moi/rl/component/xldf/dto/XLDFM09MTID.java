...
public class XLDFM09MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM09MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM09MTID(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ) {
        super();
