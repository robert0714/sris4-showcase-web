...
@XmlType(name = "XLDFW025", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW025") 
public class XLDFW025ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW025.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW025ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
