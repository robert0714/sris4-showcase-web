...
public class XLDFM05MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM05MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM05MTID(String personId ,String siteId ,String relationId ,String relationCode ) {
        super();
