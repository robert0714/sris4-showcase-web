...
import tw.gov.moi.domain.Xldfr063Type;
import tw.gov.moi.domain.Rldfr063Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr063Type.class ,
        entityDsName = "rldfr063ByKey" ,
        xldfEntityClass = Xldfr063Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr063Query", xldfDsByTrans = "xldfr063MaxSerialNo",  xldfDsBySerialNo = "xldfr063BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR063", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR063")
public class XLDFR063 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR063(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr063Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr063Type domainObj;
     ...
     */
    public Xldfr063Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr063Type domainObj) {
