...
@XmlType(name = "XLDF017E", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF017E") 
public class XLDF017EID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF017E.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF017EID(String delYyymmdd ,String delHhmmss ,String personId ,String siteId ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(delYyymmdd, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(delHhmmss, StringUtils.EMPTY)));
