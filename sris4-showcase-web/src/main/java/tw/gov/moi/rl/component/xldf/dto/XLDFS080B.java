...
import tw.gov.moi.domain.Xldfs080bType;
import tw.gov.moi.domain.Rldfs080bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs080bType.class ,
        entityDsName = "rldfs080bByKey" ,
        xldfEntityClass = Xldfs080bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs080bQuery", xldfDsByTrans = "xldfs080bMaxSerialNo",  xldfDsBySerialNo = "xldfs080bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS080B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS080B")
public class XLDFS080B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS080B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs080bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs080bType domainObj;
     ...
     */
    public Xldfs080bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs080bType domainObj) {
