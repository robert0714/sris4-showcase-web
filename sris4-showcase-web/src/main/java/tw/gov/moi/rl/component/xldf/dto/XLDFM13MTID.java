...
public class XLDFM13MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM13MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM13MTID(String personId ,String siteId ) {
        super();
