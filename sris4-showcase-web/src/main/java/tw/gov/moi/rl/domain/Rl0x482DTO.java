...
import tw.gov.moi.domain.Rldfs182Type;
...
@XmlType(name = "rl0x482DTO", propOrder = { "MainDTO", "EditResult", "QuertDto", "SelectData", "Resutlts", "Recored",
        "IsVerify", "CommononType", "lockData", "LockData", "Title", "CheckCode" })
@XmlRootElement(name = "Rl0x482DTO")
public class Rl0x482DTO implements Serializable {
    ...
    @FieldName("修改紀錄")
    private Rldfs182Type recored = new Rldfs182Type();
    ...
    public Rldfs182Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs182Type recored) {
    ...
    public String toString() {
        return "Rl0x482DTO [mainDTO=" + mainDTO + ", editResult=" + editResult + ", quertDto=" + quertDto
