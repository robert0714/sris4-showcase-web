...
import tw.gov.moi.domain.Xldfy001mType;
import tw.gov.moi.domain.Rldfy001mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy001mType.class ,
        entityDsName = "rldfy001mByKey" ,
        xldfEntityClass = Xldfy001mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy001mQuery", xldfDsByTrans = "xldfy001mMaxSerialNo",  xldfDsBySerialNo = "xldfy001mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY001M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY001M")
public class XLDFY001M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY001M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy001mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy001mType domainObj;
     ...
     */
    public Xldfy001mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy001mType domainObj) {
