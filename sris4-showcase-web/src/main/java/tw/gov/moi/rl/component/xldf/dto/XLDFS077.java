...
import tw.gov.moi.domain.Xldfs077Type;
import tw.gov.moi.domain.Rldfs077Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs077Type.class ,
        entityDsName = "rldfs077ByKey" ,
        xldfEntityClass = Xldfs077Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs077Query", xldfDsByTrans = "xldfs077MaxSerialNo",  xldfDsBySerialNo = "xldfs077BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS077", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS077")
public class XLDFS077 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS077(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs077Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs077Type domainObj;
     ...
     */
    public Xldfs077Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs077Type domainObj) {
