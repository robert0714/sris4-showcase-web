...
public class XLDF1464ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF1464.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF1464ID(String personId ,String siteId ) {
        super();
