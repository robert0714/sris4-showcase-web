...
import tw.gov.moi.domain.Xldfw016Type;
import tw.gov.moi.domain.Rldfw016Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw016Type.class ,
        entityDsName = "rldfw016ByKey" ,
        xldfEntityClass = Xldfw016Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw016Query", xldfDsByTrans = "xldfw016MaxSerialNo",  xldfDsBySerialNo = "xldfw016BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW016", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW016")
public class XLDFW016 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW016(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw016Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw016Type domainObj;
     ...
     */
    public Xldfw016Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw016Type domainObj) {
