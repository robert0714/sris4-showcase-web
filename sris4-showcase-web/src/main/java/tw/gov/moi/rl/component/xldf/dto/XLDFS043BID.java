...
@XmlType(name = "XLDFS043B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS043B") 
public class XLDFS043BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS043B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS043BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
