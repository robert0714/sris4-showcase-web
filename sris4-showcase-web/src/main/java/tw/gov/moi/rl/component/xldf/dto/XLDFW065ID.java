...
@XmlType(name = "XLDFW065", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW065") 
public class XLDFW065ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW065.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW065ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
