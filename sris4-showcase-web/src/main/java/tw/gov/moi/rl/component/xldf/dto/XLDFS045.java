...
import tw.gov.moi.domain.Rldfs045Type;
import tw.gov.moi.domain.Xldfs045Type;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfs045Type.class, entityDsName = "rldfs045ByKey", xldfEntityClass = Xldfs045Type.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfs045Query", xldfDsByTrans = "xldfs045MaxSerialNo", xldfDsBySerialNo = "xldfs045BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS045", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFS045")
public class XLDFS045 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS045(String personId, String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq) {
        super();
        this.domainObj = new Xldfs045Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs045Type domainObj;
     ...
     */
    public Xldfs045Type getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfs045Type domainObj) {
