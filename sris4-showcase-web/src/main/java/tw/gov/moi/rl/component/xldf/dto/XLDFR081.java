...
import tw.gov.moi.domain.Xldfr081Type;
import tw.gov.moi.domain.Rldfr081Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr081Type.class ,
        entityDsName = "rldfr081ByKey" ,
        xldfEntityClass = Xldfr081Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr081Query", xldfDsByTrans = "xldfr081MaxSerialNo",  xldfDsBySerialNo = "xldfr081BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR081", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR081")
public class XLDFR081 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR081(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr081Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr081Type domainObj;
     ...
     */
    public Xldfr081Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr081Type domainObj) {
