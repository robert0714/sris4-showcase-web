...
import tw.gov.moi.domain.Xldft094Type;
import tw.gov.moi.domain.Rldft094Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft094Type.class ,
        entityDsName = "rldft094ByKey" ,
        xldfEntityClass = Xldft094Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft094Query", xldfDsByTrans = "xldft094MaxSerialNo",  xldfDsBySerialNo = "xldft094BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT094", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT094")
public class XLDFT094 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT094(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft094Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft094Type domainObj;
     ...
     */
    public Xldft094Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft094Type domainObj) {
