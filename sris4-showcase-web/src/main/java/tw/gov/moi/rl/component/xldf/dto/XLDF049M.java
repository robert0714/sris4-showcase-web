...
import tw.gov.moi.domain.Xldf049mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf049mType.class ,
        entityDsName = "rldf049mByKey" ,
        xldfEntityClass = Xldf049mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "victimId" , length = 10),
            @XldfKeyMapping( name = "violatorId" , length = 10),
            @XldfKeyMapping( name = "beginYyymmdd" , length = 7),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf049mQuery", xldfDsByTrans = "xldf049mMaxSerialNo",  xldfDsBySerialNo = "xldf049mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF049M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF049M")
public class XLDF049M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF049M(String victimId ,String violatorId ,String beginYyymmdd ,String siteId ) {
        super();
        this.domainObj = new Xldf049mType();
        getDomainObj().setVictimId(victimId); 
        getDomainObj().setViolatorId(violatorId); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf049mType domainObj;
     ...
     */
    public Xldf049mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf049mType domainObj) {
