...
import tw.gov.moi.domain.Xldfs0aabType;
import tw.gov.moi.domain.Rldfs0aabType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0aabType.class ,
        entityDsName = "rldfs0aabByKey" ,
        xldfEntityClass = Xldfs0aabType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0aabQuery", xldfDsByTrans = "xldfs0aabMaxSerialNo",  xldfDsBySerialNo = "xldfs0aabBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AAB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AAB")
public class XLDFS0AAB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AAB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0aabType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0aabType domainObj;
     ...
     */
    public Xldfs0aabType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0aabType domainObj) {
