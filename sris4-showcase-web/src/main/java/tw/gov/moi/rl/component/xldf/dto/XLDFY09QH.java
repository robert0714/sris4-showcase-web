...
import tw.gov.moi.domain.Xldfy09qhType;
import tw.gov.moi.domain.Rldfy09qhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09qhType.class ,
        entityDsName = "rldfy09qhByKey" ,
        xldfEntityClass = Xldfy09qhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09qhQuery", xldfDsByTrans = "xldfy09qhMaxSerialNo",  xldfDsBySerialNo = "xldfy09qhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09QH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09QH")
public class XLDFY09QH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09QH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09qhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09qhType domainObj;
     ...
     */
    public Xldfy09qhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09qhType domainObj) {
