...
import tw.gov.moi.domain.Xldft0daType;
import tw.gov.moi.domain.Rldft0daType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0daType.class ,
        entityDsName = "rldft0daByKey" ,
        xldfEntityClass = Xldft0daType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0daQuery", xldfDsByTrans = "xldft0daMaxSerialNo",  xldfDsBySerialNo = "xldft0daBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0DA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0DA")
public class XLDFT0DA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0DA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0daType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0daType domainObj;
     ...
     */
    public Xldft0daType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0daType domainObj) {
