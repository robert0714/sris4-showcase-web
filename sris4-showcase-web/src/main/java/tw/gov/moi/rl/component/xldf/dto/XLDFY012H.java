...
import tw.gov.moi.domain.Xldfy012hType;
import tw.gov.moi.domain.Rldfy012hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy012hType.class ,
        entityDsName = "rldfy012hByKey" ,
        xldfEntityClass = Xldfy012hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy012hQuery", xldfDsByTrans = "xldfy012hMaxSerialNo",  xldfDsBySerialNo = "xldfy012hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY012H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY012H")
public class XLDFY012H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY012H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy012hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy012hType domainObj;
     ...
     */
    public Xldfy012hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy012hType domainObj) {
