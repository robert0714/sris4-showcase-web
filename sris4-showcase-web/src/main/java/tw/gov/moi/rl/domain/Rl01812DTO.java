...
import tw.gov.moi.rl.component.xldf.dto.XLDFY092H;
import tw.gov.moi.rl.component.xldf.dto.XLDFY092M;
...
public class Rl01812DTO implements Serializable {
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY092M> personNoteDetailList = new ArrayList<XLDFY092M>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY092H> removedPersonNoteDetailList = new ArrayList<XLDFY092H>();
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY092M> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY092M> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY092H> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY092H> removedPersonNoteDetailList) {
