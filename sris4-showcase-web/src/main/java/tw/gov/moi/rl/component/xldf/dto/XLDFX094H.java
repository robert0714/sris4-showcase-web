...
import tw.gov.moi.domain.Xldfx094hType;
import tw.gov.moi.domain.Rldfx094hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx094hType.class ,
        entityDsName = "rldfx094hByKey" ,
        xldfEntityClass = Xldfx094hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx094hQuery", xldfDsByTrans = "xldfx094hMaxSerialNo",  xldfDsBySerialNo = "xldfx094hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX094H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX094H")
public class XLDFX094H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX094H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx094hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx094hType domainObj;
     ...
     */
    public Xldfx094hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx094hType domainObj) {
