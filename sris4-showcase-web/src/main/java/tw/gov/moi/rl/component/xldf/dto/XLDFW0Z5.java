...
import tw.gov.moi.domain.Xldfw0z5Type;
import tw.gov.moi.domain.Rldfw0z5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0z5Type.class ,
        entityDsName = "rldfw0z5ByKey" ,
        xldfEntityClass = Xldfw0z5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0z5Query", xldfDsByTrans = "xldfw0z5MaxSerialNo",  xldfDsBySerialNo = "xldfw0z5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0Z5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0Z5")
public class XLDFW0Z5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0Z5(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String personId ) {
        super();
        this.domainObj = new Xldfw0z5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0z5Type domainObj;
     ...
     */
    public Xldfw0z5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0z5Type domainObj) {
