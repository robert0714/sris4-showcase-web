...
import tw.gov.moi.domain.Xldfy0dahType;
import tw.gov.moi.domain.Rldfy0dahType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0dahType.class ,
        entityDsName = "rldfy0dahByKey" ,
        xldfEntityClass = Xldfy0dahType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0dahQuery", xldfDsByTrans = "xldfy0dahMaxSerialNo",  xldfDsBySerialNo = "xldfy0dahBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DAH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DAH")
public class XLDFY0DAH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DAH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0dahType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0dahType domainObj;
     ...
     */
    public Xldfy0dahType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0dahType domainObj) {
