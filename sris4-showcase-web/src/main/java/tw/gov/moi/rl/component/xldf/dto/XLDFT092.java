...
import tw.gov.moi.domain.Xldft092Type;
import tw.gov.moi.domain.Rldft092Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft092Type.class ,
        entityDsName = "rldft092ByKey" ,
        xldfEntityClass = Xldft092Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft092Query", xldfDsByTrans = "xldft092MaxSerialNo",  xldfDsBySerialNo = "xldft092BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT092", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT092")
public class XLDFT092 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT092(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft092Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft092Type domainObj;
     ...
     */
    public Xldft092Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft092Type domainObj) {
