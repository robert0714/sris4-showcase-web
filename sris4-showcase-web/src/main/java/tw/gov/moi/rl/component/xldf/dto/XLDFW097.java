...
import tw.gov.moi.domain.Xldfw097Type;
import tw.gov.moi.domain.Rldfw097Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw097Type.class ,
        entityDsName = "rldfw097ByKey" ,
        xldfEntityClass = Xldfw097Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw097Query", xldfDsByTrans = "xldfw097MaxSerialNo",  xldfDsBySerialNo = "xldfw097BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW097", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW097")
public class XLDFW097 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW097(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw097Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw097Type domainObj;
     ...
     */
    public Xldfw097Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw097Type domainObj) {
