...
import tw.gov.moi.domain.Xldfy085mType;
import tw.gov.moi.domain.Rldfy085mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy085mType.class ,
        entityDsName = "rldfy085mByKey" ,
        xldfEntityClass = Xldfy085mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy085mQuery", xldfDsByTrans = "xldfy085mMaxSerialNo",  xldfDsBySerialNo = "xldfy085mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY085M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY085M")
public class XLDFY085M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY085M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy085mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy085mType domainObj;
     ...
     */
    public Xldfy085mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy085mType domainObj) {
