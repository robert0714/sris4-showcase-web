...
import tw.gov.moi.domain.Xldft0baType;
import tw.gov.moi.domain.Rldft0baType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0baType.class ,
        entityDsName = "rldft0baByKey" ,
        xldfEntityClass = Xldft0baType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0baQuery", xldfDsByTrans = "xldft0baMaxSerialNo",  xldfDsBySerialNo = "xldft0baBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0BA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0BA")
public class XLDFT0BA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0BA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0baType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0baType domainObj;
     ...
     */
    public Xldft0baType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0baType domainObj) {
