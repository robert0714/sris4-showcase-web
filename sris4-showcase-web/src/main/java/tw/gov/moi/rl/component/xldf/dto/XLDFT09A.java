...
import tw.gov.moi.domain.Xldft09aType;
import tw.gov.moi.domain.Rldft09aType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09aType.class ,
        entityDsName = "rldft09aByKey" ,
        xldfEntityClass = Xldft09aType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09aQuery", xldfDsByTrans = "xldft09aMaxSerialNo",  xldfDsBySerialNo = "xldft09aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09A")
public class XLDFT09A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09A(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09aType domainObj;
     ...
     */
    public Xldft09aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09aType domainObj) {
