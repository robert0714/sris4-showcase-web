...
import tw.gov.moi.domain.Xldfy081mType;
import tw.gov.moi.domain.Rldfy081mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy081mType.class ,
        entityDsName = "rldfy081mByKey" ,
        xldfEntityClass = Xldfy081mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy081mQuery", xldfDsByTrans = "xldfy081mMaxSerialNo",  xldfDsBySerialNo = "xldfy081mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY081M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY081M")
public class XLDFY081M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY081M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy081mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy081mType domainObj;
     ...
     */
    public Xldfy081mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy081mType domainObj) {
