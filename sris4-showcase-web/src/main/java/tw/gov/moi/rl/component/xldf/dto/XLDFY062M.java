...
import tw.gov.moi.domain.Xldfy062mType;
import tw.gov.moi.domain.Rldfy062mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy062mType.class ,
        entityDsName = "rldfy062mByKey" ,
        xldfEntityClass = Xldfy062mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy062mQuery", xldfDsByTrans = "xldfy062mMaxSerialNo",  xldfDsBySerialNo = "xldfy062mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY062M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY062M")
public class XLDFY062M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY062M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy062mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy062mType domainObj;
     ...
     */
    public Xldfy062mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy062mType domainObj) {
