...
@XmlType(name = "XLDFR0DI", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFR0DI") 
public class XLDFR0DIID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFR0DI.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFR0DIID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
