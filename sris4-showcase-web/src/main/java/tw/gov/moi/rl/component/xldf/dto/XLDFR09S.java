...
import tw.gov.moi.domain.Xldfr09sType;
import tw.gov.moi.domain.Rldfr09sType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09sType.class ,
        entityDsName = "rldfr09sByKey" ,
        xldfEntityClass = Xldfr09sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09sQuery", xldfDsByTrans = "xldfr09sMaxSerialNo",  xldfDsBySerialNo = "xldfr09sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09S")
public class XLDFR09S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09S(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09sType domainObj;
     ...
     */
    public Xldfr09sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09sType domainObj) {
