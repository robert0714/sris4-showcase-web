...
import tw.gov.moi.domain.Xldfs0dibType;
import tw.gov.moi.domain.Rldfs0dibType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0dibType.class ,
        entityDsName = "rldfs0dibByKey" ,
        xldfEntityClass = Xldfs0dibType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0dibQuery", xldfDsByTrans = "xldfs0dibMaxSerialNo",  xldfDsBySerialNo = "xldfs0dibBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DIB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DIB")
public class XLDFS0DIB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DIB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0dibType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0dibType domainObj;
     ...
     */
    public Xldfs0dibType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0dibType domainObj) {
