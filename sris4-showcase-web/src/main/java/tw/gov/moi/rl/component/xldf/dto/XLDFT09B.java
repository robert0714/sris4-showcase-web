...
import tw.gov.moi.domain.Xldft09bType;
import tw.gov.moi.domain.Rldft09bType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09bType.class ,
        entityDsName = "rldft09bByKey" ,
        xldfEntityClass = Xldft09bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09bQuery", xldfDsByTrans = "xldft09bMaxSerialNo",  xldfDsBySerialNo = "xldft09bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09B")
public class XLDFT09B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09B(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09bType domainObj;
     ...
     */
    public Xldft09bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09bType domainObj) {
