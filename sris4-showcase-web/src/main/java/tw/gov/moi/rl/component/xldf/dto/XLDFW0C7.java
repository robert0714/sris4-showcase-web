...
import tw.gov.moi.domain.Xldfw0c7Type;
import tw.gov.moi.domain.Rldfw0c7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0c7Type.class ,
        entityDsName = "rldfw0c7ByKey" ,
        xldfEntityClass = Xldfw0c7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0c7Query", xldfDsByTrans = "xldfw0c7MaxSerialNo",  xldfDsBySerialNo = "xldfw0c7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0C7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0C7")
public class XLDFW0C7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0C7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0c7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0c7Type domainObj;
     ...
     */
    public Xldfw0c7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0c7Type domainObj) {
