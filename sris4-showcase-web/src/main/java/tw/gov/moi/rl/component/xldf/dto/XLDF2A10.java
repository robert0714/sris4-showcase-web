...
import tw.gov.moi.domain.Xldf2a10Type;
import tw.gov.moi.domain.Xldf2a10Type;
 ...
 */
@RldfMappingEntity(
        value = Xldf2a10Type.class ,
        entityDsName = "xldf2a10ByKey" ,
        xldfEntityClass = Xldf2a10Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf2a10Query", xldfDsByTrans = "xldf2a10MaxSerialNo",  xldfDsBySerialNo = "xldf2a10BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF2A10", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF2A10")
public class XLDF2A10 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF2A10(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf2a10Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldf2a10Type domainObj;
     ...
     */
    public Xldf2a10Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf2a10Type domainObj) {
