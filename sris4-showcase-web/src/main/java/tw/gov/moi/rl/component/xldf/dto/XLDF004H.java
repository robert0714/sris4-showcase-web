 ...
 */
@RldfMappingEntity(
        value = Rldf004hType.class ,
        entityDsName = "rldf004hByKey" ,
        xldfEntityClass = Xldf004hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf004hQuery", xldfDsByTrans = "xldf004hMaxSerialNo",  xldfDsBySerialNo = "xldf004hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF004H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF004H")
public class XLDF004H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF004H(String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldf004hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf004hType domainObj;
     ...
     */
    public Xldf004hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf004hType domainObj) {
