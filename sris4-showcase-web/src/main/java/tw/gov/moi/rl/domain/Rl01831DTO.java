...
import tw.gov.moi.rl.component.xldf.dto.XLDFY09SH;
import tw.gov.moi.rl.component.xldf.dto.XLDFY09SM;
...
public class Rl01831DTO implements Serializable {
    ...
    /** 其他撤銷原因 */
    @XmlElement(name = "OtherCancelReason", required = true)
    @FieldName("其他撤銷原因")
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY09SM> personNoteDetailList = new ArrayList<XLDFY09SM>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY09SH> removedPersonNoteDetailList = new ArrayList<XLDFY09SH>();
     ...
     * 設定其他撤銷原因
     * 
     * @param otherCancelReason
     *            其他撤銷原因
     */
    public void setOtherCancelReason(final String otherCancelReason) {
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY09SM> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY09SM> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY09SH> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY09SH> removedPersonNoteDetailList) {
