...
import tw.gov.moi.domain.Xldfy081dmType;
...
/**
 * The Class XLDFY081DM.
 *
 * @author JL
 */
@RldfMappingEntity(
        value = Rldfy081dmType.class ,
        entityDsName = "rldfy081dmByKey" ,
        xldfEntityClass = Xldfy081dmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy081dmQuery", xldfDsByTrans = "xldfy081dmMaxSerialNo",  xldfDsBySerialNo = "xldfy081dmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY081DM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY081DM")
public class XLDFY081DM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY081DM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
        this.domainObj = new Xldfy081dmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy081dmType domainObj;
     ...
     */
    public Xldfy081dmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy081dmType domainObj) {
