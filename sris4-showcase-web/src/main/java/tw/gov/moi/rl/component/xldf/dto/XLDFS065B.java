...
import tw.gov.moi.domain.Xldfs065bType;
import tw.gov.moi.domain.Rldfs065bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs065bType.class ,
        entityDsName = "rldfs065bByKey" ,
        xldfEntityClass = Xldfs065bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs065bQuery", xldfDsByTrans = "xldfs065bMaxSerialNo",  xldfDsBySerialNo = "xldfs065bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS065B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS065B")
public class XLDFS065B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS065B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs065bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs065bType domainObj;
     ...
     */
    public Xldfs065bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs065bType domainObj) {
