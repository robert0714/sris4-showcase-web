...
import tw.gov.moi.domain.Xldfx095hType;
import tw.gov.moi.domain.Rldfx095hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx095hType.class ,
        entityDsName = "rldfx095hByKey" ,
        xldfEntityClass = Xldfx095hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx095hQuery", xldfDsByTrans = "xldfx095hMaxSerialNo",  xldfDsBySerialNo = "xldfx095hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX095H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX095H")
public class XLDFX095H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX095H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx095hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx095hType domainObj;
     ...
     */
    public Xldfx095hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx095hType domainObj) {
