...
import tw.gov.moi.domain.Xldfw09cType;
import tw.gov.moi.domain.Rldfw09cType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09cType.class ,
        entityDsName = "rldfw09cByKey" ,
        xldfEntityClass = Xldfw09cType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09cQuery", xldfDsByTrans = "xldfw09cMaxSerialNo",  xldfDsBySerialNo = "xldfw09cBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09C", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09C")
public class XLDFW09C implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09C(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09cType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09cType domainObj;
     ...
     */
    public Xldfw09cType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09cType domainObj) {
