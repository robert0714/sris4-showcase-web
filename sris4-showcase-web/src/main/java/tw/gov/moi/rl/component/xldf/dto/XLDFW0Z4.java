...
import tw.gov.moi.domain.Xldfw0z4Type;
import tw.gov.moi.domain.Rldfw0z4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0z4Type.class ,
        entityDsName = "rldfw0z4ByKey" ,
        xldfEntityClass = Xldfw0z4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0z4Query", xldfDsByTrans = "xldfw0z4MaxSerialNo",  xldfDsBySerialNo = "xldfw0z4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0Z4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0Z4")
public class XLDFW0Z4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0Z4(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String personId ) {
        super();
        this.domainObj = new Xldfw0z4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0z4Type domainObj;
     ...
     */
    public Xldfw0z4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0z4Type domainObj) {
