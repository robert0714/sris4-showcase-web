...
import tw.gov.moi.domain.Xldfw0y1Type;
import tw.gov.moi.domain.Rldfw0y1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0y1Type.class ,
        entityDsName = "rldfw0y1ByKey" ,
        xldfEntityClass = Xldfw0y1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0y1Query", xldfDsByTrans = "xldfw0y1MaxSerialNo",  xldfDsBySerialNo = "xldfw0y1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0Y1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0Y1")
public class XLDFW0Y1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0Y1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0y1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0y1Type domainObj;
     ...
     */
    public Xldfw0y1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0y1Type domainObj) {
