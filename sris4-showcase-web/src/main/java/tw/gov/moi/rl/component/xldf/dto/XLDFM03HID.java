...
public class XLDFM03HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM03H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM03HID(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ,String removeYyymmdd ,String removeTime ,String acceptAdminOfficeCode ) {
        super();
