...
import tw.gov.moi.domain.Xldfm13hType;
import tw.gov.moi.domain.Rldfm13hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm13hType.class ,
        entityDsName = "rldfm13hByKey" ,
        xldfEntityClass = Xldfm13hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm13hQuery", xldfDsByTrans = "xldfm13hMaxSerialNo",  xldfDsBySerialNo = "xldfm13hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM13H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM13H")
public class XLDFM13H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM13H(String removeYyymmdd ,String removeTime ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm13hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm13hType domainObj;
     ...
     */
    public Xldfm13hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm13hType domainObj) {
