...
import tw.gov.moi.domain.Xldfr087Type;
import tw.gov.moi.domain.Rldfr087Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr087Type.class ,
        entityDsName = "rldfr087ByKey" ,
        xldfEntityClass = Xldfr087Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr087Query", xldfDsByTrans = "xldfr087MaxSerialNo",  xldfDsBySerialNo = "xldfr087BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR087", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR087")
public class XLDFR087 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR087(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr087Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr087Type domainObj;
     ...
     */
    public Xldfr087Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr087Type domainObj) {
