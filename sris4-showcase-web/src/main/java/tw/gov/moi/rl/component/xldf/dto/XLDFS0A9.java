...
import tw.gov.moi.domain.Xldfs0a9Type;
import tw.gov.moi.domain.Rldfs0a9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a9Type.class ,
        entityDsName = "rldfs0a9ByKey" ,
        xldfEntityClass = Xldfs0a9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a9Query", xldfDsByTrans = "xldfs0a9MaxSerialNo",  xldfDsBySerialNo = "xldfs0a9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A9")
public class XLDFS0A9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a9Type domainObj;
     ...
     */
    public Xldfs0a9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a9Type domainObj) {
