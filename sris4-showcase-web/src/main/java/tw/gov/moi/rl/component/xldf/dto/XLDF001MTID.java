...
public class XLDF001MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF001MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF001MTID(String householdHeadId ,String householdId ,String siteId ) {
        super();
