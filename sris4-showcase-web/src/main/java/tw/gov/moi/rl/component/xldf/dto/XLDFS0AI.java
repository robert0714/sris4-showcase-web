...
import tw.gov.moi.domain.Rldfs0aiType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0aiType.class ,
        entityDsName = "rldfs0aiByKey" ,
        xldfEntityClass = Xldfs0aiType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0aiQuery", xldfDsByTrans = "xldfs0aiMaxSerialNo",  xldfDsBySerialNo = "xldfs0aiBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AI")
public class XLDFS0AI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0aiType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0aiType domainObj;
     ...
     */
    public Xldfs0aiType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0aiType domainObj) {
