...
import tw.gov.moi.domain.Xldfy093mType;
import tw.gov.moi.domain.Rldfy093mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy093mType.class ,
        entityDsName = "rldfy093mByKey" ,
        xldfEntityClass = Xldfy093mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy093mQuery", xldfDsByTrans = "xldfy093mMaxSerialNo",  xldfDsBySerialNo = "xldfy093mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY093M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY093M")
public class XLDFY093M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY093M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy093mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy093mType domainObj;
     ...
     */
    public Xldfy093mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy093mType domainObj) {
