...
import tw.gov.moi.domain.Xldf009dType;
import tw.gov.moi.domain.Rldf009dType;
 ...
 */
@RldfMappingEntity(
        value = Rldf009dType.class ,
        entityDsName = "rldf009dByKey" ,
        xldfEntityClass = Xldf009dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf009dQuery", xldfDsByTrans = "xldf009dMaxSerialNo",  xldfDsBySerialNo = "xldf009dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF009D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF009D")
public class XLDF009D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF009D(String trMode ,String applyMode ,String applyYyymmdd ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf009dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf009dType domainObj;
     ...
     */
    public Xldf009dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf009dType domainObj) {
