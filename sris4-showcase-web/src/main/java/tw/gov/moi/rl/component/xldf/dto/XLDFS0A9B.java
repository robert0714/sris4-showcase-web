...
import tw.gov.moi.domain.Xldfs0a9bType;
import tw.gov.moi.domain.Rldfs0a9bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a9bType.class ,
        entityDsName = "rldfs0a9bByKey" ,
        xldfEntityClass = Xldfs0a9bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a9bQuery", xldfDsByTrans = "xldfs0a9bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a9bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A9B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A9B")
public class XLDFS0A9B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A9B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a9bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a9bType domainObj;
     ...
     */
    public Xldfs0a9bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a9bType domainObj) {
