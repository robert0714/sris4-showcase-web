...
import tw.gov.moi.domain.Xldf006mtType;
 ...
 */
@RldfMappingEntity(
        value = Tldf006mType.class ,
        entityDsName = "tldf006mByKey" ,
        xldfEntityClass = Xldf006mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf006mtQuery", xldfDsByTrans = "xldf006mtMaxSerialNo",  xldfDsBySerialNo = "xldf006mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF006MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF006MT")
public class XLDF006MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF006MT(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf006mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf006mtType domainObj;
     ...
     */
    public Xldf006mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf006mtType domainObj) {
