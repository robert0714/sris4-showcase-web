...
import tw.gov.moi.domain.Xldft0bdType;
import tw.gov.moi.domain.Rldft0bdType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0bdType.class ,
        entityDsName = "rldft0bdByKey" ,
        xldfEntityClass = Xldft0bdType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0bdQuery", xldfDsByTrans = "xldft0bdMaxSerialNo",  xldfDsBySerialNo = "xldft0bdBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0BD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0BD")
public class XLDFT0BD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0BD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0bdType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0bdType domainObj;
     ...
     */
    public Xldft0bdType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0bdType domainObj) {
