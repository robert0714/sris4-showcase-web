...
import tw.gov.moi.domain.Xldfy09uhType;
import tw.gov.moi.domain.Rldfy09uhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09uhType.class ,
        entityDsName = "rldfy09uhByKey" ,
        xldfEntityClass = Xldfy09uhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09uhQuery", xldfDsByTrans = "xldfy09uhMaxSerialNo",  xldfDsBySerialNo = "xldfy09uhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09UH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09UH")
public class XLDFY09UH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09UH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09uhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09uhType domainObj;
     ...
     */
    public Xldfy09uhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09uhType domainObj) {
