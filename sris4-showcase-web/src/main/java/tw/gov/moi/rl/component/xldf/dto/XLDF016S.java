...
import tw.gov.moi.domain.Xldf016sType;
import tw.gov.moi.domain.Rldf016sType;
 ...
 */
@RldfMappingEntity(
        value = Rldf016sType.class ,
        entityDsName = "rldf016sByKey" ,
        xldfEntityClass = Xldf016sType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "applyTransactionId" , length = 22),
            @XldfKeyMapping( name = "applySequenceId" , length = 12),
            @XldfKeyMapping( name = "registrationId" , length = 5),
...
@XldfDsNameMaping(xldfDsName = "xldf016sQuery", xldfDsByTrans = "xldf016sMaxSerialNo",  xldfDsBySerialNo = "xldf016sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF016S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF016S")
public class XLDF016S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF016S(String applyTransactionId ,Integer applySequenceId ,String registrationId ,String acceptSiteId ,String registerDate ,String registerTime ) {
        super();
        this.domainObj = new Xldf016sType();
        getDomainObj().setApplyTransactionId(applyTransactionId); 
        getDomainObj().setApplySequenceId(applySequenceId); 
        getDomainObj().setRegistrationId(registrationId); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf016sType domainObj;
     ...
     */
    public Xldf016sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf016sType domainObj) {
