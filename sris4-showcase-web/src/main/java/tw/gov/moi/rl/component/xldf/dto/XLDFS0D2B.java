...
import tw.gov.moi.domain.Xldfs0d2bType;
import tw.gov.moi.domain.Rldfs0d2bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0d2bType.class ,
        entityDsName = "rldfs0d2bByKey" ,
        xldfEntityClass = Xldfs0d2bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0d2bQuery", xldfDsByTrans = "xldfs0d2bMaxSerialNo",  xldfDsBySerialNo = "xldfs0d2bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0D2B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0D2B")
public class XLDFS0D2B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0D2B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0d2bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0d2bType domainObj;
     ...
     */
    public Xldfs0d2bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0d2bType domainObj) {
