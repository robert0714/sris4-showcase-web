...
import tw.gov.moi.domain.Rldfw045Type;
import tw.gov.moi.domain.Xldfw045Type;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfw045Type.class, entityDsName = "rldfw045ByKey", xldfEntityClass = Xldfw045Type.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfw045Query", xldfDsByTrans = "xldfw045MaxSerialNo", xldfDsBySerialNo = "xldfw045BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW045", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFW045")
public class XLDFW045 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW045(String personId, String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq) {
        super();
        this.domainObj = new Xldfw045Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw045Type domainObj;
     ...
     */
    public Xldfw045Type getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfw045Type domainObj) {
