...
import tw.gov.moi.domain.Xldfr0a8Type;
import tw.gov.moi.domain.Rldfr0a8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a8Type.class ,
        entityDsName = "rldfr0a8ByKey" ,
        xldfEntityClass = Xldfr0a8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a8Query", xldfDsByTrans = "xldfr0a8MaxSerialNo",  xldfDsBySerialNo = "xldfr0a8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A8")
public class XLDFR0A8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a8Type domainObj;
     ...
     */
    public Xldfr0a8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a8Type domainObj) {
