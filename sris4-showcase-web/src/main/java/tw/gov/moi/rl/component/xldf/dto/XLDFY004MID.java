...
public class XLDFY004MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY004M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY004MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
