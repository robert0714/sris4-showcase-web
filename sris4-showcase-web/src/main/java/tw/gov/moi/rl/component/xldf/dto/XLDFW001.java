...
import tw.gov.moi.domain.Xldfw001Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw001Type.class ,
        entityDsName = "rldfw001ByKey" ,
        xldfEntityClass = Xldfw001Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw001Query", xldfDsByTrans = "xldfw001MaxSerialNo",  xldfDsBySerialNo = "xldfw001BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW001", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW001")
public class XLDFW001 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW001(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw001Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw001Type domainObj;
     ...
     */
    public Xldfw001Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw001Type domainObj) {
