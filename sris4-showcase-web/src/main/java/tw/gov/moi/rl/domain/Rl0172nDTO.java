...
@XmlType(name = "Rl0172nDTO", propOrder = { "transactionId", "acceptSiteId", "userId", "initTime",
        "openingOperationDTO", "person", "personHousehold", "foreignPerson", "householdHead", "rl0172nAppData",
        ...
        "enforcedApplicant", "personRole", "buttonDisabled", "warningMessgeList", "fineDTO", "fineQueryDTO",
        "pageTitle", "toFine", "initSuccess", "activeIndex", "lockMode" })
@XmlRootElement(name = "Rl0172nDTO")
public class Rl0172nDTO implements Serializable {

    /** serialVersion UID */
    private static final long serialVersionUID = 8788079175493750128L;
    ...
    /** 當事人-申請資料 */
    @FieldName("當事人-申請資料")
    @XmlElement(name = "Rl0172nAppData", required = false)
    private Rl0172nAppDataDTO rl0172nAppData = new Rl0172nAppDataDTO();
    ...
    /** 抬頭 */
    @FieldName("抬頭")
    @XmlElement(name = "pageTitle", required = false)
    private String pageTitle;

    /** 罰鍰檢視選取狀態-註解:true = 選取 ，false = 沒選取 */
    @FieldName("罰鍰檢視選取狀態")
    @XmlElement(name = "toFine", required = false)
    private boolean toFine;
    ...
    public Rl0172nAppDataDTO getRl0172nAppData() {
        return rl0172nAppData;
    }

    public void setRl0172nAppData(Rl0172nAppDataDTO rl0172nAppData) {
        this.rl0172nAppData = rl0172nAppData;
    }
