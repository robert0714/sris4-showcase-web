...
import tw.gov.moi.domain.Xldft003Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft003Type.class ,
        entityDsName = "rldft003ByKey" ,
        xldfEntityClass = Xldft003Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft003Query", xldfDsByTrans = "xldft003MaxSerialNo",  xldfDsBySerialNo = "xldft003BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT003", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT003")
public class XLDFT003 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT003(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft003Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft003Type domainObj;
     ...
     */
    public Xldft003Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft003Type domainObj) {
