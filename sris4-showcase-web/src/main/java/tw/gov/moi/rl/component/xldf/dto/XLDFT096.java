...
import tw.gov.moi.domain.Xldft096Type;
import tw.gov.moi.domain.Rldft096Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft096Type.class ,
        entityDsName = "rldft096ByKey" ,
        xldfEntityClass = Xldft096Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft096Query", xldfDsByTrans = "xldft096MaxSerialNo",  xldfDsBySerialNo = "xldft096BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT096", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT096")
public class XLDFT096 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT096(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft096Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft096Type domainObj;
     ...
     */
    public Xldft096Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft096Type domainObj) {
