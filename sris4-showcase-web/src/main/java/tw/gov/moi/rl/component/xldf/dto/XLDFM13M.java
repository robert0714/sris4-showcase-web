...
import tw.gov.moi.domain.Xldfm13mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm13mType.class ,
        entityDsName = "rldfm13mByKey" ,
        xldfEntityClass = Xldfm13mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm13mQuery", xldfDsByTrans = "xldfm13mMaxSerialNo",  xldfDsBySerialNo = "xldfm13mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM13M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM13M")
public class XLDFM13M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM13M(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm13mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm13mType domainObj;
     ...
     */
    public Xldfm13mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm13mType domainObj) {
