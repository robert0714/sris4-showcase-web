 ...
 */
@RldfMappingEntity(
        value = Rldf002mType.class ,
        entityDsName = "rldf002mByKey" ,
        xldfEntityClass = Xldf002mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf002mQuery", xldfDsByTrans = "xldf002mMaxSerialNo",  xldfDsBySerialNo = "xldf002mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF002M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF002M")
public class XLDF002M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF002M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf002mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf002mType domainObj;
     ...
     */
    public Xldf002mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf002mType domainObj) {
