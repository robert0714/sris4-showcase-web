...
import tw.gov.moi.rl.component.xldf.dto.XLDFY062H;
import tw.gov.moi.rl.component.xldf.dto.XLDFY062M;
...
public class Rl01273DTO implements Serializable {
    ...
    /** 終止收養類型 */
    @XmlElement(name = "ExpireAdoptType", required = true)
    @FieldName("終止收養類型")
    private String expireAdoptType;
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY062M> personNoteDetailList = new ArrayList<XLDFY062M>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY062H> removedPersonNoteDetailList = new ArrayList<XLDFY062H>();
     ...
     * @return 終止收養類型
     */
    public String getExpireAdoptType() {
        return expireAdoptType;
    }

    /**
     * 設定終止收養類型
     * 
     * @param expireAdoptType
     *            終止收養類型
     */
    public void setExpireAdoptType(final String expireAdoptType) {
        this.expireAdoptType = expireAdoptType;
    }
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY062M> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY062M> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY062H> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY062H> removedPersonNoteDetailList) {
