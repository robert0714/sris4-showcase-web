...
import tw.gov.moi.domain.Xldfw090Type;
import tw.gov.moi.domain.Rldfw090Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw090Type.class ,
        entityDsName = "rldfw090ByKey" ,
        xldfEntityClass = Xldfw090Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw090Query", xldfDsByTrans = "xldfw090MaxSerialNo",  xldfDsBySerialNo = "xldfw090BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW090", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW090")
public class XLDFW090 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW090(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw090Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw090Type domainObj;
     ...
     */
    public Xldfw090Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw090Type domainObj) {
