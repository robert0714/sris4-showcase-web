...
import tw.gov.moi.domain.Xldf030mtType;
import tw.gov.moi.domain.Tldf030mType;
 ...
 */
@RldfMappingEntity(
        value = Tldf030mType.class ,
        entityDsName = "tldf030mByKey" ,
        xldfEntityClass = Xldf030mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf030mtQuery", xldfDsByTrans = "xldf030mtMaxSerialNo",  xldfDsBySerialNo = "xldf030mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF030MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF030MT")
public class XLDF030MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF030MT(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf030mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf030mtType domainObj;
     ...
     */
    public Xldf030mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf030mtType domainObj) {
