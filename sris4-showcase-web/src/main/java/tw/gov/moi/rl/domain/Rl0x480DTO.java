...
import tw.gov.moi.domain.Rldfs180Type;

/**
 * 未成年子女權利義務行使負擔登記申請書職權更正DTO
 * 
 * @author Derek
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl0x480DTO", propOrder = { "mainDTO", "editResult", "quertDto", "selectData", "resutlts", "recored",
        "reason", "isVerify", "commononType", "lockData", "unLockData", "title", "checkCode" })
@XmlRootElement(name = "Rl0x480DTO")
public class Rl0x480DTO implements Serializable {
    ...
    @FieldName("修改紀錄")
    private Rldfs180Type recored = new Rldfs180Type();
    ...
    public Rldfs180Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs180Type recored) {
