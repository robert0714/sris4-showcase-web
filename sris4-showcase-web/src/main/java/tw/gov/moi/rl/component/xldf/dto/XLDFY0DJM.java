...
import tw.gov.moi.domain.Xldfy0djmType;
import tw.gov.moi.domain.Rldfy0djmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0djmType.class ,
        entityDsName = "rldfy0djmByKey" ,
        xldfEntityClass = Xldfy0djmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0djmQuery", xldfDsByTrans = "xldfy0djmMaxSerialNo",  xldfDsBySerialNo = "xldfy0djmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DJM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DJM")
public class XLDFY0DJM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DJM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0djmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0djmType domainObj;
     ...
     */
    public Xldfy0djmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0djmType domainObj) {
