...
import tw.gov.moi.domain.Xldfm08hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm08hType.class ,
        entityDsName = "rldfm08hByKey" ,
        xldfEntityClass = Xldfm08hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm08hQuery", xldfDsByTrans = "xldfm08hMaxSerialNo",  xldfDsBySerialNo = "xldfm08hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM08H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM08H")
public class XLDFM08H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM08H(String personId ,String siteId ,String relationId ,String relationCode ,String updateDate ,String updateTime ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldfm08hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm08hType domainObj;
     ...
     */
    public Xldfm08hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm08hType domainObj) {
