...
import tw.gov.moi.domain.Xldft0bbType;
import tw.gov.moi.domain.Rldft0bbType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0bbType.class ,
        entityDsName = "rldft0bbByKey" ,
        xldfEntityClass = Xldft0bbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0bbQuery", xldfDsByTrans = "xldft0bbMaxSerialNo",  xldfDsBySerialNo = "xldft0bbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0BB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0BB")
public class XLDFT0BB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0BB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0bbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0bbType domainObj;
     ...
     */
    public Xldft0bbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0bbType domainObj) {
