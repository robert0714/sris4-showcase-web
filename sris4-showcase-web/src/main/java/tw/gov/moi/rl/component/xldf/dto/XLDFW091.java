...
import tw.gov.moi.domain.Xldfw091Type;
import tw.gov.moi.domain.Rldfw091Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw091Type.class ,
        entityDsName = "rldfw091ByKey" ,
        xldfEntityClass = Xldfw091Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw091Query", xldfDsByTrans = "xldfw091MaxSerialNo",  xldfDsBySerialNo = "xldfw091BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW091", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW091")
public class XLDFW091 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW091(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw091Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw091Type domainObj;
     ...
     */
    public Xldfw091Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw091Type domainObj) {
