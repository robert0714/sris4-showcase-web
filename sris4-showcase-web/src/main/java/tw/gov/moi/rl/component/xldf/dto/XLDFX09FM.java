...
import tw.gov.moi.domain.Xldfx09fmType;
import tw.gov.moi.domain.Rldfx09fmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09fmType.class ,
        entityDsName = "rldfx09fmByKey" ,
        xldfEntityClass = Xldfx09fmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09fmQuery", xldfDsByTrans = "xldfx09fmMaxSerialNo",  xldfDsBySerialNo = "xldfx09fmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09FM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09FM")
public class XLDFX09FM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09FM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09fmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09fmType domainObj;
     ...
     */
    public Xldfx09fmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09fmType domainObj) {
