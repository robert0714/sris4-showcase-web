...
import tw.gov.moi.domain.Xldft09jType;
import tw.gov.moi.domain.Rldft09jType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09jType.class ,
        entityDsName = "rldft09jByKey" ,
        xldfEntityClass = Xldft09jType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09jQuery", xldfDsByTrans = "xldft09jMaxSerialNo",  xldfDsBySerialNo = "xldft09jBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09J", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09J")
public class XLDFT09J implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09J(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09jType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09jType domainObj;
     ...
     */
    public Xldft09jType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09jType domainObj) {
