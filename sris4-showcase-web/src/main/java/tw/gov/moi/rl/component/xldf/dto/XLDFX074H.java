...
import tw.gov.moi.domain.Xldfx074hType;
import tw.gov.moi.domain.Rldfx074hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx074hType.class ,
        entityDsName = "rldfx074hByKey" ,
        xldfEntityClass = Xldfx074hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx074hQuery", xldfDsByTrans = "xldfx074hMaxSerialNo",  xldfDsBySerialNo = "xldfx074hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX074H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX074H")
public class XLDFX074H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX074H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx074hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx074hType domainObj;
     ...
     */
    public Xldfx074hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx074hType domainObj) {
