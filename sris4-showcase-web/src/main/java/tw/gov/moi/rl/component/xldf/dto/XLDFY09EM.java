...
import tw.gov.moi.domain.Xldfy09emType;
import tw.gov.moi.domain.Rldfy09emType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09emType.class ,
        entityDsName = "rldfy09emByKey" ,
        xldfEntityClass = Xldfy09emType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09emQuery", xldfDsByTrans = "xldfy09emMaxSerialNo",  xldfDsBySerialNo = "xldfy09emBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09EM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09EM")
public class XLDFY09EM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09EM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09emType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09emType domainObj;
     ...
     */
    public Xldfy09emType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09emType domainObj) {
