...
import tw.gov.moi.domain.Xldfy0almType;
import tw.gov.moi.domain.Rldfy0almType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0almType.class ,
        entityDsName = "rldfy0almByKey" ,
        xldfEntityClass = Xldfy0almType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0almQuery", xldfDsByTrans = "xldfy0almMaxSerialNo",  xldfDsBySerialNo = "xldfy0almBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0ALM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0ALM")
public class XLDFY0ALM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0ALM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0almType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0almType domainObj;
     ...
     */
    public Xldfy0almType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0almType domainObj) {
