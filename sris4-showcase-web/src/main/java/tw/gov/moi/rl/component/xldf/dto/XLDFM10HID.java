...
public class XLDFM10HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM10H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM10HID(String personId ,String siteId ,String dataSiteId ,String applyTransactionId ,Integer applySequenceId ,Integer applySeq ,String applyType ,String removeYyymmdd ,String removeTime,String applyCode ,String registerDate,String registerTime) {
        super();
     ...
     * 
     */
    public XLDFM10HID(String personId ,String siteId ,String dataSiteId ,String applyTransactionId ,Integer applySequenceId ,Integer applySeq ,String applyType ,String removeYyymmdd ,String removeTime ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(personId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(siteId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(dataSiteId, StringUtils.EMPTY)));
