...
/**
 * The Class Rl01835DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl01835DTO", propOrder = { "openingOperationDTO", "fatherPersonData", "xldfHouseholdHeadPersonData",
        "xldfHouseholdData", "applicant1", "applicant2", "delegatedPerson", "xldfefaplcType", "registerDate",
        "registerTime", "acceptAdminOfficeCode", "enforcedFlag", "rl01835AppDataDTOList", "rl01835AppDataDTO",
        "initializationFlag" })
@XmlRootElement(name = "Rl01835DTO")
public class Rl01835DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -368376334097861032L;
    ...
    /** 子女資料清單. */
    @XmlElement(name = "Rl01835AppDataDTOList")
    @FieldName("子女資料清單")
    private List<RlRevokeNameAppDataDTO> rl01835AppDataDTOList = new ArrayList<RlRevokeNameAppDataDTO>();

    /** 子女資料. */
    @XmlElement(name = "Rl01835AppDataDTO")
    @FieldName("子女資料")
    private RlRevokeNameAppDataDTO rl01835AppDataDTO;
    ...
    /**
     * Gets the rl01835 app data dto list.
     * 
     * @return the rl01835 app data dto list
     */
    public List<RlRevokeNameAppDataDTO> getRl01835AppDataDTOList() {
        return rl01835AppDataDTOList;
    }

    /**
     * Sets the rl01835 app data dto list.
     * 
     * @param rl01835AppDataDTOList
     *            the new rl01835 app data dto list
     */
    public void setRl01835AppDataDTOList(List<RlRevokeNameAppDataDTO> rl01835AppDataDTOList) {
        this.rl01835AppDataDTOList = rl01835AppDataDTOList;
    }

    /**
     * Gets the rl01835 app data dto.
     * 
     * @return the rl01835 app data dto
     */
    public RlRevokeNameAppDataDTO getRl01835AppDataDTO() {
        return rl01835AppDataDTO;
    }

    /**
     * Sets the rl01835 app data dto.
     * 
     * @param rl01835AppDataDTO
     *            the new rl01835 app data dto
     */
    public void setRl01835AppDataDTO(RlRevokeNameAppDataDTO rl01835AppDataDTO) {
        this.rl01835AppDataDTO = rl01835AppDataDTO;
    }
