...
import tw.gov.moi.domain.Xldfs086Type;
import tw.gov.moi.domain.Rldfs086Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs086Type.class ,
        entityDsName = "rldfs086ByKey" ,
        xldfEntityClass = Xldfs086Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs086Query", xldfDsByTrans = "xldfs086MaxSerialNo",  xldfDsBySerialNo = "xldfs086BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS086", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS086")
public class XLDFS086 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS086(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs086Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs086Type domainObj;
     ...
     */
    public Xldfs086Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs086Type domainObj) {
