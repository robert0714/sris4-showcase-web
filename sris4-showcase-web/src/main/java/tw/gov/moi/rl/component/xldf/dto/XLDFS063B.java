...
import tw.gov.moi.domain.Xldfs063bType;
import tw.gov.moi.domain.Rldfs063bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs063bType.class ,
        entityDsName = "rldfs063bByKey" ,
        xldfEntityClass = Xldfs063bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs063bQuery", xldfDsByTrans = "xldfs063bMaxSerialNo",  xldfDsBySerialNo = "xldfs063bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS063B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS063B")
public class XLDFS063B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS063B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs063bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs063bType domainObj;
     ...
     */
    public Xldfs063bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs063bType domainObj) {
