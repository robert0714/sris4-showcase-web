...
import tw.gov.moi.domain.Xldfs09bType;
import tw.gov.moi.domain.Rldfs09bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09bType.class ,
        entityDsName = "rldfs09bByKey" ,
        xldfEntityClass = Xldfs09bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09bQuery", xldfDsByTrans = "xldfs09bMaxSerialNo",  xldfDsBySerialNo = "xldfs09bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09B")
public class XLDFS09B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09B(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09bType domainObj;
     ...
     */
    public Xldfs09bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09bType domainObj) {
