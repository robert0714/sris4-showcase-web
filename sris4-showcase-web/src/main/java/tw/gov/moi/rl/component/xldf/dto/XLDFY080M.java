...
import tw.gov.moi.domain.Xldfy080mType;
import tw.gov.moi.domain.Rldfy080mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy080mType.class ,
        entityDsName = "rldfy080mByKey" ,
        xldfEntityClass = Xldfy080mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy080mQuery", xldfDsByTrans = "xldfy080mMaxSerialNo",  xldfDsBySerialNo = "xldfy080mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY080M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY080M")
public class XLDFY080M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY080M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy080mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy080mType domainObj;
     ...
     */
    public Xldfy080mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy080mType domainObj) {
