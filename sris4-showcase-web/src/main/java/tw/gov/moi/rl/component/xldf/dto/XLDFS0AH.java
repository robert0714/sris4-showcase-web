...
import tw.gov.moi.domain.Rldfs0ahType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0ahType.class ,
        entityDsName = "rldfs0ahByKey" ,
        xldfEntityClass = Xldfs0ahType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0ahQuery", xldfDsByTrans = "xldfs0ahMaxSerialNo",  xldfDsBySerialNo = "xldfs0ahBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AH")
public class XLDFS0AH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AH(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0ahType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0ahType domainObj;
     ...
     */
    public Xldfs0ahType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0ahType domainObj) {
