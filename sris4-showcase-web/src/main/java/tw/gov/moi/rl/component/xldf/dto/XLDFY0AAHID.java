...
@XmlType(name = "XLDFY0AAH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0AAH") 
public class XLDFY0AAHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0AAH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0AAHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
