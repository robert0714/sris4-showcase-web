...
import tw.gov.moi.domain.Xldfs0a4bType;
import tw.gov.moi.domain.Rldfs0a4bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a4bType.class ,
        entityDsName = "rldfs0a4bByKey" ,
        xldfEntityClass = Xldfs0a4bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a4bQuery", xldfDsByTrans = "xldfs0a4bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a4bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A4B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A4B")
public class XLDFS0A4B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A4B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a4bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a4bType domainObj;
     ...
     */
    public Xldfs0a4bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a4bType domainObj) {
