...
import tw.gov.moi.domain.Xldf003sType;
import tw.gov.moi.domain.Rldf003sType;
 ...
 */
@RldfMappingEntity(
        value = Rldf003sType.class ,
        entityDsName = "rldf003sByKey" ,
        xldfEntityClass = Xldf003sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf003sQuery", xldfDsByTrans = "xldf003sMaxSerialNo",  xldfDsBySerialNo = "xldf003sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF003S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF003S")
public class XLDF003S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF003S(String siteId ,String statisticYyymm ,String village ,String inOutCode ,String registerTime ) {
        super();
        this.domainObj = new Xldf003sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf003sType domainObj;
     ...
     */
    public Xldf003sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf003sType domainObj) {
