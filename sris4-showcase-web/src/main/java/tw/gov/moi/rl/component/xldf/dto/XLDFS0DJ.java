...
import tw.gov.moi.domain.Xldfs0djType;
import tw.gov.moi.domain.Rldfs0djType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0djType.class ,
        entityDsName = "rldfs0djByKey" ,
        xldfEntityClass = Xldfs0djType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0djQuery", xldfDsByTrans = "xldfs0djMaxSerialNo",  xldfDsBySerialNo = "xldfs0djBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DJ", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DJ")
public class XLDFS0DJ implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DJ(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0djType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0djType domainObj;
     ...
     */
    public Xldfs0djType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0djType domainObj) {
