...
public class XLDF047HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF047H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF047HID(String personId ,String removeYyymmdd ,String removeTime ,String seqNo ,String siteId ) {
        super();
