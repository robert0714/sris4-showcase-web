...
/**
 * The Class Rl02730PersonNoteDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl02730PersonNoteDTO", propOrder = { "registerYyymmdd", "registerHhmmss", "registerContent",
        "subType", "deleteFlag" })
@XmlRootElement(name = "Rl02730PersonNoteDTO")
public class Rl02730PersonNoteDTO implements Serializable {
