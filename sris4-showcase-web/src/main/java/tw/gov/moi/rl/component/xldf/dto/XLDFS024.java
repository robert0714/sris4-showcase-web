...
import tw.gov.moi.domain.Xldfs024Type;
import tw.gov.moi.domain.Rldfs024Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs024Type.class ,
        entityDsName = "rldfs024ByKey" ,
        xldfEntityClass = Xldfs024Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs024Query", xldfDsByTrans = "xldfs024MaxSerialNo",  xldfDsBySerialNo = "xldfs024BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS024", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS024")
public class XLDFS024 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS024(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs024Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs024Type domainObj;
     ...
     */
    public Xldfs024Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs024Type domainObj) {
