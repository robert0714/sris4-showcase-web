...
import tw.gov.moi.domain.Xldfw065Type;
import tw.gov.moi.domain.Rldfw065Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw065Type.class ,
        entityDsName = "rldfw065ByKey" ,
        xldfEntityClass = Xldfw065Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw065Query", xldfDsByTrans = "xldfw065MaxSerialNo",  xldfDsBySerialNo = "xldfw065BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW065", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW065")
public class XLDFW065 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW065(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw065Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw065Type domainObj;
     ...
     */
    public Xldfw065Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw065Type domainObj) {
