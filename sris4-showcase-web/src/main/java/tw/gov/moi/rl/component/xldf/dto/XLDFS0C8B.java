...
import tw.gov.moi.domain.Xldfs0c8bType;
import tw.gov.moi.domain.Rldfs0c8bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0c8bType.class ,
        entityDsName = "rldfs0c8bByKey" ,
        xldfEntityClass = Xldfs0c8bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0c8bQuery", xldfDsByTrans = "xldfs0c8bMaxSerialNo",  xldfDsBySerialNo = "xldfs0c8bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0C8B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0C8B")
public class XLDFS0C8B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0C8B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0c8bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0c8bType domainObj;
     ...
     */
    public Xldfs0c8bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0c8bType domainObj) {
