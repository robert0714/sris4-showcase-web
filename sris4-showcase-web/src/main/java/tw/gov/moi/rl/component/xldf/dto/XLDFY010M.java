...
import tw.gov.moi.domain.Xldfy010mType;
import tw.gov.moi.domain.Rldfy010mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy010mType.class ,
        entityDsName = "rldfy010mByKey" ,
        xldfEntityClass = Xldfy010mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy010mQuery", xldfDsByTrans = "xldfy010mMaxSerialNo",  xldfDsBySerialNo = "xldfy010mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY010M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY010M")
public class XLDFY010M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY010M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy010mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy010mType domainObj;
     ...
     */
    public Xldfy010mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy010mType domainObj) {
