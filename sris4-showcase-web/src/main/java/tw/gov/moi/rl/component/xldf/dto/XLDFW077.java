...
import tw.gov.moi.domain.Xldfw077Type;
import tw.gov.moi.domain.Rldfw077Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw077Type.class ,
        entityDsName = "rldfw077ByKey" ,
        xldfEntityClass = Xldfw077Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw077Query", xldfDsByTrans = "xldfw077MaxSerialNo",  xldfDsBySerialNo = "xldfw077BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW077", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW077")
public class XLDFW077 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW077(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw077Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw077Type domainObj;
     ...
     */
    public Xldfw077Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw077Type domainObj) {
