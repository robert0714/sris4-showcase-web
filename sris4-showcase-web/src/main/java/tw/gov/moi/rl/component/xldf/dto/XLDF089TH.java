...
import tw.gov.moi.domain.Xldf089thType;
 ...
 */
@RldfMappingEntity(
        value = Rldf089thType.class ,
        entityDsName = "rldf089thByKey" ,
        xldfEntityClass = Xldf089thType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf089thQuery", xldfDsByTrans = "xldf089thMaxSerialNo",  xldfDsBySerialNo = "xldf089thBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF089TH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF089TH")
public class XLDF089TH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF089TH(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String applyCode ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldf089thType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf089thType domainObj;
     ...
     */
    public Xldf089thType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf089thType domainObj) {
