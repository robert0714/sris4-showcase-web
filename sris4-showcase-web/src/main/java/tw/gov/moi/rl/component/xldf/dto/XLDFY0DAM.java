...
import tw.gov.moi.domain.Xldfy0damType;
import tw.gov.moi.domain.Rldfy0damType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0damType.class ,
        entityDsName = "rldfy0damByKey" ,
        xldfEntityClass = Xldfy0damType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0damQuery", xldfDsByTrans = "xldfy0damMaxSerialNo",  xldfDsBySerialNo = "xldfy0damBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DAM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DAM")
public class XLDFY0DAM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DAM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0damType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0damType domainObj;
     ...
     */
    public Xldfy0damType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0damType domainObj) {
