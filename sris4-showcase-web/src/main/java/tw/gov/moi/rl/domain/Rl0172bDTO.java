...
@XmlType(name = "rl0172bDTO", propOrder = { "lockMode", "mainPersonHouseholdData", "mainPersonData", "mainPersonRole",
        ...
        "afterPersonName", "afterLastName", "afterFirstName", "afterMidenName", "afterMarriedName", "changeNameFlag",
        "applyDate", "noChangeReasonCode", "updateYyymmdd", "afterItem", "lawCode", "updateReasonCode",
        "nameChangeType", "nameChangeNum", "orgNameType", "orgLastName", "orgNameWay", "nameChangeTypeShow",
        "nameChangeNumShow", "orgNameTypeShow", "orgNameWayShow", "spouseRl03100QueryShow", "certificate",
...
@XmlRootElement(name = "Rl0172bDTO")
public class Rl0172bDTO implements Serializable {
    ...
    /** 是否變更姓名. */
    @XmlElement(name = "ChangeNameFlag", required = true)
    @FieldName("是否變更姓名")
    ...
    /** 不變更原因代碼. */
    @XmlElement(name = "NoChangeReasonCode", required = true)
    @FieldName("不變更原因代碼")
    ...
    /** 變更項目. */
    @XmlElement(name = "AfterItem", required = true)
    @FieldName("變更項目")
    ...
    /** 姓名變更類別. */
    @XmlElement(name = "NameChangeType", required = true)
    @FieldName("姓名變更類別")
    private String nameChangeType;

    /** 改名次數. */
    @XmlElement(name = "NameChangeNum", required = true)
    @FieldName("改名次數")
    private String nameChangeNum;

    /** 原從姓類別. */
    @XmlElement(name = "OrgNameType", required = true)
    @FieldName("原從姓類別")
    private String orgNameType;

    /** 原從姓. */
    @XmlElement(name = "OrgLastName", required = true)
    @FieldName("原從姓")
    private String orgLastName;

    /** 原命名方式. */
    @XmlElement(name = "OrgNameWay", required = true)
    @FieldName("原命名方式")
    private String orgNameWay;

    /** 姓名變更類別是否顯示. */
    @XmlElement(name = "NameChangeTypeShow", required = true)
    @FieldName("姓名變更類別是否顯示")
    private boolean nameChangeTypeShow;

    /** 改名次數是否顯示. */
    @XmlElement(name = "NameChangeNumShow", required = true)
    @FieldName("改名次數是否顯示")
    private boolean nameChangeNumShow;

    /** 原從姓類別是否顯示. */
    @XmlElement(name = "OrgNameTypeShow", required = true)
    @FieldName("原從姓類別是否顯示")
    private boolean orgNameTypeShow;

    /** 原命名方式是否顯示. */
    @XmlElement(name = "OrgNameWayShow", required = true)
    @FieldName("原命名方式是否顯示")
     ...
     * 設定是否變更姓名.
     * 
     * @param changeNameFlag
     *            是否變更姓名
     */
    public void setChangeNameFlag(final String changeNameFlag) {
     ...
     * 設定不變更原因代碼.
     * 
     * @param noChangeReasonCode
     *            不變更原因代碼
     */
    public void setNoChangeReasonCode(final String noChangeReasonCode) {
     ...
     *            變更項目
     */
    public void setAfterItem(final String afterItem) {
     ...
     * 設定姓名變更類別.
     * 
     * @param nameChangeType
     *            姓名變更類別
     */
    public void setNameChangeType(final String nameChangeType) {
     ...
     *            改名次數
     */
    public void setNameChangeNum(final String nameChangeNum) {
     ...
     *            原從姓類別
     */
    public void setOrgNameType(final String orgNameType) {
     ...
     *            原從姓
     */
    public void setOrgLastName(final String orgLastName) {
     ...
     *            原命名方式
     */
    public void setOrgNameWay(final String orgNameWay) {
     ...
     * @return 姓名變更類別是否顯示
     */
    public boolean isNameChangeTypeShow() {
     ...
     * 設定姓名變更類別是否顯示.
     * 
     * @param nameChangeTypeShow
     *            姓名變更類別是否顯示
     */
    public void setNameChangeTypeShow(final boolean nameChangeTypeShow) {
     ...
     * @return 改名次數是否顯示
     */
    public boolean isNameChangeNumShow() {
     ...
     * 設定改名次數是否顯示.
     * 
     * @param nameChangeNumShow
     *            改名次數是否顯示
     */
    public void setNameChangeNumShow(final boolean nameChangeNumShow) {
     ...
     * @return 原從姓類別是否顯示
     */
    public boolean isOrgNameTypeShow() {
     ...
     * 設定原從姓類別是否顯示.
     * 
     * @param orgNameTypeShow
     *            原從姓類別是否顯示
     */
    public void setOrgNameTypeShow(final boolean orgNameTypeShow) {
     ...
     * @return 原命名方式是否顯示
     */
    public boolean isOrgNameWayShow() {
     ...
     * 設定原命名方式是否顯示.
     * 
     * @param orgNameWayShow
     *            原命名方式是否顯示
     */
    public void setOrgNameWayShow(final boolean orgNameWayShow) {
