...
import tw.gov.moi.domain.Xldfs0b1bType;
import tw.gov.moi.domain.Rldfs0b1bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b1bType.class ,
        entityDsName = "rldfs0b1bByKey" ,
        xldfEntityClass = Xldfs0b1bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b1bQuery", xldfDsByTrans = "xldfs0b1bMaxSerialNo",  xldfDsBySerialNo = "xldfs0b1bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B1B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B1B")
public class XLDFS0B1B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B1B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0b1bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b1bType domainObj;
     ...
     */
    public Xldfs0b1bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b1bType domainObj) {
