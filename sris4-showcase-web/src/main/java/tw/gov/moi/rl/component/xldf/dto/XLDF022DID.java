...
@XmlType(name = "XLDF022D", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF022D") 
public class XLDF022DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF022D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF022DID(String personId ,String siteId ,String applyYyymmdd ,String applyHhmmss ) {
        super();
