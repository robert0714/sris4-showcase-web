...
@XmlType(name = "XLDF089TT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF089TT") 
public class XLDF089TTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF089TT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF089TTID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String applyCode ) {
        super();
