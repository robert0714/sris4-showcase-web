...
@XmlType(name = "rl0171dAppDataDTO", propOrder = { "registerDate", "registerTime", "acceptAdminOfficeCode",
        "registerContent", "enforcedFlag", "orgEducationMark", "afterPersonName", "afterLastName", "afterFirstName",
        "afterMidenName", "afterMarriedName", "updateReasonCode", "nameWay", "updateYyymmdd", "lawCode",
        "certificateList", "certificate1", "certificate2", "certificate3", "certificate4", "certificate5",
        "certificate6", "certificate7", "certificate8", "certificate9", "certificate10", "certificate11",
        "certificate12", "certificate13", "certificate14", "certificate15", "certificate16", "certificate17",
        "certificate18", "certificate19", "certificate20", "certificate21", "certificate22", "certificate23",
        "certificate24", "certificate25", "otherCertificate", "bookFlag", "householdHeadFlag", "personForeignFlag",
        "beforePersonName", "beforeLastName", "beforeFirstName", "beforeMidenName", "beforeMarriedName", "nameWayShow",
        "outliveCaseFlag" })
@XmlRootElement(name = "Rl0171dAppDataDTO")
public class Rl0171dAppDataDTO implements Serializable {
    ...
    /** 從姓方式代碼 */
    @FieldName("從姓方式代碼")
    @XmlElement(name = "nameWay", required = false)
    ...
    /** 從姓方式 是否顯示 */
    @FieldName("從姓方式 是否顯示")
    @XmlElement(name = "nameWayShow", required = false)
    ...
    public Boolean getNameWayShow() {
        return nameWayShow;
    }

    public void setNameWayShow(Boolean nameWayShow) {
