...
import tw.gov.moi.domain.Xldfm03mtType;
import tw.gov.moi.domain.Tldfm03mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm03mType.class ,
        entityDsName = "tldfm03mByKey" ,
        xldfEntityClass = Xldfm03mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm03mtQuery", xldfDsByTrans = "xldfm03mtMaxSerialNo",  xldfDsBySerialNo = "xldfm03mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM03MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM03MT")
public class XLDFM03MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM03MT(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ) {
        super();
        this.domainObj = new Xldfm03mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm03mtType domainObj;
     ...
     */
    public Xldfm03mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm03mtType domainObj) {
