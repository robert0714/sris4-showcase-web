...
import tw.gov.moi.domain.Xldfx077hType;
import tw.gov.moi.domain.Rldfx077hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx077hType.class ,
        entityDsName = "rldfx077hByKey" ,
        xldfEntityClass = Xldfx077hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx077hQuery", xldfDsByTrans = "xldfx077hMaxSerialNo",  xldfDsBySerialNo = "xldfx077hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX077H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX077H")
public class XLDFX077H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX077H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx077hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx077hType domainObj;
     ...
     */
    public Xldfx077hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx077hType domainObj) {
