...
import tw.gov.moi.domain.Xldfs09oType;
import tw.gov.moi.domain.Rldfs09oType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09oType.class ,
        entityDsName = "rldfs09oByKey" ,
        xldfEntityClass = Xldfs09oType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09oQuery", xldfDsByTrans = "xldfs09oMaxSerialNo",  xldfDsBySerialNo = "xldfs09oBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09O", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09O")
public class XLDFS09O implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09O(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09oType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09oType domainObj;
     ...
     */
    public Xldfs09oType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09oType domainObj) {
