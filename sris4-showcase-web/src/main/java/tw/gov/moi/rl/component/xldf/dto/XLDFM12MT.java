...
import tw.gov.moi.domain.Xldfm12mtType;
import tw.gov.moi.domain.Tldfm12mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm12mType.class ,
        entityDsName = "tldfm12mByKey" ,
        xldfEntityClass = Xldfm12mtType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm12mtQuery", xldfDsByTrans = "xldfm12mtMaxSerialNo",  xldfDsBySerialNo = "xldfm12mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM12MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM12MT")
public class XLDFM12MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM12MT(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm12mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm12mtType domainObj;
     ...
     */
    public Xldfm12mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm12mtType domainObj) {
