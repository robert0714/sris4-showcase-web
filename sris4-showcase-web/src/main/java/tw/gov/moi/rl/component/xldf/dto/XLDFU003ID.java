...
@XmlType(name = "XLDFU003", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFU003") 
public class XLDFU003ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFU003.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFU003ID(String serialNumber ,String siteId ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(serialNumber, StringUtils.EMPTY)));
