...
import tw.gov.moi.domain.Xldfy010hType;
import tw.gov.moi.domain.Rldfy010hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy010hType.class ,
        entityDsName = "rldfy010hByKey" ,
        xldfEntityClass = Xldfy010hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy010hQuery", xldfDsByTrans = "xldfy010hMaxSerialNo",  xldfDsBySerialNo = "xldfy010hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY010H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY010H")
public class XLDFY010H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY010H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy010hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy010hType domainObj;
     ...
     */
    public Xldfy010hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy010hType domainObj) {
