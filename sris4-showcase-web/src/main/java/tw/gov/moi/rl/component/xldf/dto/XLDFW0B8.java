...
import tw.gov.moi.domain.Xldfw0b8Type;
import tw.gov.moi.domain.Rldfw0b8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0b8Type.class ,
        entityDsName = "rldfw0b8ByKey" ,
        xldfEntityClass = Xldfw0b8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0b8Query", xldfDsByTrans = "xldfw0b8MaxSerialNo",  xldfDsBySerialNo = "xldfw0b8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0B8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0B8")
public class XLDFW0B8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0B8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0b8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0b8Type domainObj;
     ...
     */
    public Xldfw0b8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0b8Type domainObj) {
