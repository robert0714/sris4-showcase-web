...
import tw.gov.moi.domain.Xldft088Type;
import tw.gov.moi.domain.Rldft088Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft088Type.class ,
        entityDsName = "rldft088ByKey" ,
        xldfEntityClass = Xldft088Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft088Query", xldfDsByTrans = "xldft088MaxSerialNo",  xldfDsBySerialNo = "xldft088BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT088", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT088")
public class XLDFT088 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT088(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft088Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft088Type domainObj;
     ...
     */
    public Xldft088Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft088Type domainObj) {
