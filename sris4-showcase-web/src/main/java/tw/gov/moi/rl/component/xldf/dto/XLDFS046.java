...
import tw.gov.moi.domain.Rldfs046Type;
import tw.gov.moi.domain.Xldfs046Type;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfs046Type.class, entityDsName = "rldfs046ByKey", xldfEntityClass = Xldfs046Type.class, keys = {
        @XldfKeyMapping(name = "personId", length = 10), @XldfKeyMapping(name = "applyTransactionId", length = 22),
        @XldfKeyMapping(name = "applySequenceId", length = 12), @XldfKeyMapping(name = "siteId", length = 8),
        @XldfKeyMapping(name = "applySeq", length = 12)

})
@XldfDsNameMaping(xldfDsName = "xldfs046Query", xldfDsByTrans = "xldfs046MaxSerialNo", xldfDsBySerialNo = "xldfs046BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS046", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFS046")
public class XLDFS046 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS046(String personId, String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq) {
        super();
        this.domainObj = new Xldfs046Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs046Type domainObj;
     ...
     */
    public Xldfs046Type getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfs046Type domainObj) {
     ...
     * (non-Javadoc)
     * 
     * @see tw.gov.moi.rl.component.dto.XLDFDomainObject#getTransactionId()
     */
    @Override
     ...
     * 
     * @see
     * tw.gov.moi.rl.component.dto.XLDFDomainObject#getOperationSequenceId()
     */
    @Override
