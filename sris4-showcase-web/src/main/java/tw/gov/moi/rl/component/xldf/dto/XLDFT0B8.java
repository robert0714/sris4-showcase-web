...
import tw.gov.moi.domain.Xldft0b8Type;
import tw.gov.moi.domain.Rldft0b8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0b8Type.class ,
        entityDsName = "rldft0b8ByKey" ,
        xldfEntityClass = Xldft0b8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0b8Query", xldfDsByTrans = "xldft0b8MaxSerialNo",  xldfDsBySerialNo = "xldft0b8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0B8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0B8")
public class XLDFT0B8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0B8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0b8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0b8Type domainObj;
     ...
     */
    public Xldft0b8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0b8Type domainObj) {
