...
import tw.gov.moi.domain.Xldft0a1Type;
import tw.gov.moi.domain.Rldft0a1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a1Type.class ,
        entityDsName = "rldft0a1ByKey" ,
        xldfEntityClass = Xldft0a1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a1Query", xldfDsByTrans = "xldft0a1MaxSerialNo",  xldfDsBySerialNo = "xldft0a1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A1")
public class XLDFT0A1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a1Type domainObj;
     ...
     */
    public Xldft0a1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a1Type domainObj) {
