...
import tw.gov.moi.domain.Xldfw09mType;
import tw.gov.moi.domain.Rldfw09mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09mType.class ,
        entityDsName = "rldfw09mByKey" ,
        xldfEntityClass = Xldfw09mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09mQuery", xldfDsByTrans = "xldfw09mMaxSerialNo",  xldfDsBySerialNo = "xldfw09mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09M")
public class XLDFW09M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09M(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09mType domainObj;
     ...
     */
    public Xldfw09mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09mType domainObj) {
