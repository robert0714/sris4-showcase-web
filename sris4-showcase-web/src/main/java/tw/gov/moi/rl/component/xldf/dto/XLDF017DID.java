...
@XmlType(name = "XLDF017D", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF017D") 
public class XLDF017DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF017D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF017DID(String personId ,String applyYyymmdd ,String applyHhmmss ,String siteId ) {
        super();
