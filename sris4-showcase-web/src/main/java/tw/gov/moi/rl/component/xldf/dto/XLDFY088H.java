...
import tw.gov.moi.domain.Xldfy088hType;
import tw.gov.moi.domain.Rldfy088hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy088hType.class ,
        entityDsName = "rldfy088hByKey" ,
        xldfEntityClass = Xldfy088hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy088hQuery", xldfDsByTrans = "xldfy088hMaxSerialNo",  xldfDsBySerialNo = "xldfy088hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY088H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY088H")
public class XLDFY088H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY088H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy088hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy088hType domainObj;
     ...
     */
    public Xldfy088hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy088hType domainObj) {
