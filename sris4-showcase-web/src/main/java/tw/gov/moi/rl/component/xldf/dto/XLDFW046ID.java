...
@XmlType(name = "XLDFW046", propOrder = { "keys", "xldfClass" })
@XmlRootElement(name = "XLDFW046")
public class XLDFW046ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW046.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW046ID(String personId, String applyTransactionId, Integer applySequenceId, String siteId,
            Integer applySeq) {
        super();
