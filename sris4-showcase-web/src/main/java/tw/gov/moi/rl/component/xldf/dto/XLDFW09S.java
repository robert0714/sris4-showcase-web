...
import tw.gov.moi.domain.Xldfw09sType;
import tw.gov.moi.domain.Rldfw09sType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09sType.class ,
        entityDsName = "rldfw09sByKey" ,
        xldfEntityClass = Xldfw09sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09sQuery", xldfDsByTrans = "xldfw09sMaxSerialNo",  xldfDsBySerialNo = "xldfw09sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09S")
public class XLDFW09S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09S(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09sType domainObj;
     ...
     */
    public Xldfw09sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09sType domainObj) {
