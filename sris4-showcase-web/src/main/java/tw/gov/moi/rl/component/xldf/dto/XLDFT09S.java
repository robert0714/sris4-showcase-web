...
import tw.gov.moi.domain.Xldft09sType;
import tw.gov.moi.domain.Rldft09sType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09sType.class ,
        entityDsName = "rldft09sByKey" ,
        xldfEntityClass = Xldft09sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09sQuery", xldfDsByTrans = "xldft09sMaxSerialNo",  xldfDsBySerialNo = "xldft09sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09S")
public class XLDFT09S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09S(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09sType domainObj;
     ...
     */
    public Xldft09sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09sType domainObj) {
