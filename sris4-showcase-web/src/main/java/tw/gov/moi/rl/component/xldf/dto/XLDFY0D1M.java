...
import tw.gov.moi.domain.Xldfy0d1mType;
import tw.gov.moi.domain.Rldfy0d1mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0d1mType.class ,
        entityDsName = "rldfy0d1mByKey" ,
        xldfEntityClass = Xldfy0d1mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0d1mQuery", xldfDsByTrans = "xldfy0d1mMaxSerialNo",  xldfDsBySerialNo = "xldfy0d1mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0D1M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0D1M")
public class XLDFY0D1M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0D1M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0d1mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0d1mType domainObj;
     ...
     */
    public Xldfy0d1mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0d1mType domainObj) {
