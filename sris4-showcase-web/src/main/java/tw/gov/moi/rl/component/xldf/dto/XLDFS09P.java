...
import tw.gov.moi.domain.Xldfs09pType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09pType.class ,
        entityDsName = "rldfs09pByKey" ,
        xldfEntityClass = Xldfs09pType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09pQuery", xldfDsByTrans = "xldfs09pMaxSerialNo",  xldfDsBySerialNo = "xldfs09pBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09P", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09P")
public class XLDFS09P implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09P(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09pType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09pType domainObj;
     ...
     */
    public Xldfs09pType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09pType domainObj) {
