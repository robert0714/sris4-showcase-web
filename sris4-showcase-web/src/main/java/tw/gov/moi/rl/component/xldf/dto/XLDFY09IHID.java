...
@XmlType(name = "XLDFY09IH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY09IH") 
public class XLDFY09IHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY09IH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY09IHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
