...
import tw.gov.moi.domain.Xldft09iType;
import tw.gov.moi.domain.Rldft09iType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09iType.class ,
        entityDsName = "rldft09iByKey" ,
        xldfEntityClass = Xldft09iType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09iQuery", xldfDsByTrans = "xldft09iMaxSerialNo",  xldfDsBySerialNo = "xldft09iBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09I", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09I")
public class XLDFT09I implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09I(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09iType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09iType domainObj;
     ...
     */
    public Xldft09iType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09iType domainObj) {
