...
import tw.gov.moi.domain.Xldfy079dmType;
...
/**
 * The Class XLDFY079DM.
 *
 * @author JL
 */
@RldfMappingEntity(
        value = Rldfy079dmType.class ,
        entityDsName = "rldfy079dmByKey" ,
        xldfEntityClass = Xldfy079dmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy079dmQuery", xldfDsByTrans = "xldfy079dmMaxSerialNo",  xldfDsBySerialNo = "xldfy079dmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY079DM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY079DM")
public class XLDFY079DM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY079DM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
        this.domainObj = new Xldfy079dmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy079dmType domainObj;
     ...
     */
    public Xldfy079dmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy079dmType domainObj) {
