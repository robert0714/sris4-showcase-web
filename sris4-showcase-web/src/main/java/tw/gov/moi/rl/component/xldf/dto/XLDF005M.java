 ...
 */
@RldfMappingEntity(
        value = Rldf005mType.class ,
        entityDsName = "rldf005mByKey" ,
        xldfEntityClass = Xldf005mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf005mQuery", xldfDsByTrans = "xldf005mMaxSerialNo",  xldfDsBySerialNo = "xldf005mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF005M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF005M")
public class XLDF005M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF005M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf005mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf005mType domainObj;
     ...
     */
    public Xldf005mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf005mType domainObj) {
