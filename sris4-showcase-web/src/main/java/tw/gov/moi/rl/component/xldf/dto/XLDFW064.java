...
import tw.gov.moi.domain.Xldfw064Type;
import tw.gov.moi.domain.Rldfw064Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw064Type.class ,
        entityDsName = "rldfw064ByKey" ,
        xldfEntityClass = Xldfw064Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw064Query", xldfDsByTrans = "xldfw064MaxSerialNo",  xldfDsBySerialNo = "xldfw064BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW064", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW064")
public class XLDFW064 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW064(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw064Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw064Type domainObj;
     ...
     */
    public Xldfw064Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw064Type domainObj) {
