...
import tw.gov.moi.domain.Xldft0b1Type;
import tw.gov.moi.domain.Rldft0b1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0b1Type.class ,
        entityDsName = "rldft0b1ByKey" ,
        xldfEntityClass = Xldft0b1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0b1Query", xldfDsByTrans = "xldft0b1MaxSerialNo",  xldfDsBySerialNo = "xldft0b1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0B1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0B1")
public class XLDFT0B1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0B1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0b1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0b1Type domainObj;
     ...
     */
    public Xldft0b1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0b1Type domainObj) {
