...
import tw.gov.moi.domain.Xldfm01hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm01hType.class ,
        entityDsName = "rldfm01hByKey" ,
        xldfEntityClass = Xldfm01hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm01hQuery", xldfDsByTrans = "xldfm01hMaxSerialNo",  xldfDsBySerialNo = "xldfm01hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM01H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM01H")
public class XLDFM01H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM01H(String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldfm01hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm01hType domainObj;
     ...
     */
    public Xldfm01hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm01hType domainObj) {
