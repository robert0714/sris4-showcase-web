...
import tw.gov.moi.domain.Xldfs09rType;
import tw.gov.moi.domain.Rldfs09rType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09rType.class ,
        entityDsName = "rldfs09rByKey" ,
        xldfEntityClass = Xldfs09rType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09rQuery", xldfDsByTrans = "xldfs09rMaxSerialNo",  xldfDsBySerialNo = "xldfs09rBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09R", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09R")
public class XLDFS09R implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09R(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09rType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09rType domainObj;
     ...
     */
    public Xldfs09rType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09rType domainObj) {
