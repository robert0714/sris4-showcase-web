...
import tw.gov.moi.domain.Xldf021mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf021mType.class ,
        entityDsName = "rldf021mByKey" ,
        xldfEntityClass = Xldf021mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "householdId" , length = 8),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf021mQuery", xldfDsByTrans = "xldf021mMaxSerialNo",  xldfDsBySerialNo = "xldf021mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF021M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF021M")
public class XLDF021M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF021M(String householdId ,String siteId ) {
        super();
        this.domainObj = new Xldf021mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf021mType domainObj;
     ...
     */
    public Xldf021mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf021mType domainObj) {
