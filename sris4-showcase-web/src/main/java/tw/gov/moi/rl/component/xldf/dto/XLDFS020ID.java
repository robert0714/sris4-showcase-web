...
@XmlType(name = "XLDFS020", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS020") 
public class XLDFS020ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS020.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS020ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
