...
import tw.gov.moi.domain.Xldfy0a3mType;
import tw.gov.moi.domain.Rldfy0a3mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a3mType.class ,
        entityDsName = "rldfy0a3mByKey" ,
        xldfEntityClass = Xldfy0a3mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a3mQuery", xldfDsByTrans = "xldfy0a3mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a3mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A3M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A3M")
public class XLDFY0A3M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A3M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a3mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a3mType domainObj;
     ...
     */
    public Xldfy0a3mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a3mType domainObj) {
