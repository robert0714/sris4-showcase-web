...
@XmlType(name = "Rl01810DTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl01810AppDataDTO",
        "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication" })
@XmlRootElement(name = "Rl01810DTO")
public class Rl01810DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -6286701644018302681L;
    ...
    @XmlElement(name = "Rl01810AppDataDTO")
    @FieldName("配偶姓名更正撤銷登記AppDataDTO")
    private Rl01810AppDataDTO rl01810AppDataDTO = new Rl01810AppDataDTO();
    ...
    /**
     * Gets the rl01810 app data dto.
     * 
     * @return the rl01810 app data dto
     */
    public Rl01810AppDataDTO getRl01810AppDataDTO() {
        return rl01810AppDataDTO;
    }

    /**
     * Sets the rl01810 app data dto.
     * 
     * @param rl01810AppDataDTO
     *            the new rl01810 app data dto
     */
    public void setRl01810AppDataDTO(final Rl01810AppDataDTO rl01810AppDataDTO) {
        this.rl01810AppDataDTO = rl01810AppDataDTO;
    }
