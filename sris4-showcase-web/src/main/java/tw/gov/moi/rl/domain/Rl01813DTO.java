...
import tw.gov.moi.rl.component.xldf.dto.XLDFY093H;
import tw.gov.moi.rl.component.xldf.dto.XLDFY093M;
...
public class Rl01813DTO implements Serializable {
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY093M> personNoteDetailList = new ArrayList<XLDFY093M>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY093H> removedPersonNoteDetailList = new ArrayList<XLDFY093H>();
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY093M> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY093M> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY093H> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY093H> removedPersonNoteDetailList) {
