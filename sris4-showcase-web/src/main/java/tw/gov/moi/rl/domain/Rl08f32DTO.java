...
@XmlType(name = "rl08f32DTO", propOrder = { "voteCode", "voteDate", "votePoint", "voteReportType", "voteReportName",
        ...
        "issueName1", "issueName2", "issueName3", "issueName4", "issueName5", "reportUrl", "reportParams",
        "reportName", "rlde808wFlag", "rlde808w", "labelHead", "voterRollsInfoDTO" })
@XmlRootElement(name = "Rl08f32DTO")
public class Rl08f32DTO implements Serializable {
    ...
    @XmlElement(name = "VoteReportType")
    @FieldName("選舉名冊種類")
    private String voteReportType = "";
    ...
    public String getVoteReportType() {
        return voteReportType;
    }

    public void setVoteReportType(String voteReportType) {
        this.voteReportType = voteReportType;
    }
