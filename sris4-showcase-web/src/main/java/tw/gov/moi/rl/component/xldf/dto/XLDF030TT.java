...
import tw.gov.moi.domain.Xldf030ttType;
import tw.gov.moi.domain.Tldf030tType;
 ...
 */
@RldfMappingEntity(
        value = Tldf030tType.class ,
        entityDsName = "tldf030tByKey" ,
        xldfEntityClass = Xldf030ttType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf030ttQuery", xldfDsByTrans = "xldf030ttMaxSerialNo",  xldfDsBySerialNo = "xldf030ttBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF030TT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF030TT")
public class XLDF030TT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF030TT(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf030ttType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf030ttType domainObj;
     ...
     */
    public Xldf030ttType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf030ttType domainObj) {
