...
import tw.gov.moi.domain.Xldfx0a8mType;
import tw.gov.moi.domain.Rldfx0a8mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0a8mType.class ,
        entityDsName = "rldfx0a8mByKey" ,
        xldfEntityClass = Xldfx0a8mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0a8mQuery", xldfDsByTrans = "xldfx0a8mMaxSerialNo",  xldfDsBySerialNo = "xldfx0a8mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0A8M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0A8M")
public class XLDFX0A8M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0A8M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0a8mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0a8mType domainObj;
     ...
     */
    public Xldfx0a8mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0a8mType domainObj) {
