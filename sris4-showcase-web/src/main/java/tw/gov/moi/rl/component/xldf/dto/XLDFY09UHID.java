...
@XmlType(name = "XLDFY09UH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY09UH") 
public class XLDFY09UHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY09UH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY09UHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
