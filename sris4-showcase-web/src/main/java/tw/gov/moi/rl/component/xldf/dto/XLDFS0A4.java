...
import tw.gov.moi.domain.Xldfs0a4Type;
import tw.gov.moi.domain.Rldfs0a4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a4Type.class ,
        entityDsName = "rldfs0a4ByKey" ,
        xldfEntityClass = Xldfs0a4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a4Query", xldfDsByTrans = "xldfs0a4MaxSerialNo",  xldfDsBySerialNo = "xldfs0a4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A4")
public class XLDFS0A4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a4Type domainObj;
     ...
     */
    public Xldfs0a4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a4Type domainObj) {
