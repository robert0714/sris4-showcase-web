...
import tw.gov.moi.domain.Xldft0y1Type;
import tw.gov.moi.domain.Rldft0y1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0y1Type.class ,
        entityDsName = "rldft0y1ByKey" ,
        xldfEntityClass = Xldft0y1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0y1Query", xldfDsByTrans = "xldft0y1MaxSerialNo",  xldfDsBySerialNo = "xldft0y1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0Y1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0Y1")
public class XLDFT0Y1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0Y1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0y1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0y1Type domainObj;
     ...
     */
    public Xldft0y1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0y1Type domainObj) {
