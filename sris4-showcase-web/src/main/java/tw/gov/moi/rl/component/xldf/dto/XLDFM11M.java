...
import tw.gov.moi.domain.Xldfm11mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm11mType.class ,
        entityDsName = "rldfm11mByKey" ,
        xldfEntityClass = Xldfm11mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "personId" , length = 10)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm11mQuery", xldfDsByTrans = "xldfm11mMaxSerialNo",  xldfDsBySerialNo = "xldfm11mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM11M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM11M")
public class XLDFM11M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM11M(String siteId ,String personId ) {
        super();
        this.domainObj = new Xldfm11mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm11mType domainObj;
     ...
     */
    public Xldfm11mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm11mType domainObj) {
