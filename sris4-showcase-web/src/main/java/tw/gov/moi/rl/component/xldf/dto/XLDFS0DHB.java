...
import tw.gov.moi.domain.Xldfs0dhbType;
import tw.gov.moi.domain.Rldfs0dhbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0dhbType.class ,
        entityDsName = "rldfs0dhbByKey" ,
        xldfEntityClass = Xldfs0dhbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0dhbQuery", xldfDsByTrans = "xldfs0dhbMaxSerialNo",  xldfDsBySerialNo = "xldfs0dhbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DHB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DHB")
public class XLDFS0DHB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DHB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0dhbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0dhbType domainObj;
     ...
     */
    public Xldfs0dhbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0dhbType domainObj) {
