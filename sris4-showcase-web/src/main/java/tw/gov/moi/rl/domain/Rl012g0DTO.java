...
import tw.gov.moi.rl.component.xldf.dto.XLDFY081DH;
import tw.gov.moi.rl.component.xldf.dto.XLDFY081DM;
import tw.gov.moi.rl.component.xldf.dto.XLDFY081H;
import tw.gov.moi.rl.component.xldf.dto.XLDFY081M;
...
public class Rl012g0DTO implements Serializable {
    ...
    @FieldName("受輔助人-輔助資料檔清單")
    private List<Rldfm05mType> m05mList = new ArrayList<Rldfm05mType>();

    /** 受輔助人符合民法第15條之2第1項第7款旗標 */
    @XmlElement(name = "MainPersonMeetRule15217Flag", required = true)
    @FieldName("受輔助人符合民法第15條之2第1項第7款旗標")
    private String mainPersonMeetRule15217Flag;
    ...
    /** 輔助人變更旗標 */
    @XmlElement(name = "SuperviorChangeFlag", required = true)
    @FieldName("輔助人變更旗標")
    private String superviorChangeFlag;
    ...
    /** 非輔助人變更-法院裁判日期 */
    @XmlElement(name = "NoChangeSuJudgeDate", required = true)
    @FieldName("非輔助人變更-法院裁判日期")
    private String noChangeSuJudgeDate;

    /** 非輔助人變更-法院裁判方式 */
    @XmlElement(name = "NoChangeSuJudgeWay", required = true)
    @FieldName("非輔助人變更-法院裁判方式")
    private String noChangeSuJudgeWay;

    /** 輔助人變更-法院裁判日期 */
    @XmlElement(name = "ChangeSuJudgeDate", required = true)
    @FieldName("輔助人變更-法院裁判日期")
    private String changeSuJudgeDate;

    /** 輔助人變更-法院裁判方式 */
    @XmlElement(name = "ChangeSuJudgeWay", required = true)
    @FieldName("輔助人變更-法院裁判方式")
    private String changeSuJudgeWay;

    /** 輔助人變更-輔助人變更原因 */
    @XmlElement(name = "ChangeSuSuChangeReason", required = true)
    @FieldName("輔助人變更-輔助人變更原因")
    private String changeSuSuChangeReason;

    /** 輔助人變更-其他變更原因 */
    @XmlElement(name = "ChangeSuOtherSuChangeReason", required = true)
    @FieldName("輔助人變更-其他變更原因")
    private String changeSuOtherSuChangeReason;

    /** 輔助人變更-前輔助人姓名 */
    @XmlElement(name = "ChangeSuPreviousSuName", required = true)
    @FieldName("輔助人變更-前輔助人姓名")
    private String changeSuPreviousSuName;

    /** 輔助人變更-前父姓名 */
    @XmlElement(name = "ChangeSuPreviousFatherName", required = true)
    @FieldName("輔助人變更-前父姓名")
    private String changeSuPreviousFatherName;

    /** 輔助人變更-前母姓名 */
    @XmlElement(name = "ChangeSuPreviousMotherName", required = true)
    @FieldName("輔助人變更-前母姓名")
    private String changeSuPreviousMotherName;
    ...
    /** 其他輔助原因 */
    @XmlElement(name = "OtherSuperviseReason", required = true)
    @FieldName("其他輔助原因")
    private String otherSuperviseReason;
    ...
    private List<XLDFY081M> personNoteDetailList = new ArrayList<XLDFY081M>();

    /** 除戶個人記事欄位化清單-主檔 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單-主檔")
    private List<XLDFY081H> removedPersonNoteDetailList = new ArrayList<XLDFY081H>();

    /** 個人記事欄位化清單-子檔 */
    @XmlElement(name = "PersonNoteDetailSubList", required = true)
    @FieldName("個人記事欄位化清單-子檔")
    private List<XLDFY081DM> personNoteDetailSubList = new ArrayList<XLDFY081DM>();

    /** 除戶個人記事欄位化清單-子檔 */
    @XmlElement(name = "RemovedPersonNoteDetailSubList", required = true)
    @FieldName("除戶個人記事欄位化清單-子檔")
    private List<XLDFY081DH> removedPersonNoteDetailSubList = new ArrayList<XLDFY081DH>();
    ...
    /**
     * 取得受輔助人符合民法第15條之2第1項第7款旗標
     * 
     * @return 受輔助人符合民法第15條之2第1項第7款旗標
     */
    public String getMainPersonMeetRule15217Flag() {
        return mainPersonMeetRule15217Flag;
    }

    /**
     * 設定受輔助人符合民法第15條之2第1項第7款旗標
     * 
     * @param mainPersonMeetRule15217Flag
     *            受輔助人符合民法第15條之2第1項第7款旗標
     */
    public void setMainPersonMeetRule15217Flag(final String mainPersonMeetRule15217Flag) {
        this.mainPersonMeetRule15217Flag = mainPersonMeetRule15217Flag;
    }
     ...
     * @return 輔助人變更旗標
     */
    public String getSuperviorChangeFlag() {
        return superviorChangeFlag;
    }

    /**
     * 設定輔助人變更旗標
     * 
     * @param superviorChangeFlag
     *            輔助人變更旗標
     */
    public void setSuperviorChangeFlag(final String superviorChangeFlag) {
        this.superviorChangeFlag = superviorChangeFlag;
    }
     ...
     * 取得非輔助人變更-法院裁判日期
     * 
     * @return 非輔助人變更-法院裁判日期
     */
    public String getNoChangeSuJudgeDate() {
        return noChangeSuJudgeDate;
    }

    /**
     * 設定非輔助人變更-法院裁判日期
     * 
     * @param noChangeSuJudgeDate
     *            非輔助人變更-法院裁判日期
     */
    public void setNoChangeSuJudgeDate(final String noChangeSuJudgeDate) {
        this.noChangeSuJudgeDate = noChangeSuJudgeDate;
    }

    /**
     * 取得非輔助人變更-法院裁判方式
     * 
     * @return 非輔助人變更-法院裁判方式
     */
    public String getNoChangeSuJudgeWay() {
        return noChangeSuJudgeWay;
    }

    /**
     * 設定非輔助人變更-法院裁判方式
     * 
     * @param noChangeSuJudgeWay
     *            非輔助人變更-法院裁判方式
     */
    public void setNoChangeSuJudgeWay(final String noChangeSuJudgeWay) {
        this.noChangeSuJudgeWay = noChangeSuJudgeWay;
    }
     ...
     * @return 輔助人變更-法院裁判日期
     */
    public String getChangeSuJudgeDate() {
        return changeSuJudgeDate;
    }

    /**
     * 設定輔助人變更-法院裁判日期
     * 
     * @param changeSuJudgeDate
     *            輔助人變更-法院裁判日期
     */
    public void setChangeSuJudgeDate(final String changeSuJudgeDate) {
        this.changeSuJudgeDate = changeSuJudgeDate;
    }
     ...
     * @return 輔助人變更-法院裁判方式
     */
    public String getChangeSuJudgeWay() {
        return changeSuJudgeWay;
    }

    /**
     * 設定輔助人變更-法院裁判方式
     * 
     * @param changeSuJudgeWay
     *            輔助人變更-法院裁判方式
     */
    public void setChangeSuJudgeWay(final String changeSuJudgeWay) {
        this.changeSuJudgeWay = changeSuJudgeWay;
    }

    /**
     * 取得輔助人變更-輔助人變更原因
     * 
     * @return 輔助人變更-輔助人變更原因
     */
    public String getChangeSuSuChangeReason() {
        return changeSuSuChangeReason;
    }

    /**
     * 設定輔助人變更-輔助人變更原因
     * 
     * @param changeSuSuChangeReason
     *            輔助人變更-輔助人變更原因
     */
    public void setChangeSuSuChangeReason(final String changeSuSuChangeReason) {
        this.changeSuSuChangeReason = changeSuSuChangeReason;
    }
     ...
     * @return 輔助人變更-其他變更原因
     */
    public String getChangeSuOtherSuChangeReason() {
        return changeSuOtherSuChangeReason;
    }

    /**
     * 設定輔助人變更-其他變更原因
     * 
     * @param changeSuOtherSuChangeReason
     *            輔助人變更-其他變更原因
     */
    public void setChangeSuOtherSuChangeReason(final String changeSuOtherSuChangeReason) {
        this.changeSuOtherSuChangeReason = changeSuOtherSuChangeReason;
    }
     ...
     * @return 輔助人變更-前輔助人姓名
     */
    public String getChangeSuPreviousSuName() {
        return changeSuPreviousSuName;
    }

    /**
     * 設定輔助人變更-前輔助人姓名
     * 
     * @param changeSuPreviousSuName
     *            輔助人變更-前輔助人姓名
     */
    public void setChangeSuPreviousSuName(final String changeSuPreviousSuName) {
        this.changeSuPreviousSuName = changeSuPreviousSuName;
    }
     ...
     * @return 輔助人變更-前父姓名
     */
    public String getChangeSuPreviousFatherName() {
        return changeSuPreviousFatherName;
    }

    /**
     * 設定輔助人變更-前父姓名
     * 
     * @param changeSuPreviousFatherName
     *            輔助人變更-前父姓名
     */
    public void setChangeSuPreviousFatherName(final String changeSuPreviousFatherName) {
        this.changeSuPreviousFatherName = changeSuPreviousFatherName;
    }
     ...
     * @return 輔助人變更-前母姓名
     */
    public String getChangeSuPreviousMotherName() {
        return changeSuPreviousMotherName;
    }

    /**
     * 設定輔助人變更-前母姓名
     * 
     * @param changeSuPreviousMotherName
     *            輔助人變更-前母姓名
     */
    public void setChangeSuPreviousMotherName(final String changeSuPreviousMotherName) {
        this.changeSuPreviousMotherName = changeSuPreviousMotherName;
    }
     ...
     * @return 其他輔助原因
     */
    public String getOtherSuperviseReason() {
        return otherSuperviseReason;
    }

    /**
     * 設定其他輔助原因
     * 
     * @param otherSuperviseReason
     *            其他輔助原因
     */
    public void setOtherSuperviseReason(final String otherSuperviseReason) {
        this.otherSuperviseReason = otherSuperviseReason;
    }
     ...
     * @return 個人記事欄位化清單-主檔
     */
    public List<XLDFY081M> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單-主檔
     */
    public void setPersonNoteDetailList(final List<XLDFY081M> personNoteDetailList) {
     ...
     */
    public List<XLDFY081H> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單-主檔
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY081H> removedPersonNoteDetailList) {
     ...
     * @return 個人記事欄位化清單-子檔
     */
    public List<XLDFY081DM> getPersonNoteDetailSubList() {
     ...
     *            個人記事欄位化清單-子檔
     */
    public void setPersonNoteDetailSubList(final List<XLDFY081DM> personNoteDetailSubList) {
     ...
     */
    public List<XLDFY081DH> getRemovedPersonNoteDetailSubList() {
     ...
     *            除戶個人記事欄位化清單-子檔
     */
    public void setRemovedPersonNoteDetailSubList(final List<XLDFY081DH> removedPersonNoteDetailSubList) {
    ...
    /**
     * 取得頁面控制:新增申請人1為輔助人之按鈕是否顯示
     * 
     * @return 頁面控制:新增申請人1為輔助人之按鈕是否顯示
     */
    ...
    /**
     * 取得頁面控制:新增申請人2為輔助人之按鈕是否顯示
     * 
     * @return 頁面控制:新增申請人2為輔助人之按鈕是否顯示
     */
    ...
    /**
     * 取得頁面控制:新增輔助人資料模式(true=申請人轉輔助人;false=取得新輔助人)
     * 
     * @return 頁面控制:新增輔助人資料模式(true=申請人轉輔助人;false=取得新輔助人)
     */
    ...
    /**
     * 設定頁面控制:新增輔助人資料模式(true=申請人轉輔助人;false=取得新輔助人)
     * 
