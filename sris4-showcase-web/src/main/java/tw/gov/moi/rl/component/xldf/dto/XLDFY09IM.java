...
import tw.gov.moi.domain.Xldfy09imType;
import tw.gov.moi.domain.Rldfy09imType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09imType.class ,
        entityDsName = "rldfy09imByKey" ,
        xldfEntityClass = Xldfy09imType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09imQuery", xldfDsByTrans = "xldfy09imMaxSerialNo",  xldfDsBySerialNo = "xldfy09imBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09IM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09IM")
public class XLDFY09IM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09IM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09imType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09imType domainObj;
     ...
     */
    public Xldfy09imType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09imType domainObj) {
