...
import tw.gov.moi.domain.Xldfs088bType;
import tw.gov.moi.domain.Rldfs088bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs088bType.class ,
        entityDsName = "rldfs088bByKey" ,
        xldfEntityClass = Xldfs088bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs088bQuery", xldfDsByTrans = "xldfs088bMaxSerialNo",  xldfDsBySerialNo = "xldfs088bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS088B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS088B")
public class XLDFS088B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS088B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs088bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs088bType domainObj;
     ...
     */
    public Xldfs088bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs088bType domainObj) {
