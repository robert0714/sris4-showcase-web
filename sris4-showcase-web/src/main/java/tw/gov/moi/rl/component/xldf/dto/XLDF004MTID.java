...
public class XLDF004MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF004MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF004MTID(String personId ,String siteId ) {
        super();
