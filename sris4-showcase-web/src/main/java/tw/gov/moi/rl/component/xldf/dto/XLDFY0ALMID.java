...
public class XLDFY0ALMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0ALM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0ALMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
