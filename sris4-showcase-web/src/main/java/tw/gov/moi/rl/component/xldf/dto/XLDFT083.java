...
import tw.gov.moi.domain.Xldft083Type;
import tw.gov.moi.domain.Rldft083Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft083Type.class ,
        entityDsName = "rldft083ByKey" ,
        xldfEntityClass = Xldft083Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft083Query", xldfDsByTrans = "xldft083MaxSerialNo",  xldfDsBySerialNo = "xldft083BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT083", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT083")
public class XLDFT083 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT083(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft083Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft083Type domainObj;
     ...
     */
    public Xldft083Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft083Type domainObj) {
