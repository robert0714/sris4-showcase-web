...
import tw.gov.moi.domain.Xldf010hType;
 ...
 */
@RldfMappingEntity(
        value = Rldf010hType.class ,
        entityDsName = "rldf010hByKey" ,
        xldfEntityClass = Xldf010hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf010hQuery", xldfDsByTrans = "xldf010hMaxSerialNo",  xldfDsBySerialNo = "xldf010hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF010H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF010H")
public class XLDF010H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF010H(String personId ,String removeYyymmdd ,String removeTime ,String siteId ,String specialCode ) {
        super();
        this.domainObj = new Xldf010hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf010hType domainObj;
     ...
     */
    public Xldf010hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf010hType domainObj) {
