...
public class Rl07450DTO implements Serializable {
    ...
    @XmlElement(name = "tempYyymmdd")
    @FieldName("法定月日")
    private String tempYyymmdd;
    
    @XmlElement(name = "applyCaseCodeChs")
    @FieldName("申登岸別中文")
    private String applyCaseCodeChs;
    ...
    public String getTempYyymmdd() {
        return tempYyymmdd;
    }

    public void setTempYyymmdd(String tempYyymmdd) {
        this.tempYyymmdd = tempYyymmdd;
    }

    public String getApplyCaseCodeChs() {
        return applyCaseCodeChs;
    }

    public void setApplyCaseCodeChs(String applyCaseCodeChs) {
        this.applyCaseCodeChs = applyCaseCodeChs;
    }
    ...
    public String toString() {
        return "Rl07450DTO [areaCode1=" + areaCode1 + ", personId=" + personId + ", personIdFind=" + personIdFind
                + ", siteIdFind=" + siteIdFind + ", registerDate=" + registerDate + ", registerTime=" + registerTime
                + ", document=" + document + ", transactionCaseCode=" + transactionCaseCode + ", applyCaseCode="
                + applyCaseCode + ", nowUseNo=" + nowUseNo + ", personName=" + personName + ", birthYyymmdd="
                + birthYyymmdd + ", gender=" + gender + ", endingDate=" + endingDate + ", assignAddr=" + assignAddr
                + ", areaCode=" + areaCode + ", village=" + village + ", neighbor=" + neighbor + ", streetDoorplate="
                + streetDoorplate + ", householdHeadId=" + householdHeadId + ", householdId=" + householdId
                + ", householdHeadName=" + householdHeadName + ", transactionId=" + transactionId + ", gist=" + gist
                + ", fact=" + fact + ", laws=" + laws + ", annotation=" + annotation + ", incidentDate=" + incidentDate
                + ", siteType=" + siteType + ", reportURL=" + reportURL + ", printFlag=" + printFlag
                + ", personIdFlag=" + personIdFlag + ", transactionCaseCodeFlag=" + transactionCaseCodeFlag
                + ", incidentDateFlag=" + incidentDateFlag + ", applyCaseCodeFlag=" + applyCaseCodeFlag
                + ", endingDateFlag=" + endingDateFlag + ", siteTypeFlag=" + siteTypeFlag
                + ", addVerifyDataButtonFlag=" + addVerifyDataButtonFlag + ", addConfirmDataButtonFlag="
                + addConfirmDataButtonFlag + ", selectedRldf009eType=" + selectedRldf009eType + ", editedRldf009eType="
                + editedRldf009eType + ", listRldf009eType=" + listRldf009eType + ", listRlde009e01Type="
                + listRlde009e01Type + ", listRlde009e02Type=" + listRlde009e02Type + ", listRlde009e03Type="
                + listRlde009e03Type + ", listRlde009e04Type=" + listRlde009e04Type + ", officeTel=" + officeTel
                + ", officeUserName=" + officeUserName + ", tempYyymmdd=" + tempYyymmdd + ", applyCaseCodeChs="
                + applyCaseCodeChs + "]";
    }
}
