...
import tw.gov.moi.domain.Xldfs079bType;
import tw.gov.moi.domain.Rldfs079bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs079bType.class ,
        entityDsName = "rldfs079bByKey" ,
        xldfEntityClass = Xldfs079bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs079bQuery", xldfDsByTrans = "xldfs079bMaxSerialNo",  xldfDsBySerialNo = "xldfs079bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS079B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS079B")
public class XLDFS079B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS079B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs079bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs079bType domainObj;
     ...
     */
    public Xldfs079bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs079bType domainObj) {
