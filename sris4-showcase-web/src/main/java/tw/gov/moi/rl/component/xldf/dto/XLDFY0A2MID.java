...
@XmlType(name = "XLDFY0A2M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0A2M") 
public class XLDFY0A2MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0A2M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0A2MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
