...
import tw.gov.moi.domain.Xldfr099Type;
import tw.gov.moi.domain.Rldfr099Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr099Type.class ,
        entityDsName = "rldfr099ByKey" ,
        xldfEntityClass = Xldfr099Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr099Query", xldfDsByTrans = "xldfr099MaxSerialNo",  xldfDsBySerialNo = "xldfr099BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR099", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR099")
public class XLDFR099 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR099(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr099Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr099Type domainObj;
     ...
     */
    public Xldfr099Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr099Type domainObj) {
