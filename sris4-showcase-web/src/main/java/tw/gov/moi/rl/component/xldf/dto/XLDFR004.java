...
import tw.gov.moi.domain.Xldfr004Type;
import tw.gov.moi.domain.Rldfr004Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr004Type.class ,
        entityDsName = "rldfr004ByKey" ,
        xldfEntityClass = Xldfr004Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr004Query", xldfDsByTrans = "xldfr004MaxSerialNo",  xldfDsBySerialNo = "xldfr004BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR004", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR004")
public class XLDFR004 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR004(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr004Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr004Type domainObj;
     ...
     */
    public Xldfr004Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr004Type domainObj) {
