...
import tw.gov.moi.domain.Xldfs0b5bType;
import tw.gov.moi.domain.Rldfs0b5bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b5bType.class ,
        entityDsName = "rldfs0b5bByKey" ,
        xldfEntityClass = Xldfs0b5bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b5bQuery", xldfDsByTrans = "xldfs0b5bMaxSerialNo",  xldfDsBySerialNo = "xldfs0b5bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B5B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B5B")
public class XLDFS0B5B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B5B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0b5bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b5bType domainObj;
     ...
     */
    public Xldfs0b5bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b5bType domainObj) {
