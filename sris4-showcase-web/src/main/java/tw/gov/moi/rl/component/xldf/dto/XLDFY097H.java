...
import tw.gov.moi.domain.Xldfy097hType;
import tw.gov.moi.domain.Rldfy097hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy097hType.class ,
        entityDsName = "rldfy097hByKey" ,
        xldfEntityClass = Xldfy097hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy097hQuery", xldfDsByTrans = "xldfy097hMaxSerialNo",  xldfDsBySerialNo = "xldfy097hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY097H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY097H")
public class XLDFY097H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY097H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy097hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy097hType domainObj;
     ...
     */
    public Xldfy097hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy097hType domainObj) {
