...
import tw.gov.moi.domain.Xldfw09rType;
import tw.gov.moi.domain.Rldfw09rType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09rType.class ,
        entityDsName = "rldfw09rByKey" ,
        xldfEntityClass = Xldfw09rType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09rQuery", xldfDsByTrans = "xldfw09rMaxSerialNo",  xldfDsBySerialNo = "xldfw09rBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09R", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09R")
public class XLDFW09R implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09R(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09rType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09rType domainObj;
     ...
     */
    public Xldfw09rType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09rType domainObj) {
