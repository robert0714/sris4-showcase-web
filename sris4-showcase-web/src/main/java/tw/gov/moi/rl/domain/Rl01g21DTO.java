...
import tw.gov.moi.rl.component.xldf.dto.XLDFY0DHH;
import tw.gov.moi.rl.component.xldf.dto.XLDFY0DHM;
...
public class Rl01g21DTO implements Serializable {
    ...
    /** 法院撤銷監護宣告 */
    @XmlElement(name = "DeclareSuCancelFlag", required = true)
    @FieldName("法院撤銷監護宣告")
    private String declareSuCancelFlag;

    /** 法院撤銷監護宣告日期 */
    @XmlElement(name = "DeclareSuCancelDate", required = true)
    @FieldName("法院撤銷監護宣告日期")
    private String declareSuCancelDate;

    /** 廢止監護為委託監護 */
    @XmlElement(name = "DelegateSuFlag", required = true)
    @FieldName("廢止監護為委託監護")
    private String delegateSuFlag;
    ...
    /** 其他廢止原因 */
    @XmlElement(name = "OtherTerminateReason", required = true)
    @FieldName("其他廢止原因")
    private String otherTerminateReason;
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY0DHM> personNoteDetailList = new ArrayList<XLDFY0DHM>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY0DHH> removedPersonNoteDetailList = new ArrayList<XLDFY0DHH>();
     ...
     * @return 法院撤銷監護宣告
     */
    public String getDeclareSuCancelFlag() {
        return declareSuCancelFlag;
    }

    /**
     * 設定法院撤銷監護宣告
     * 
     * @param declareSuCancelFlag
     *            法院撤銷監護宣告
     */
    public void setDeclareSuCancelFlag(final String declareSuCancelFlag) {
        this.declareSuCancelFlag = declareSuCancelFlag;
    }
     ...
     * @return 法院撤銷監護宣告日期
     */
    public String getDeclareSuCancelDate() {
        return declareSuCancelDate;
    }

    /**
     * 設定法院撤銷監護宣告日期
     * 
     * @param declareSuCancelDate
     *            法院撤銷監護宣告日期
     */
    public void setDeclareSuCancelDate(final String declareSuCancelDate) {
        this.declareSuCancelDate = declareSuCancelDate;
    }
     ...
     * @return 廢止監護為委託監護
     */
    public String getDelegateSuFlag() {
        return delegateSuFlag;
    }

    /**
     * 設定廢止監護為委託監護
     * 
     * @param delegateSuFlag
     *            廢止監護為委託監護
     */
    public void setDelegateSuFlag(final String delegateSuFlag) {
        this.delegateSuFlag = delegateSuFlag;
    }
     ...
     * @return 其他廢止原因
     */
    public String getOtherTerminateReason() {
        return otherTerminateReason;
    }

    /**
     * 設定其他廢止原因
     * 
     * @param otherTerminateReason
     *            其他廢止原因
     */
    public void setOtherTerminateReason(final String otherTerminateReason) {
        this.otherTerminateReason = otherTerminateReason;
    }
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY0DHM> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY0DHM> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY0DHH> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY0DHH> removedPersonNoteDetailList) {
