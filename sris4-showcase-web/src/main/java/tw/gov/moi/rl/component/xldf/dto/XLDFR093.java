...
import tw.gov.moi.domain.Xldfr093Type;
import tw.gov.moi.domain.Rldfr093Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr093Type.class ,
        entityDsName = "rldfr093ByKey" ,
        xldfEntityClass = Xldfr093Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr093Query", xldfDsByTrans = "xldfr093MaxSerialNo",  xldfDsBySerialNo = "xldfr093BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR093", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR093")
public class XLDFR093 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR093(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr093Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr093Type domainObj;
     ...
     */
    public Xldfr093Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr093Type domainObj) {
