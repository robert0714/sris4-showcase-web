...
import tw.gov.moi.domain.Xldfs097Type;
import tw.gov.moi.domain.Rldfs097Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs097Type.class ,
        entityDsName = "rldfs097ByKey" ,
        xldfEntityClass = Xldfs097Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs097Query", xldfDsByTrans = "xldfs097MaxSerialNo",  xldfDsBySerialNo = "xldfs097BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS097", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS097")
public class XLDFS097 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS097(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs097Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs097Type domainObj;
     ...
     */
    public Xldfs097Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs097Type domainObj) {
