...
import tw.gov.moi.domain.Xldft004Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft004Type.class ,
        entityDsName = "rldft004ByKey" ,
        xldfEntityClass = Xldft004Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft004Query", xldfDsByTrans = "xldft004MaxSerialNo",  xldfDsBySerialNo = "xldft004BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT004", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT004")
public class XLDFT004 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT004(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft004Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft004Type domainObj;
     ...
     */
    public Xldft004Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft004Type domainObj) {
