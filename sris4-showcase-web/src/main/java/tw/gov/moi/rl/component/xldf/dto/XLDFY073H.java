...
import tw.gov.moi.domain.Xldfy073hType;
import tw.gov.moi.domain.Rldfy073hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy073hType.class ,
        entityDsName = "rldfy073hByKey" ,
        xldfEntityClass = Xldfy073hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy073hQuery", xldfDsByTrans = "xldfy073hMaxSerialNo",  xldfDsBySerialNo = "xldfy073hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY073H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY073H")
public class XLDFY073H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY073H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy073hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy073hType domainObj;
     ...
     */
    public Xldfy073hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy073hType domainObj) {
