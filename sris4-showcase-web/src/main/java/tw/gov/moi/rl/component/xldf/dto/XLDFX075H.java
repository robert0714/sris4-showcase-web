...
import tw.gov.moi.domain.Xldfx075hType;
import tw.gov.moi.domain.Rldfx075hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx075hType.class ,
        entityDsName = "rldfx075hByKey" ,
        xldfEntityClass = Xldfx075hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx075hQuery", xldfDsByTrans = "xldfx075hMaxSerialNo",  xldfDsBySerialNo = "xldfx075hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX075H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX075H")
public class XLDFX075H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX075H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx075hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx075hType domainObj;
     ...
     */
    public Xldfx075hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx075hType domainObj) {
