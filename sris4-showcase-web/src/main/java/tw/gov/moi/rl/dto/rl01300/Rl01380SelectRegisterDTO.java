...
/**
 * Rl01380SelectRegisterDTO
 * 
 * @author Stanley.Li
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl01380SelectRegisterDTO", propOrder = { "selectRegister", "note" })
@XmlRootElement(name = "Rl01380SelectRegisterDTO")
public class Rl01380SelectRegisterDTO implements Serializable {
