...
import tw.gov.moi.domain.Xldft091Type;
import tw.gov.moi.domain.Rldft091Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft091Type.class ,
        entityDsName = "rldft091ByKey" ,
        xldfEntityClass = Xldft091Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft091Query", xldfDsByTrans = "xldft091MaxSerialNo",  xldfDsBySerialNo = "xldft091BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT091", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT091")
public class XLDFT091 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT091(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft091Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft091Type domainObj;
     ...
     */
    public Xldft091Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft091Type domainObj) {
