...
public class XLDF010MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF010MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF010MTID(String personId ,String siteId ,String specialCode ) {
        super();
