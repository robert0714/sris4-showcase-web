...
import tw.gov.moi.domain.Xldfs016bType;
import tw.gov.moi.domain.Rldfs016bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs016bType.class ,
        entityDsName = "rldfs016bByKey" ,
        xldfEntityClass = Xldfs016bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs016bQuery", xldfDsByTrans = "xldfs016bMaxSerialNo",  xldfDsBySerialNo = "xldfs016bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS016B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS016B")
public class XLDFS016B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS016B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs016bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs016bType domainObj;
     ...
     */
    public Xldfs016bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs016bType domainObj) {
