...
public class XLDFY081HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY081H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY081HID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
