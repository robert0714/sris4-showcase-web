...
import tw.gov.moi.domain.Xldfw087Type;
import tw.gov.moi.domain.Rldfw087Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw087Type.class ,
        entityDsName = "rldfw087ByKey" ,
        xldfEntityClass = Xldfw087Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw087Query", xldfDsByTrans = "xldfw087MaxSerialNo",  xldfDsBySerialNo = "xldfw087BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW087", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW087")
public class XLDFW087 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW087(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw087Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw087Type domainObj;
     ...
     */
    public Xldfw087Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw087Type domainObj) {
