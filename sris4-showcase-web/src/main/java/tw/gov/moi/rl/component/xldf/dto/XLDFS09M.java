...
import tw.gov.moi.domain.Xldfs09mType;
import tw.gov.moi.domain.Rldfs09mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09mType.class ,
        entityDsName = "rldfs09mByKey" ,
        xldfEntityClass = Xldfs09mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09mQuery", xldfDsByTrans = "xldfs09mMaxSerialNo",  xldfDsBySerialNo = "xldfs09mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09M")
public class XLDFS09M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09M(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09mType domainObj;
     ...
     */
    public Xldfs09mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09mType domainObj) {
