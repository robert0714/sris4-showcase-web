 ...
 */
@RldfMappingEntity(
        value = Rldfu003Type.class ,
        entityDsName = "rldfu003ByKey" ,
        xldfEntityClass = Xldfu003Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "serialNumber" , length = 22),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfu003Query", xldfDsByTrans = "xldfu003MaxSerialNo",  xldfDsBySerialNo = "xldfu003BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFU003", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFU003")
public class XLDFU003 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFU003(String serialNumber ,String siteId ) {
        super();
        this.domainObj = new Xldfu003Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfu003Type domainObj;
     ...
     */
    public Xldfu003Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfu003Type domainObj) {
