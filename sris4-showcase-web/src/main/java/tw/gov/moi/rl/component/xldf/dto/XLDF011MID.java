...
public class XLDF011MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF011M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF011MID(String personId ,String siteId ) {
        super();
