...
import tw.gov.moi.domain.Xldfy094mType;
import tw.gov.moi.domain.Rldfy094mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy094mType.class ,
        entityDsName = "rldfy094mByKey" ,
        xldfEntityClass = Xldfy094mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy094mQuery", xldfDsByTrans = "xldfy094mMaxSerialNo",  xldfDsBySerialNo = "xldfy094mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY094M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY094M")
public class XLDFY094M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY094M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy094mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy094mType domainObj;
     ...
     */
    public Xldfy094mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy094mType domainObj) {
