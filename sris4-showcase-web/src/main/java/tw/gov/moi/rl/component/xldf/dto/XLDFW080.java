...
import tw.gov.moi.domain.Xldfw080Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw080Type.class ,
        entityDsName = "rldfw080ByKey" ,
        xldfEntityClass = Xldfw080Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw080Query", xldfDsByTrans = "xldfw080MaxSerialNo",  xldfDsBySerialNo = "xldfw080BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW080", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW080")
public class XLDFW080 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW080(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw080Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw080Type domainObj;
     ...
     */
    public Xldfw080Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw080Type domainObj) {
