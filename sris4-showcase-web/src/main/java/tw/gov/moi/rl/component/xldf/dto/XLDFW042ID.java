...
@XmlType(name = "XLDFW042", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW042") 
public class XLDFW042ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW042.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW042ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
