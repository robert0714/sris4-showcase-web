...
import tw.gov.moi.domain.Xldfy063mType;
import tw.gov.moi.domain.Rldfy063mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy063mType.class ,
        entityDsName = "rldfy063mByKey" ,
        xldfEntityClass = Xldfy063mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy063mQuery", xldfDsByTrans = "xldfy063mMaxSerialNo",  xldfDsBySerialNo = "xldfy063mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY063M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY063M")
public class XLDFY063M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY063M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy063mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy063mType domainObj;
     ...
     */
    public Xldfy063mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy063mType domainObj) {
