...
import tw.gov.moi.domain.Xldfy079dhType;
import tw.gov.moi.domain.Rldfy079dhType;
...
/**
 * The Class XLDFY079DH.
 *
 * @author JL
 */
@RldfMappingEntity(
        value = Rldfy079dhType.class ,
        entityDsName = "rldfy079dhByKey" ,
        xldfEntityClass = Xldfy079dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy079dhQuery", xldfDsByTrans = "xldfy079dhMaxSerialNo",  xldfDsBySerialNo = "xldfy079dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY079DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY079DH")
public class XLDFY079DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY079DH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
        this.domainObj = new Xldfy079dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy079dhType domainObj;
     ...
     */
    public Xldfy079dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy079dhType domainObj) {
