...
import tw.gov.moi.domain.Xldft09eType;
import tw.gov.moi.domain.Rldft09eType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09eType.class ,
        entityDsName = "rldft09eByKey" ,
        xldfEntityClass = Xldft09eType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09eQuery", xldfDsByTrans = "xldft09eMaxSerialNo",  xldfDsBySerialNo = "xldft09eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09E")
public class XLDFT09E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09E(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09eType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09eType domainObj;
     ...
     */
    public Xldft09eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09eType domainObj) {
