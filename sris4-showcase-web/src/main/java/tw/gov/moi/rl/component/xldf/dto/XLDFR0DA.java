...
import tw.gov.moi.domain.Xldfr0daType;
import tw.gov.moi.domain.Rldfr0daType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0daType.class ,
        entityDsName = "rldfr0daByKey" ,
        xldfEntityClass = Xldfr0daType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0daQuery", xldfDsByTrans = "xldfr0daMaxSerialNo",  xldfDsBySerialNo = "xldfr0daBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0DA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0DA")
public class XLDFR0DA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0DA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0daType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0daType domainObj;
     ...
     */
    public Xldfr0daType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0daType domainObj) {
