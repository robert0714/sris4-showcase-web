...
import tw.gov.moi.domain.Xldfy066hType;
import tw.gov.moi.domain.Rldfy066hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy066hType.class ,
        entityDsName = "rldfy066hByKey" ,
        xldfEntityClass = Xldfy066hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy066hQuery", xldfDsByTrans = "xldfy066hMaxSerialNo",  xldfDsBySerialNo = "xldfy066hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY066H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY066H")
public class XLDFY066H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY066H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy066hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy066hType domainObj;
     ...
     */
    public Xldfy066hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy066hType domainObj) {
