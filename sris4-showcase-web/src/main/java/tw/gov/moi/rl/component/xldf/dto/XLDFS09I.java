...
import tw.gov.moi.domain.Xldfs09iType;
import tw.gov.moi.domain.Rldfs09iType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09iType.class ,
        entityDsName = "rldfs09iByKey" ,
        xldfEntityClass = Xldfs09iType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09iQuery", xldfDsByTrans = "xldfs09iMaxSerialNo",  xldfDsBySerialNo = "xldfs09iBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09I", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09I")
public class XLDFS09I implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09I(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09iType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09iType domainObj;
     ...
     */
    public Xldfs09iType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09iType domainObj) {
