...
import tw.gov.moi.domain.Xldfy0djhType;
import tw.gov.moi.domain.Rldfy0djhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0djhType.class ,
        entityDsName = "rldfy0djhByKey" ,
        xldfEntityClass = Xldfy0djhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0djhQuery", xldfDsByTrans = "xldfy0djhMaxSerialNo",  xldfDsBySerialNo = "xldfy0djhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DJH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DJH")
public class XLDFY0DJH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DJH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0djhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0djhType domainObj;
     ...
     */
    public Xldfy0djhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0djhType domainObj) {
