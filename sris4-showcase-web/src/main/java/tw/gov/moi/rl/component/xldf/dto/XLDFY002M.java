...
import tw.gov.moi.domain.Xldfy002mType;
import tw.gov.moi.domain.Rldfy002mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy002mType.class ,
        entityDsName = "rldfy002mByKey" ,
        xldfEntityClass = Xldfy002mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy002mQuery", xldfDsByTrans = "xldfy002mMaxSerialNo",  xldfDsBySerialNo = "xldfy002mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY002M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY002M")
public class XLDFY002M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY002M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy002mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy002mType domainObj;
     ...
     */
    public Xldfy002mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy002mType domainObj) {
