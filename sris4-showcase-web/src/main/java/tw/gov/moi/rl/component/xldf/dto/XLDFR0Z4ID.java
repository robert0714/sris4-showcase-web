...
@XmlType(name = "XLDFR0Z4", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFR0Z4") 
public class XLDFR0Z4ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFR0Z4.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFR0Z4ID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String personId ) {
        super();
