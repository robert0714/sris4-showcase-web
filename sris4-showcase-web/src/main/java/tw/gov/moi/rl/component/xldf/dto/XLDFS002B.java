...
import tw.gov.moi.domain.Xldfs002bType;
import tw.gov.moi.domain.Rldfs002bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs002bType.class ,
        entityDsName = "rldfs002bByKey" ,
        xldfEntityClass = Xldfs002bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs002bQuery", xldfDsByTrans = "xldfs002bMaxSerialNo",  xldfDsBySerialNo = "xldfs002bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS002B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS002B")
public class XLDFS002B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS002B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs002bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs002bType domainObj;
     ...
     */
    public Xldfs002bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs002bType domainObj) {
