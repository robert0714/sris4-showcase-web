...
@XmlType(name = "XCDF001MRL", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XCDF001MRL") 
public class XCDF001MRLID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XCDF001MRL.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XCDF001MRLID(String personId ) {
        super();
