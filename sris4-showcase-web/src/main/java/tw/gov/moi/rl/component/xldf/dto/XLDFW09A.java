...
import tw.gov.moi.domain.Xldfw09aType;
import tw.gov.moi.domain.Rldfw09aType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09aType.class ,
        entityDsName = "rldfw09aByKey" ,
        xldfEntityClass = Xldfw09aType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09aQuery", xldfDsByTrans = "xldfw09aMaxSerialNo",  xldfDsBySerialNo = "xldfw09aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09A")
public class XLDFW09A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09A(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09aType domainObj;
     ...
     */
    public Xldfw09aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09aType domainObj) {
