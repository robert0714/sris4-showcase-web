...
import tw.gov.moi.domain.Xldfs09rbType;
import tw.gov.moi.domain.Rldfs09rbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09rbType.class ,
        entityDsName = "rldfs09rbByKey" ,
        xldfEntityClass = Xldfs09rbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09rbQuery", xldfDsByTrans = "xldfs09rbMaxSerialNo",  xldfDsBySerialNo = "xldfs09rbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09RB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09RB")
public class XLDFS09RB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09RB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09rbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09rbType domainObj;
     ...
     */
    public Xldfs09rbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09rbType domainObj) {
