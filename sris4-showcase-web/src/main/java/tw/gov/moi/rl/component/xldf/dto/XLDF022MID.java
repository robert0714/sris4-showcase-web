...
@XmlType(name = "XLDF022M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF022M") 
public class XLDF022MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF022M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF022MID(String personId ,String siteId ) {
        super();
