...
import tw.gov.moi.domain.Xldfm13mtType;
import tw.gov.moi.domain.Tldfm13mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm13mType.class ,
        entityDsName = "tldfm13mByKey" ,
        xldfEntityClass = Xldfm13mtType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm13mtQuery", xldfDsByTrans = "xldfm13mtMaxSerialNo",  xldfDsBySerialNo = "xldfm13mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM13MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM13MT")
public class XLDFM13MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM13MT(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm13mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm13mtType domainObj;
     ...
     */
    public Xldfm13mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm13mtType domainObj) {
