...
import tw.gov.moi.domain.Xldfs094bType;
import tw.gov.moi.domain.Rldfs094bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs094bType.class ,
        entityDsName = "rldfs094bByKey" ,
        xldfEntityClass = Xldfs094bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs094bQuery", xldfDsByTrans = "xldfs094bMaxSerialNo",  xldfDsBySerialNo = "xldfs094bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS094B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS094B")
public class XLDFS094B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS094B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs094bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs094bType domainObj;
     ...
     */
    public Xldfs094bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs094bType domainObj) {
