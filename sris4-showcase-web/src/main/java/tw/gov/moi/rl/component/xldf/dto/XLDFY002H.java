...
import tw.gov.moi.domain.Xldfy002hType;
import tw.gov.moi.domain.Rldfy002hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy002hType.class ,
        entityDsName = "rldfy002hByKey" ,
        xldfEntityClass = Xldfy002hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy002hQuery", xldfDsByTrans = "xldfy002hMaxSerialNo",  xldfDsBySerialNo = "xldfy002hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY002H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY002H")
public class XLDFY002H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY002H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy002hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy002hType domainObj;
     ...
     */
    public Xldfy002hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy002hType domainObj) {
