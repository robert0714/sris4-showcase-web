...
import tw.gov.moi.domain.Xldft075Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft075Type.class ,
        entityDsName = "rldft075ByKey" ,
        xldfEntityClass = Xldft075Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft075Query", xldfDsByTrans = "xldft075MaxSerialNo",  xldfDsBySerialNo = "xldft075BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT075", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT075")
public class XLDFT075 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT075(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft075Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft075Type domainObj;
     ...
     */
    public Xldft075Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft075Type domainObj) {
