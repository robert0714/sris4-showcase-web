...
@XmlType(name = "XLDF100M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF100M") 
public class XLDF100MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF100M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF100MID(String personId ,String tranYyy ,String siteId ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(personId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(tranYyy, StringUtils.EMPTY)));
