...
import tw.gov.moi.domain.Xldfr0z6Type;
import tw.gov.moi.domain.Rldfr0z6Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0z6Type.class ,
        entityDsName = "rldfr0z6ByKey" ,
        xldfEntityClass = Xldfr0z6Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0z6Query", xldfDsByTrans = "xldfr0z6MaxSerialNo",  xldfDsBySerialNo = "xldfr0z6BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0Z6", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0Z6")
public class XLDFR0Z6 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0Z6(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0z6Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0z6Type domainObj;
     ...
     */
    public Xldfr0z6Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0z6Type domainObj) {
