...
import tw.gov.moi.domain.Xldfy0d1hType;
import tw.gov.moi.domain.Rldfy0d1hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0d1hType.class ,
        entityDsName = "rldfy0d1hByKey" ,
        xldfEntityClass = Xldfy0d1hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0d1hQuery", xldfDsByTrans = "xldfy0d1hMaxSerialNo",  xldfDsBySerialNo = "xldfy0d1hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0D1H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0D1H")
public class XLDFY0D1H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0D1H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0d1hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0d1hType domainObj;
     ...
     */
    public Xldfy0d1hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0d1hType domainObj) {
