...
@XmlType(name = "Rl01807DTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl01807AppDataDTO",
        "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication" })
@XmlRootElement(name = "Rl01807DTO")
public class Rl01807DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 6895979212561914460L;
    ...
    /** 母姓名更正撤銷登記AppDataDTO. */
    @XmlElement(name = "Rl01807AppDataDTO")
    @FieldName("母姓名更正撤銷登記AppDataDTO")
    private Rl01807AppDataDTO rl01807AppDataDTO = new Rl01807AppDataDTO();
    ...
    /**
     * Gets the rl01807 app data dto.
     * 
     * @return the rl01807 app data dto
     */
    public Rl01807AppDataDTO getRl01807AppDataDTO() {
        return rl01807AppDataDTO;
    }

    /**
     * Sets the rl01807 app data dto.
     * 
     * @param rl01807AppDataDTO
     *            the new rl01807 app data dto
     */
    public void setRl01807AppDataDTO(final Rl01807AppDataDTO rl01807AppDataDTO) {
        this.rl01807AppDataDTO = rl01807AppDataDTO;
    }
