...
public class Rl01828DTO implements Serializable {
    ...
    /** 申請事由代碼 */
    @XmlElement(name = "OrgApplyReasonCode", required = true)
    @FieldName("申請事由代碼")
    private String orgApplyReasonCode;

    /** 原住民身分及族別旗標 */
    @XmlElement(name = "LivingFlag", required = true)
    @FieldName("原住民身分及族別旗標")
     ...
     * 設定申請事由代碼
     * 
     * @param orgApplyReasonCode
     *            申請事由代碼
     */
    public void setOrgApplyReasonCode(final String orgApplyReasonCode) {
     ...
     *            原住民身分及族別旗標
     */
    public void setLivingFlag(final boolean livingFlag) {
