...
import tw.gov.moi.domain.Xldfw0afType;
import tw.gov.moi.domain.Rldfw0afType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0afType.class ,
        entityDsName = "rldfw0afByKey" ,
        xldfEntityClass = Xldfw0afType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0afQuery", xldfDsByTrans = "xldfw0afMaxSerialNo",  xldfDsBySerialNo = "xldfw0afBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AF", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AF")
public class XLDFW0AF implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AF(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0afType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0afType domainObj;
     ...
     */
    public Xldfw0afType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0afType domainObj) {
