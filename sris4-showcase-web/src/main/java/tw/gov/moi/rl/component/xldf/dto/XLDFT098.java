...
import tw.gov.moi.domain.Xldft098Type;
import tw.gov.moi.domain.Rldft098Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft098Type.class ,
        entityDsName = "rldft098ByKey" ,
        xldfEntityClass = Xldft098Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft098Query", xldfDsByTrans = "xldft098MaxSerialNo",  xldfDsBySerialNo = "xldft098BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT098", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT098")
public class XLDFT098 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT098(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft098Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft098Type domainObj;
     ...
     */
    public Xldft098Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft098Type domainObj) {
