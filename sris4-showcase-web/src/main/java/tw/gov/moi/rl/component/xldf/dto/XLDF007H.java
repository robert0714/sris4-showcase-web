...
import tw.gov.moi.domain.Xldf007hType;
 ...
 */
@RldfMappingEntity(
        value = Rldf007hType.class ,
        entityDsName = "rldf007hByKey" ,
        xldfEntityClass = Xldf007hType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "modifyYyymmdd" , length = 7),
            @XldfKeyMapping( name = "modifyTime" , length = 6),
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "removeYyymmdd" , length = 7),
            @XldfKeyMapping( name = "removeTime" , length = 6)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf007hQuery", xldfDsByTrans = "xldf007hMaxSerialNo",  xldfDsBySerialNo = "xldf007hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF007H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF007H")
public class XLDF007H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF007H(String personId ,String modifyYyymmdd ,String modifyTime ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldf007hType();
        getDomainObj().setPersonId(personId); 
        getDomainObj().setModifyYyymmdd(modifyYyymmdd); 
        getDomainObj().setModifyTime(modifyTime); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf007hType domainObj;
     ...
     */
    public Xldf007hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf007hType domainObj) {
