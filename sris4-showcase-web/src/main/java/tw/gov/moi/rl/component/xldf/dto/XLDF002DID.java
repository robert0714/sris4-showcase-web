...
@XmlType(name = "XLDF002D", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF002D") 
public class XLDF002DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF002D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF002DID(String personId ,String siteId ,String applyYyymmdd ,String applyHhmmss ) {
        super();
