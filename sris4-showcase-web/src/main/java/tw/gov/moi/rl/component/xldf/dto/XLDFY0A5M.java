...
import tw.gov.moi.domain.Xldfy0a5mType;
import tw.gov.moi.domain.Rldfy0a5mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a5mType.class ,
        entityDsName = "rldfy0a5mByKey" ,
        xldfEntityClass = Xldfy0a5mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a5mQuery", xldfDsByTrans = "xldfy0a5mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a5mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A5M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A5M")
public class XLDFY0A5M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A5M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a5mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a5mType domainObj;
     ...
     */
    public Xldfy0a5mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a5mType domainObj) {
