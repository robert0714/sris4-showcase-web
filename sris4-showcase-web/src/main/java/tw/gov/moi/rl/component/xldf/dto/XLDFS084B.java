...
import tw.gov.moi.domain.Xldfs084bType;
import tw.gov.moi.domain.Rldfs084bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs084bType.class ,
        entityDsName = "rldfs084bByKey" ,
        xldfEntityClass = Xldfs084bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs084bQuery", xldfDsByTrans = "xldfs084bMaxSerialNo",  xldfDsBySerialNo = "xldfs084bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS084B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS084B")
public class XLDFS084B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS084B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs084bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs084bType domainObj;
     ...
     */
    public Xldfs084bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs084bType domainObj) {
