...
@XmlType(name = "rl01110AppDataDTO", propOrder = { "isHouseholdHead", "registerYyymmdd", "registerHhmmss",
        "acceptAdminOfficeCode", "beforeRegisterContent", "afterRegisterContent", "updateYyymmdd", "updateReason",
        "mainType", "subType", "reasonCode", "remark", "backupUpdateYyymmdd", "certificateList", "otherCertificate",
        "backupUpdateReason", "backupAfterRegisterContent", "bakcupRemark" })
@XmlRootElement(name = "Rl01110AppDataDTO")
public class Rl01110AppDataDTO implements Serializable {
    ...
    public String toString() {
        return "Rl01110AppDataDTO [isHouseholdHead=" + isHouseholdHead + ", registerYyymmdd=" + registerYyymmdd
                + ", registerHhmmss=" + registerHhmmss + ", acceptAdminOfficeCode=" + acceptAdminOfficeCode
                + ", beforeRegisterContent=" + beforeRegisterContent + ", afterRegisterContent=" + afterRegisterContent
                + ", updateYyymmdd=" + updateYyymmdd + ", updateReason=" + updateReason + ", mainType=" + mainType
                + ", subType=" + subType + ", reasonCode=" + reasonCode + ", remark=" + remark
                + ", backupUpdateYyymmdd=" + backupUpdateYyymmdd + "]";
    }
