...
import tw.gov.moi.domain.Xldfs09fbType;
import tw.gov.moi.domain.Rldfs09fbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09fbType.class ,
        entityDsName = "rldfs09fbByKey" ,
        xldfEntityClass = Xldfs09fbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09fbQuery", xldfDsByTrans = "xldfs09fbMaxSerialNo",  xldfDsBySerialNo = "xldfs09fbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09FB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09FB")
public class XLDFS09FB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09FB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09fbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09fbType domainObj;
     ...
     */
    public Xldfs09fbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09fbType domainObj) {
