...
import tw.gov.moi.domain.Xldf089tType;
 ...
 */
@RldfMappingEntity(
        value = Rldf089tType.class ,
        entityDsName = "rldf089tByKey" ,
        xldfEntityClass = Xldf089tType.class ,        
        keys  = { 
            ...
            @XldfKeyMapping( name = "applyCode" , length = 2)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf089tQuery", xldfDsByTrans = "xldf089tMaxSerialNo",  xldfDsBySerialNo = "xldf089tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF089T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF089T")
public class XLDF089T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF089T(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String applyCode ) {
        super();
        this.domainObj = new Xldf089tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf089tType domainObj;
     ...
     */
    public Xldf089tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf089tType domainObj) {
