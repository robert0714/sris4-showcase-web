...
import tw.gov.moi.domain.Xldfr0abType;
import tw.gov.moi.domain.Rldfr0abType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0abType.class ,
        entityDsName = "rldfr0abByKey" ,
        xldfEntityClass = Xldfr0abType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0abQuery", xldfDsByTrans = "xldfr0abMaxSerialNo",  xldfDsBySerialNo = "xldfr0abBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0AB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0AB")
public class XLDFR0AB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0AB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0abType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0abType domainObj;
     ...
     */
    public Xldfr0abType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0abType domainObj) {
