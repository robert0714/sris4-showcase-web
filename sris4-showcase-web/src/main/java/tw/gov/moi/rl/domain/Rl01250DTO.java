...
import tw.gov.moi.rl.component.xldf.dto.XLDFY005H;
import tw.gov.moi.rl.component.xldf.dto.XLDFY005M;
...
public class Rl01250DTO implements Serializable {
    ...
    /** 被認領者-認領前出生別 */
    @XmlElement(name = "BeforeBirthOrderSex", required = true)
    @FieldName("被認領者-認領前出生別")
    private String beforeBirthOrderSex;

    /** 被認領者-認領後出生別 */
    @XmlElement(name = "AfterBirthOrderSex", required = true)
    @FieldName("被認領者-認領後出生別")
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY005M> personNoteDetailList = new ArrayList<XLDFY005M>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY005H> removedPersonNoteDetailList = new ArrayList<XLDFY005H>();
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY005M> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY005M> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY005H> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY005H> removedPersonNoteDetailList) {
