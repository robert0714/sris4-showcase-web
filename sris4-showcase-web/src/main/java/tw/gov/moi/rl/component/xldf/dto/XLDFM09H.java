...
import tw.gov.moi.domain.Xldfm09hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm09hType.class ,
        entityDsName = "rldfm09hByKey" ,
        xldfEntityClass = Xldfm09hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm09hQuery", xldfDsByTrans = "xldfm09hMaxSerialNo",  xldfDsBySerialNo = "xldfm09hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM09H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM09H")
public class XLDFM09H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM09H(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldfm09hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm09hType domainObj;
     ...
     */
    public Xldfm09hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm09hType domainObj) {
