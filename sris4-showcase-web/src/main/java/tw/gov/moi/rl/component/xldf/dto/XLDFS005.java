...
import tw.gov.moi.domain.Xldfs005Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs005Type.class ,
        entityDsName = "rldfs005ByKey" ,
        xldfEntityClass = Xldfs005Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs005Query", xldfDsByTrans = "xldfs005MaxSerialNo",  xldfDsBySerialNo = "xldfs005BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS005", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS005")
public class XLDFS005 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS005(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs005Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs005Type domainObj;
     ...
     */
    public Xldfs005Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs005Type domainObj) {
