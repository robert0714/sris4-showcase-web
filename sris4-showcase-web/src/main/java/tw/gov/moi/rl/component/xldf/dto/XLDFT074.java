...
import tw.gov.moi.domain.Xldft074Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft074Type.class ,
        entityDsName = "rldft074ByKey" ,
        xldfEntityClass = Xldft074Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft074Query", xldfDsByTrans = "xldft074MaxSerialNo",  xldfDsBySerialNo = "xldft074BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT074", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT074")
public class XLDFT074 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT074(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft074Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft074Type domainObj;
     ...
     */
    public Xldft074Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft074Type domainObj) {
