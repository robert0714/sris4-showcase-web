...
import tw.gov.moi.domain.Xldfy098hType;
import tw.gov.moi.domain.Rldfy098hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy098hType.class ,
        entityDsName = "rldfy098hByKey" ,
        xldfEntityClass = Xldfy098hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy098hQuery", xldfDsByTrans = "xldfy098hMaxSerialNo",  xldfDsBySerialNo = "xldfy098hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY098H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY098H")
public class XLDFY098H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY098H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy098hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy098hType domainObj;
     ...
     */
    public Xldfy098hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy098hType domainObj) {
