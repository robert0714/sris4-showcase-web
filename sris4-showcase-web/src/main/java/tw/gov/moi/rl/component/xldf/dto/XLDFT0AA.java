...
import tw.gov.moi.domain.Xldft0aaType;
import tw.gov.moi.domain.Rldft0aaType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0aaType.class ,
        entityDsName = "rldft0aaByKey" ,
        xldfEntityClass = Xldft0aaType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0aaQuery", xldfDsByTrans = "xldft0aaMaxSerialNo",  xldfDsBySerialNo = "xldft0aaBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AA")
public class XLDFT0AA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0aaType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0aaType domainObj;
     ...
     */
    public Xldft0aaType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0aaType domainObj) {
