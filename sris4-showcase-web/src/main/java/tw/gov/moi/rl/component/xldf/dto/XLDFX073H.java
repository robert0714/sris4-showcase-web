...
import tw.gov.moi.domain.Xldfx073hType;
import tw.gov.moi.domain.Rldfx073hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx073hType.class ,
        entityDsName = "rldfx073hByKey" ,
        xldfEntityClass = Xldfx073hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx073hQuery", xldfDsByTrans = "xldfx073hMaxSerialNo",  xldfDsBySerialNo = "xldfx073hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX073H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX073H")
public class XLDFX073H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX073H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx073hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx073hType domainObj;
     ...
     */
    public Xldfx073hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx073hType domainObj) {
