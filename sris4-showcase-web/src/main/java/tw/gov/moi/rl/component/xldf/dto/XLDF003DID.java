...
public class XLDF003DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF003D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF003DID(String personId ,String expireYyymmdd ,String expireHhmmss ,String siteId ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(personId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(expireYyymmdd, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(expireHhmmss, StringUtils.EMPTY)));
