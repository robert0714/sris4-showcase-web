...
@XmlType(name = "XLDFX094M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX094M") 
public class XLDFX094MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX094M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX094MID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
