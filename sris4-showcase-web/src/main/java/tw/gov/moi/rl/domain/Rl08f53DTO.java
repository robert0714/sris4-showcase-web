...
/**
 * The Class Rl08f53DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl08f53DTO", propOrder = { "labelHead", "voteCode", "voteDate", "personId", "ResultPersonId",
        "personName", "livingStyleCode", "votePoint", "workVotePoint", "remark", "listRl08f53ResultDTO" })
@XmlRootElement(name = "Rl08f53DTO")
public class Rl08f53DTO implements Serializable {
    ...
    /** listRl08f53ResultDTO. */
    @XmlElement(name = "ListRl08f53ResultDTO")
    @FieldName("查詢結果")
    private List<Rl08f53ResultDTO> listRl08f53ResultDTO = new ArrayList<Rl08f53ResultDTO>(0);
    ...
    /**
     * Gets the list rl08f53 result dto.
     * 
     * @return the list rl08f53 result dto
     */
    public List<Rl08f53ResultDTO> getListRl08f53ResultDTO() {
        return listRl08f53ResultDTO;
    }

    /**
     * Sets the list rl08f53 result dto.
     * 
     * @param listRl08f53ResultDTO
     *            the new list rl08f53 result dto
     */
    public void setListRl08f53ResultDTO(List<Rl08f53ResultDTO> listRl08f53ResultDTO) {
        this.listRl08f53ResultDTO = listRl08f53ResultDTO;
    }
