...
import tw.gov.moi.domain.Xldfy0a6hType;
import tw.gov.moi.domain.Rldfy0a6hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a6hType.class ,
        entityDsName = "rldfy0a6hByKey" ,
        xldfEntityClass = Xldfy0a6hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a6hQuery", xldfDsByTrans = "xldfy0a6hMaxSerialNo",  xldfDsBySerialNo = "xldfy0a6hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A6H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A6H")
public class XLDFY0A6H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A6H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a6hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a6hType domainObj;
     ...
     */
    public Xldfy0a6hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a6hType domainObj) {
