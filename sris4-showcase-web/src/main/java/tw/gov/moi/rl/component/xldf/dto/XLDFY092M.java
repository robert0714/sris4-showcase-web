...
import tw.gov.moi.domain.Xldfy092mType;
import tw.gov.moi.domain.Rldfy092mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy092mType.class ,
        entityDsName = "rldfy092mByKey" ,
        xldfEntityClass = Xldfy092mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy092mQuery", xldfDsByTrans = "xldfy092mMaxSerialNo",  xldfDsBySerialNo = "xldfy092mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY092M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY092M")
public class XLDFY092M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY092M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy092mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy092mType domainObj;
     ...
     */
    public Xldfy092mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy092mType domainObj) {
