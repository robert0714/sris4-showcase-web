...
import tw.gov.moi.domain.Xldfs0b8bType;
import tw.gov.moi.domain.Rldfs0b8bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b8bType.class ,
        entityDsName = "rldfs0b8bByKey" ,
        xldfEntityClass = Xldfs0b8bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b8bQuery", xldfDsByTrans = "xldfs0b8bMaxSerialNo",  xldfDsBySerialNo = "xldfs0b8bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B8B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B8B")
public class XLDFS0B8B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B8B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0b8bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b8bType domainObj;
     ...
     */
    public Xldfs0b8bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b8bType domainObj) {
