...
import tw.gov.moi.domain.Xldfy082hType;
import tw.gov.moi.domain.Rldfy082hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy082hType.class ,
        entityDsName = "rldfy082hByKey" ,
        xldfEntityClass = Xldfy082hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy082hQuery", xldfDsByTrans = "xldfy082hMaxSerialNo",  xldfDsBySerialNo = "xldfy082hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY082H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY082H")
public class XLDFY082H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY082H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy082hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy082hType domainObj;
     ...
     */
    public Xldfy082hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy082hType domainObj) {
