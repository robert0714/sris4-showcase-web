...
@XmlType(name = "XLDFY093M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY093M") 
public class XLDFY093MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY093M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY093MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
