...
import tw.gov.moi.domain.Xldfs063Type;
import tw.gov.moi.domain.Rldfs063Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs063Type.class ,
        entityDsName = "rldfs063ByKey" ,
        xldfEntityClass = Xldfs063Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs063Query", xldfDsByTrans = "xldfs063MaxSerialNo",  xldfDsBySerialNo = "xldfs063BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS063", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS063")
public class XLDFS063 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS063(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs063Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs063Type domainObj;
     ...
     */
    public Xldfs063Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs063Type domainObj) {
