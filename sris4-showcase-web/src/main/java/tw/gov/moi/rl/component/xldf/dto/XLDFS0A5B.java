...
import tw.gov.moi.domain.Xldfs0a5bType;
import tw.gov.moi.domain.Rldfs0a5bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a5bType.class ,
        entityDsName = "rldfs0a5bByKey" ,
        xldfEntityClass = Xldfs0a5bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a5bQuery", xldfDsByTrans = "xldfs0a5bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a5bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A5B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A5B")
public class XLDFS0A5B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A5B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a5bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a5bType domainObj;
     ...
     */
    public Xldfs0a5bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a5bType domainObj) {
