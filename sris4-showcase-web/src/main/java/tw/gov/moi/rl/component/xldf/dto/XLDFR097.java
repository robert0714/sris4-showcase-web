...
import tw.gov.moi.domain.Xldfr097Type;
import tw.gov.moi.domain.Rldfr097Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr097Type.class ,
        entityDsName = "rldfr097ByKey" ,
        xldfEntityClass = Xldfr097Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr097Query", xldfDsByTrans = "xldfr097MaxSerialNo",  xldfDsBySerialNo = "xldfr097BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR097", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR097")
public class XLDFR097 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR097(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr097Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr097Type domainObj;
     ...
     */
    public Xldfr097Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr097Type domainObj) {
