...
import tw.gov.moi.domain.Xldfy0abmType;
import tw.gov.moi.domain.Rldfy0abmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0abmType.class ,
        entityDsName = "rldfy0abmByKey" ,
        xldfEntityClass = Xldfy0abmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0abmQuery", xldfDsByTrans = "xldfy0abmMaxSerialNo",  xldfDsBySerialNo = "xldfy0abmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0ABM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0ABM")
public class XLDFY0ABM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0ABM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0abmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0abmType domainObj;
     ...
     */
    public Xldfy0abmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0abmType domainObj) {
