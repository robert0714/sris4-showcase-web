...
import tw.gov.moi.domain.Xldfm09mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm09mType.class ,
        entityDsName = "rldfm09mByKey" ,
        xldfEntityClass = Xldfm09mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm09mQuery", xldfDsByTrans = "xldfm09mMaxSerialNo",  xldfDsBySerialNo = "xldfm09mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM09M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM09M")
public class XLDFM09M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM09M(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ) {
        super();
        this.domainObj = new Xldfm09mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm09mType domainObj;
     ...
     */
    public Xldfm09mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm09mType domainObj) {
