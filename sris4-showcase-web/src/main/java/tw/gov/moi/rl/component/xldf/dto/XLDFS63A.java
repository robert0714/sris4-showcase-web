...
import tw.gov.moi.domain.Xldfs63aType;
import tw.gov.moi.domain.Rldfs63aType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs63aType.class ,
        entityDsName = "rldfs63aByKey" ,
        xldfEntityClass = Xldfs63aType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs63aQuery", xldfDsByTrans = "xldfs63aMaxSerialNo",  xldfDsBySerialNo = "xldfs63aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS63A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS63A")
public class XLDFS63A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS63A(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
        this.domainObj = new Xldfs63aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs63aType domainObj;
     ...
     */
    public Xldfs63aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs63aType domainObj) {
