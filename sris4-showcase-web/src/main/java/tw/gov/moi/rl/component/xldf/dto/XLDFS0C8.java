...
import tw.gov.moi.domain.Xldfs0c8Type;
import tw.gov.moi.domain.Rldfs0c8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0c8Type.class ,
        entityDsName = "rldfs0c8ByKey" ,
        xldfEntityClass = Xldfs0c8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0c8Query", xldfDsByTrans = "xldfs0c8MaxSerialNo",  xldfDsBySerialNo = "xldfs0c8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0C8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0C8")
public class XLDFS0C8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0C8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0c8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0c8Type domainObj;
     ...
     */
    public Xldfs0c8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0c8Type domainObj) {
