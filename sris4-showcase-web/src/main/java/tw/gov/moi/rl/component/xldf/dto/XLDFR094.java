...
import tw.gov.moi.domain.Xldfr094Type;
import tw.gov.moi.domain.Rldfr094Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr094Type.class ,
        entityDsName = "rldfr094ByKey" ,
        xldfEntityClass = Xldfr094Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr094Query", xldfDsByTrans = "xldfr094MaxSerialNo",  xldfDsBySerialNo = "xldfr094BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR094", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR094")
public class XLDFR094 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR094(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr094Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr094Type domainObj;
     ...
     */
    public Xldfr094Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr094Type domainObj) {
