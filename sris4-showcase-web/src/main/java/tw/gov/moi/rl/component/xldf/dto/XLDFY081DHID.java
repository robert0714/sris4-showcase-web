...
public class XLDFY081DHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY081DH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY081DHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
