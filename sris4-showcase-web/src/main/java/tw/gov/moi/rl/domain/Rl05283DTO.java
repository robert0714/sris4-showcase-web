...
/**
 * The Class Rl05283DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl05283DTO", propOrder = { "printType", "dateStart", "dateEnd", "processMark", "pageChange", "reportType", "chk1", "chk2" })
@XmlRootElement(name = "Rl05283DTO")
public class Rl05283DTO implements Serializable {
