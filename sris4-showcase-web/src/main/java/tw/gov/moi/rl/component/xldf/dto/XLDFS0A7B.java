...
import tw.gov.moi.domain.Xldfs0a7bType;
import tw.gov.moi.domain.Rldfs0a7bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a7bType.class ,
        entityDsName = "rldfs0a7bByKey" ,
        xldfEntityClass = Xldfs0a7bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a7bQuery", xldfDsByTrans = "xldfs0a7bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a7bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A7B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A7B")
public class XLDFS0A7B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A7B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a7bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a7bType domainObj;
     ...
     */
    public Xldfs0a7bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a7bType domainObj) {
