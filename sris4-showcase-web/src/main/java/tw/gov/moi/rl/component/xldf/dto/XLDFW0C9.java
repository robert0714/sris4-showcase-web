...
import tw.gov.moi.domain.Xldfw0c9Type;
import tw.gov.moi.domain.Rldfw0c9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0c9Type.class ,
        entityDsName = "rldfw0c9ByKey" ,
        xldfEntityClass = Xldfw0c9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0c9Query", xldfDsByTrans = "xldfw0c9MaxSerialNo",  xldfDsBySerialNo = "xldfw0c9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0C9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0C9")
public class XLDFW0C9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0C9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0c9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0c9Type domainObj;
     ...
     */
    public Xldfw0c9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0c9Type domainObj) {
