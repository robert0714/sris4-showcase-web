...
import tw.gov.moi.domain.Xldfs025bType;
import tw.gov.moi.domain.Rldfs025bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs025bType.class ,
        entityDsName = "rldfs025bByKey" ,
        xldfEntityClass = Xldfs025bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs025bQuery", xldfDsByTrans = "xldfs025bMaxSerialNo",  xldfDsBySerialNo = "xldfs025bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS025B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS025B")
public class XLDFS025B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS025B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs025bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs025bType domainObj;
     ...
     */
    public Xldfs025bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs025bType domainObj) {
