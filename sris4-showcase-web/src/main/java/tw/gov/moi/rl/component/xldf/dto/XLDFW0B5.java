...
import tw.gov.moi.domain.Xldfw0b5Type;
import tw.gov.moi.domain.Rldfw0b5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0b5Type.class ,
        entityDsName = "rldfw0b5ByKey" ,
        xldfEntityClass = Xldfw0b5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0b5Query", xldfDsByTrans = "xldfw0b5MaxSerialNo",  xldfDsBySerialNo = "xldfw0b5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0B5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0B5")
public class XLDFW0B5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0B5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0b5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0b5Type domainObj;
     ...
     */
    public Xldfw0b5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0b5Type domainObj) {
