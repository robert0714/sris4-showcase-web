...
import tw.gov.moi.domain.Xldfy09ahType;
import tw.gov.moi.domain.Rldfy09ahType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09ahType.class ,
        entityDsName = "rldfy09ahByKey" ,
        xldfEntityClass = Xldfy09ahType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09ahQuery", xldfDsByTrans = "xldfy09ahMaxSerialNo",  xldfDsBySerialNo = "xldfy09ahBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09AH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09AH")
public class XLDFY09AH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09AH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09ahType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09ahType domainObj;
     ...
     */
    public Xldfy09ahType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09ahType domainObj) {
