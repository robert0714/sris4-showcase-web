...
import tw.gov.moi.domain.Xldfy0bahType;
import tw.gov.moi.domain.Rldfy0bahType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0bahType.class ,
        entityDsName = "rldfy0bahByKey" ,
        xldfEntityClass = Xldfy0bahType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0bahQuery", xldfDsByTrans = "xldfy0bahMaxSerialNo",  xldfDsBySerialNo = "xldfy0bahBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0BAH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0BAH")
public class XLDFY0BAH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0BAH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0bahType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0bahType domainObj;
     ...
     */
    public Xldfy0bahType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0bahType domainObj) {
