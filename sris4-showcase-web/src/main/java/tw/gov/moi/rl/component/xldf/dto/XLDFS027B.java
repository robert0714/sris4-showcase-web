...
import tw.gov.moi.domain.Xldfs027bType;
import tw.gov.moi.domain.Rldfs027bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs027bType.class ,
        entityDsName = "rldfs027bByKey" ,
        xldfEntityClass = Xldfs027bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs027bQuery", xldfDsByTrans = "xldfs027bMaxSerialNo",  xldfDsBySerialNo = "xldfs027bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS027B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS027B")
public class XLDFS027B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS027B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs027bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs027bType domainObj;
     ...
     */
    public Xldfs027bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs027bType domainObj) {
