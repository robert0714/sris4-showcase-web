...
import tw.gov.moi.domain.Xldfy0b4hType;
import tw.gov.moi.domain.Rldfy0b4hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b4hType.class ,
        entityDsName = "rldfy0b4hByKey" ,
        xldfEntityClass = Xldfy0b4hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b4hQuery", xldfDsByTrans = "xldfy0b4hMaxSerialNo",  xldfDsBySerialNo = "xldfy0b4hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B4H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B4H")
public class XLDFY0B4H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B4H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b4hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b4hType domainObj;
     ...
     */
    public Xldfy0b4hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b4hType domainObj) {
