...
import tw.gov.moi.domain.Xldft0a3Type;
import tw.gov.moi.domain.Rldft0a3Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a3Type.class ,
        entityDsName = "rldft0a3ByKey" ,
        xldfEntityClass = Xldft0a3Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a3Query", xldfDsByTrans = "xldft0a3MaxSerialNo",  xldfDsBySerialNo = "xldft0a3BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A3", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A3")
public class XLDFT0A3 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A3(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a3Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a3Type domainObj;
     ...
     */
    public Xldft0a3Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a3Type domainObj) {
