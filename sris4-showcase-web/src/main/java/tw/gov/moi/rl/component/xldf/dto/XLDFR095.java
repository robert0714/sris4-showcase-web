...
import tw.gov.moi.domain.Xldfr095Type;
import tw.gov.moi.domain.Rldfr095Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr095Type.class ,
        entityDsName = "rldfr095ByKey" ,
        xldfEntityClass = Xldfr095Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr095Query", xldfDsByTrans = "xldfr095MaxSerialNo",  xldfDsBySerialNo = "xldfr095BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR095", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR095")
public class XLDFR095 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR095(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr095Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr095Type domainObj;
     ...
     */
    public Xldfr095Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr095Type domainObj) {
