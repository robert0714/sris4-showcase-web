...
import tw.gov.moi.domain.Xldft081Type;
import tw.gov.moi.domain.Rldft081Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft081Type.class ,
        entityDsName = "rldft081ByKey" ,
        xldfEntityClass = Xldft081Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft081Query", xldfDsByTrans = "xldft081MaxSerialNo",  xldfDsBySerialNo = "xldft081BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT081", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT081")
public class XLDFT081 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT081(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft081Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft081Type domainObj;
     ...
     */
    public Xldft081Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft081Type domainObj) {
