...
import tw.gov.moi.domain.Xldfy094hType;
import tw.gov.moi.domain.Rldfy094hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy094hType.class ,
        entityDsName = "rldfy094hByKey" ,
        xldfEntityClass = Xldfy094hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy094hQuery", xldfDsByTrans = "xldfy094hMaxSerialNo",  xldfDsBySerialNo = "xldfy094hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY094H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY094H")
public class XLDFY094H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY094H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy094hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy094hType domainObj;
     ...
     */
    public Xldfy094hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy094hType domainObj) {
