...
import tw.gov.moi.domain.Xldfy0d2mType;
import tw.gov.moi.domain.Rldfy0d2mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0d2mType.class ,
        entityDsName = "rldfy0d2mByKey" ,
        xldfEntityClass = Xldfy0d2mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0d2mQuery", xldfDsByTrans = "xldfy0d2mMaxSerialNo",  xldfDsBySerialNo = "xldfy0d2mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0D2M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0D2M")
public class XLDFY0D2M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0D2M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0d2mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0d2mType domainObj;
     ...
     */
    public Xldfy0d2mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0d2mType domainObj) {
