...
import tw.gov.moi.domain.Xldfm05hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm05hType.class ,
        entityDsName = "rldfm05hByKey" ,
        xldfEntityClass = Xldfm05hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm05hQuery", xldfDsByTrans = "xldfm05hMaxSerialNo",  xldfDsBySerialNo = "xldfm05hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM05H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM05H")
public class XLDFM05H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM05H(String personId ,String siteId ,String relationId ,String removeYyymmdd ,String removeTime ,String relationCode ) {
        super();
        this.domainObj = new Xldfm05hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm05hType domainObj;
     ...
     */
    public Xldfm05hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm05hType domainObj) {
