...
import tw.gov.moi.domain.Xldft012Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft012Type.class ,
        entityDsName = "rldft012ByKey" ,
        xldfEntityClass = Xldft012Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft012Query", xldfDsByTrans = "xldft012MaxSerialNo",  xldfDsBySerialNo = "xldft012BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT012", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT012")
public class XLDFT012 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT012(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft012Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft012Type domainObj;
     ...
     */
    public Xldft012Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft012Type domainObj) {
