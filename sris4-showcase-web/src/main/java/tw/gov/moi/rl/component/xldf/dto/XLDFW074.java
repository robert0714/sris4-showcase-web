...
import tw.gov.moi.domain.Xldfw074Type;
import tw.gov.moi.domain.Rldfw074Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw074Type.class ,
        entityDsName = "rldfw074ByKey" ,
        xldfEntityClass = Xldfw074Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw074Query", xldfDsByTrans = "xldfw074MaxSerialNo",  xldfDsBySerialNo = "xldfw074BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW074", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW074")
public class XLDFW074 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW074(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw074Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw074Type domainObj;
     ...
     */
    public Xldfw074Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw074Type domainObj) {
