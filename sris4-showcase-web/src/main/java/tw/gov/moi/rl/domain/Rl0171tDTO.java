...
/**
 * The Class Rl0171tDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl0171tDTO", propOrder = { "openingOperationDTO", "fatherPersonData", "xldfHouseholdHeadPersonData",
        "xldfHouseholdData", "applicant1", "applicant2", "delegatedPerson", "xldfefaplcType", "registerDate",
        "registerTime", "acceptAdminOfficeCode", "enforcedFlag", "rl0171tAppDataDTOList", "rl0171tAppDataDTO",
        "initializationFlag" })
@XmlRootElement(name = "Rl0171tDTO")
public class Rl0171tDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 6262650525217906212L;
    ...
    /** 子女資料清單. */
    @XmlElement(name = "Rl0171tAppDataDTOList")
    @FieldName("子女資料清單")
    private List<RlChangeNameAppDataDTO> rl0171tAppDataDTOList = new ArrayList<RlChangeNameAppDataDTO>();

    /** 子女資料. */
    @XmlElement(name = "Rl0171tAppDataDTO")
    @FieldName("子女資料")
    private RlChangeNameAppDataDTO rl0171tAppDataDTO;
    ...
    /**
     * Gets the rl0171t app data dto list.
     * 
     * @return the rl0171t app data dto list
     */
    public List<RlChangeNameAppDataDTO> getRl0171tAppDataDTOList() {
        return rl0171tAppDataDTOList;
    }

    /**
     * Sets the rl0171t app data dto list.
     * 
     * @param rl0171tAppDataDTOList
     *            the new rl0171t app data dto list
     */
    public void setRl0171tAppDataDTOList(List<RlChangeNameAppDataDTO> rl0171tAppDataDTOList) {
        this.rl0171tAppDataDTOList = rl0171tAppDataDTOList;
    }

    /**
     * Gets the rl0171t app data dto.
     * 
     * @return the rl0171t app data dto
     */
    public RlChangeNameAppDataDTO getRl0171tAppDataDTO() {
        return rl0171tAppDataDTO;
    }

    /**
     * Sets the rl0171t app data dto.
     * 
     * @param rl0171tAppDataDTO
     *            the new rl0171t app data dto
     */
    public void setRl0171tAppDataDTO(RlChangeNameAppDataDTO rl0171tAppDataDTO) {
        this.rl0171tAppDataDTO = rl0171tAppDataDTO;
    }
