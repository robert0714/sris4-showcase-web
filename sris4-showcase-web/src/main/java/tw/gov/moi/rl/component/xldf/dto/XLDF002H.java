 ...
 */
@RldfMappingEntity(
        value = Rldf002hType.class ,
        entityDsName = "rldf002hByKey" ,
        xldfEntityClass = Xldf002hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf002hQuery", xldfDsByTrans = "xldf002hMaxSerialNo",  xldfDsBySerialNo = "xldf002hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF002H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF002H")
public class XLDF002H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF002H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf002hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf002hType domainObj;
     ...
     */
    public Xldf002hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf002hType domainObj) {
