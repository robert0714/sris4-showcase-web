...
import tw.gov.moi.domain.Xldfr0bdType;
import tw.gov.moi.domain.Rldfr0bdType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0bdType.class ,
        entityDsName = "rldfr0bdByKey" ,
        xldfEntityClass = Xldfr0bdType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0bdQuery", xldfDsByTrans = "xldfr0bdMaxSerialNo",  xldfDsBySerialNo = "xldfr0bdBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0BD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0BD")
public class XLDFR0BD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0BD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0bdType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0bdType domainObj;
     ...
     */
    public Xldfr0bdType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0bdType domainObj) {
