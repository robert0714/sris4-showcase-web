...
import tw.gov.moi.domain.Xldfy09ohType;
import tw.gov.moi.domain.Rldfy09ohType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09ohType.class ,
        entityDsName = "rldfy09ohByKey" ,
        xldfEntityClass = Xldfy09ohType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09ohQuery", xldfDsByTrans = "xldfy09ohMaxSerialNo",  xldfDsBySerialNo = "xldfy09ohBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09OH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09OH")
public class XLDFY09OH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09OH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09ohType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09ohType domainObj;
     ...
     */
    public Xldfy09ohType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09ohType domainObj) {
