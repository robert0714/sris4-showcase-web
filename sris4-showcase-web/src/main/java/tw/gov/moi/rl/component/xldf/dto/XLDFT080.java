...
import tw.gov.moi.domain.Xldft080Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft080Type.class ,
        entityDsName = "rldft080ByKey" ,
        xldfEntityClass = Xldft080Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft080Query", xldfDsByTrans = "xldft080MaxSerialNo",  xldfDsBySerialNo = "xldft080BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT080", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT080")
public class XLDFT080 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT080(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft080Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft080Type domainObj;
     ...
     */
    public Xldft080Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft080Type domainObj) {
