...
import tw.gov.moi.domain.Xldfy09nhType;
import tw.gov.moi.domain.Rldfy09nhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09nhType.class ,
        entityDsName = "rldfy09nhByKey" ,
        xldfEntityClass = Xldfy09nhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09nhQuery", xldfDsByTrans = "xldfy09nhMaxSerialNo",  xldfDsBySerialNo = "xldfy09nhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09NH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09NH")
public class XLDFY09NH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09NH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09nhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09nhType domainObj;
     ...
     */
    public Xldfy09nhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09nhType domainObj) {
