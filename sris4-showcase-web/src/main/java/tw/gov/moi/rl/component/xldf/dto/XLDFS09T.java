...
import tw.gov.moi.domain.Xldfs09tType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09tType.class ,
        entityDsName = "rldfs09tByKey" ,
        xldfEntityClass = Xldfs09tType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09tQuery", xldfDsByTrans = "xldfs09tMaxSerialNo",  xldfDsBySerialNo = "xldfs09tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09T")
public class XLDFS09T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09T(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09tType domainObj;
     ...
     */
    public Xldfs09tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09tType domainObj) {
