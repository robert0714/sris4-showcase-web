...
import tw.gov.moi.domain.Xldft063Type;
import tw.gov.moi.domain.Rldft063Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft063Type.class ,
        entityDsName = "rldft063ByKey" ,
        xldfEntityClass = Xldft063Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft063Query", xldfDsByTrans = "xldft063MaxSerialNo",  xldfDsBySerialNo = "xldft063BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT063", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT063")
public class XLDFT063 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT063(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft063Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft063Type domainObj;
     ...
     */
    public Xldft063Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft063Type domainObj) {
