...
import tw.gov.moi.domain.Xldfx09imType;
import tw.gov.moi.domain.Rldfx09imType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09imType.class ,
        entityDsName = "rldfx09imByKey" ,
        xldfEntityClass = Xldfx09imType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09imQuery", xldfDsByTrans = "xldfx09imMaxSerialNo",  xldfDsBySerialNo = "xldfx09imBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09IM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09IM")
public class XLDFX09IM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09IM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09imType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09imType domainObj;
     ...
     */
    public Xldfx09imType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09imType domainObj) {
