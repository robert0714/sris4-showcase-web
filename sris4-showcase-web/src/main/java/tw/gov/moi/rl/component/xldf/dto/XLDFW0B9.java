...
import tw.gov.moi.domain.Xldfw0b9Type;
import tw.gov.moi.domain.Rldfw0b9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0b9Type.class ,
        entityDsName = "rldfw0b9ByKey" ,
        xldfEntityClass = Xldfw0b9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0b9Query", xldfDsByTrans = "xldfw0b9MaxSerialNo",  xldfDsBySerialNo = "xldfw0b9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0B9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0B9")
public class XLDFW0B9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0B9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0b9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0b9Type domainObj;
     ...
     */
    public Xldfw0b9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0b9Type domainObj) {
