...
import tw.gov.moi.domain.Xldft0b2Type;
import tw.gov.moi.domain.Rldft0b2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0b2Type.class ,
        entityDsName = "rldft0b2ByKey" ,
        xldfEntityClass = Xldft0b2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0b2Query", xldfDsByTrans = "xldft0b2MaxSerialNo",  xldfDsBySerialNo = "xldft0b2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0B2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0B2")
public class XLDFT0B2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0B2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0b2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0b2Type domainObj;
     ...
     */
    public Xldft0b2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0b2Type domainObj) {
