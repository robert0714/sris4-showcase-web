...
public class XLDF1440ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF1440.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF1440ID(String personId ,String siteId ) {
        super();
