 ...
 */
@RldfMappingEntity(
        value = Tldf004mType.class ,
        entityDsName = "tldf004mByKey" ,
        xldfEntityClass = Xldf004mtType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf004mtQuery", xldfDsByTrans = "xldf004mtMaxSerialNo",  xldfDsBySerialNo = "xldf004mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF004MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF004MT")
public class XLDF004MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF004MT(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf004mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf004mtType domainObj;
     ...
     */
    public Xldf004mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf004mtType domainObj) {
