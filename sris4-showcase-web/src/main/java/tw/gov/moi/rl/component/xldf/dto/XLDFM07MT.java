...
import tw.gov.moi.domain.Xldfm07mtType;
import tw.gov.moi.domain.Tldfm07mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm07mType.class ,
        entityDsName = "tldfm07mByKey" ,
        xldfEntityClass = Xldfm07mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm07mtQuery", xldfDsByTrans = "xldfm07mtMaxSerialNo",  xldfDsBySerialNo = "xldfm07mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM07MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM07MT")
public class XLDFM07MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM07MT(String personId ,String siteId ,String registerYyymmdd ,String registerHhmmss ) {
        super();
        this.domainObj = new Xldfm07mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm07mtType domainObj;
     ...
     */
    public Xldfm07mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm07mtType domainObj) {
