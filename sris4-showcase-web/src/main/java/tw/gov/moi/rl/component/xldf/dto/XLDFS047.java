...
import tw.gov.moi.domain.Rldfs047Type;
import tw.gov.moi.domain.Xldfs047Type;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfs047Type.class, entityDsName = "rldfs047ByKey", xldfEntityClass = Xldfs047Type.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfs047Query", xldfDsByTrans = "xldfs047MaxSerialNo", xldfDsBySerialNo = "xldfs047BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS047", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFS047")
public class XLDFS047 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS047(String personId, String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq) {
        super();
        this.domainObj = new Xldfs047Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs047Type domainObj;
     ...
     */
    public Xldfs047Type getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfs047Type domainObj) {
