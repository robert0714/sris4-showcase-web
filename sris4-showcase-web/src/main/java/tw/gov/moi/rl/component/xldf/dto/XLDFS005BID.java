...
@XmlType(name = "XLDFS005B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS005B") 
public class XLDFS005BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS005B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS005BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
