...
import tw.gov.moi.domain.Xldfy0d2hType;
import tw.gov.moi.domain.Rldfy0d2hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0d2hType.class ,
        entityDsName = "rldfy0d2hByKey" ,
        xldfEntityClass = Xldfy0d2hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0d2hQuery", xldfDsByTrans = "xldfy0d2hMaxSerialNo",  xldfDsBySerialNo = "xldfy0d2hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0D2H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0D2H")
public class XLDFY0D2H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0D2H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0d2hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0d2hType domainObj;
     ...
     */
    public Xldfy0d2hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0d2hType domainObj) {
