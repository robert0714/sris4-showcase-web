...
import tw.gov.moi.domain.Xldft09mType;
import tw.gov.moi.domain.Rldft09mType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09mType.class ,
        entityDsName = "rldft09mByKey" ,
        xldfEntityClass = Xldft09mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09mQuery", xldfDsByTrans = "xldft09mMaxSerialNo",  xldfDsBySerialNo = "xldft09mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09M")
public class XLDFT09M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09M(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09mType domainObj;
     ...
     */
    public Xldft09mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09mType domainObj) {
