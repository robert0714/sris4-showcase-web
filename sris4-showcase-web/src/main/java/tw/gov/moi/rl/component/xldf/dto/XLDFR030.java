...
import tw.gov.moi.domain.Xldfr030Type;
import tw.gov.moi.domain.Rldfr030Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr030Type.class ,
        entityDsName = "rldfr030ByKey" ,
        xldfEntityClass = Xldfr030Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr030Query", xldfDsByTrans = "xldfr030MaxSerialNo",  xldfDsBySerialNo = "xldfr030BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR030", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR030")
public class XLDFR030 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR030(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr030Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr030Type domainObj;
     ...
     */
    public Xldfr030Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr030Type domainObj) {
