...
import tw.gov.moi.domain.Xldfs09fType;
import tw.gov.moi.domain.Rldfs09fType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09fType.class ,
        entityDsName = "rldfs09fByKey" ,
        xldfEntityClass = Xldfs09fType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09fQuery", xldfDsByTrans = "xldfs09fMaxSerialNo",  xldfDsBySerialNo = "xldfs09fBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09F", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09F")
public class XLDFS09F implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09F(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09fType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09fType domainObj;
     ...
     */
    public Xldfs09fType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09fType domainObj) {
