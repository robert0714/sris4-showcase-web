...
import tw.gov.moi.domain.Xldfx0b1mType;
import tw.gov.moi.domain.Rldfx0b1mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0b1mType.class ,
        entityDsName = "rldfx0b1mByKey" ,
        xldfEntityClass = Xldfx0b1mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0b1mQuery", xldfDsByTrans = "xldfx0b1mMaxSerialNo",  xldfDsBySerialNo = "xldfx0b1mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0B1M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0B1M")
public class XLDFX0B1M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0B1M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0b1mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0b1mType domainObj;
     ...
     */
    public Xldfx0b1mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0b1mType domainObj) {
