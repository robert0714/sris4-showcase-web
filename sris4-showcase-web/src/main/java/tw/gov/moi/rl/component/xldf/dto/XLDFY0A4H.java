...
import tw.gov.moi.domain.Xldfy0a4hType;
import tw.gov.moi.domain.Rldfy0a4hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a4hType.class ,
        entityDsName = "rldfy0a4hByKey" ,
        xldfEntityClass = Xldfy0a4hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a4hQuery", xldfDsByTrans = "xldfy0a4hMaxSerialNo",  xldfDsBySerialNo = "xldfy0a4hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A4H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A4H")
public class XLDFY0A4H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A4H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a4hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a4hType domainObj;
     ...
     */
    public Xldfy0a4hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a4hType domainObj) {
