...
import tw.gov.moi.domain.Xldfs061Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs061Type.class ,
        entityDsName = "rldfs061ByKey" ,
        xldfEntityClass = Xldfs061Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs061Query", xldfDsByTrans = "xldfs061MaxSerialNo",  xldfDsBySerialNo = "xldfs061BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS061", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS061")
public class XLDFS061 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS061(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs061Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs061Type domainObj;
     ...
     */
    public Xldfs061Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs061Type domainObj) {
