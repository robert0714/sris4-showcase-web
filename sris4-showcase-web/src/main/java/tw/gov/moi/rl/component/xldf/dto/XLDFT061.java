...
import tw.gov.moi.domain.Xldft061Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft061Type.class ,
        entityDsName = "rldft061ByKey" ,
        xldfEntityClass = Xldft061Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft061Query", xldfDsByTrans = "xldft061MaxSerialNo",  xldfDsBySerialNo = "xldft061BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT061", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT061")
public class XLDFT061 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT061(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft061Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft061Type domainObj;
     ...
     */
    public Xldft061Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft061Type domainObj) {
