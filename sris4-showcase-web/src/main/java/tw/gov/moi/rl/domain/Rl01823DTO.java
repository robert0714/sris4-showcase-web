...
@XmlType(name = "rl01823DTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl01823AppDataDTO",
        "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication" })
@XmlRootElement(name = "Rl01823DTO")
public class Rl01823DTO implements Serializable {
    ...
    /** 撤銷出生地登記 AppDataDTO. */
    @XmlElement(name = "Rl01823AppDataDTO")
    @FieldName("撤銷出生地登記 AppDataDTO")
    private Rl01823AppDataDTO rl01823AppDataDTO = new Rl01823AppDataDTO();
    ...
    /**
     * Gets the rl01823 app data dto.
     * 
     * @return the rl01823 app data dto
     */
    public Rl01823AppDataDTO getRl01823AppDataDTO() {
        return rl01823AppDataDTO;
    }

    /**
     * Sets the rl01823 app data dto.
     * 
     * @param rl01823AppDataDTO
     *            the new rl01823 app data dto
     */
    public void setRl01823AppDataDTO(final Rl01823AppDataDTO rl01823AppDataDTO) {
        this.rl01823AppDataDTO = rl01823AppDataDTO;
    }
