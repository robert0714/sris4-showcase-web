...
import tw.gov.moi.domain.Xldfy0b8mType;
import tw.gov.moi.domain.Rldfy0b8mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b8mType.class ,
        entityDsName = "rldfy0b8mByKey" ,
        xldfEntityClass = Xldfy0b8mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b8mQuery", xldfDsByTrans = "xldfy0b8mMaxSerialNo",  xldfDsBySerialNo = "xldfy0b8mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B8M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B8M")
public class XLDFY0B8M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B8M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b8mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b8mType domainObj;
     ...
     */
    public Xldfy0b8mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b8mType domainObj) {
