...
public class XLDFM07MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM07M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM07MID(String personId ,String siteId ,String registerYyymmdd ,String registerHhmmss ) {
        super();
