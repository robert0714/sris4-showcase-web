...
@XmlType(name = "XLDFX09DH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX09DH") 
public class XLDFX09DHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX09DH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX09DHID(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
