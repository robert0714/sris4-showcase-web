...
import tw.gov.moi.domain.Xldfr09pType;
import tw.gov.moi.domain.Rldfr09pType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09pType.class ,
        entityDsName = "rldfr09pByKey" ,
        xldfEntityClass = Xldfr09pType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09pQuery", xldfDsByTrans = "xldfr09pMaxSerialNo",  xldfDsBySerialNo = "xldfr09pBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09P", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09P")
public class XLDFR09P implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09P(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09pType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09pType domainObj;
     ...
     */
    public Xldfr09pType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09pType domainObj) {
