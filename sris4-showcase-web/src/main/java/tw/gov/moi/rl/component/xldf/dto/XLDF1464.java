 ...
 */
@RldfMappingEntity(
        value = Xldf1464Type.class ,
        entityDsName = "xldf1464ByKey" ,
        xldfEntityClass = Xldf1464Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf1464Query", xldfDsByTrans = "xldf1464MaxSerialNo",  xldfDsBySerialNo = "xldf1464BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF1464", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF1464")
public class XLDF1464 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF1464(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf1464Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldf1464Type domainObj;
     ...
     */
    public Xldf1464Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf1464Type domainObj) {
