...
public class XLDFM07HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM07H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM07HID(String personId ,String siteId ,String registerYyymmdd ,String registerHhmmss ,String removeYyymmdd ,String removeTime ) {
        super();
