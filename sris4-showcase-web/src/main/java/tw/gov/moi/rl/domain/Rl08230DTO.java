...
/**
 * The Class Rl08230DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl08230DTO", propOrder = { "catalog", "printType", "reportFormat", "fileURL", "reportURL" })
@XmlRootElement(name = "Rl08230DTO")
public class Rl08230DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -5906908829677699111L;
