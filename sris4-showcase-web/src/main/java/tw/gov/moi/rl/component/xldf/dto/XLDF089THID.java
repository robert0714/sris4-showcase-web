...
@XmlType(name = "XLDF089TH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF089TH") 
public class XLDF089THID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF089TH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF089THID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String applyCode ,String removeYyymmdd ,String removeTime ) {
        super();
