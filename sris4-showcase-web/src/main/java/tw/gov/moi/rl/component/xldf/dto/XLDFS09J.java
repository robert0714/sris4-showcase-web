...
import tw.gov.moi.domain.Xldfs09jType;
import tw.gov.moi.domain.Rldfs09jType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09jType.class ,
        entityDsName = "rldfs09jByKey" ,
        xldfEntityClass = Xldfs09jType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09jQuery", xldfDsByTrans = "xldfs09jMaxSerialNo",  xldfDsBySerialNo = "xldfs09jBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09J", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09J")
public class XLDFS09J implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09J(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09jType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09jType domainObj;
     ...
     */
    public Xldfs09jType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09jType domainObj) {
