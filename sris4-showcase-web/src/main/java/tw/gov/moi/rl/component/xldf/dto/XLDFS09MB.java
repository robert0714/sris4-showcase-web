...
import tw.gov.moi.domain.Xldfs09mbType;
import tw.gov.moi.domain.Rldfs09mbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09mbType.class ,
        entityDsName = "rldfs09mbByKey" ,
        xldfEntityClass = Xldfs09mbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09mbQuery", xldfDsByTrans = "xldfs09mbMaxSerialNo",  xldfDsBySerialNo = "xldfs09mbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09MB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09MB")
public class XLDFS09MB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09MB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09mbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09mbType domainObj;
     ...
     */
    public Xldfs09mbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09mbType domainObj) {
