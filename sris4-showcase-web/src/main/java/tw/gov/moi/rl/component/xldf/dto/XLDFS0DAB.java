...
import tw.gov.moi.domain.Xldfs0dabType;
import tw.gov.moi.domain.Rldfs0dabType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0dabType.class ,
        entityDsName = "rldfs0dabByKey" ,
        xldfEntityClass = Xldfs0dabType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0dabQuery", xldfDsByTrans = "xldfs0dabMaxSerialNo",  xldfDsBySerialNo = "xldfs0dabBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DAB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DAB")
public class XLDFS0DAB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DAB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0dabType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0dabType domainObj;
     ...
     */
    public Xldfs0dabType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0dabType domainObj) {
