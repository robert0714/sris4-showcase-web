...
import tw.gov.moi.domain.Xldfs041Type;
import tw.gov.moi.domain.Rldfs041Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs041Type.class ,
        entityDsName = "rldfs041ByKey" ,
        xldfEntityClass = Xldfs041Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs041Query", xldfDsByTrans = "xldfs041MaxSerialNo",  xldfDsBySerialNo = "xldfs041BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS041", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS041")
public class XLDFS041 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS041(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs041Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs041Type domainObj;
     ...
     */
    public Xldfs041Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs041Type domainObj) {
