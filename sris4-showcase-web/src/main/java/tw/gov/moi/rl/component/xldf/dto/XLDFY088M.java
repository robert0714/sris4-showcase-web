...
import tw.gov.moi.domain.Xldfy088mType;
import tw.gov.moi.domain.Rldfy088mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy088mType.class ,
        entityDsName = "rldfy088mByKey" ,
        xldfEntityClass = Xldfy088mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy088mQuery", xldfDsByTrans = "xldfy088mMaxSerialNo",  xldfDsBySerialNo = "xldfy088mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY088M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY088M")
public class XLDFY088M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY088M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy088mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy088mType domainObj;
     ...
     */
    public Xldfy088mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy088mType domainObj) {
