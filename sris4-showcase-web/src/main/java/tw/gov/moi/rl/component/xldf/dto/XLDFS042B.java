...
import tw.gov.moi.domain.Xldfs042bType;
import tw.gov.moi.domain.Rldfs042bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs042bType.class ,
        entityDsName = "rldfs042bByKey" ,
        xldfEntityClass = Xldfs042bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs042bQuery", xldfDsByTrans = "xldfs042bMaxSerialNo",  xldfDsBySerialNo = "xldfs042bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS042B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS042B")
public class XLDFS042B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS042B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs042bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs042bType domainObj;
     ...
     */
    public Xldfs042bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs042bType domainObj) {
