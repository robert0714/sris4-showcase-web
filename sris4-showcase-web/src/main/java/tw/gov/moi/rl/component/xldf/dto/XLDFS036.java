...
import tw.gov.moi.domain.Xldfs036Type;
import tw.gov.moi.domain.Rldfs036Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs036Type.class ,
        entityDsName = "rldfs036ByKey" ,
        xldfEntityClass = Xldfs036Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs036Query", xldfDsByTrans = "xldfs036MaxSerialNo",  xldfDsBySerialNo = "xldfs036BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS036", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS036")
public class XLDFS036 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS036(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs036Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs036Type domainObj;
     ...
     */
    public Xldfs036Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs036Type domainObj) {
