...
import tw.gov.moi.domain.Xldfr0aeType;
import tw.gov.moi.domain.Rldfr0aeType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0aeType.class ,
        entityDsName = "rldfr0aeByKey" ,
        xldfEntityClass = Xldfr0aeType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0aeQuery", xldfDsByTrans = "xldfr0aeMaxSerialNo",  xldfDsBySerialNo = "xldfr0aeBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0AE", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0AE")
public class XLDFR0AE implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0AE(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0aeType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0aeType domainObj;
     ...
     */
    public Xldfr0aeType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0aeType domainObj) {
