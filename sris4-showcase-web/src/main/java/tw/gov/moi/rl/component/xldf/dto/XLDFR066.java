...
import tw.gov.moi.domain.Xldfr066Type;
import tw.gov.moi.domain.Rldfr066Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr066Type.class ,
        entityDsName = "rldfr066ByKey" ,
        xldfEntityClass = Xldfr066Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr066Query", xldfDsByTrans = "xldfr066MaxSerialNo",  xldfDsBySerialNo = "xldfr066BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR066", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR066")
public class XLDFR066 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR066(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr066Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr066Type domainObj;
     ...
     */
    public Xldfr066Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr066Type domainObj) {
