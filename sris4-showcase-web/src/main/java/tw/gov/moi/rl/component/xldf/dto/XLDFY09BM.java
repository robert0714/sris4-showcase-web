...
import tw.gov.moi.domain.Xldfy09bmType;
import tw.gov.moi.domain.Rldfy09bmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09bmType.class ,
        entityDsName = "rldfy09bmByKey" ,
        xldfEntityClass = Xldfy09bmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09bmQuery", xldfDsByTrans = "xldfy09bmMaxSerialNo",  xldfDsBySerialNo = "xldfy09bmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09BM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09BM")
public class XLDFY09BM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09BM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09bmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09bmType domainObj;
     ...
     */
    public Xldfy09bmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09bmType domainObj) {
