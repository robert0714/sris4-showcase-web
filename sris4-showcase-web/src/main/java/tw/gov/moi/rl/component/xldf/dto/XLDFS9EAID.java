...
public class XLDFS9EAID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS9EA.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS9EAID(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
