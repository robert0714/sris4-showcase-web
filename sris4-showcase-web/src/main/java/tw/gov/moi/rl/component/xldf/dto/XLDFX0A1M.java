...
import tw.gov.moi.domain.Xldfx0a1mType;
import tw.gov.moi.domain.Rldfx0a1mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0a1mType.class ,
        entityDsName = "rldfx0a1mByKey" ,
        xldfEntityClass = Xldfx0a1mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0a1mQuery", xldfDsByTrans = "xldfx0a1mMaxSerialNo",  xldfDsBySerialNo = "xldfx0a1mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0A1M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0A1M")
public class XLDFX0A1M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0A1M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0a1mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0a1mType domainObj;
     ...
     */
    public Xldfx0a1mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0a1mType domainObj) {
