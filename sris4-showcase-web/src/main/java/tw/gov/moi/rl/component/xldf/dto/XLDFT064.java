...
import tw.gov.moi.domain.Xldft064Type;
import tw.gov.moi.domain.Rldft064Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft064Type.class ,
        entityDsName = "rldft064ByKey" ,
        xldfEntityClass = Xldft064Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft064Query", xldfDsByTrans = "xldft064MaxSerialNo",  xldfDsBySerialNo = "xldft064BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT064", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT064")
public class XLDFT064 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT064(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft064Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft064Type domainObj;
     ...
     */
    public Xldft064Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft064Type domainObj) {
