...
import tw.gov.moi.domain.Xldfy075hType;
import tw.gov.moi.domain.Rldfy075hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy075hType.class ,
        entityDsName = "rldfy075hByKey" ,
        xldfEntityClass = Xldfy075hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy075hQuery", xldfDsByTrans = "xldfy075hMaxSerialNo",  xldfDsBySerialNo = "xldfy075hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY075H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY075H")
public class XLDFY075H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY075H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy075hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy075hType domainObj;
     ...
     */
    public Xldfy075hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy075hType domainObj) {
