...
import tw.gov.moi.domain.Xldfw0ahType;
import tw.gov.moi.domain.Rldfw0ahType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0ahType.class ,
        entityDsName = "rldfw0ahByKey" ,
        xldfEntityClass = Xldfw0ahType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0ahQuery", xldfDsByTrans = "xldfw0ahMaxSerialNo",  xldfDsBySerialNo = "xldfw0ahBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AH")
public class XLDFW0AH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AH(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0ahType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0ahType domainObj;
     ...
     */
    public Xldfw0ahType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0ahType domainObj) {
