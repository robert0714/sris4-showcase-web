...
import tw.gov.moi.domain.Xldfm05mtType;
import tw.gov.moi.domain.Tldfm05mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm05mType.class ,
        entityDsName = "tldfm05mByKey" ,
        xldfEntityClass = Xldfm05mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm05mtQuery", xldfDsByTrans = "xldfm05mtMaxSerialNo",  xldfDsBySerialNo = "xldfm05mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM05MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM05MT")
public class XLDFM05MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM05MT(String personId ,String siteId ,String relationId ,String relationCode ) {
        super();
        this.domainObj = new Xldfm05mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm05mtType domainObj;
     ...
     */
    public Xldfm05mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm05mtType domainObj) {
