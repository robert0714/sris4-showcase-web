...
import tw.gov.moi.domain.Xldfs064bType;
import tw.gov.moi.domain.Rldfs064bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs064bType.class ,
        entityDsName = "rldfs064bByKey" ,
        xldfEntityClass = Xldfs064bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs064bQuery", xldfDsByTrans = "xldfs064bMaxSerialNo",  xldfDsBySerialNo = "xldfs064bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS064B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS064B")
public class XLDFS064B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS064B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs064bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs064bType domainObj;
     ...
     */
    public Xldfs064bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs064bType domainObj) {
