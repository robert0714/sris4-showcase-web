...
import tw.gov.moi.domain.Xldft010Type;
import tw.gov.moi.domain.Rldft010Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft010Type.class ,
        entityDsName = "rldft010ByKey" ,
        xldfEntityClass = Xldft010Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft010Query", xldfDsByTrans = "xldft010MaxSerialNo",  xldfDsBySerialNo = "xldft010BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT010", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT010")
public class XLDFT010 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT010(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft010Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft010Type domainObj;
     ...
     */
    public Xldft010Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft010Type domainObj) {
