...
import tw.gov.moi.domain.Xldft0b4Type;
import tw.gov.moi.domain.Rldft0b4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0b4Type.class ,
        entityDsName = "rldft0b4ByKey" ,
        xldfEntityClass = Xldft0b4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0b4Query", xldfDsByTrans = "xldft0b4MaxSerialNo",  xldfDsBySerialNo = "xldft0b4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0B4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0B4")
public class XLDFT0B4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0B4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0b4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0b4Type domainObj;
     ...
     */
    public Xldft0b4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0b4Type domainObj) {
