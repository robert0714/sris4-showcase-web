 ...
 */
@RldfMappingEntity(
        value = Rldf006mType.class ,
        entityDsName = "rldf006mByKey" ,
        xldfEntityClass = Xldf006mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf006mQuery", xldfDsByTrans = "xldf006mMaxSerialNo",  xldfDsBySerialNo = "xldf006mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF006M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF006M")
public class XLDF006M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF006M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf006mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf006mType domainObj;
     ...
     */
    public Xldf006mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf006mType domainObj) {
