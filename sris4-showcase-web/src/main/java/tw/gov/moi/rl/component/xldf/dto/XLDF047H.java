...
import tw.gov.moi.domain.Xldf047hType;
 ...
 */
@RldfMappingEntity(
        value = Rldf047hType.class ,
        entityDsName = "rldf047hByKey" ,
        xldfEntityClass = Xldf047hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf047hQuery", xldfDsByTrans = "xldf047hMaxSerialNo",  xldfDsBySerialNo = "xldf047hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF047H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF047H")
public class XLDF047H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF047H(String personId ,String removeYyymmdd ,String removeTime ,String seqNo ,String siteId ) {
        super();
        this.domainObj = new Xldf047hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf047hType domainObj;
     ...
     */
    public Xldf047hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf047hType domainObj) {
