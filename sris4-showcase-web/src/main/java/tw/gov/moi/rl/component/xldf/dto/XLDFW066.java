...
import tw.gov.moi.domain.Xldfw066Type;
import tw.gov.moi.domain.Rldfw066Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw066Type.class ,
        entityDsName = "rldfw066ByKey" ,
        xldfEntityClass = Xldfw066Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw066Query", xldfDsByTrans = "xldfw066MaxSerialNo",  xldfDsBySerialNo = "xldfw066BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW066", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW066")
public class XLDFW066 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW066(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw066Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw066Type domainObj;
     ...
     */
    public Xldfw066Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw066Type domainObj) {
