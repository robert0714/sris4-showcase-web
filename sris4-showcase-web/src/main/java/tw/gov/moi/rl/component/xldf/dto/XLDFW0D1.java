...
import tw.gov.moi.domain.Xldfw0d1Type;
import tw.gov.moi.domain.Rldfw0d1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0d1Type.class ,
        entityDsName = "rldfw0d1ByKey" ,
        xldfEntityClass = Xldfw0d1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0d1Query", xldfDsByTrans = "xldfw0d1MaxSerialNo",  xldfDsBySerialNo = "xldfw0d1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0D1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0D1")
public class XLDFW0D1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0D1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0d1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0d1Type domainObj;
     ...
     */
    public Xldfw0d1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0d1Type domainObj) {
