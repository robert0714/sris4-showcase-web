...
public class XLDFY079DMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY079DM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY079DMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
