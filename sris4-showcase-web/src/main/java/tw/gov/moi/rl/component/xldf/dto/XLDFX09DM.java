...
import tw.gov.moi.domain.Xldfx09dmType;
import tw.gov.moi.domain.Rldfx09dmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09dmType.class ,
        entityDsName = "rldfx09dmByKey" ,
        xldfEntityClass = Xldfx09dmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09dmQuery", xldfDsByTrans = "xldfx09dmMaxSerialNo",  xldfDsBySerialNo = "xldfx09dmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09DM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09DM")
public class XLDFX09DM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09DM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09dmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09dmType domainObj;
     ...
     */
    public Xldfx09dmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09dmType domainObj) {
