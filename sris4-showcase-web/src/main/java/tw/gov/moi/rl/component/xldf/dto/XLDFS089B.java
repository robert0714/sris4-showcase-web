...
import tw.gov.moi.domain.Xldfs089bType;
import tw.gov.moi.domain.Rldfs089bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs089bType.class ,
        entityDsName = "rldfs089bByKey" ,
        xldfEntityClass = Xldfs089bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs089bQuery", xldfDsByTrans = "xldfs089bMaxSerialNo",  xldfDsBySerialNo = "xldfs089bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS089B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS089B")
public class XLDFS089B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS089B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs089bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs089bType domainObj;
     ...
     */
    public Xldfs089bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs089bType domainObj) {
