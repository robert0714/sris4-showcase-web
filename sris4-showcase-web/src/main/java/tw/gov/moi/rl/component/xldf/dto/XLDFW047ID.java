...
@XmlType(name = "XLDFW047", propOrder = { "keys", "xldfClass" })
@XmlRootElement(name = "XLDFW047")
public class XLDFW047ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW047.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW047ID(String personId, String applyTransactionId, Integer applySequenceId, String siteId,
            Integer applySeq) {
        super();
