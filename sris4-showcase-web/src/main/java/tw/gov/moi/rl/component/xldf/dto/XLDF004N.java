...
import tw.gov.moi.domain.Xldf004nType;
 ...
 */
@RldfMappingEntity(
        value = Rldf004nType.class ,
        entityDsName = "rldf004nByKey" ,
        xldfEntityClass = Xldf004nType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "noticeType" , length = 2),
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "noticeDate" , length = 7),
            @XldfKeyMapping( name = "noticeTime" , length = 6),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf004nQuery", xldfDsByTrans = "xldf004nMaxSerialNo",  xldfDsBySerialNo = "xldf004nBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF004N", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF004N")
public class XLDF004N implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF004N(String noticeType ,String personId ,String noticeDate ,String noticeTime ,String siteId ) {
        super();
        this.domainObj = new Xldf004nType();
        getDomainObj().setNoticeType(noticeType); 
        getDomainObj().setPersonId(personId); 
        getDomainObj().setNoticeDate(noticeDate); 
        getDomainObj().setNoticeTime(noticeTime); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf004nType domainObj;
     ...
     */
    public Xldf004nType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf004nType domainObj) {
