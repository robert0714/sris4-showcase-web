...
@XmlType(name = "XLDFW09E", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW09E") 
public class XLDFW09EID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW09E.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW09EID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
