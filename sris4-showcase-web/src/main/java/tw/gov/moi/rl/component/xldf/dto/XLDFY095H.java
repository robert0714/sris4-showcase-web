...
import tw.gov.moi.domain.Xldfy095hType;
import tw.gov.moi.domain.Rldfy095hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy095hType.class ,
        entityDsName = "rldfy095hByKey" ,
        xldfEntityClass = Xldfy095hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy095hQuery", xldfDsByTrans = "xldfy095hMaxSerialNo",  xldfDsBySerialNo = "xldfy095hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY095H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY095H")
public class XLDFY095H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY095H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy095hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy095hType domainObj;
     ...
     */
    public Xldfy095hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy095hType domainObj) {
