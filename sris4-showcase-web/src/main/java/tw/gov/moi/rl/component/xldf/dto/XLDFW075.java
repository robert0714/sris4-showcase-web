...
import tw.gov.moi.domain.Xldfw075Type;
import tw.gov.moi.domain.Rldfw075Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw075Type.class ,
        entityDsName = "rldfw075ByKey" ,
        xldfEntityClass = Xldfw075Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw075Query", xldfDsByTrans = "xldfw075MaxSerialNo",  xldfDsBySerialNo = "xldfw075BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW075", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW075")
public class XLDFW075 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW075(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw075Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw075Type domainObj;
     ...
     */
    public Xldfw075Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw075Type domainObj) {
