...
import tw.gov.moi.domain.Xldfx09qmType;
import tw.gov.moi.domain.Rldfx09qmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09qmType.class ,
        entityDsName = "rldfx09qmByKey" ,
        xldfEntityClass = Xldfx09qmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09qmQuery", xldfDsByTrans = "xldfx09qmMaxSerialNo",  xldfDsBySerialNo = "xldfx09qmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09QM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09QM")
public class XLDFX09QM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09QM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09qmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09qmType domainObj;
     ...
     */
    public Xldfx09qmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09qmType domainObj) {
