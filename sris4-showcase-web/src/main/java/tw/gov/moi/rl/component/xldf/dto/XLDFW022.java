...
import tw.gov.moi.domain.Xldfw022Type;
import tw.gov.moi.domain.Rldfw022Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw022Type.class ,
        entityDsName = "rldfw022ByKey" ,
        xldfEntityClass = Xldfw022Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw022Query", xldfDsByTrans = "xldfw022MaxSerialNo",  xldfDsBySerialNo = "xldfw022BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW022", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW022")
public class XLDFW022 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW022(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw022Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw022Type domainObj;
     ...
     */
    public Xldfw022Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw022Type domainObj) {
