...
import tw.gov.moi.domain.Xldfy003mType;
import tw.gov.moi.domain.Rldfy003mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy003mType.class ,
        entityDsName = "rldfy003mByKey" ,
        xldfEntityClass = Xldfy003mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy003mQuery", xldfDsByTrans = "xldfy003mMaxSerialNo",  xldfDsBySerialNo = "xldfy003mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY003M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY003M")
public class XLDFY003M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY003M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy003mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy003mType domainObj;
     ...
     */
    public Xldfy003mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy003mType domainObj) {
