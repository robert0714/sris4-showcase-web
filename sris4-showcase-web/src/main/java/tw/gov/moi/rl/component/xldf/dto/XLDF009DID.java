...
@XmlType(name = "XLDF009D", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF009D") 
public class XLDF009DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF009D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF009DID(String trMode ,String applyMode ,String applyYyymmdd ,String personId ,String siteId ) {
        super();
