...
import tw.gov.moi.domain.Xldfr027Type;
import tw.gov.moi.domain.Rldfr027Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr027Type.class ,
        entityDsName = "rldfr027ByKey" ,
        xldfEntityClass = Xldfr027Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr027Query", xldfDsByTrans = "xldfr027MaxSerialNo",  xldfDsBySerialNo = "xldfr027BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR027", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR027")
public class XLDFR027 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR027(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr027Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr027Type domainObj;
     ...
     */
    public Xldfr027Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr027Type domainObj) {
