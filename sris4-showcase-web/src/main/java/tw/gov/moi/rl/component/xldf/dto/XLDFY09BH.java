...
import tw.gov.moi.domain.Xldfy09bhType;
import tw.gov.moi.domain.Rldfy09bhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09bhType.class ,
        entityDsName = "rldfy09bhByKey" ,
        xldfEntityClass = Xldfy09bhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09bhQuery", xldfDsByTrans = "xldfy09bhMaxSerialNo",  xldfDsBySerialNo = "xldfy09bhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09BH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09BH")
public class XLDFY09BH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09BH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09bhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09bhType domainObj;
     ...
     */
    public Xldfy09bhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09bhType domainObj) {
