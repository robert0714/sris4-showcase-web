...
import tw.gov.moi.domain.Xldfy09mhType;
import tw.gov.moi.domain.Rldfy09mhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09mhType.class ,
        entityDsName = "rldfy09mhByKey" ,
        xldfEntityClass = Xldfy09mhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09mhQuery", xldfDsByTrans = "xldfy09mhMaxSerialNo",  xldfDsBySerialNo = "xldfy09mhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09MH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09MH")
public class XLDFY09MH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09MH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09mhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09mhType domainObj;
     ...
     */
    public Xldfy09mhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09mhType domainObj) {
