...
import tw.gov.moi.domain.Xldfs0a6Type;
import tw.gov.moi.domain.Rldfs0a6Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a6Type.class ,
        entityDsName = "rldfs0a6ByKey" ,
        xldfEntityClass = Xldfs0a6Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a6Query", xldfDsByTrans = "xldfs0a6MaxSerialNo",  xldfDsBySerialNo = "xldfs0a6BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A6", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A6")
public class XLDFS0A6 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A6(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a6Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a6Type domainObj;
     ...
     */
    public Xldfs0a6Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a6Type domainObj) {
