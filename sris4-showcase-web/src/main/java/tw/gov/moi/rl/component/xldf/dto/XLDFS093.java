...
import tw.gov.moi.domain.Xldfs093Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs093Type.class ,
        entityDsName = "rldfs093ByKey" ,
        xldfEntityClass = Xldfs093Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs093Query", xldfDsByTrans = "xldfs093MaxSerialNo",  xldfDsBySerialNo = "xldfs093BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS093", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS093")
public class XLDFS093 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS093(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs093Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs093Type domainObj;
     ...
     */
    public Xldfs093Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs093Type domainObj) {
