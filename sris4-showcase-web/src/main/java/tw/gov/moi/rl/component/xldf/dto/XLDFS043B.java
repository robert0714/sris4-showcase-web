...
import tw.gov.moi.domain.Rldfs043bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs043bType.class ,
        entityDsName = "rldfs043bByKey" ,
        xldfEntityClass = Xldfs043bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs043bQuery", xldfDsByTrans = "xldfs043bMaxSerialNo",  xldfDsBySerialNo = "xldfs043bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS043B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS043B")
public class XLDFS043B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS043B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs043bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs043bType domainObj;
     ...
     */
    public Xldfs043bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs043bType domainObj) {
