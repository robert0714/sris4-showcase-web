...
import tw.gov.moi.domain.Xldfy089hType;
import tw.gov.moi.domain.Rldfy089hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy089hType.class ,
        entityDsName = "rldfy089hByKey" ,
        xldfEntityClass = Xldfy089hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy089hQuery", xldfDsByTrans = "xldfy089hMaxSerialNo",  xldfDsBySerialNo = "xldfy089hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY089H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY089H")
public class XLDFY089H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY089H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy089hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy089hType domainObj;
     ...
     */
    public Xldfy089hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy089hType domainObj) {
