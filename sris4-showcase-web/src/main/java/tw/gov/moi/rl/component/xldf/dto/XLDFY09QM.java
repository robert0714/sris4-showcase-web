...
import tw.gov.moi.domain.Xldfy09qmType;
import tw.gov.moi.domain.Rldfy09qmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09qmType.class ,
        entityDsName = "rldfy09qmByKey" ,
        xldfEntityClass = Xldfy09qmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09qmQuery", xldfDsByTrans = "xldfy09qmMaxSerialNo",  xldfDsBySerialNo = "xldfy09qmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09QM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09QM")
public class XLDFY09QM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09QM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09qmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09qmType domainObj;
     ...
     */
    public Xldfy09qmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09qmType domainObj) {
