...
import tw.gov.moi.domain.Xldfs0b4bType;
import tw.gov.moi.domain.Rldfs0b4bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b4bType.class ,
        entityDsName = "rldfs0b4bByKey" ,
        xldfEntityClass = Xldfs0b4bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b4bQuery", xldfDsByTrans = "xldfs0b4bMaxSerialNo",  xldfDsBySerialNo = "xldfs0b4bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B4B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B4B")
public class XLDFS0B4B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B4B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0b4bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b4bType domainObj;
     ...
     */
    public Xldfs0b4bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b4bType domainObj) {
