...
import tw.gov.moi.domain.Rldfs104Type;
...
@XmlType(name = "rl0x404DTO", propOrder = { "MainDTO", "EditResult", "QuertDto", "SelectData", "Resutlts", "Recored",
        "IsVerify", "CommononType" })
@XmlRootElement(name = "Rl0x404DTO")
public class Rl0x404DTO implements Serializable {
    ...
    @FieldName("修改紀錄")
    private Rldfs104Type recored = new Rldfs104Type();
    ...
    @FieldName("R檔預設值")
    private Rldft004Type commononType = null;
    ...
    public static class Rl0x404ChoiceBtn {
    ...
    public Rldft004Type getCommononType() {
        return commononType;
    }

    public void setCommononType(Rldft004Type commononType) {
    ...
    public Rldfs104Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs104Type recored) {
        this.recored = recored;
    }

    @Override
    public String toString() {
        return "Rl0x404DTO [mainDTO=" + mainDTO + ", editResult=" + editResult + ", quertDto=" + quertDto
