...
import tw.gov.moi.domain.Xldfy09smType;
import tw.gov.moi.domain.Rldfy09smType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09smType.class ,
        entityDsName = "rldfy09smByKey" ,
        xldfEntityClass = Xldfy09smType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09smQuery", xldfDsByTrans = "xldfy09smMaxSerialNo",  xldfDsBySerialNo = "xldfy09smBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09SM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09SM")
public class XLDFY09SM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09SM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09smType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09smType domainObj;
     ...
     */
    public Xldfy09smType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09smType domainObj) {
