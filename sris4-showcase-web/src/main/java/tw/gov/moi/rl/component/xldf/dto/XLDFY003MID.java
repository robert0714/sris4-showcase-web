...
public class XLDFY003MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY003M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY003MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
