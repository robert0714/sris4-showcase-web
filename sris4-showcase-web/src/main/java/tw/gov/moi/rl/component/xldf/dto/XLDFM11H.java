...
import tw.gov.moi.domain.Xldfm11hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm11hType.class ,
        entityDsName = "rldfm11hByKey" ,
        xldfEntityClass = Xldfm11hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm11hQuery", xldfDsByTrans = "xldfm11hMaxSerialNo",  xldfDsBySerialNo = "xldfm11hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM11H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM11H")
public class XLDFM11H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM11H(String siteId ,String removeYyymmdd ,String removeTime ,String personId ) {
        super();
        this.domainObj = new Xldfm11hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm11hType domainObj;
     ...
     */
    public Xldfm11hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm11hType domainObj) {
