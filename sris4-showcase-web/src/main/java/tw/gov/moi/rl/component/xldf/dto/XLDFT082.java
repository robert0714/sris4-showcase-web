...
import tw.gov.moi.domain.Xldft082Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft082Type.class ,
        entityDsName = "rldft082ByKey" ,
        xldfEntityClass = Xldft082Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft082Query", xldfDsByTrans = "xldft082MaxSerialNo",  xldfDsBySerialNo = "xldft082BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT082", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT082")
public class XLDFT082 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT082(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft082Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft082Type domainObj;
     ...
     */
    public Xldft082Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft082Type domainObj) {
