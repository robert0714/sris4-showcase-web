...
import tw.gov.moi.domain.Xldfr010Type;
import tw.gov.moi.domain.Rldfr010Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr010Type.class ,
        entityDsName = "rldfr010ByKey" ,
        xldfEntityClass = Xldfr010Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr010Query", xldfDsByTrans = "xldfr010MaxSerialNo",  xldfDsBySerialNo = "xldfr010BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR010", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR010")
public class XLDFR010 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR010(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr010Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr010Type domainObj;
     ...
     */
    public Xldfr010Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr010Type domainObj) {
