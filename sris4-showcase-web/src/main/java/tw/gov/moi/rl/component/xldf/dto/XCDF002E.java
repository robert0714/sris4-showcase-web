...
import tw.gov.moi.domain.Xcdf002eType;
 ...
 */
@RldfMappingEntity(
        value = Xcdf002eType.class ,
        entityDsName = "xcdf002eByKey" ,
        xldfEntityClass = Xcdf002eType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "txYyymmdd" , length = 7),
            @XldfKeyMapping( name = "txHhmmss" , length = 6)

        }) 
@XldfDsNameMaping(xldfDsName = "xcdf002eQuery", xldfDsByTrans = "xcdf002eMaxSerialNo",  xldfDsBySerialNo = "xcdf002eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XCDF002E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XCDF002E")
public class XCDF002E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XCDF002E(String personId ,String txYyymmdd ,String txHhmmss ) {
        super();
        this.domainObj = new Xcdf002eType();
        getDomainObj().setPersonId(personId); 
        getDomainObj().setTxYyymmdd(txYyymmdd); 
        getDomainObj().setTxHhmmss(txHhmmss); 
    ...
    @FieldName("XLDF領域物件")
    private Xcdf002eType domainObj;
     ...
     */
    public Xcdf002eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xcdf002eType domainObj) {
