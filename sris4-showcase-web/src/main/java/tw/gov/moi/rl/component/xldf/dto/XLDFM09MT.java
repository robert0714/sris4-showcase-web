...
import tw.gov.moi.domain.Xldfm09mtType;
import tw.gov.moi.domain.Tldfm09mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm09mType.class ,
        entityDsName = "tldfm09mByKey" ,
        xldfEntityClass = Xldfm09mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm09mtQuery", xldfDsByTrans = "xldfm09mtMaxSerialNo",  xldfDsBySerialNo = "xldfm09mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM09MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM09MT")
public class XLDFM09MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM09MT(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ) {
        super();
        this.domainObj = new Xldfm09mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm09mtType domainObj;
     ...
     */
    public Xldfm09mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm09mtType domainObj) {
