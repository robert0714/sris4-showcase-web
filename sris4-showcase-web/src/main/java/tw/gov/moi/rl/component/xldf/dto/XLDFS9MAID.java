...
@XmlType(name = "XLDFS9MA", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS9MA") 
public class XLDFS9MAID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS9MA.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS9MAID(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
