...
import tw.gov.moi.domain.Xldfs0bbbType;
import tw.gov.moi.domain.Rldfs0bbbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0bbbType.class ,
        entityDsName = "rldfs0bbbByKey" ,
        xldfEntityClass = Xldfs0bbbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0bbbQuery", xldfDsByTrans = "xldfs0bbbMaxSerialNo",  xldfDsBySerialNo = "xldfs0bbbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BBB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BBB")
public class XLDFS0BBB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BBB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0bbbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0bbbType domainObj;
     ...
     */
    public Xldfs0bbbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0bbbType domainObj) {
