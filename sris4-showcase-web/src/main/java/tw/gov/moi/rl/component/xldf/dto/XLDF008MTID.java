...
@XmlType(name = "XLDF008MT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF008MT") 
public class XLDF008MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF008MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF008MTID(String personId ,String specialCode ,String siteId ) {
        super();
