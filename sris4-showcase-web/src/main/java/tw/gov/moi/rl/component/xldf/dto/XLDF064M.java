...
import tw.gov.moi.domain.Xldf064mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf064mType.class ,
        entityDsName = "rldf064mByKey" ,
        xldfEntityClass = Xldf064mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "personId" , length = 10)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf064mQuery", xldfDsByTrans = "xldf064mMaxSerialNo",  xldfDsBySerialNo = "xldf064mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF064M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF064M")
public class XLDF064M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF064M(String siteId ,String personId ) {
        super();
        this.domainObj = new Xldf064mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf064mType domainObj;
     ...
     */
    public Xldf064mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf064mType domainObj) {
