...
import tw.gov.moi.domain.Xldfm07hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm07hType.class ,
        entityDsName = "rldfm07hByKey" ,
        xldfEntityClass = Xldfm07hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm07hQuery", xldfDsByTrans = "xldfm07hMaxSerialNo",  xldfDsBySerialNo = "xldfm07hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM07H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM07H")
public class XLDFM07H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM07H(String personId ,String siteId ,String registerYyymmdd ,String registerHhmmss ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldfm07hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm07hType domainObj;
     ...
     */
    public Xldfm07hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm07hType domainObj) {
