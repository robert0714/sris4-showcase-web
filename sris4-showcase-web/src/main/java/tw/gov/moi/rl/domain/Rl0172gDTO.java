...
@XmlType(name = "rl0172gDTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl0172gAppDataDTO" })
@XmlRootElement(name = "Rl0172gDTO")
public class Rl0172gDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -5234878905343652115L;
    ...
    /** 父姓名變更登記 AppDataDTO. */
    @XmlElement(name = "Rl0172gAppDataDTO")
    @FieldName("父姓名變更登記 AppDataDTO")
    private Rl0172gAppDataDTO rl0172gAppDataDTO = new Rl0172gAppDataDTO();
    ...
    /**
     * Gets the rl0172g app data dto.
     * 
     * @return the rl0172g app data dto
     */
    public Rl0172gAppDataDTO getRl0172gAppDataDTO() {
        return rl0172gAppDataDTO;
    }

    /**
     * Sets the rl0172g app data dto.
     * 
     * @param rl0172gAppDataDTO
     *            the new rl0172g app data dto
     */
    public void setRl0172gAppDataDTO(final Rl0172gAppDataDTO rl0172gAppDataDTO) {
        this.rl0172gAppDataDTO = rl0172gAppDataDTO;
    }
}
