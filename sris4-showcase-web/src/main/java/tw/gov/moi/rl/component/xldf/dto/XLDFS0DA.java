...
import tw.gov.moi.domain.Xldfs0daType;
import tw.gov.moi.domain.Rldfs0daType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0daType.class ,
        entityDsName = "rldfs0daByKey" ,
        xldfEntityClass = Xldfs0daType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0daQuery", xldfDsByTrans = "xldfs0daMaxSerialNo",  xldfDsBySerialNo = "xldfs0daBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DA")
public class XLDFS0DA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0daType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0daType domainObj;
     ...
     */
    public Xldfs0daType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0daType domainObj) {
