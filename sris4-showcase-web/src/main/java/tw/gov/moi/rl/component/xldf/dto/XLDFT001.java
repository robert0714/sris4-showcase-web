...
import tw.gov.moi.domain.Xldft001Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft001Type.class ,
        entityDsName = "rldft001ByKey" ,
        xldfEntityClass = Xldft001Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft001Query", xldfDsByTrans = "xldft001MaxSerialNo",  xldfDsBySerialNo = "xldft001BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT001", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT001")
public class XLDFT001 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT001(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft001Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft001Type domainObj;
     ...
     */
    public Xldft001Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft001Type domainObj) {
