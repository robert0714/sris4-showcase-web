...
@XmlType(name = "XLDFY0BBH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0BBH") 
public class XLDFY0BBHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0BBH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0BBHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
