...
public class XLDFM06HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM06H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM06HID(String trMode ,String applyMode ,String applyYyymmdd ,String applyHhmmss ,String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
