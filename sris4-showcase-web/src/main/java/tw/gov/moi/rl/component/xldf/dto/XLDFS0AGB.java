...
import tw.gov.moi.domain.Xldfs0agbType;
import tw.gov.moi.domain.Rldfs0agbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0agbType.class ,
        entityDsName = "rldfs0agbByKey" ,
        xldfEntityClass = Xldfs0agbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0agbQuery", xldfDsByTrans = "xldfs0agbMaxSerialNo",  xldfDsBySerialNo = "xldfs0agbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AGB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AGB")
public class XLDFS0AGB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AGB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0agbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0agbType domainObj;
     ...
     */
    public Xldfs0agbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0agbType domainObj) {
