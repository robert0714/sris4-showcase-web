...
import tw.gov.moi.domain.Rldfs174Type;
...
@XmlType(name = "rl0x474DTO", propOrder = { "MainDTO", "EditResult", "QuertDto", "SelectData", "Resutlts", "Recored",
        "IsVerify", "CommononType", "lockData", "LockData", "Title", "CheckCode" })
@XmlRootElement(name = "Rl0x474DTO")
public class Rl0x474DTO implements Serializable {
    ...
    @FieldName("修改紀錄")
    private Rldfs174Type recored = new Rldfs174Type();
    ...
    public Rldfs174Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs174Type recored) {
    ...
    public String toString() {
        return "Rl0x474DTO [mainDTO=" + mainDTO + ", editResult=" + editResult + ", quertDto=" + quertDto
