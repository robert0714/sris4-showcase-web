...
import tw.gov.moi.domain.Xldfy066mType;
import tw.gov.moi.domain.Rldfy066mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy066mType.class ,
        entityDsName = "rldfy066mByKey" ,
        xldfEntityClass = Xldfy066mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy066mQuery", xldfDsByTrans = "xldfy066mMaxSerialNo",  xldfDsBySerialNo = "xldfy066mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY066M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY066M")
public class XLDFY066M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY066M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy066mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy066mType domainObj;
     ...
     */
    public Xldfy066mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy066mType domainObj) {
