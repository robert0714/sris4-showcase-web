...
import tw.gov.moi.domain.Xldfs026bType;
import tw.gov.moi.domain.Rldfs026bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs026bType.class ,
        entityDsName = "rldfs026bByKey" ,
        xldfEntityClass = Xldfs026bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs026bQuery", xldfDsByTrans = "xldfs026bMaxSerialNo",  xldfDsBySerialNo = "xldfs026bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS026B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS026B")
public class XLDFS026B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS026B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs026bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs026bType domainObj;
     ...
     */
    public Xldfs026bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs026bType domainObj) {
