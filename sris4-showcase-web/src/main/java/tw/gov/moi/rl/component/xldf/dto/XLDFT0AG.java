...
import tw.gov.moi.domain.Xldft0agType;
import tw.gov.moi.domain.Rldft0agType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0agType.class ,
        entityDsName = "rldft0agByKey" ,
        xldfEntityClass = Xldft0agType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0agQuery", xldfDsByTrans = "xldft0agMaxSerialNo",  xldfDsBySerialNo = "xldft0agBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AG", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AG")
public class XLDFT0AG implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AG(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0agType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0agType domainObj;
     ...
     */
    public Xldft0agType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0agType domainObj) {
