...
import tw.gov.moi.domain.Xldfy0a6mType;
import tw.gov.moi.domain.Rldfy0a6mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a6mType.class ,
        entityDsName = "rldfy0a6mByKey" ,
        xldfEntityClass = Xldfy0a6mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a6mQuery", xldfDsByTrans = "xldfy0a6mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a6mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A6M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A6M")
public class XLDFY0A6M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A6M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a6mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a6mType domainObj;
     ...
     */
    public Xldfy0a6mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a6mType domainObj) {
