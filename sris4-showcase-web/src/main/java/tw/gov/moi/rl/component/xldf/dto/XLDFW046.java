...
import tw.gov.moi.domain.Rldfw046Type;
import tw.gov.moi.domain.Xldfw046Type;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfw046Type.class, entityDsName = "rldfw046ByKey", xldfEntityClass = Xldfw046Type.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfw046Query", xldfDsByTrans = "xldfw046MaxSerialNo", xldfDsBySerialNo = "xldfw046BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW046", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFW046")
public class XLDFW046 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW046(String personId, String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq) {
        super();
        this.domainObj = new Xldfw046Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw046Type domainObj;
     ...
     */
    public Xldfw046Type getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfw046Type domainObj) {
