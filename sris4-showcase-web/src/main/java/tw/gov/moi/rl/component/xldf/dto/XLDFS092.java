...
import tw.gov.moi.domain.Xldfs092Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs092Type.class ,
        entityDsName = "rldfs092ByKey" ,
        xldfEntityClass = Xldfs092Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs092Query", xldfDsByTrans = "xldfs092MaxSerialNo",  xldfDsBySerialNo = "xldfs092BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS092", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS092")
public class XLDFS092 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS092(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs092Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs092Type domainObj;
     ...
     */
    public Xldfs092Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs092Type domainObj) {
