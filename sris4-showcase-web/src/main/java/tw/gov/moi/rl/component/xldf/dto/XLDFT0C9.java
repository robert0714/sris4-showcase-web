...
import tw.gov.moi.domain.Xldft0c9Type;
import tw.gov.moi.domain.Rldft0c9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0c9Type.class ,
        entityDsName = "rldft0c9ByKey" ,
        xldfEntityClass = Xldft0c9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0c9Query", xldfDsByTrans = "xldft0c9MaxSerialNo",  xldfDsBySerialNo = "xldft0c9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0C9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0C9")
public class XLDFT0C9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0C9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0c9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0c9Type domainObj;
     ...
     */
    public Xldft0c9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0c9Type domainObj) {
