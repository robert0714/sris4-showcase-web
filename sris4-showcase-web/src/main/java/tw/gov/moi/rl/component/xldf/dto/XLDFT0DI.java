...
import tw.gov.moi.domain.Xldft0diType;
import tw.gov.moi.domain.Rldft0diType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0diType.class ,
        entityDsName = "rldft0diByKey" ,
        xldfEntityClass = Xldft0diType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0diQuery", xldfDsByTrans = "xldft0diMaxSerialNo",  xldfDsBySerialNo = "xldft0diBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0DI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0DI")
public class XLDFT0DI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0DI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0diType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0diType domainObj;
     ...
     */
    public Xldft0diType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0diType domainObj) {
