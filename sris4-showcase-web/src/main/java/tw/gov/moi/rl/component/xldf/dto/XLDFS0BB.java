...
import tw.gov.moi.domain.Xldfs0bbType;
import tw.gov.moi.domain.Rldfs0bbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0bbType.class ,
        entityDsName = "rldfs0bbByKey" ,
        xldfEntityClass = Xldfs0bbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0bbQuery", xldfDsByTrans = "xldfs0bbMaxSerialNo",  xldfDsBySerialNo = "xldfs0bbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BB")
public class XLDFS0BB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0bbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0bbType domainObj;
     ...
     */
    public Xldfs0bbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0bbType domainObj) {
