...
import tw.gov.moi.domain.Xldft025Type;
import tw.gov.moi.domain.Rldft025Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft025Type.class ,
        entityDsName = "rldft025ByKey" ,
        xldfEntityClass = Xldft025Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft025Query", xldfDsByTrans = "xldft025MaxSerialNo",  xldfDsBySerialNo = "xldft025BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT025", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT025")
public class XLDFT025 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT025(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft025Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft025Type domainObj;
     ...
     */
    public Xldft025Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft025Type domainObj) {
