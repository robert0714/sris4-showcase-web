...
import tw.gov.moi.domain.Xldfs0c7Type;
import tw.gov.moi.domain.Rldfs0c7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0c7Type.class ,
        entityDsName = "rldfs0c7ByKey" ,
        xldfEntityClass = Xldfs0c7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0c7Query", xldfDsByTrans = "xldfs0c7MaxSerialNo",  xldfDsBySerialNo = "xldfs0c7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0C7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0C7")
public class XLDFS0C7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0C7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0c7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0c7Type domainObj;
     ...
     */
    public Xldfs0c7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0c7Type domainObj) {
