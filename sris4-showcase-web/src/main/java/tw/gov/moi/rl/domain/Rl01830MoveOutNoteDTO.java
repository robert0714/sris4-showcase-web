...
@XmlType(name = "rl01830MoveOutNoteDTO", propOrder = { "Note", "Selected" })
@XmlRootElement(name = "Rl01830MoveOutNoteDTO")
public class Rl01830MoveOutNoteDTO implements Serializable {
    /**
     * 
     */
    ...
    public String toString() {
        return "Rl01830MoveOutNoteDTO [note=" + note + ", selected=" + selected + "]";
    }
