...
@XmlType(name = "XLDFX09FM", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX09FM") 
public class XLDFX09FMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX09FM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX09FMID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
