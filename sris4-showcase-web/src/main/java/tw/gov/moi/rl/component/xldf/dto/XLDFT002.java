...
import tw.gov.moi.domain.Xldft002Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft002Type.class ,
        entityDsName = "rldft002ByKey" ,
        xldfEntityClass = Xldft002Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft002Query", xldfDsByTrans = "xldft002MaxSerialNo",  xldfDsBySerialNo = "xldft002BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT002", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT002")
public class XLDFT002 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT002(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft002Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft002Type domainObj;
     ...
     */
    public Xldft002Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft002Type domainObj) {
