...
import tw.gov.moi.domain.Xldfx09ihType;
import tw.gov.moi.domain.Rldfx09ihType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09ihType.class ,
        entityDsName = "rldfx09ihByKey" ,
        xldfEntityClass = Xldfx09ihType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09ihQuery", xldfDsByTrans = "xldfx09ihMaxSerialNo",  xldfDsBySerialNo = "xldfx09ihBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09IH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09IH")
public class XLDFX09IH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09IH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09ihType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09ihType domainObj;
     ...
     */
    public Xldfx09ihType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09ihType domainObj) {
