...
import tw.gov.moi.domain.Xldfr098Type;
import tw.gov.moi.domain.Rldfr098Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr098Type.class ,
        entityDsName = "rldfr098ByKey" ,
        xldfEntityClass = Xldfr098Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr098Query", xldfDsByTrans = "xldfr098MaxSerialNo",  xldfDsBySerialNo = "xldfr098BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR098", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR098")
public class XLDFR098 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR098(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr098Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr098Type domainObj;
     ...
     */
    public Xldfr098Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr098Type domainObj) {
