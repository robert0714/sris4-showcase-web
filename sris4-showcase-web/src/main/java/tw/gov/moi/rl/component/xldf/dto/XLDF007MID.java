...
public class XLDF007MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF007M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF007MID(String personId ,String modifyYyymmdd ,String modifyTime ,String siteId ) {
        super();
