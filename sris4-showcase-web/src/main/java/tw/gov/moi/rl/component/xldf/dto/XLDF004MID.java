...
@XmlType(name = "XLDF004M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF004M") 
public class XLDF004MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF004M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF004MID(String personId ,String siteId ) {
        super();
