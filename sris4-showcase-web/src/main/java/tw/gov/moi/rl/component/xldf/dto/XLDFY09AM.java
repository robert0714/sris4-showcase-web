...
import tw.gov.moi.domain.Xldfy09amType;
import tw.gov.moi.domain.Rldfy09amType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09amType.class ,
        entityDsName = "rldfy09amByKey" ,
        xldfEntityClass = Xldfy09amType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09amQuery", xldfDsByTrans = "xldfy09amMaxSerialNo",  xldfDsBySerialNo = "xldfy09amBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09AM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09AM")
public class XLDFY09AM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09AM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09amType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09amType domainObj;
     ...
     */
    public Xldfy09amType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09amType domainObj) {
