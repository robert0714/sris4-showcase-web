...
import tw.gov.moi.domain.Xldfy001hType;
import tw.gov.moi.domain.Rldfy001hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy001hType.class ,
        entityDsName = "rldfy001hByKey" ,
        xldfEntityClass = Xldfy001hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy001hQuery", xldfDsByTrans = "xldfy001hMaxSerialNo",  xldfDsBySerialNo = "xldfy001hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY001H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY001H")
public class XLDFY001H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY001H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy001hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy001hType domainObj;
     ...
     */
    public Xldfy001hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy001hType domainObj) {
