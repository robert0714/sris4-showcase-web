...
import tw.gov.moi.domain.Xldfs099Type;
import tw.gov.moi.domain.Rldfs099Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs099Type.class ,
        entityDsName = "rldfs099ByKey" ,
        xldfEntityClass = Xldfs099Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs099Query", xldfDsByTrans = "xldfs099MaxSerialNo",  xldfDsBySerialNo = "xldfs099BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS099", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS099")
public class XLDFS099 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS099(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs099Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs099Type domainObj;
     ...
     */
    public Xldfs099Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs099Type domainObj) {
