...
import tw.gov.moi.domain.Xldf087ttType;
import tw.gov.moi.domain.Tldf087tType;
 ...
 */
@RldfMappingEntity(
        value = Tldf087tType.class ,
        entityDsName = "tldf087tByKey" ,
        xldfEntityClass = Xldf087ttType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf087ttQuery", xldfDsByTrans = "xldf087ttMaxSerialNo",  xldfDsBySerialNo = "xldf087ttBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF087TT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF087TT")
public class XLDF087TT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF087TT(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf087ttType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf087ttType domainObj;
     ...
     */
    public Xldf087ttType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf087ttType domainObj) {
