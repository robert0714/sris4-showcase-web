...
import tw.gov.moi.domain.Xldfm02mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm02mType.class ,
        entityDsName = "rldfm02mByKey" ,
        xldfEntityClass = Xldfm02mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm02mQuery", xldfDsByTrans = "xldfm02mMaxSerialNo",  xldfDsBySerialNo = "xldfm02mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM02M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM02M")
public class XLDFM02M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM02M(String personId ,String siteId ,String spouseId ,String updateYyymmdd ,String updateHhmmss ) {
        super();
        this.domainObj = new Xldfm02mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm02mType domainObj;
     ...
     */
    public Xldfm02mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm02mType domainObj) {
