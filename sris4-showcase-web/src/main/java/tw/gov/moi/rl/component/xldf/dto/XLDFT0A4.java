...
import tw.gov.moi.domain.Xldft0a4Type;
import tw.gov.moi.domain.Rldft0a4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a4Type.class ,
        entityDsName = "rldft0a4ByKey" ,
        xldfEntityClass = Xldft0a4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a4Query", xldfDsByTrans = "xldft0a4MaxSerialNo",  xldfDsBySerialNo = "xldft0a4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A4")
public class XLDFT0A4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a4Type domainObj;
     ...
     */
    public Xldft0a4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a4Type domainObj) {
