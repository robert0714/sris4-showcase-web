...
import tw.gov.moi.domain.Xldfw027Type;
import tw.gov.moi.domain.Rldfw027Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw027Type.class ,
        entityDsName = "rldfw027ByKey" ,
        xldfEntityClass = Xldfw027Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw027Query", xldfDsByTrans = "xldfw027MaxSerialNo",  xldfDsBySerialNo = "xldfw027BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW027", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW027")
public class XLDFW027 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW027(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw027Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw027Type domainObj;
     ...
     */
    public Xldfw027Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw027Type domainObj) {
