...
import tw.gov.moi.domain.Xldfw079Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw079Type.class ,
        entityDsName = "rldfw079ByKey" ,
        xldfEntityClass = Xldfw079Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw079Query", xldfDsByTrans = "xldfw079MaxSerialNo",  xldfDsBySerialNo = "xldfw079BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW079", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW079")
public class XLDFW079 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW079(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw079Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw079Type domainObj;
     ...
     */
    public Xldfw079Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw079Type domainObj) {
