...
public class XLDF064MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF064M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF064MID(String siteId ,String personId ) {
        super();
