...
import tw.gov.moi.domain.Xldfu002Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfu002Type.class ,
        entityDsName = "rldfu002ByKey" ,
        xldfEntityClass = Xldfu002Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "serialNumber" , length = 22),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfu002Query", xldfDsByTrans = "xldfu002MaxSerialNo",  xldfDsBySerialNo = "xldfu002BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFU002", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFU002")
public class XLDFU002 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFU002(String serialNumber ,String siteId ) {
        super();
        this.domainObj = new Xldfu002Type();
        getDomainObj().setSerialNumber(serialNumber); 
    ...
    @FieldName("XLDF領域物件")
    private Xldfu002Type domainObj;
     ...
     */
    public Xldfu002Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfu002Type domainObj) {
