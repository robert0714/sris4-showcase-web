...
import tw.gov.moi.domain.Xldft0a9Type;
import tw.gov.moi.domain.Rldft0a9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a9Type.class ,
        entityDsName = "rldft0a9ByKey" ,
        xldfEntityClass = Xldft0a9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a9Query", xldfDsByTrans = "xldft0a9MaxSerialNo",  xldfDsBySerialNo = "xldft0a9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A9")
public class XLDFT0A9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a9Type domainObj;
     ...
     */
    public Xldft0a9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a9Type domainObj) {
