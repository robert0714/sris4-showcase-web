...
public class XLDFY081DMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY081DM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY081DMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
