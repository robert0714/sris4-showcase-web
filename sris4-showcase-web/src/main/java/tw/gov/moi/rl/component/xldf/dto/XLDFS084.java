...
import tw.gov.moi.domain.Xldfs084Type;
import tw.gov.moi.domain.Rldfs084Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs084Type.class ,
        entityDsName = "rldfs084ByKey" ,
        xldfEntityClass = Xldfs084Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs084Query", xldfDsByTrans = "xldfs084MaxSerialNo",  xldfDsBySerialNo = "xldfs084BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS084", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS084")
public class XLDFS084 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS084(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs084Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs084Type domainObj;
     ...
     */
    public Xldfs084Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs084Type domainObj) {
