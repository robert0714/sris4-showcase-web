...
import tw.gov.moi.domain.Xldfs0b1Type;
import tw.gov.moi.domain.Rldfs0b1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b1Type.class ,
        entityDsName = "rldfs0b1ByKey" ,
        xldfEntityClass = Xldfs0b1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b1Query", xldfDsByTrans = "xldfs0b1MaxSerialNo",  xldfDsBySerialNo = "xldfs0b1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B1")
public class XLDFS0B1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0b1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b1Type domainObj;
     ...
     */
    public Xldfs0b1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b1Type domainObj) {
