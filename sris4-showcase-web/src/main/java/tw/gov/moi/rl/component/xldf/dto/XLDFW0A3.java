...
import tw.gov.moi.domain.Xldfw0a3Type;
import tw.gov.moi.domain.Rldfw0a3Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a3Type.class ,
        entityDsName = "rldfw0a3ByKey" ,
        xldfEntityClass = Xldfw0a3Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a3Query", xldfDsByTrans = "xldfw0a3MaxSerialNo",  xldfDsBySerialNo = "xldfw0a3BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A3", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A3")
public class XLDFW0A3 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A3(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a3Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a3Type domainObj;
     ...
     */
    public Xldfw0a3Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a3Type domainObj) {
