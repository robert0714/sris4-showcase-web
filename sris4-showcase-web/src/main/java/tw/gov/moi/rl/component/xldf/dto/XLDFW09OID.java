...
@XmlType(name = "XLDFW09O", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW09O") 
public class XLDFW09OID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW09O.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW09OID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
