...
@XmlType(name = "XLDF088TT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF088TT") 
public class XLDF088TTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF088TT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF088TTID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
