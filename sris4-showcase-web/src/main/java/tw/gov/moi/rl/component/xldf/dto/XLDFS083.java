...
import tw.gov.moi.domain.Xldfs083Type;
import tw.gov.moi.domain.Rldfs083Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs083Type.class ,
        entityDsName = "rldfs083ByKey" ,
        xldfEntityClass = Xldfs083Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs083Query", xldfDsByTrans = "xldfs083MaxSerialNo",  xldfDsBySerialNo = "xldfs083BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS083", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS083")
public class XLDFS083 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS083(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs083Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs083Type domainObj;
     ...
     */
    public Xldfs083Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs083Type domainObj) {
