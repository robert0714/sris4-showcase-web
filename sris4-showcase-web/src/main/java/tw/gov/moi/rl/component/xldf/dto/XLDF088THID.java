...
public class XLDF088THID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF088TH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF088THID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
