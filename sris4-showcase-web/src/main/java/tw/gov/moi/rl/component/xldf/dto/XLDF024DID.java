...
public class XLDF024DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF024D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF024DID(String personId ,String specialCode ,String siteId ) {
        super();
