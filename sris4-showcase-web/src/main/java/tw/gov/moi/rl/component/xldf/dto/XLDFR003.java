...
import tw.gov.moi.domain.Xldfr003Type;
import tw.gov.moi.domain.Rldfr003Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr003Type.class ,
        entityDsName = "rldfr003ByKey" ,
        xldfEntityClass = Xldfr003Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr003Query", xldfDsByTrans = "xldfr003MaxSerialNo",  xldfDsBySerialNo = "xldfr003BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR003", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR003")
public class XLDFR003 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR003(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr003Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr003Type domainObj;
     ...
     */
    public Xldfr003Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr003Type domainObj) {
