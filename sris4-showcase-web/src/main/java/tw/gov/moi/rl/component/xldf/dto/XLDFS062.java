...
import tw.gov.moi.domain.Xldfs062Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs062Type.class ,
        entityDsName = "rldfs062ByKey" ,
        xldfEntityClass = Xldfs062Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs062Query", xldfDsByTrans = "xldfs062MaxSerialNo",  xldfDsBySerialNo = "xldfs062BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS062", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS062")
public class XLDFS062 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS062(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs062Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs062Type domainObj;
     ...
     */
    public Xldfs062Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs062Type domainObj) {
