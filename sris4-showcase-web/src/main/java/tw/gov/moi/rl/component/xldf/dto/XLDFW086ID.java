...
@XmlType(name = "XLDFW086", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW086") 
public class XLDFW086ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW086.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW086ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
