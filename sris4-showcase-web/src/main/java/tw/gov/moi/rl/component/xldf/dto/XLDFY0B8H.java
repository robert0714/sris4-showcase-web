...
import tw.gov.moi.domain.Xldfy0b8hType;
import tw.gov.moi.domain.Rldfy0b8hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b8hType.class ,
        entityDsName = "rldfy0b8hByKey" ,
        xldfEntityClass = Xldfy0b8hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b8hQuery", xldfDsByTrans = "xldfy0b8hMaxSerialNo",  xldfDsBySerialNo = "xldfy0b8hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B8H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B8H")
public class XLDFY0B8H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B8H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b8hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b8hType domainObj;
     ...
     */
    public Xldfy0b8hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b8hType domainObj) {
