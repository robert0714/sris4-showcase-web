...
import tw.gov.moi.domain.Xldfw0diType;
import tw.gov.moi.domain.Rldfw0diType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0diType.class ,
        entityDsName = "rldfw0diByKey" ,
        xldfEntityClass = Xldfw0diType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0diQuery", xldfDsByTrans = "xldfw0diMaxSerialNo",  xldfDsBySerialNo = "xldfw0diBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0DI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0DI")
public class XLDFW0DI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0DI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0diType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0diType domainObj;
     ...
     */
    public Xldfw0diType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0diType domainObj) {
