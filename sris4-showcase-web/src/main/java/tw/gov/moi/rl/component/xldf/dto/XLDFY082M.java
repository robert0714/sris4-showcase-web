...
import tw.gov.moi.domain.Xldfy082mType;
import tw.gov.moi.domain.Rldfy082mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy082mType.class ,
        entityDsName = "rldfy082mByKey" ,
        xldfEntityClass = Xldfy082mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy082mQuery", xldfDsByTrans = "xldfy082mMaxSerialNo",  xldfDsBySerialNo = "xldfy082mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY082M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY082M")
public class XLDFY082M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY082M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy082mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy082mType domainObj;
     ...
     */
    public Xldfy082mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy082mType domainObj) {
