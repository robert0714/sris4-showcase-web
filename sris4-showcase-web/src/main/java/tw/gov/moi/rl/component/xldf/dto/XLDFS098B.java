...
import tw.gov.moi.domain.Xldfs098bType;
import tw.gov.moi.domain.Rldfs098bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs098bType.class ,
        entityDsName = "rldfs098bByKey" ,
        xldfEntityClass = Xldfs098bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs098bQuery", xldfDsByTrans = "xldfs098bMaxSerialNo",  xldfDsBySerialNo = "xldfs098bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS098B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS098B")
public class XLDFS098B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS098B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs098bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs098bType domainObj;
     ...
     */
    public Xldfs098bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs098bType domainObj) {
