...
import tw.gov.moi.domain.Xldft0d2Type;
import tw.gov.moi.domain.Rldft0d2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0d2Type.class ,
        entityDsName = "rldft0d2ByKey" ,
        xldfEntityClass = Xldft0d2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0d2Query", xldfDsByTrans = "xldft0d2MaxSerialNo",  xldfDsBySerialNo = "xldft0d2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0D2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0D2")
public class XLDFT0D2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0D2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0d2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0d2Type domainObj;
     ...
     */
    public Xldft0d2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0d2Type domainObj) {
