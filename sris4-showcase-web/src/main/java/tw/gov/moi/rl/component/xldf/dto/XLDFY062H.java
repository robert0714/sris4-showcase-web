...
import tw.gov.moi.domain.Xldfy062hType;
import tw.gov.moi.domain.Rldfy062hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy062hType.class ,
        entityDsName = "rldfy062hByKey" ,
        xldfEntityClass = Xldfy062hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy062hQuery", xldfDsByTrans = "xldfy062hMaxSerialNo",  xldfDsBySerialNo = "xldfy062hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY062H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY062H")
public class XLDFY062H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY062H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy062hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy062hType domainObj;
     ...
     */
    public Xldfy062hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy062hType domainObj) {
