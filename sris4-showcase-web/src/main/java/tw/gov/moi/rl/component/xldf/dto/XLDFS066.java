...
import tw.gov.moi.domain.Xldfs066Type;
import tw.gov.moi.domain.Rldfs066Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs066Type.class ,
        entityDsName = "rldfs066ByKey" ,
        xldfEntityClass = Xldfs066Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs066Query", xldfDsByTrans = "xldfs066MaxSerialNo",  xldfDsBySerialNo = "xldfs066BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS066", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS066")
public class XLDFS066 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS066(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs066Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs066Type domainObj;
     ...
     */
    public Xldfs066Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs066Type domainObj) {
