...
import tw.gov.moi.domain.Xldfs016Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs016Type.class ,
        entityDsName = "rldfs016ByKey" ,
        xldfEntityClass = Xldfs016Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs016Query", xldfDsByTrans = "xldfs016MaxSerialNo",  xldfDsBySerialNo = "xldfs016BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS016", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS016")
public class XLDFS016 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS016(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs016Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs016Type domainObj;
     ...
     */
    public Xldfs016Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs016Type domainObj) {
