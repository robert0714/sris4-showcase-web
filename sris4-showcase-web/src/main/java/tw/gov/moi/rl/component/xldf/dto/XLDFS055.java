...
import tw.gov.moi.domain.Rldfs055Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs055Type.class ,
        entityDsName = "rldfs055ByKey" ,
        xldfEntityClass = Xldfs055Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs055Query", xldfDsByTrans = "xldfs055MaxSerialNo",  xldfDsBySerialNo = "xldfs055BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS055", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS055")
public class XLDFS055 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS055(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs055Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs055Type domainObj;
     ...
     */
    public Xldfs055Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs055Type domainObj) {
