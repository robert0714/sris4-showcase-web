...
import tw.gov.moi.domain.Xldfw09iType;
import tw.gov.moi.domain.Rldfw09iType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09iType.class ,
        entityDsName = "rldfw09iByKey" ,
        xldfEntityClass = Xldfw09iType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09iQuery", xldfDsByTrans = "xldfw09iMaxSerialNo",  xldfDsBySerialNo = "xldfw09iBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09I", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09I")
public class XLDFW09I implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09I(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09iType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09iType domainObj;
     ...
     */
    public Xldfw09iType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09iType domainObj) {
