...
import tw.gov.moi.domain.Xldfy081hType;
import tw.gov.moi.domain.Rldfy081hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy081hType.class ,
        entityDsName = "rldfy081hByKey" ,
        xldfEntityClass = Xldfy081hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy081hQuery", xldfDsByTrans = "xldfy081hMaxSerialNo",  xldfDsBySerialNo = "xldfy081hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY081H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY081H")
public class XLDFY081H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY081H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy081hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy081hType domainObj;
     ...
     */
    public Xldfy081hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy081hType domainObj) {
