...
import tw.gov.moi.domain.Xldfw0bcType;
import tw.gov.moi.domain.Rldfw0bcType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0bcType.class ,
        entityDsName = "rldfw0bcByKey" ,
        xldfEntityClass = Xldfw0bcType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0bcQuery", xldfDsByTrans = "xldfw0bcMaxSerialNo",  xldfDsBySerialNo = "xldfw0bcBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0BC", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0BC")
public class XLDFW0BC implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0BC(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0bcType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0bcType domainObj;
     ...
     */
    public Xldfw0bcType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0bcType domainObj) {
