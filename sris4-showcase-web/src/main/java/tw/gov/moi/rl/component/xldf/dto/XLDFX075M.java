...
import tw.gov.moi.domain.Xldfx075mType;
import tw.gov.moi.domain.Rldfx075mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx075mType.class ,
        entityDsName = "rldfx075mByKey" ,
        xldfEntityClass = Xldfx075mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx075mQuery", xldfDsByTrans = "xldfx075mMaxSerialNo",  xldfDsBySerialNo = "xldfx075mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX075M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX075M")
public class XLDFX075M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX075M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx075mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx075mType domainObj;
     ...
     */
    public Xldfx075mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx075mType domainObj) {
