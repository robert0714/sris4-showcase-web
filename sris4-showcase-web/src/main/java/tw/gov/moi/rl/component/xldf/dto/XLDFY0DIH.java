...
import tw.gov.moi.domain.Xldfy0dihType;
import tw.gov.moi.domain.Rldfy0dihType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0dihType.class ,
        entityDsName = "rldfy0dihByKey" ,
        xldfEntityClass = Xldfy0dihType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0dihQuery", xldfDsByTrans = "xldfy0dihMaxSerialNo",  xldfDsBySerialNo = "xldfy0dihBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DIH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DIH")
public class XLDFY0DIH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DIH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0dihType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0dihType domainObj;
     ...
     */
    public Xldfy0dihType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0dihType domainObj) {
