...
public class XLDFY081MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY081M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY081MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
