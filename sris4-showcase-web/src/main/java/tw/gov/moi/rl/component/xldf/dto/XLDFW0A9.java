...
import tw.gov.moi.domain.Xldfw0a9Type;
import tw.gov.moi.domain.Rldfw0a9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a9Type.class ,
        entityDsName = "rldfw0a9ByKey" ,
        xldfEntityClass = Xldfw0a9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a9Query", xldfDsByTrans = "xldfw0a9MaxSerialNo",  xldfDsBySerialNo = "xldfw0a9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A9")
public class XLDFW0A9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a9Type domainObj;
     ...
     */
    public Xldfw0a9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a9Type domainObj) {
