...
import tw.gov.moi.domain.Xldft077Type;
import tw.gov.moi.domain.Rldft077Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft077Type.class ,
        entityDsName = "rldft077ByKey" ,
        xldfEntityClass = Xldft077Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft077Query", xldfDsByTrans = "xldft077MaxSerialNo",  xldfDsBySerialNo = "xldft077BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT077", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT077")
public class XLDFT077 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT077(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft077Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft077Type domainObj;
     ...
     */
    public Xldft077Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft077Type domainObj) {
