...
import tw.gov.moi.domain.Xldfs0aaType;
import tw.gov.moi.domain.Rldfs0aaType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0aaType.class ,
        entityDsName = "rldfs0aaByKey" ,
        xldfEntityClass = Xldfs0aaType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0aaQuery", xldfDsByTrans = "xldfs0aaMaxSerialNo",  xldfDsBySerialNo = "xldfs0aaBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AA")
public class XLDFS0AA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0aaType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0aaType domainObj;
     ...
     */
    public Xldfs0aaType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0aaType domainObj) {
