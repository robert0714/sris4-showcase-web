...
import tw.gov.moi.domain.Rldfs017Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs017Type.class ,
        entityDsName = "rldfs017ByKey" ,
        xldfEntityClass = Xldfs017Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs017Query", xldfDsByTrans = "xldfs017MaxSerialNo",  xldfDsBySerialNo = "xldfs017BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS017", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS017")
public class XLDFS017 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS017(String personId ,String transactionId ,Integer sequenceId ,Integer applySeq ,String siteId ) {
        super();
        this.domainObj = new Xldfs017Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs017Type domainObj;
     ...
     */
    public Xldfs017Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs017Type domainObj) {
