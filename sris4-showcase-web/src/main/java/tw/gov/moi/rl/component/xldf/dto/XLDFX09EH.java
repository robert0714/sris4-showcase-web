...
import tw.gov.moi.domain.Xldfx09ehType;
import tw.gov.moi.domain.Rldfx09ehType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09ehType.class ,
        entityDsName = "rldfx09ehByKey" ,
        xldfEntityClass = Xldfx09ehType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09ehQuery", xldfDsByTrans = "xldfx09ehMaxSerialNo",  xldfDsBySerialNo = "xldfx09ehBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09EH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09EH")
public class XLDFX09EH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09EH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09ehType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09ehType domainObj;
     ...
     */
    public Xldfx09ehType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09ehType domainObj) {
