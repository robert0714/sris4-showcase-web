...
@XmlType(name = "rl0171jDTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl0171jAppDataDTO" })
@XmlRootElement(name = "Rl0171jDTO")
public class Rl0171jDTO implements Serializable {
    ...
    /** 母姓名更正登記 AppDataDTO. */
    @XmlElement(name = "Rl0171jAppDataDTO")
    @FieldName("母姓名更正登記 AppDataDTO")
    private Rl0171jAppDataDTO rl0171jAppDataDTO = new Rl0171jAppDataDTO();
    ...
    /**
     * Gets the rl0171j app data dto.
     * 
     * @return the rl0171j app data dto
     */
    public Rl0171jAppDataDTO getRl0171jAppDataDTO() {
        return rl0171jAppDataDTO;
    }

    /**
     * Sets the rl0171j app data dto.
     * 
     * @param rl0171jAppDataDTO
     *            the new rl0171j app data dto
     */
    public void setRl0171jAppDataDTO(Rl0171jAppDataDTO rl0171jAppDataDTO) {
        this.rl0171jAppDataDTO = rl0171jAppDataDTO;
    }
