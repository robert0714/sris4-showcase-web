...
import tw.gov.moi.domain.Xldf100mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf100mType.class ,
        entityDsName = "rldf100mByKey" ,
        xldfEntityClass = Xldf100mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "tranYyy" , length = 3),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf100mQuery", xldfDsByTrans = "xldf100mMaxSerialNo",  xldfDsBySerialNo = "xldf100mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF100M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF100M")
public class XLDF100M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF100M(String personId ,String tranYyy ,String siteId ) {
        super();
        this.domainObj = new Xldf100mType();
        getDomainObj().setPersonId(personId); 
        getDomainObj().setTranYyy(tranYyy); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf100mType domainObj;
     ...
     */
    public Xldf100mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf100mType domainObj) {
