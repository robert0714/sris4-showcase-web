...
/**
 * The Class Rl02b20DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl02b20DTO", propOrder = { "Type", "Option", "StartNo", "EndNo", "UseYyymmddFlag", "StatisticsType",
        ...
        "Rldf012dObj", "ReportType", "ReportURL", "reportName", "reportParams", "FileURL" })
@XmlRootElement(name = "Rl02b20DTO")
public class Rl02b20DTO implements Serializable {
    ...
    @FieldName("報表名稱")
    private String reportName = "RLRP02B20";
