...
@XmlType(name = "XLDFT018", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFT018") 
public class XLDFT018ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFT018.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFT018ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
