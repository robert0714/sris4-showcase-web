...
import tw.gov.moi.domain.Xldft005Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft005Type.class ,
        entityDsName = "rldft005ByKey" ,
        xldfEntityClass = Xldft005Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft005Query", xldfDsByTrans = "xldft005MaxSerialNo",  xldfDsBySerialNo = "xldft005BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT005", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT005")
public class XLDFT005 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT005(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft005Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft005Type domainObj;
     ...
     */
    public Xldft005Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft005Type domainObj) {
