...
import tw.gov.moi.domain.Xldfw09eType;
import tw.gov.moi.domain.Rldfw09eType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09eType.class ,
        entityDsName = "rldfw09eByKey" ,
        xldfEntityClass = Xldfw09eType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09eQuery", xldfDsByTrans = "xldfw09eMaxSerialNo",  xldfDsBySerialNo = "xldfw09eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09E")
public class XLDFW09E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09E(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09eType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09eType domainObj;
     ...
     */
    public Xldfw09eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09eType domainObj) {
