...
import tw.gov.moi.domain.Xldfx001hType;
import tw.gov.moi.domain.Rldfx001hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx001hType.class ,
        entityDsName = "rldfx001hByKey" ,
        xldfEntityClass = Xldfx001hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx001hQuery", xldfDsByTrans = "xldfx001hMaxSerialNo",  xldfDsBySerialNo = "xldfx001hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX001H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX001H")
public class XLDFX001H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX001H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx001hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx001hType domainObj;
     ...
     */
    public Xldfx001hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx001hType domainObj) {
