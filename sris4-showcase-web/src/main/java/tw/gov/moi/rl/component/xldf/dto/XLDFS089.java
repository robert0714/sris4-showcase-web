...
import tw.gov.moi.domain.Xldfs089Type;
import tw.gov.moi.domain.Rldfs089Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs089Type.class ,
        entityDsName = "rldfs089ByKey" ,
        xldfEntityClass = Xldfs089Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs089Query", xldfDsByTrans = "xldfs089MaxSerialNo",  xldfDsBySerialNo = "xldfs089BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS089", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS089")
public class XLDFS089 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS089(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs089Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs089Type domainObj;
     ...
     */
    public Xldfs089Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs089Type domainObj) {
