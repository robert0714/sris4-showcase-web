...
import tw.gov.moi.domain.Xldfw003Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw003Type.class ,
        entityDsName = "rldfw003ByKey" ,
        xldfEntityClass = Xldfw003Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw003Query", xldfDsByTrans = "xldfw003MaxSerialNo",  xldfDsBySerialNo = "xldfw003BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW003", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW003")
public class XLDFW003 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW003(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw003Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw003Type domainObj;
     ...
     */
    public Xldfw003Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw003Type domainObj) {
