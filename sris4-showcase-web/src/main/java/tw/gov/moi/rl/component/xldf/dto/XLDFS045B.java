...
import tw.gov.moi.domain.Rldfs045bType;
import tw.gov.moi.domain.Xldfs045bType;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfs045bType.class, entityDsName = "rldfs045bByKey", xldfEntityClass = Xldfs045bType.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfs045bQuery", xldfDsByTrans = "xldfs045bMaxSerialNo", xldfDsBySerialNo = "xldfs045bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS045B", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFS045B")
public class XLDFS045B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS045B(String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq,
            String certificateCode) {
        super();
        this.domainObj = new Xldfs045bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs045bType domainObj;
     ...
     */
    public Xldfs045bType getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfs045bType domainObj) {
