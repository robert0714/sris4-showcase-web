...
import tw.gov.moi.domain.Xldfw0adType;
import tw.gov.moi.domain.Rldfw0adType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0adType.class ,
        entityDsName = "rldfw0adByKey" ,
        xldfEntityClass = Xldfw0adType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0adQuery", xldfDsByTrans = "xldfw0adMaxSerialNo",  xldfDsBySerialNo = "xldfw0adBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AD")
public class XLDFW0AD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0adType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0adType domainObj;
     ...
     */
    public Xldfw0adType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0adType domainObj) {
