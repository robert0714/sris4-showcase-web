...
import tw.gov.moi.domain.Xldfy0a4mType;
import tw.gov.moi.domain.Rldfy0a4mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a4mType.class ,
        entityDsName = "rldfy0a4mByKey" ,
        xldfEntityClass = Xldfy0a4mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a4mQuery", xldfDsByTrans = "xldfy0a4mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a4mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A4M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A4M")
public class XLDFY0A4M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A4M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a4mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a4mType domainObj;
     ...
     */
    public Xldfy0a4mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a4mType domainObj) {
