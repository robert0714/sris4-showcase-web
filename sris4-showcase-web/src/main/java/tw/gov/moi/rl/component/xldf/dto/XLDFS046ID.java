...
@XmlType(name = "XLDFS046", propOrder = { "keys", "xldfClass" })
@XmlRootElement(name = "XLDFS046")
public class XLDFS046ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS046.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS046ID(String personId, String applyTransactionId, Integer applySequenceId, String siteId,
            Integer applySeq) {
        super();
