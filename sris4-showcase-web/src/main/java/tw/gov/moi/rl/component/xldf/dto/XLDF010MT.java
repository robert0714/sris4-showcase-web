...
import tw.gov.moi.domain.Xldf010mtType;
 ...
 */
@RldfMappingEntity(
        value = Tldf010mType.class ,
        entityDsName = "tldf010mByKey" ,
        xldfEntityClass = Xldf010mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf010mtQuery", xldfDsByTrans = "xldf010mtMaxSerialNo",  xldfDsBySerialNo = "xldf010mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF010MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF010MT")
public class XLDF010MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF010MT(String personId ,String siteId ,String specialCode ) {
        super();
        this.domainObj = new Xldf010mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf010mtType domainObj;
     ...
     */
    public Xldf010mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf010mtType domainObj) {
