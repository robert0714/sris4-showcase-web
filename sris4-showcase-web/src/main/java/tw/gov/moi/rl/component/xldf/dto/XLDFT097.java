...
import tw.gov.moi.domain.Xldft097Type;
import tw.gov.moi.domain.Rldft097Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft097Type.class ,
        entityDsName = "rldft097ByKey" ,
        xldfEntityClass = Xldft097Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft097Query", xldfDsByTrans = "xldft097MaxSerialNo",  xldfDsBySerialNo = "xldft097BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT097", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT097")
public class XLDFT097 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT097(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft097Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft097Type domainObj;
     ...
     */
    public Xldft097Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft097Type domainObj) {
