...
import tw.gov.moi.domain.Xldfx082hType;
import tw.gov.moi.domain.Rldfx082hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx082hType.class ,
        entityDsName = "rldfx082hByKey" ,
        xldfEntityClass = Xldfx082hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx082hQuery", xldfDsByTrans = "xldfx082hMaxSerialNo",  xldfDsBySerialNo = "xldfx082hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX082H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX082H")
public class XLDFX082H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX082H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx082hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx082hType domainObj;
     ...
     */
    public Xldfx082hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx082hType domainObj) {
