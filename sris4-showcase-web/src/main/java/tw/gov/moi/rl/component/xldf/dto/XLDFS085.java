...
import tw.gov.moi.domain.Xldfs085Type;
import tw.gov.moi.domain.Rldfs085Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs085Type.class ,
        entityDsName = "rldfs085ByKey" ,
        xldfEntityClass = Xldfs085Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs085Query", xldfDsByTrans = "xldfs085MaxSerialNo",  xldfDsBySerialNo = "xldfs085BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS085", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS085")
public class XLDFS085 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS085(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs085Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs085Type domainObj;
     ...
     */
    public Xldfs085Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs085Type domainObj) {
