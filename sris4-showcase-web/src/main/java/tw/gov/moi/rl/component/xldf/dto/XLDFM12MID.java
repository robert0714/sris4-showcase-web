...
public class XLDFM12MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM12M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM12MID(String personId ,String siteId ) {
        super();
