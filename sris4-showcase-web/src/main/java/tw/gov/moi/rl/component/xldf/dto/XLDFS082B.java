...
import tw.gov.moi.domain.Xldfs082bType;
import tw.gov.moi.domain.Rldfs082bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs082bType.class ,
        entityDsName = "rldfs082bByKey" ,
        xldfEntityClass = Xldfs082bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs082bQuery", xldfDsByTrans = "xldfs082bMaxSerialNo",  xldfDsBySerialNo = "xldfs082bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS082B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS082B")
public class XLDFS082B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS082B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs082bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs082bType domainObj;
     ...
     */
    public Xldfs082bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs082bType domainObj) {
