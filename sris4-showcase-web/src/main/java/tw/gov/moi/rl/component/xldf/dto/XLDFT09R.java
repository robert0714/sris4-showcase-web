...
import tw.gov.moi.domain.Xldft09rType;
import tw.gov.moi.domain.Rldft09rType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09rType.class ,
        entityDsName = "rldft09rByKey" ,
        xldfEntityClass = Xldft09rType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09rQuery", xldfDsByTrans = "xldft09rMaxSerialNo",  xldfDsBySerialNo = "xldft09rBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09R", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09R")
public class XLDFT09R implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09R(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09rType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09rType domainObj;
     ...
     */
    public Xldft09rType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09rType domainObj) {
