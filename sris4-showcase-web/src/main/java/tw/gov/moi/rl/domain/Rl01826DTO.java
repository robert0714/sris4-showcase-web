...
import tw.gov.moi.rl.component.xldf.dto.XLDFY09PH;
import tw.gov.moi.rl.component.xldf.dto.XLDFY09PM;
...
public class Rl01826DTO implements Serializable {
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY09PM> personNoteDetailList = new ArrayList<XLDFY09PM>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY09PH> removedPersonNoteDetailList = new ArrayList<XLDFY09PH>();
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY09PM> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY09PM> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY09PH> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY09PH> removedPersonNoteDetailList) {
