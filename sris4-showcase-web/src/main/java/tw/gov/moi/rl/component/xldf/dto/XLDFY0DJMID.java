...
public class XLDFY0DJMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0DJM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0DJMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
