...
import tw.gov.moi.domain.Xldf009sType;
 ...
 */
@RldfMappingEntity(
        value = Rldf009sType.class ,
        entityDsName = "rldf009sByKey" ,
        xldfEntityClass = Xldf009sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf009sQuery", xldfDsByTrans = "xldf009sMaxSerialNo",  xldfDsBySerialNo = "xldf009sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF009S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF009S")
public class XLDF009S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF009S(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldf009sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf009sType domainObj;
     ...
     */
    public Xldf009sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf009sType domainObj) {
