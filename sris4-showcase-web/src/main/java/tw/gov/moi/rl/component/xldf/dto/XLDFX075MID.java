...
@XmlType(name = "XLDFX075M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX075M") 
public class XLDFX075MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX075M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX075MID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
