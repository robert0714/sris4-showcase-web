...
import tw.gov.moi.domain.Xldfr09eType;
import tw.gov.moi.domain.Rldfr09eType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09eType.class ,
        entityDsName = "rldfr09eByKey" ,
        xldfEntityClass = Xldfr09eType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09eQuery", xldfDsByTrans = "xldfr09eMaxSerialNo",  xldfDsBySerialNo = "xldfr09eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09E")
public class XLDFR09E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09E(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09eType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09eType domainObj;
     ...
     */
    public Xldfr09eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09eType domainObj) {
