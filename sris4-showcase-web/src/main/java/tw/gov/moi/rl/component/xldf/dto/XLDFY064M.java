...
import tw.gov.moi.domain.Xldfy064mType;
import tw.gov.moi.domain.Rldfy064mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy064mType.class ,
        entityDsName = "rldfy064mByKey" ,
        xldfEntityClass = Xldfy064mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy064mQuery", xldfDsByTrans = "xldfy064mMaxSerialNo",  xldfDsBySerialNo = "xldfy064mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY064M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY064M")
public class XLDFY064M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY064M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy064mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy064mType domainObj;
     ...
     */
    public Xldfy064mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy064mType domainObj) {
