...
import tw.gov.moi.domain.Xldfy0a9mType;
import tw.gov.moi.domain.Rldfy0a9mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a9mType.class ,
        entityDsName = "rldfy0a9mByKey" ,
        xldfEntityClass = Xldfy0a9mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a9mQuery", xldfDsByTrans = "xldfy0a9mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a9mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A9M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A9M")
public class XLDFY0A9M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A9M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a9mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a9mType domainObj;
     ...
     */
    public Xldfy0a9mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a9mType domainObj) {
