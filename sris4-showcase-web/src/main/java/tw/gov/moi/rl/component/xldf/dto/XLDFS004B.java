...
import tw.gov.moi.domain.Xldfs004bType;
import tw.gov.moi.domain.Rldfs004bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs004bType.class ,
        entityDsName = "rldfs004bByKey" ,
        xldfEntityClass = Xldfs004bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs004bQuery", xldfDsByTrans = "xldfs004bMaxSerialNo",  xldfDsBySerialNo = "xldfs004bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS004B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS004B")
public class XLDFS004B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS004B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs004bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs004bType domainObj;
     ...
     */
    public Xldfs004bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs004bType domainObj) {
