...
public class XLDFM01MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM01MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM01MTID(String personId ,String siteId ) {
        super();
