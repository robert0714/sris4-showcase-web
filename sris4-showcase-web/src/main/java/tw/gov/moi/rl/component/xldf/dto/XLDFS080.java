...
import tw.gov.moi.domain.Xldfs080Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs080Type.class ,
        entityDsName = "rldfs080ByKey" ,
        xldfEntityClass = Xldfs080Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs080Query", xldfDsByTrans = "xldfs080MaxSerialNo",  xldfDsBySerialNo = "xldfs080BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS080", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS080")
public class XLDFS080 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS080(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs080Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs080Type domainObj;
     ...
     */
    public Xldfs080Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs080Type domainObj) {
