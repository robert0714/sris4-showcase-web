...
/**
 * The Class Rl08250DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl08250DTO", propOrder = { "catalog", "printType", "reportFormat", "fileURL", "reportURL" })
@XmlRootElement(name = "Rl08250DTO")
public class Rl08250DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -571512153472232723L;
