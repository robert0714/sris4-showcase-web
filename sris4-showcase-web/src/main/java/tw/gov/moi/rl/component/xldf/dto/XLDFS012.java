...
import tw.gov.moi.domain.Xldfs012Type;
import tw.gov.moi.domain.Rldfs012Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs012Type.class ,
        entityDsName = "rldfs012ByKey" ,
        xldfEntityClass = Xldfs012Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs012Query", xldfDsByTrans = "xldfs012MaxSerialNo",  xldfDsBySerialNo = "xldfs012BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS012", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS012")
public class XLDFS012 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS012(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs012Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs012Type domainObj;
     ...
     */
    public Xldfs012Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs012Type domainObj) {
