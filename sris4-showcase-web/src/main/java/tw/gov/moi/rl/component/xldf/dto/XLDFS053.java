...
import tw.gov.moi.domain.Rldfs053Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs053Type.class ,
        entityDsName = "rldfs053ByKey" ,
        xldfEntityClass = Xldfs053Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs053Query", xldfDsByTrans = "xldfs053MaxSerialNo",  xldfDsBySerialNo = "xldfs053BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS053", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS053")
public class XLDFS053 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS053(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs053Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs053Type domainObj;
     ...
     */
    public Xldfs053Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs053Type domainObj) {
