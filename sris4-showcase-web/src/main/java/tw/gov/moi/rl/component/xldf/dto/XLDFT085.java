...
import tw.gov.moi.domain.Xldft085Type;
import tw.gov.moi.domain.Rldft085Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft085Type.class ,
        entityDsName = "rldft085ByKey" ,
        xldfEntityClass = Xldft085Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft085Query", xldfDsByTrans = "xldft085MaxSerialNo",  xldfDsBySerialNo = "xldft085BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT085", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT085")
public class XLDFT085 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT085(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft085Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft085Type domainObj;
     ...
     */
    public Xldft085Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft085Type domainObj) {
