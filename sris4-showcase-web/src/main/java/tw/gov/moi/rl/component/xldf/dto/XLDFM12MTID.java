...
public class XLDFM12MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM12MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM12MTID(String personId ,String siteId ) {
        super();
