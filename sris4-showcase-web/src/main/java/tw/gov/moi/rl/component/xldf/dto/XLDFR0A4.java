...
import tw.gov.moi.domain.Xldfr0a4Type;
import tw.gov.moi.domain.Rldfr0a4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a4Type.class ,
        entityDsName = "rldfr0a4ByKey" ,
        xldfEntityClass = Xldfr0a4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a4Query", xldfDsByTrans = "xldfr0a4MaxSerialNo",  xldfDsBySerialNo = "xldfr0a4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A4")
public class XLDFR0A4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a4Type domainObj;
     ...
     */
    public Xldfr0a4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a4Type domainObj) {
