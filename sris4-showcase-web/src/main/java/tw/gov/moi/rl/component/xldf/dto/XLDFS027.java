...
import tw.gov.moi.domain.Xldfs027Type;
import tw.gov.moi.domain.Rldfs027Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs027Type.class ,
        entityDsName = "rldfs027ByKey" ,
        xldfEntityClass = Xldfs027Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs027Query", xldfDsByTrans = "xldfs027MaxSerialNo",  xldfDsBySerialNo = "xldfs027BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS027", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS027")
public class XLDFS027 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS027(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs027Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs027Type domainObj;
     ...
     */
    public Xldfs027Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs027Type domainObj) {
