...
import tw.gov.moi.domain.Xldfy09umType;
import tw.gov.moi.domain.Rldfy09umType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09umType.class ,
        entityDsName = "rldfy09umByKey" ,
        xldfEntityClass = Xldfy09umType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09umQuery", xldfDsByTrans = "xldfy09umMaxSerialNo",  xldfDsBySerialNo = "xldfy09umBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09UM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09UM")
public class XLDFY09UM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09UM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09umType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09umType domainObj;
     ...
     */
    public Xldfy09umType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09umType domainObj) {
