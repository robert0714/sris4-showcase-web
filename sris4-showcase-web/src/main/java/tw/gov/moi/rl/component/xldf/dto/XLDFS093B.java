...
import tw.gov.moi.domain.Xldfs093bType;
import tw.gov.moi.domain.Rldfs093bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs093bType.class ,
        entityDsName = "rldfs093bByKey" ,
        xldfEntityClass = Xldfs093bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs093bQuery", xldfDsByTrans = "xldfs093bMaxSerialNo",  xldfDsBySerialNo = "xldfs093bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS093B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS093B")
public class XLDFS093B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS093B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs093bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs093bType domainObj;
     ...
     */
    public Xldfs093bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs093bType domainObj) {
