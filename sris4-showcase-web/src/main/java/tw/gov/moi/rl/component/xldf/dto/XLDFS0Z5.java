...
import tw.gov.moi.domain.Xldfs0z5Type;
import tw.gov.moi.domain.Rldfs0z5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0z5Type.class ,
        entityDsName = "rldfs0z5ByKey" ,
        xldfEntityClass = Xldfs0z5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0z5Query", xldfDsByTrans = "xldfs0z5MaxSerialNo",  xldfDsBySerialNo = "xldfs0z5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0Z5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0Z5")
public class XLDFS0Z5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0Z5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0z5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0z5Type domainObj;
     ...
     */
    public Xldfs0z5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0z5Type domainObj) {
