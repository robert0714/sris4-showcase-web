...
import tw.gov.moi.domain.Xldfr089Type;
import tw.gov.moi.domain.Rldfr089Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr089Type.class ,
        entityDsName = "rldfr089ByKey" ,
        xldfEntityClass = Xldfr089Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr089Query", xldfDsByTrans = "xldfr089MaxSerialNo",  xldfDsBySerialNo = "xldfr089BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR089", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR089")
public class XLDFR089 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR089(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr089Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr089Type domainObj;
     ...
     */
    public Xldfr089Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr089Type domainObj) {
