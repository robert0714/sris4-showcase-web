...
import tw.gov.moi.domain.Xldft0afType;
import tw.gov.moi.domain.Rldft0afType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0afType.class ,
        entityDsName = "rldft0afByKey" ,
        xldfEntityClass = Xldft0afType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0afQuery", xldfDsByTrans = "xldft0afMaxSerialNo",  xldfDsBySerialNo = "xldft0afBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AF", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AF")
public class XLDFT0AF implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AF(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0afType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0afType domainObj;
     ...
     */
    public Xldft0afType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0afType domainObj) {
