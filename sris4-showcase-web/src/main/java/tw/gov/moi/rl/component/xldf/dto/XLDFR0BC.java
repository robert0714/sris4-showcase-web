...
import tw.gov.moi.domain.Xldfr0bcType;
import tw.gov.moi.domain.Rldfr0bcType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0bcType.class ,
        entityDsName = "rldfr0bcByKey" ,
        xldfEntityClass = Xldfr0bcType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0bcQuery", xldfDsByTrans = "xldfr0bcMaxSerialNo",  xldfDsBySerialNo = "xldfr0bcBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0BC", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0BC")
public class XLDFR0BC implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0BC(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0bcType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0bcType domainObj;
     ...
     */
    public Xldfr0bcType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0bcType domainObj) {
