...
import tw.gov.moi.domain.Xldf030mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf030mType.class ,
        entityDsName = "rldf030mByKey" ,
        xldfEntityClass = Xldf030mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf030mQuery", xldfDsByTrans = "xldf030mMaxSerialNo",  xldfDsBySerialNo = "xldf030mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF030M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF030M")
public class XLDF030M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF030M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf030mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf030mType domainObj;
     ...
     */
    public Xldf030mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf030mType domainObj) {
