...
import tw.gov.moi.domain.Xldfy098mType;
import tw.gov.moi.domain.Rldfy098mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy098mType.class ,
        entityDsName = "rldfy098mByKey" ,
        xldfEntityClass = Xldfy098mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy098mQuery", xldfDsByTrans = "xldfy098mMaxSerialNo",  xldfDsBySerialNo = "xldfy098mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY098M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY098M")
public class XLDFY098M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY098M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy098mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy098mType domainObj;
     ...
     */
    public Xldfy098mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy098mType domainObj) {
