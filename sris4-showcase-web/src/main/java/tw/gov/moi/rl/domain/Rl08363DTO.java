...
@XmlType(name = "rl08363DTO", propOrder = { "village", "neighbor", "householdHeadId", "householdId", "householdType",
...
@XmlRootElement(name = "Rl08363DTO")
public class Rl08363DTO implements Serializable {
    ...
    @FieldName("查詢清單")
    private List<Rl08363DTO> infoList = new ArrayList<Rl08363DTO>();

    /** The info list. */
    @XmlElement(name = "Rldf004mList")
    @FieldName("修改個人細項資料清單")
     ...
     */
    // public List<Rl08363DTO> getInfoList() {
    // return infoList;
    // }
     ...
     *            the new info list
     */
    // public void setInfoList(List<Rl08363DTO> infoList) {
