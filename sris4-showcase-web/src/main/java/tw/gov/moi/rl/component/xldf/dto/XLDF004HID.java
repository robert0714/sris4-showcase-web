...
public class XLDF004HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF004H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF004HID(String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
