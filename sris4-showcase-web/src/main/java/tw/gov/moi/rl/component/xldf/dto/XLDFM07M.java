...
import tw.gov.moi.domain.Xldfm07mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm07mType.class ,
        entityDsName = "rldfm07mByKey" ,
        xldfEntityClass = Xldfm07mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm07mQuery", xldfDsByTrans = "xldfm07mMaxSerialNo",  xldfDsBySerialNo = "xldfm07mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM07M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM07M")
public class XLDFM07M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM07M(String personId ,String siteId ,String registerYyymmdd ,String registerHhmmss ) {
        super();
        this.domainObj = new Xldfm07mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm07mType domainObj;
     ...
     */
    public Xldfm07mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm07mType domainObj) {
