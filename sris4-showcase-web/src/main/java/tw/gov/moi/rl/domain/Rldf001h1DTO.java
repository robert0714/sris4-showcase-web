...
@XmlType(name = "rldf001h1DTO", propOrder = { "householdHeadId", "householdId", "siteId" })
@XmlRootElement(name = "Rldf001h1DTO", namespace = RlConstant.Namespace_RL_DOMAIN)
public class Rldf001h1DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 1631186668684513003L;
