 ...
 * @author Alan Lo
 */
public class Rl07430DTO implements Serializable {
    ...
    @FieldName("查詢結果")
    private List<Rl07430DetailDTO> resultList = new ArrayList<Rl07430DetailDTO>();

    /** Query Result Detail */
    @XmlElement(name = "ResultList")
    @FieldName("查詢結果明細")
    private Rl07430DetailDTO detailDTO = new Rl07430DetailDTO();

    /** Query Result List */
    @XmlElement(name = "ResultList")
    @FieldName("Rlde019e查詢結果")
    private List<Rl07430DTO> rlde019eList = new ArrayList<Rl07430DTO>();
    ...
    public List<Rl07430DetailDTO> getResultList() {
        return resultList;
    }

    public void setResultList(List<Rl07430DetailDTO> resultList) {
        this.resultList = resultList;
    }

    public Rl07430DetailDTO getDetailDTO() {
        return detailDTO;
    }

    public void setDetailDTO(Rl07430DetailDTO detailDTO) {
        this.detailDTO = detailDTO;
    }

    public List<Rl07430DTO> getRlde019eList() {
        return rlde019eList;
    }

    public void setRlde019eList(List<Rl07430DTO> rlde019eList) {
