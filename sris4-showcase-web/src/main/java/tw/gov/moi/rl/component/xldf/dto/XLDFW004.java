...
import tw.gov.moi.domain.Xldfw004Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw004Type.class ,
        entityDsName = "rldfw004ByKey" ,
        xldfEntityClass = Xldfw004Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw004Query", xldfDsByTrans = "xldfw004MaxSerialNo",  xldfDsBySerialNo = "xldfw004BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW004", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW004")
public class XLDFW004 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW004(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw004Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw004Type domainObj;
     ...
     */
    public Xldfw004Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw004Type domainObj) {
