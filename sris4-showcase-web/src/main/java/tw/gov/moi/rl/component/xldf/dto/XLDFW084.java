...
import tw.gov.moi.domain.Xldfw084Type;
import tw.gov.moi.domain.Rldfw084Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw084Type.class ,
        entityDsName = "rldfw084ByKey" ,
        xldfEntityClass = Xldfw084Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw084Query", xldfDsByTrans = "xldfw084MaxSerialNo",  xldfDsBySerialNo = "xldfw084BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW084", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW084")
public class XLDFW084 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW084(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw084Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw084Type domainObj;
     ...
     */
    public Xldfw084Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw084Type domainObj) {
