...
import tw.gov.moi.domain.Xldfy005hType;
import tw.gov.moi.domain.Rldfy005hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy005hType.class ,
        entityDsName = "rldfy005hByKey" ,
        xldfEntityClass = Xldfy005hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy005hQuery", xldfDsByTrans = "xldfy005hMaxSerialNo",  xldfDsBySerialNo = "xldfy005hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY005H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY005H")
public class XLDFY005H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY005H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy005hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy005hType domainObj;
     ...
     */
    public Xldfy005hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy005hType domainObj) {
