...
import tw.gov.moi.domain.Xldfw085Type;
import tw.gov.moi.domain.Rldfw085Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw085Type.class ,
        entityDsName = "rldfw085ByKey" ,
        xldfEntityClass = Xldfw085Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw085Query", xldfDsByTrans = "xldfw085MaxSerialNo",  xldfDsBySerialNo = "xldfw085BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW085", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW085")
public class XLDFW085 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW085(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw085Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw085Type domainObj;
     ...
     */
    public Xldfw085Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw085Type domainObj) {
