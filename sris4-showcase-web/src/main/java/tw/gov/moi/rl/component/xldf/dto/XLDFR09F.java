...
import tw.gov.moi.domain.Xldfr09fType;
import tw.gov.moi.domain.Rldfr09fType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09fType.class ,
        entityDsName = "rldfr09fByKey" ,
        xldfEntityClass = Xldfr09fType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09fQuery", xldfDsByTrans = "xldfr09fMaxSerialNo",  xldfDsBySerialNo = "xldfr09fBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09F", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09F")
public class XLDFR09F implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09F(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09fType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09fType domainObj;
     ...
     */
    public Xldfr09fType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09fType domainObj) {
