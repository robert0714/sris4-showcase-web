...
@XmlType(name = "XLDFY095H", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY095H") 
public class XLDFY095HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY095H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY095HID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
