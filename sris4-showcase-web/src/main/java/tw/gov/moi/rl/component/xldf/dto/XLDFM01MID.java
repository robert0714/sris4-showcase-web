...
@XmlType(name = "XLDFM01M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM01M") 
public class XLDFM01MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM01M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM01MID(String personId ,String siteId ) {
        super();
