...
import tw.gov.moi.domain.Xldfs077bType;
import tw.gov.moi.domain.Rldfs077bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs077bType.class ,
        entityDsName = "rldfs077bByKey" ,
        xldfEntityClass = Xldfs077bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs077bQuery", xldfDsByTrans = "xldfs077bMaxSerialNo",  xldfDsBySerialNo = "xldfs077bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS077B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS077B")
public class XLDFS077B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS077B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs077bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs077bType domainObj;
     ...
     */
    public Xldfs077bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs077bType domainObj) {
