...
import tw.gov.moi.domain.Xldfr0a6Type;
import tw.gov.moi.domain.Rldfr0a6Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a6Type.class ,
        entityDsName = "rldfr0a6ByKey" ,
        xldfEntityClass = Xldfr0a6Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a6Query", xldfDsByTrans = "xldfr0a6MaxSerialNo",  xldfDsBySerialNo = "xldfr0a6BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A6", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A6")
public class XLDFR0A6 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A6(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a6Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a6Type domainObj;
     ...
     */
    public Xldfr0a6Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a6Type domainObj) {
