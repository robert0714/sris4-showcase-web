...
import tw.gov.moi.domain.Xldfr0d1Type;
import tw.gov.moi.domain.Rldfr0d1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0d1Type.class ,
        entityDsName = "rldfr0d1ByKey" ,
        xldfEntityClass = Xldfr0d1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0d1Query", xldfDsByTrans = "xldfr0d1MaxSerialNo",  xldfDsBySerialNo = "xldfr0d1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0D1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0D1")
public class XLDFR0D1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0D1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0d1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0d1Type domainObj;
     ...
     */
    public Xldfr0d1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0d1Type domainObj) {
