...
import tw.gov.moi.domain.Xldfs0bcType;
import tw.gov.moi.domain.Rldfs0bcType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0bcType.class ,
        entityDsName = "rldfs0bcByKey" ,
        xldfEntityClass = Xldfs0bcType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0bcQuery", xldfDsByTrans = "xldfs0bcMaxSerialNo",  xldfDsBySerialNo = "xldfs0bcBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BC", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BC")
public class XLDFS0BC implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BC(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0bcType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0bcType domainObj;
     ...
     */
    public Xldfs0bcType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0bcType domainObj) {
