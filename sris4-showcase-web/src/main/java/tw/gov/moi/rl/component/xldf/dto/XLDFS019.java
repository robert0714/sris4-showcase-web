...
import tw.gov.moi.domain.Xldfs019Type;
import tw.gov.moi.domain.Rldfs019Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs019Type.class ,
        entityDsName = "rldfs019ByKey" ,
        xldfEntityClass = Xldfs019Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs019Query", xldfDsByTrans = "xldfs019MaxSerialNo",  xldfDsBySerialNo = "xldfs019BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS019", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS019")
public class XLDFS019 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS019(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs019Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs019Type domainObj;
     ...
     */
    public Xldfs019Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs019Type domainObj) {
