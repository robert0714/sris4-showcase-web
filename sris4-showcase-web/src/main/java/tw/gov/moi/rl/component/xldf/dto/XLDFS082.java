...
import tw.gov.moi.domain.Xldfs082Type;
import tw.gov.moi.domain.Rldfs082Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs082Type.class ,
        entityDsName = "rldfs082ByKey" ,
        xldfEntityClass = Xldfs082Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs082Query", xldfDsByTrans = "xldfs082MaxSerialNo",  xldfDsBySerialNo = "xldfs082BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS082", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS082")
public class XLDFS082 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS082(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs082Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs082Type domainObj;
     ...
     */
    public Xldfs082Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs082Type domainObj) {
