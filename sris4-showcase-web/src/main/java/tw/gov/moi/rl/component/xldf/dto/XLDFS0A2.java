...
import tw.gov.moi.domain.Xldfs0a2Type;
import tw.gov.moi.domain.Rldfs0a2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a2Type.class ,
        entityDsName = "rldfs0a2ByKey" ,
        xldfEntityClass = Xldfs0a2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a2Query", xldfDsByTrans = "xldfs0a2MaxSerialNo",  xldfDsBySerialNo = "xldfs0a2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A2")
public class XLDFS0A2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a2Type domainObj;
     ...
     */
    public Xldfs0a2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a2Type domainObj) {
