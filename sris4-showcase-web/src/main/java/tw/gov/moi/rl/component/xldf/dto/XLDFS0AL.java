...
import tw.gov.moi.domain.Xldfs0alType;
import tw.gov.moi.domain.Rldfs0alType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0alType.class ,
        entityDsName = "rldfs0alByKey" ,
        xldfEntityClass = Xldfs0alType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0alQuery", xldfDsByTrans = "xldfs0alMaxSerialNo",  xldfDsBySerialNo = "xldfs0alBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AL", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AL")
public class XLDFS0AL implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AL(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0alType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0alType domainObj;
     ...
     */
    public Xldfs0alType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0alType domainObj) {
