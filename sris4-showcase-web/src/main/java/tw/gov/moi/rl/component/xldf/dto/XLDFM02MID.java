...
@XmlType(name = "XLDFM02M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM02M") 
public class XLDFM02MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM02M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM02MID(String personId ,String siteId ,String spouseId ,String updateYyymmdd ,String updateHhmmss ) {
        super();
