...
import tw.gov.moi.domain.Xldfs09tbType;
import tw.gov.moi.domain.Rldfs09tbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09tbType.class ,
        entityDsName = "rldfs09tbByKey" ,
        xldfEntityClass = Xldfs09tbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09tbQuery", xldfDsByTrans = "xldfs09tbMaxSerialNo",  xldfDsBySerialNo = "xldfs09tbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09TB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09TB")
public class XLDFS09TB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09TB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09tbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09tbType domainObj;
     ...
     */
    public Xldfs09tbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09tbType domainObj) {
