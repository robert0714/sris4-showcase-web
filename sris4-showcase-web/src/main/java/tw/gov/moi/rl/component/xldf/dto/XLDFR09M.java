...
import tw.gov.moi.domain.Xldfr09mType;
import tw.gov.moi.domain.Rldfr09mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09mType.class ,
        entityDsName = "rldfr09mByKey" ,
        xldfEntityClass = Xldfr09mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09mQuery", xldfDsByTrans = "xldfr09mMaxSerialNo",  xldfDsBySerialNo = "xldfr09mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09M")
public class XLDFR09M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09M(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09mType domainObj;
     ...
     */
    public Xldfr09mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09mType domainObj) {
