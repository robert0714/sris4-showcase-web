...
import tw.gov.moi.domain.Xldfy0aahType;
import tw.gov.moi.domain.Rldfy0aahType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0aahType.class ,
        entityDsName = "rldfy0aahByKey" ,
        xldfEntityClass = Xldfy0aahType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0aahQuery", xldfDsByTrans = "xldfy0aahMaxSerialNo",  xldfDsBySerialNo = "xldfy0aahBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0AAH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0AAH")
public class XLDFY0AAH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0AAH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0aahType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0aahType domainObj;
     ...
     */
    public Xldfy0aahType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0aahType domainObj) {
