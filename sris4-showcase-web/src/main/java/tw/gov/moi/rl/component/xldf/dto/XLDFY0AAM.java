...
import tw.gov.moi.domain.Xldfy0aamType;
import tw.gov.moi.domain.Rldfy0aamType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0aamType.class ,
        entityDsName = "rldfy0aamByKey" ,
        xldfEntityClass = Xldfy0aamType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0aamQuery", xldfDsByTrans = "xldfy0aamMaxSerialNo",  xldfDsBySerialNo = "xldfy0aamBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0AAM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0AAM")
public class XLDFY0AAM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0AAM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0aamType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0aamType domainObj;
     ...
     */
    public Xldfy0aamType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0aamType domainObj) {
