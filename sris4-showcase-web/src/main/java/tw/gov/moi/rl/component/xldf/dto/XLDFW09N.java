...
import tw.gov.moi.domain.Xldfw09nType;
import tw.gov.moi.domain.Rldfw09nType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09nType.class ,
        entityDsName = "rldfw09nByKey" ,
        xldfEntityClass = Xldfw09nType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09nQuery", xldfDsByTrans = "xldfw09nMaxSerialNo",  xldfDsBySerialNo = "xldfw09nBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09N", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09N")
public class XLDFW09N implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09N(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09nType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09nType domainObj;
     ...
     */
    public Xldfw09nType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09nType domainObj) {
