...
public class XLDF028DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF028D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF028DID(String siteId ,String householdHeadId ,String householdId ,String seqNo ,String applyYyymmdd ,String applyHhmmss ,String personId ) {
        super();
