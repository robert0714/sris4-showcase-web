...
import tw.gov.moi.domain.Xldfx073mType;
import tw.gov.moi.domain.Rldfx073mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx073mType.class ,
        entityDsName = "rldfx073mByKey" ,
        xldfEntityClass = Xldfx073mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx073mQuery", xldfDsByTrans = "xldfx073mMaxSerialNo",  xldfDsBySerialNo = "xldfx073mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX073M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX073M")
public class XLDFX073M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX073M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx073mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx073mType domainObj;
     ...
     */
    public Xldfx073mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx073mType domainObj) {
