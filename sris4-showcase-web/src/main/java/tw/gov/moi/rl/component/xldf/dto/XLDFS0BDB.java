...
import tw.gov.moi.domain.Xldfs0bdbType;
import tw.gov.moi.domain.Rldfs0bdbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0bdbType.class ,
        entityDsName = "rldfs0bdbByKey" ,
        xldfEntityClass = Xldfs0bdbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0bdbQuery", xldfDsByTrans = "xldfs0bdbMaxSerialNo",  xldfDsBySerialNo = "xldfs0bdbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BDB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BDB")
public class XLDFS0BDB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BDB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0bdbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0bdbType domainObj;
     ...
     */
    public Xldfs0bdbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0bdbType domainObj) {
