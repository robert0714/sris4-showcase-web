...
import tw.gov.moi.domain.Xldfx095mType;
import tw.gov.moi.domain.Rldfx095mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx095mType.class ,
        entityDsName = "rldfx095mByKey" ,
        xldfEntityClass = Xldfx095mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx095mQuery", xldfDsByTrans = "xldfx095mMaxSerialNo",  xldfDsBySerialNo = "xldfx095mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX095M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX095M")
public class XLDFX095M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX095M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx095mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx095mType domainObj;
     ...
     */
    public Xldfx095mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx095mType domainObj) {
