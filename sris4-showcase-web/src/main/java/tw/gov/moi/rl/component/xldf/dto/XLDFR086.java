...
import tw.gov.moi.domain.Xldfr086Type;
import tw.gov.moi.domain.Rldfr086Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr086Type.class ,
        entityDsName = "rldfr086ByKey" ,
        xldfEntityClass = Xldfr086Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr086Query", xldfDsByTrans = "xldfr086MaxSerialNo",  xldfDsBySerialNo = "xldfr086BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR086", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR086")
public class XLDFR086 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR086(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr086Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr086Type domainObj;
     ...
     */
    public Xldfr086Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr086Type domainObj) {
