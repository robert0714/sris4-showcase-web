...
import tw.gov.moi.domain.Xldfs09abType;
import tw.gov.moi.domain.Rldfs09abType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09abType.class ,
        entityDsName = "rldfs09abByKey" ,
        xldfEntityClass = Xldfs09abType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09abQuery", xldfDsByTrans = "xldfs09abMaxSerialNo",  xldfDsBySerialNo = "xldfs09abBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09AB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09AB")
public class XLDFS09AB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09AB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09abType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09abType domainObj;
     ...
     */
    public Xldfs09abType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09abType domainObj) {
