...
@XmlType(name = "rl01825AppDataDTO", propOrder = { "registerDate", "registerTime", "applyDate",
        "acceptAdminOfficeCode", "registerContent", "needFineFlag", "fineFreeFlag", "removeFeeReason", "enforcedFlag",
        "orgEducationMark", "beforeWork", "afterPersonName", "afterLastName", "afterFirstName", "afterMidenName",
        "afterMarriedName", "revokeReasonCode", "otherRevokeReason", "revokeYyymmdd", "lawCode", "eventDate",
        "certificateList", "certificate_1", "certificate_2", "certificate_3", "certificate_4", "certificate_5",
        "certificate_6", "certificate_7", "certificate_8", "certificate_9", "certificate_10", "otherCertificate",
        "doFineCheckFlag", "bookFlag", "householdHeadFlag", "personForeignFlag", "beforePersonName", "beforeLastName",
        "beforeFirstName", "beforeMidenName", "beforeMarriedName", "outliveCaseFlag" })
@XmlRootElement(name = "Rl01825AppDataDTO")
public class Rl01825AppDataDTO implements Serializable {
