...
import tw.gov.moi.domain.Xldfw09oType;
import tw.gov.moi.domain.Rldfw09oType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09oType.class ,
        entityDsName = "rldfw09oByKey" ,
        xldfEntityClass = Xldfw09oType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09oQuery", xldfDsByTrans = "xldfw09oMaxSerialNo",  xldfDsBySerialNo = "xldfw09oBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09O", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09O")
public class XLDFW09O implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09O(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09oType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09oType domainObj;
     ...
     */
    public Xldfw09oType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09oType domainObj) {
