...
import tw.gov.moi.domain.Xldfr024Type;
import tw.gov.moi.domain.Rldfr024Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr024Type.class ,
        entityDsName = "rldfr024ByKey" ,
        xldfEntityClass = Xldfr024Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr024Query", xldfDsByTrans = "xldfr024MaxSerialNo",  xldfDsBySerialNo = "xldfr024BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR024", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR024")
public class XLDFR024 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR024(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr024Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr024Type domainObj;
     ...
     */
    public Xldfr024Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr024Type domainObj) {
