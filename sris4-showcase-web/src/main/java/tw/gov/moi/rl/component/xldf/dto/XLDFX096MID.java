...
@XmlType(name = "XLDFX096M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX096M") 
public class XLDFX096MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX096M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX096MID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
