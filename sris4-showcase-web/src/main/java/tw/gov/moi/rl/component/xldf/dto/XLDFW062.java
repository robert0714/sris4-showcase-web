...
import tw.gov.moi.domain.Xldfw062Type;
import tw.gov.moi.domain.Rldfw062Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw062Type.class ,
        entityDsName = "rldfw062ByKey" ,
        xldfEntityClass = Xldfw062Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw062Query", xldfDsByTrans = "xldfw062MaxSerialNo",  xldfDsBySerialNo = "xldfw062BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW062", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW062")
public class XLDFW062 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW062(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw062Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw062Type domainObj;
     ...
     */
    public Xldfw062Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw062Type domainObj) {
