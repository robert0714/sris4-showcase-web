...
import tw.gov.moi.domain.Xldft018Type;
import tw.gov.moi.domain.Rldft018Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft018Type.class ,
        entityDsName = "rldft018ByKey" ,
        xldfEntityClass = Xldft018Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft018Query", xldfDsByTrans = "xldft018MaxSerialNo",  xldfDsBySerialNo = "xldft018BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT018", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT018")
public class XLDFT018 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT018(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft018Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft018Type domainObj;
     ...
     */
    public Xldft018Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft018Type domainObj) {
