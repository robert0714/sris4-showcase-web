...
import tw.gov.moi.domain.Xldfx096mType;
import tw.gov.moi.domain.Rldfx096mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx096mType.class ,
        entityDsName = "rldfx096mByKey" ,
        xldfEntityClass = Xldfx096mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx096mQuery", xldfDsByTrans = "xldfx096mMaxSerialNo",  xldfDsBySerialNo = "xldfx096mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX096M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX096M")
public class XLDFX096M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX096M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx096mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx096mType domainObj;
     ...
     */
    public Xldfx096mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx096mType domainObj) {
