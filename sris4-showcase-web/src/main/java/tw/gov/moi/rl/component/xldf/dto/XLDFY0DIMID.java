...
@XmlType(name = "XLDFY0DIM", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0DIM") 
public class XLDFY0DIMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0DIM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0DIMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
