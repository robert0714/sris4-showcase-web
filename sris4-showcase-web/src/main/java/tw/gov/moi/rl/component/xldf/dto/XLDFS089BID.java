...
@XmlType(name = "XLDFS089B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS089B") 
public class XLDFS089BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS089B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS089BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
