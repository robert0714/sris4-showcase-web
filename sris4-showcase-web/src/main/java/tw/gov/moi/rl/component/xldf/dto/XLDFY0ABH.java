...
import tw.gov.moi.domain.Xldfy0abhType;
import tw.gov.moi.domain.Rldfy0abhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0abhType.class ,
        entityDsName = "rldfy0abhByKey" ,
        xldfEntityClass = Xldfy0abhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0abhQuery", xldfDsByTrans = "xldfy0abhMaxSerialNo",  xldfDsBySerialNo = "xldfy0abhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0ABH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0ABH")
public class XLDFY0ABH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0ABH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0abhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0abhType domainObj;
     ...
     */
    public Xldfy0abhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0abhType domainObj) {
