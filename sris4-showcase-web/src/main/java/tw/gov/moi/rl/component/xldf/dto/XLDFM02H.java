...
import tw.gov.moi.domain.Xldfm02hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm02hType.class ,
        entityDsName = "rldfm02hByKey" ,
        xldfEntityClass = Xldfm02hType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "spouseId" , length = 10),
            @XldfKeyMapping( name = "updateYyymmdd" , length = 7),
            @XldfKeyMapping( name = "updateHhmmss" , length = 6),
            @XldfKeyMapping( name = "removeYyymmdd" , length = 7),
            @XldfKeyMapping( name = "removeTime" , length = 6)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm02hQuery", xldfDsByTrans = "xldfm02hMaxSerialNo",  xldfDsBySerialNo = "xldfm02hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM02H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM02H")
public class XLDFM02H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM02H(String personId ,String siteId ,String spouseId ,String updateYyymmdd ,String updateHhmmss ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldfm02hType();
        getDomainObj().setPersonId(personId); 
        getDomainObj().setSiteId(siteId); 
        getDomainObj().setSpouseId(spouseId); 
        getDomainObj().setUpdateYyymmdd(updateYyymmdd); 
        getDomainObj().setUpdateHhmmss(updateHhmmss); 
    ...
    @FieldName("XLDF領域物件")
    private Xldfm02hType domainObj;
     ...
     */
    public Xldfm02hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm02hType domainObj) {
