...
import tw.gov.moi.domain.Xcdf001mrlType;
...
/**
 * The Class XCDF001MRL.
 *
 * @author JL
 */
@RldfMappingEntity(
        value = Rcdf001mrlType.class ,
        entityDsName = "rcdf001mrlByKey" ,
        xldfEntityClass = Xcdf001mrlType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10)

        }) 
@XldfDsNameMaping(xldfDsName = "xcdf001mrlQuery", xldfDsByTrans = "xcdf001mrlMaxSerialNo",  xldfDsBySerialNo = "xcdf001mrlBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XCDF001MRL", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XCDF001MRL")
public class XCDF001MRL implements XLDFDomainObject, java.io.Serializable {
    ...
    public XCDF001MRL(String personId ) {
        super();
        this.domainObj = new Xcdf001mrlType();
    ...
    @FieldName("XLDF領域物件")
    private Xcdf001mrlType domainObj;
     ...
     */
    public Xcdf001mrlType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xcdf001mrlType domainObj) {
