...
@XmlType(name = "XLDF008A", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF008A") 
public class XLDF008AID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF008A.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF008AID(String siteId ) {
        super();
