...
import tw.gov.moi.domain.Xldfs09sType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09sType.class ,
        entityDsName = "rldfs09sByKey" ,
        xldfEntityClass = Xldfs09sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09sQuery", xldfDsByTrans = "xldfs09sMaxSerialNo",  xldfDsBySerialNo = "xldfs09sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09S")
public class XLDFS09S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09S(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09sType domainObj;
     ...
     */
    public Xldfs09sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09sType domainObj) {
