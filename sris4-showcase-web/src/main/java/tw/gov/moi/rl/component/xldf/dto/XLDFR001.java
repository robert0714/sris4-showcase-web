...
import tw.gov.moi.domain.Xldfr001Type;
import tw.gov.moi.domain.Rldfr001Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr001Type.class ,
        entityDsName = "rldfr001ByKey" ,
        xldfEntityClass = Xldfr001Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr001Query", xldfDsByTrans = "xldfr001MaxSerialNo",  xldfDsBySerialNo = "xldfr001BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR001", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR001")
public class XLDFR001 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR001(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr001Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr001Type domainObj;
     ...
     */
    public Xldfr001Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr001Type domainObj) {
