...
import tw.gov.moi.domain.Xldfs09aType;
import tw.gov.moi.domain.Rldfs09aType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09aType.class ,
        entityDsName = "rldfs09aByKey" ,
        xldfEntityClass = Xldfs09aType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09aQuery", xldfDsByTrans = "xldfs09aMaxSerialNo",  xldfDsBySerialNo = "xldfs09aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09A")
public class XLDFS09A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09A(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09aType domainObj;
     ...
     */
    public Xldfs09aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09aType domainObj) {
