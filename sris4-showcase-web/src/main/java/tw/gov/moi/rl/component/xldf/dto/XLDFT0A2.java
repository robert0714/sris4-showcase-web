...
import tw.gov.moi.domain.Xldft0a2Type;
import tw.gov.moi.domain.Rldft0a2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a2Type.class ,
        entityDsName = "rldft0a2ByKey" ,
        xldfEntityClass = Xldft0a2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a2Query", xldfDsByTrans = "xldft0a2MaxSerialNo",  xldfDsBySerialNo = "xldft0a2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A2")
public class XLDFT0A2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a2Type domainObj;
     ...
     */
    public Xldft0a2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a2Type domainObj) {
