...
@XmlType(name = "XLDFX002M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX002M") 
public class XLDFX002MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX002M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX002MID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
