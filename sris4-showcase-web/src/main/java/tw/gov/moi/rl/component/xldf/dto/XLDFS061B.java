...
import tw.gov.moi.domain.Xldfs061bType;
import tw.gov.moi.domain.Rldfs061bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs061bType.class ,
        entityDsName = "rldfs061bByKey" ,
        xldfEntityClass = Xldfs061bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs061bQuery", xldfDsByTrans = "xldfs061bMaxSerialNo",  xldfDsBySerialNo = "xldfs061bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS061B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS061B")
public class XLDFS061B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS061B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs061bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs061bType domainObj;
     ...
     */
    public Xldfs061bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs061bType domainObj) {
