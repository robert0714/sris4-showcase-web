...
import tw.gov.moi.domain.Xldfs09nType;
import tw.gov.moi.domain.Rldfs09nType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09nType.class ,
        entityDsName = "rldfs09nByKey" ,
        xldfEntityClass = Xldfs09nType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09nQuery", xldfDsByTrans = "xldfs09nMaxSerialNo",  xldfDsBySerialNo = "xldfs09nBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09N", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09N")
public class XLDFS09N implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09N(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09nType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09nType domainObj;
     ...
     */
    public Xldfs09nType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09nType domainObj) {
