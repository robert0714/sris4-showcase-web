...
import tw.gov.moi.domain.Xldfw09pType;
import tw.gov.moi.domain.Rldfw09pType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09pType.class ,
        entityDsName = "rldfw09pByKey" ,
        xldfEntityClass = Xldfw09pType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09pQuery", xldfDsByTrans = "xldfw09pMaxSerialNo",  xldfDsBySerialNo = "xldfw09pBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09P", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09P")
public class XLDFW09P implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09P(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09pType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09pType domainObj;
     ...
     */
    public Xldfw09pType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09pType domainObj) {
