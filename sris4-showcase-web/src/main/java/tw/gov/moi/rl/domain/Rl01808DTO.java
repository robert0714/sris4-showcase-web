...
@XmlType(name = "Rl01808DTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl01808AppDataDTO",
        "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication" })
@XmlRootElement(name = "Rl01808DTO")
public class Rl01808DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 3120782750743781782L;
    ...
    @XmlElement(name = "Rl01808AppDataDTO")
    @FieldName("養父姓名更正撤銷登記AppDataDTO")
    private Rl01808AppDataDTO rl01808AppDataDTO = new Rl01808AppDataDTO();
    ...
    /**
     * Gets the rl01808 app data dto.
     * 
     * @return the rl01808 app data dto
     */
    public Rl01808AppDataDTO getRl01808AppDataDTO() {
        return rl01808AppDataDTO;
    }

    /**
     * Sets the rl01808 app data dto.
     * 
     * @param rl01808AppDataDTO
     *            the new rl01808 app data dto
     */
    public void setRl01808AppDataDTO(final Rl01808AppDataDTO rl01808AppDataDTO) {
        this.rl01808AppDataDTO = rl01808AppDataDTO;
    }
