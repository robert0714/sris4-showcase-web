...
import tw.gov.moi.domain.Xldft09oType;
import tw.gov.moi.domain.Rldft09oType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09oType.class ,
        entityDsName = "rldft09oByKey" ,
        xldfEntityClass = Xldft09oType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09oQuery", xldfDsByTrans = "xldft09oMaxSerialNo",  xldfDsBySerialNo = "xldft09oBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09O", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09O")
public class XLDFT09O implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09O(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09oType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09oType domainObj;
     ...
     */
    public Xldft09oType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09oType domainObj) {
