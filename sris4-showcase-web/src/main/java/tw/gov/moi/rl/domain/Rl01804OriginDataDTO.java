...
public class Rl01804OriginDataDTO implements Serializable {
    /**
     * Serial id.
     */
     ...
     * @param personData
     */
    public Rl01804OriginDataDTO(XLDFPersonDataDomainObject personDataObj) {
     ...
     * @param personData
     */
    public Rl01804OriginDataDTO(Rl01804MoveinDTO moveinDTO) {
        this.selectedHead = Boolean.FALSE;
