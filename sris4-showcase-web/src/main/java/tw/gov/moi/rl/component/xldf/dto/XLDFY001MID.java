...
public class XLDFY001MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY001M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY001MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
