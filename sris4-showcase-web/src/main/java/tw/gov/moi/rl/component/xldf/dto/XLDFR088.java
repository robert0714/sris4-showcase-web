...
import tw.gov.moi.domain.Xldfr088Type;
import tw.gov.moi.domain.Rldfr088Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr088Type.class ,
        entityDsName = "rldfr088ByKey" ,
        xldfEntityClass = Xldfr088Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr088Query", xldfDsByTrans = "xldfr088MaxSerialNo",  xldfDsBySerialNo = "xldfr088BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR088", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR088")
public class XLDFR088 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR088(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr088Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr088Type domainObj;
     ...
     */
    public Xldfr088Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr088Type domainObj) {
