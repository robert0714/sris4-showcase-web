...
import tw.gov.moi.domain.Xldfs079Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs079Type.class ,
        entityDsName = "rldfs079ByKey" ,
        xldfEntityClass = Xldfs079Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs079Query", xldfDsByTrans = "xldfs079MaxSerialNo",  xldfDsBySerialNo = "xldfs079BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS079", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS079")
public class XLDFS079 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS079(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs079Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs079Type domainObj;
     ...
     */
    public Xldfs079Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs079Type domainObj) {
