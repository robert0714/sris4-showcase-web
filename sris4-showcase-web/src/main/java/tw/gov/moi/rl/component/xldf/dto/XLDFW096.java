...
import tw.gov.moi.domain.Xldfw096Type;
import tw.gov.moi.domain.Rldfw096Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw096Type.class ,
        entityDsName = "rldfw096ByKey" ,
        xldfEntityClass = Xldfw096Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw096Query", xldfDsByTrans = "xldfw096MaxSerialNo",  xldfDsBySerialNo = "xldfw096BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW096", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW096")
public class XLDFW096 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW096(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw096Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw096Type domainObj;
     ...
     */
    public Xldfw096Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw096Type domainObj) {
