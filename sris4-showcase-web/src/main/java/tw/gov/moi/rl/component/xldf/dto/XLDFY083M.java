...
import tw.gov.moi.domain.Xldfy083mType;
import tw.gov.moi.domain.Rldfy083mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy083mType.class ,
        entityDsName = "rldfy083mByKey" ,
        xldfEntityClass = Xldfy083mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy083mQuery", xldfDsByTrans = "xldfy083mMaxSerialNo",  xldfDsBySerialNo = "xldfy083mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY083M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY083M")
public class XLDFY083M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY083M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy083mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy083mType domainObj;
     ...
     */
    public Xldfy083mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy083mType domainObj) {
