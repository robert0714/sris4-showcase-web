...
import tw.gov.moi.domain.Xldfw0daType;
import tw.gov.moi.domain.Rldfw0daType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0daType.class ,
        entityDsName = "rldfw0daByKey" ,
        xldfEntityClass = Xldfw0daType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0daQuery", xldfDsByTrans = "xldfw0daMaxSerialNo",  xldfDsBySerialNo = "xldfw0daBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0DA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0DA")
public class XLDFW0DA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0DA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0daType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0daType domainObj;
     ...
     */
    public Xldfw0daType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0daType domainObj) {
