...
import tw.gov.moi.domain.Xldfs0a3Type;
import tw.gov.moi.domain.Rldfs0a3Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a3Type.class ,
        entityDsName = "rldfs0a3ByKey" ,
        xldfEntityClass = Xldfs0a3Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a3Query", xldfDsByTrans = "xldfs0a3MaxSerialNo",  xldfDsBySerialNo = "xldfs0a3BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A3", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A3")
public class XLDFS0A3 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A3(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a3Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a3Type domainObj;
     ...
     */
    public Xldfs0a3Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a3Type domainObj) {
