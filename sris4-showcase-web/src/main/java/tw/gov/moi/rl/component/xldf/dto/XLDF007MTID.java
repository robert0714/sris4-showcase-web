...
public class XLDF007MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF007MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF007MTID(String personId ,String modifyYyymmdd ,String modifyTime ,String siteId ) {
        super();
