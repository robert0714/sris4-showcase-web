...
@XmlType(name = "XLDFS047B", propOrder = { "keys", "xldfClass" })
@XmlRootElement(name = "XLDFS047B")
public class XLDFS047BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS047B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS047BID(String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq,
