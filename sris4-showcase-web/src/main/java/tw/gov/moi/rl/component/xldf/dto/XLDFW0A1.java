...
import tw.gov.moi.domain.Xldfw0a1Type;
import tw.gov.moi.domain.Rldfw0a1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a1Type.class ,
        entityDsName = "rldfw0a1ByKey" ,
        xldfEntityClass = Xldfw0a1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a1Query", xldfDsByTrans = "xldfw0a1MaxSerialNo",  xldfDsBySerialNo = "xldfw0a1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A1")
public class XLDFW0A1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a1Type domainObj;
     ...
     */
    public Xldfw0a1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a1Type domainObj) {
