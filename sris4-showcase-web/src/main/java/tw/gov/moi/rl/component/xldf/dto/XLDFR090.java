...
import tw.gov.moi.domain.Xldfr090Type;
import tw.gov.moi.domain.Rldfr090Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr090Type.class ,
        entityDsName = "rldfr090ByKey" ,
        xldfEntityClass = Xldfr090Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr090Query", xldfDsByTrans = "xldfr090MaxSerialNo",  xldfDsBySerialNo = "xldfr090BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR090", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR090")
public class XLDFR090 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR090(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr090Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr090Type domainObj;
     ...
     */
    public Xldfr090Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr090Type domainObj) {
