 ...
 */
@RldfMappingEntity(
        value = Rldf004mType.class ,
        entityDsName = "rldf004mByKey" ,
        xldfEntityClass = Xldf004mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf004mQuery", xldfDsByTrans = "xldf004mMaxSerialNo",  xldfDsBySerialNo = "xldf004mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF004M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF004M")
public class XLDF004M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF004M(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf004mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf004mType domainObj;
     ...
     */
    public Xldf004mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf004mType domainObj) {
