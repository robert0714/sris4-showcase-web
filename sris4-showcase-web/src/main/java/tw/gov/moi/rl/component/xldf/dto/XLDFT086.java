...
import tw.gov.moi.domain.Xldft086Type;
import tw.gov.moi.domain.Rldft086Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft086Type.class ,
        entityDsName = "rldft086ByKey" ,
        xldfEntityClass = Xldft086Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft086Query", xldfDsByTrans = "xldft086MaxSerialNo",  xldfDsBySerialNo = "xldft086BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT086", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT086")
public class XLDFT086 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT086(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft086Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft086Type domainObj;
     ...
     */
    public Xldft086Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft086Type domainObj) {
