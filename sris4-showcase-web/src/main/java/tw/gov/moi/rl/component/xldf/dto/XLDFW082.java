...
import tw.gov.moi.domain.Xldfw082Type;
import tw.gov.moi.domain.Rldfw082Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw082Type.class ,
        entityDsName = "rldfw082ByKey" ,
        xldfEntityClass = Xldfw082Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw082Query", xldfDsByTrans = "xldfw082MaxSerialNo",  xldfDsBySerialNo = "xldfw082BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW082", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW082")
public class XLDFW082 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW082(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw082Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw082Type domainObj;
     ...
     */
    public Xldfw082Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw082Type domainObj) {
