...
import tw.gov.moi.domain.Xldfr0a7Type;
import tw.gov.moi.domain.Rldfr0a7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a7Type.class ,
        entityDsName = "rldfr0a7ByKey" ,
        xldfEntityClass = Xldfr0a7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a7Query", xldfDsByTrans = "xldfr0a7MaxSerialNo",  xldfDsBySerialNo = "xldfr0a7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A7")
public class XLDFR0A7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a7Type domainObj;
     ...
     */
    public Xldfr0a7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a7Type domainObj) {
