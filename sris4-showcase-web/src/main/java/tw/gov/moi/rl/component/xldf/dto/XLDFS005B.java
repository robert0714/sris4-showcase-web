...
import tw.gov.moi.domain.Xldfs005bType;
import tw.gov.moi.domain.Rldfs005bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs005bType.class ,
        entityDsName = "rldfs005bByKey" ,
        xldfEntityClass = Xldfs005bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs005bQuery", xldfDsByTrans = "xldfs005bMaxSerialNo",  xldfDsBySerialNo = "xldfs005bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS005B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS005B")
public class XLDFS005B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS005B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs005bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs005bType domainObj;
     ...
     */
    public Xldfs005bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs005bType domainObj) {
