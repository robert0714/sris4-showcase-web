...
import tw.gov.moi.domain.Xldfw026Type;
import tw.gov.moi.domain.Rldfw026Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw026Type.class ,
        entityDsName = "rldfw026ByKey" ,
        xldfEntityClass = Xldfw026Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw026Query", xldfDsByTrans = "xldfw026MaxSerialNo",  xldfDsBySerialNo = "xldfw026BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW026", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW026")
public class XLDFW026 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW026(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw026Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw026Type domainObj;
     ...
     */
    public Xldfw026Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw026Type domainObj) {
