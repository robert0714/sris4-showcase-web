...
import tw.gov.moi.rl.component.xldf.dto.XLDFY09UH;
import tw.gov.moi.rl.component.xldf.dto.XLDFY09UM;
...
public class Rl01833DTO implements Serializable {
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY09UM> personNoteDetailList = new ArrayList<XLDFY09UM>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY09UH> removedPersonNoteDetailList = new ArrayList<XLDFY09UH>();
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY09UM> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY09UM> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY09UH> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY09UH> removedPersonNoteDetailList) {
