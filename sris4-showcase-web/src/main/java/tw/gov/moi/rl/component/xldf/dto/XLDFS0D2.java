...
import tw.gov.moi.domain.Xldfs0d2Type;
import tw.gov.moi.domain.Rldfs0d2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0d2Type.class ,
        entityDsName = "rldfs0d2ByKey" ,
        xldfEntityClass = Xldfs0d2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0d2Query", xldfDsByTrans = "xldfs0d2MaxSerialNo",  xldfDsBySerialNo = "xldfs0d2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0D2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0D2")
public class XLDFS0D2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0D2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0d2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0d2Type domainObj;
     ...
     */
    public Xldfs0d2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0d2Type domainObj) {
