...
import tw.gov.moi.domain.Xldfy0b5mType;
import tw.gov.moi.domain.Rldfy0b5mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b5mType.class ,
        entityDsName = "rldfy0b5mByKey" ,
        xldfEntityClass = Xldfy0b5mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b5mQuery", xldfDsByTrans = "xldfy0b5mMaxSerialNo",  xldfDsBySerialNo = "xldfy0b5mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B5M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B5M")
public class XLDFY0B5M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B5M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b5mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b5mType domainObj;
     ...
     */
    public Xldfy0b5mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b5mType domainObj) {
