...
import tw.gov.moi.domain.Xldft09cType;
import tw.gov.moi.domain.Rldft09cType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09cType.class ,
        entityDsName = "rldft09cByKey" ,
        xldfEntityClass = Xldft09cType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09cQuery", xldfDsByTrans = "xldft09cMaxSerialNo",  xldfDsBySerialNo = "xldft09cBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09C", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09C")
public class XLDFT09C implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09C(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09cType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09cType domainObj;
     ...
     */
    public Xldft09cType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09cType domainObj) {
