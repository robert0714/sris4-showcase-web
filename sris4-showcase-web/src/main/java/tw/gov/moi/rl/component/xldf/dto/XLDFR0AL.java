...
import tw.gov.moi.domain.Xldfr0alType;
import tw.gov.moi.domain.Rldfr0alType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0alType.class ,
        entityDsName = "rldfr0alByKey" ,
        xldfEntityClass = Xldfr0alType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0alQuery", xldfDsByTrans = "xldfr0alMaxSerialNo",  xldfDsBySerialNo = "xldfr0alBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0AL", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0AL")
public class XLDFR0AL implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0AL(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0alType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0alType domainObj;
     ...
     */
    public Xldfr0alType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0alType domainObj) {
