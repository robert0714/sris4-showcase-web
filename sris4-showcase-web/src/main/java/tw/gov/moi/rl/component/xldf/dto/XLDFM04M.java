...
import tw.gov.moi.domain.Xldfm04mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm04mType.class ,
        entityDsName = "rldfm04mByKey" ,
        xldfEntityClass = Xldfm04mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm04mQuery", xldfDsByTrans = "xldfm04mMaxSerialNo",  xldfDsBySerialNo = "xldfm04mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM04M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM04M")
public class XLDFM04M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM04M(String personId ,String siteId ,String relationId ,String relationCode ,String updateDate ,String updateTime ) {
        super();
        this.domainObj = new Xldfm04mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm04mType domainObj;
     ...
     */
    public Xldfm04mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm04mType domainObj) {
