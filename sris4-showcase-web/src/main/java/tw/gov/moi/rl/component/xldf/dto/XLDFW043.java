...
import tw.gov.moi.domain.Xldfw043Type;
import tw.gov.moi.domain.Rldfw043Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw043Type.class ,
        entityDsName = "rldfw043ByKey" ,
        xldfEntityClass = Xldfw043Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw043Query", xldfDsByTrans = "xldfw043MaxSerialNo",  xldfDsBySerialNo = "xldfw043BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW043", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW043")
public class XLDFW043 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW043(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw043Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw043Type domainObj;
     ...
     */
    public Xldfw043Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw043Type domainObj) {
