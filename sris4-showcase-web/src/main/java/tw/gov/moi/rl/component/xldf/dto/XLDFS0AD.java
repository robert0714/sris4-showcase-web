...
import tw.gov.moi.domain.Xldfs0adType;
import tw.gov.moi.domain.Rldfs0adType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0adType.class ,
        entityDsName = "rldfs0adByKey" ,
        xldfEntityClass = Xldfs0adType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0adQuery", xldfDsByTrans = "xldfs0adMaxSerialNo",  xldfDsBySerialNo = "xldfs0adBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AD")
public class XLDFS0AD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0adType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0adType domainObj;
     ...
     */
    public Xldfs0adType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0adType domainObj) {
