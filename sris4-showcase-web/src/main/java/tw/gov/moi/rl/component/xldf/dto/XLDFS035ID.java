...
@XmlType(name = "XLDFS035", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS035") 
public class XLDFS035ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS035.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS035ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
