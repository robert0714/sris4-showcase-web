...
import tw.gov.moi.domain.Xldfx0admType;
import tw.gov.moi.domain.Rldfx0admType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0admType.class ,
        entityDsName = "rldfx0admByKey" ,
        xldfEntityClass = Xldfx0admType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0admQuery", xldfDsByTrans = "xldfx0admMaxSerialNo",  xldfDsBySerialNo = "xldfx0admBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0ADM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0ADM")
public class XLDFX0ADM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0ADM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0admType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0admType domainObj;
     ...
     */
    public Xldfx0admType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0admType domainObj) {
