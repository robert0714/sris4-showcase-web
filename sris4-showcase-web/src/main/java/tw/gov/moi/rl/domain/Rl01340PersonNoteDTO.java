...
@XmlType(name = "rl01340PersonNoteDTO", propOrder = { "PersonId", "PersonName", "Remark", "ClassType", "RegisterCode",
        "RegisterContent", "Note", "Selected"

})
@XmlRootElement(name = "Rl01340PersonNoteDTO")
public class Rl01340PersonNoteDTO implements Serializable, Comparable<Rl01340PersonNoteDTO> {
    /**
     * 
     */
    ...
    public String toString() {
        return "Rl01340PersonNoteDTO [personId=" + personId + ", personName=" + personName + ", remark=" + remark
                + ", classType=" + classType + ", registerCode=" + registerCode + ", registerContent="
                + registerContent + "]";
    }

    @Override
    public int compareTo(Rl01340PersonNoteDTO param) {
