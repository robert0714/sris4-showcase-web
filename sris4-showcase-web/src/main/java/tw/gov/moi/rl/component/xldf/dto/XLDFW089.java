...
import tw.gov.moi.domain.Xldfw089Type;
import tw.gov.moi.domain.Rldfw089Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw089Type.class ,
        entityDsName = "rldfw089ByKey" ,
        xldfEntityClass = Xldfw089Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw089Query", xldfDsByTrans = "xldfw089MaxSerialNo",  xldfDsBySerialNo = "xldfw089BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW089", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW089")
public class XLDFW089 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW089(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw089Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw089Type domainObj;
     ...
     */
    public Xldfw089Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw089Type domainObj) {
