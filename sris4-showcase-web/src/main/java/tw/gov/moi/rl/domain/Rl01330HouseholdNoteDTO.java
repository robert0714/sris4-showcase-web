...
@XmlType(name = "rl01330HouseholdNoteDTO", propOrder = { "HouseholdHeadId", "HouseholdHeadName", "HouseholdId",
        "Remark", "ClassType", "RegisterCode", "RegisterContent", "SiteId"

})
@XmlRootElement(name = "Rl01330HouseholdNoteDTO")
public class Rl01330HouseholdNoteDTO implements Serializable, Comparable<Rl01330HouseholdNoteDTO> {
	...
	@Override
	public int compareTo(Rl01330HouseholdNoteDTO param) {
		return new CompareToBuilder().append(this.getRemark(), param.getRemark()).append(this.getClassType(), param.getClassType()).toComparison() * -1;
	}
