...
import tw.gov.moi.domain.Xldfy077hType;
import tw.gov.moi.domain.Rldfy077hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy077hType.class ,
        entityDsName = "rldfy077hByKey" ,
        xldfEntityClass = Xldfy077hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy077hQuery", xldfDsByTrans = "xldfy077hMaxSerialNo",  xldfDsBySerialNo = "xldfy077hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY077H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY077H")
public class XLDFY077H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY077H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy077hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy077hType domainObj;
     ...
     */
    public Xldfy077hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy077hType domainObj) {
