...
import tw.gov.moi.domain.Xldfs086bType;
import tw.gov.moi.domain.Rldfs086bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs086bType.class ,
        entityDsName = "rldfs086bByKey" ,
        xldfEntityClass = Xldfs086bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs086bQuery", xldfDsByTrans = "xldfs086bMaxSerialNo",  xldfDsBySerialNo = "xldfs086bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS086B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS086B")
public class XLDFS086B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS086B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs086bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs086bType domainObj;
     ...
     */
    public Xldfs086bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs086bType domainObj) {
