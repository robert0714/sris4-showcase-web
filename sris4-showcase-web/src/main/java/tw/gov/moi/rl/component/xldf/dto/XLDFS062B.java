...
import tw.gov.moi.domain.Xldfs062bType;
import tw.gov.moi.domain.Rldfs062bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs062bType.class ,
        entityDsName = "rldfs062bByKey" ,
        xldfEntityClass = Xldfs062bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs062bQuery", xldfDsByTrans = "xldfs062bMaxSerialNo",  xldfDsBySerialNo = "xldfs062bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS062B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS062B")
public class XLDFS062B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS062B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs062bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs062bType domainObj;
     ...
     */
    public Xldfs062bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs062bType domainObj) {
