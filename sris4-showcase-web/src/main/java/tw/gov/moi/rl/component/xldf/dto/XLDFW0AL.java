...
import tw.gov.moi.domain.Xldfw0alType;
import tw.gov.moi.domain.Rldfw0alType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0alType.class ,
        entityDsName = "rldfw0alByKey" ,
        xldfEntityClass = Xldfw0alType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0alQuery", xldfDsByTrans = "xldfw0alMaxSerialNo",  xldfDsBySerialNo = "xldfw0alBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AL", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AL")
public class XLDFW0AL implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AL(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0alType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0alType domainObj;
     ...
     */
    public Xldfw0alType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0alType domainObj) {
