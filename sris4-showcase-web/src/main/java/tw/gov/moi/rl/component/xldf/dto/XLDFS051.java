...
import tw.gov.moi.domain.Rldfs051Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs051Type.class ,
        entityDsName = "rldfs051ByKey" ,
        xldfEntityClass = Xldfs051Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs051Query", xldfDsByTrans = "xldfs051MaxSerialNo",  xldfDsBySerialNo = "xldfs051BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS051", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS051")
public class XLDFS051 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS051(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs051Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs051Type domainObj;
     ...
     */
    public Xldfs051Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs051Type domainObj) {
