...
@XmlType(name = "XLDFX0A1M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX0A1M") 
public class XLDFX0A1MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX0A1M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX0A1MID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
