...
import tw.gov.moi.domain.Xldfs019bType;
import tw.gov.moi.domain.Rldfs019bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs019bType.class ,
        entityDsName = "rldfs019bByKey" ,
        xldfEntityClass = Xldfs019bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs019bQuery", xldfDsByTrans = "xldfs019bMaxSerialNo",  xldfDsBySerialNo = "xldfs019bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS019B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS019B")
public class XLDFS019B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS019B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs019bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs019bType domainObj;
     ...
     */
    public Xldfs019bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs019bType domainObj) {
