...
import tw.gov.moi.domain.Xldfm04mtType;
import tw.gov.moi.domain.Tldfm04mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm04mType.class ,
        entityDsName = "tldfm04mByKey" ,
        xldfEntityClass = Xldfm04mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm04mtQuery", xldfDsByTrans = "xldfm04mtMaxSerialNo",  xldfDsBySerialNo = "xldfm04mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM04MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM04MT")
public class XLDFM04MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM04MT(String personId ,String siteId ,String relationId ,String relationCode ,String updateDate ,String updateTime ) {
        super();
        this.domainObj = new Xldfm04mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm04mtType domainObj;
     ...
     */
    public Xldfm04mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm04mtType domainObj) {
