...
@XmlType(name = "Rl06900DTO", propOrder = { "printAll", "maleIdStart", "maleIdEnd", "femaleIdStart", "FemaleIdEnd",
        "assignDateStart", "assignDateEnd", "reportFormat", "reportURL" })
@XmlRootElement(name = "Rl06900DTO")
public class Rl06900DTO implements Serializable {
