...
@XmlType(name = "rl01825DTO", propOrder = { "lockMode", "mainPersonHouseholdData", "mainPersonData", "mainPersonRole",
        ...
        "afterPersonName", "afterLastName", "afterFirstName", "afterMidenName", "afterMarriedName", "revokeReasonCode",
        "otherRevokeReason", "revokeYyymmdd", "lawCode", "beforePersonName", "beforeLastName", "beforeFirstName",
        "beforeMidenName", "beforeMarriedName", "beforeWork", "spouseRl03100QueryShow", "certificate",
        "certificateList", "otherCertificate", "registerContent", "m10mList", "viewM10m", "viewPostiveApplication",
        "selectedM10m", "selectedPostiveApplication", "apply1", "apply2", "delegated", "householdNoteList",
...
@XmlRootElement(name = "Rl01825DTO")
public class Rl01825DTO implements Serializable {
