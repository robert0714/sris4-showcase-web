...
@XmlType(name = "XLDFT09P", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFT09P") 
public class XLDFT09PID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFT09P.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFT09PID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
