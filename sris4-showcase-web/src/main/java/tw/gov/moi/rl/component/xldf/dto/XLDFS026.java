...
import tw.gov.moi.domain.Xldfs026Type;
import tw.gov.moi.domain.Rldfs026Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs026Type.class ,
        entityDsName = "rldfs026ByKey" ,
        xldfEntityClass = Xldfs026Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs026Query", xldfDsByTrans = "xldfs026MaxSerialNo",  xldfDsBySerialNo = "xldfs026BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS026", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS026")
public class XLDFS026 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS026(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs026Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs026Type domainObj;
     ...
     */
    public Xldfs026Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs026Type domainObj) {
