...
@XmlType(name = "rl01340HouseholdNoteDTO", propOrder = { "HouseholdHeadId", "HouseholdHeadName", "HouseholdId",
        "Remark", "ClassType", "RegisterCode", "RegisterContent"

})
@XmlRootElement(name = "Rl01340HouseholdNoteDTO")
public class Rl01340HouseholdNoteDTO implements Serializable, Comparable<Rl01340HouseholdNoteDTO> {
    ...
    @Override
    public int compareTo(Rl01340HouseholdNoteDTO param) {
