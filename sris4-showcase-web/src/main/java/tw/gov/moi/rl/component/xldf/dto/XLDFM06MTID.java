...
@XmlType(name = "XLDFM06MT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM06MT") 
public class XLDFM06MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM06MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM06MTID(String trMode ,String applyMode ,String applyYyymmdd ,String applyHhmmss ,String personId ,String siteId ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(trMode, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(applyMode, StringUtils.EMPTY)));
