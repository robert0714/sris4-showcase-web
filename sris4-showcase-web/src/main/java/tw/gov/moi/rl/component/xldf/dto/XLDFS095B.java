...
import tw.gov.moi.domain.Xldfs095bType;
import tw.gov.moi.domain.Rldfs095bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs095bType.class ,
        entityDsName = "rldfs095bByKey" ,
        xldfEntityClass = Xldfs095bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs095bQuery", xldfDsByTrans = "xldfs095bMaxSerialNo",  xldfDsBySerialNo = "xldfs095bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS095B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS095B")
public class XLDFS095B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS095B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs095bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs095bType domainObj;
     ...
     */
    public Xldfs095bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs095bType domainObj) {
