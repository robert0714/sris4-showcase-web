...
import tw.gov.moi.domain.Xldfs0cabType;
import tw.gov.moi.domain.Rldfs0cabType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0cabType.class ,
        entityDsName = "rldfs0cabByKey" ,
        xldfEntityClass = Xldfs0cabType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0cabQuery", xldfDsByTrans = "xldfs0cabMaxSerialNo",  xldfDsBySerialNo = "xldfs0cabBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0CAB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0CAB")
public class XLDFS0CAB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0CAB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0cabType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0cabType domainObj;
     ...
     */
    public Xldfs0cabType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0cabType domainObj) {
