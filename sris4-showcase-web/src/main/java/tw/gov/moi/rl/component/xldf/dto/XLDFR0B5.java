...
import tw.gov.moi.domain.Xldfr0b5Type;
import tw.gov.moi.domain.Rldfr0b5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0b5Type.class ,
        entityDsName = "rldfr0b5ByKey" ,
        xldfEntityClass = Xldfr0b5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0b5Query", xldfDsByTrans = "xldfr0b5MaxSerialNo",  xldfDsBySerialNo = "xldfr0b5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0B5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0B5")
public class XLDFR0B5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0B5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0b5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0b5Type domainObj;
     ...
     */
    public Xldfr0b5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0b5Type domainObj) {
