...
import tw.gov.moi.domain.Xldfs0bdType;
import tw.gov.moi.domain.Rldfs0bdType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0bdType.class ,
        entityDsName = "rldfs0bdByKey" ,
        xldfEntityClass = Xldfs0bdType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0bdQuery", xldfDsByTrans = "xldfs0bdMaxSerialNo",  xldfDsBySerialNo = "xldfs0bdBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BD")
public class XLDFS0BD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0bdType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0bdType domainObj;
     ...
     */
    public Xldfs0bdType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0bdType domainObj) {
