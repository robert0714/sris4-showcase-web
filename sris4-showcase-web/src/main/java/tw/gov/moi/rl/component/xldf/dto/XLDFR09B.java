...
import tw.gov.moi.domain.Xldfr09bType;
import tw.gov.moi.domain.Rldfr09bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09bType.class ,
        entityDsName = "rldfr09bByKey" ,
        xldfEntityClass = Xldfr09bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09bQuery", xldfDsByTrans = "xldfr09bMaxSerialNo",  xldfDsBySerialNo = "xldfr09bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09B")
public class XLDFR09B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09B(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09bType domainObj;
     ...
     */
    public Xldfr09bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09bType domainObj) {
