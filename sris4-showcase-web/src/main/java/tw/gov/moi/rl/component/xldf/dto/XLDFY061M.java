...
import tw.gov.moi.domain.Xldfy061mType;
import tw.gov.moi.domain.Rldfy061mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy061mType.class ,
        entityDsName = "rldfy061mByKey" ,
        xldfEntityClass = Xldfy061mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy061mQuery", xldfDsByTrans = "xldfy061mMaxSerialNo",  xldfDsBySerialNo = "xldfy061mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY061M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY061M")
public class XLDFY061M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY061M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy061mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy061mType domainObj;
     ...
     */
    public Xldfy061mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy061mType domainObj) {
