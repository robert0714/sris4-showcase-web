...
@XmlType(name = "rl01380MemberDTO", propOrder = { "select", "memberPersonId", "name" })
@XmlRootElement(name = "Rl01380MemberDTO")
public class Rl01380MemberDTO implements Serializable {
