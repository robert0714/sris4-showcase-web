...
import tw.gov.moi.domain.Xldfs096Type;
import tw.gov.moi.domain.Rldfs096Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs096Type.class ,
        entityDsName = "rldfs096ByKey" ,
        xldfEntityClass = Xldfs096Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs096Query", xldfDsByTrans = "xldfs096MaxSerialNo",  xldfDsBySerialNo = "xldfs096BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS096", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS096")
public class XLDFS096 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS096(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs096Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs096Type domainObj;
     ...
     */
    public Xldfs096Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs096Type domainObj) {
