...
import tw.gov.moi.domain.Xldfw0a6Type;
import tw.gov.moi.domain.Rldfw0a6Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a6Type.class ,
        entityDsName = "rldfw0a6ByKey" ,
        xldfEntityClass = Xldfw0a6Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a6Query", xldfDsByTrans = "xldfw0a6MaxSerialNo",  xldfDsBySerialNo = "xldfw0a6BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A6", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A6")
public class XLDFW0A6 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A6(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a6Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a6Type domainObj;
     ...
     */
    public Xldfw0a6Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a6Type domainObj) {
