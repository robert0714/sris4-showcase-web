...
import tw.gov.moi.domain.Xldfy09mmType;
import tw.gov.moi.domain.Rldfy09mmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09mmType.class ,
        entityDsName = "rldfy09mmByKey" ,
        xldfEntityClass = Xldfy09mmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09mmQuery", xldfDsByTrans = "xldfy09mmMaxSerialNo",  xldfDsBySerialNo = "xldfy09mmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09MM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09MM")
public class XLDFY09MM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09MM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09mmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09mmType domainObj;
     ...
     */
    public Xldfy09mmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09mmType domainObj) {
