...
import tw.gov.moi.domain.Xldfs066bType;
import tw.gov.moi.domain.Rldfs066bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs066bType.class ,
        entityDsName = "rldfs066bByKey" ,
        xldfEntityClass = Xldfs066bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs066bQuery", xldfDsByTrans = "xldfs066bMaxSerialNo",  xldfDsBySerialNo = "xldfs066bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS066B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS066B")
public class XLDFS066B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS066B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs066bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs066bType domainObj;
     ...
     */
    public Xldfs066bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs066bType domainObj) {
