...
public class XLDF089TID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF089T.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF089TID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String applyCode ) {
        super();
