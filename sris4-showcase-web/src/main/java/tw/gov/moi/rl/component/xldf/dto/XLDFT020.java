...
import tw.gov.moi.domain.Xldft020Type;
import tw.gov.moi.domain.Rldft020Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft020Type.class ,
        entityDsName = "rldft020ByKey" ,
        xldfEntityClass = Xldft020Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft020Query", xldfDsByTrans = "xldft020MaxSerialNo",  xldfDsBySerialNo = "xldft020BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT020", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT020")
public class XLDFT020 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT020(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft020Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft020Type domainObj;
     ...
     */
    public Xldft020Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft020Type domainObj) {
