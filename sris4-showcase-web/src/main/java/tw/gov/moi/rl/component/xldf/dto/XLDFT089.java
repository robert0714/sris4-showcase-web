...
import tw.gov.moi.domain.Xldft089Type;
import tw.gov.moi.domain.Rldft089Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft089Type.class ,
        entityDsName = "rldft089ByKey" ,
        xldfEntityClass = Xldft089Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft089Query", xldfDsByTrans = "xldft089MaxSerialNo",  xldfDsBySerialNo = "xldft089BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT089", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT089")
public class XLDFT089 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT089(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft089Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft089Type domainObj;
     ...
     */
    public Xldft089Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft089Type domainObj) {
