...
@XmlType(name = "XLDFR09C", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFR09C") 
public class XLDFR09CID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFR09C.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFR09CID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
