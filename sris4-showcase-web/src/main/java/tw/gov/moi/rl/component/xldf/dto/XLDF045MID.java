...
public class XLDF045MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF045M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF045MID(String personId ,String beginYyymmdd ,String noticeYyymmdd ,String noticeHhqqss ,String siteId ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(noticeYyymmdd, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(noticeHhqqss, StringUtils.EMPTY)));
