...
import tw.gov.moi.domain.Xldfy0dimType;
import tw.gov.moi.domain.Rldfy0dimType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0dimType.class ,
        entityDsName = "rldfy0dimByKey" ,
        xldfEntityClass = Xldfy0dimType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0dimQuery", xldfDsByTrans = "xldfy0dimMaxSerialNo",  xldfDsBySerialNo = "xldfy0dimBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DIM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DIM")
public class XLDFY0DIM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DIM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0dimType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0dimType domainObj;
     ...
     */
    public Xldfy0dimType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0dimType domainObj) {
