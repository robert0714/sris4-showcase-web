...
import tw.gov.moi.domain.Xldfr0baType;
import tw.gov.moi.domain.Rldfr0baType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0baType.class ,
        entityDsName = "rldfr0baByKey" ,
        xldfEntityClass = Xldfr0baType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0baQuery", xldfDsByTrans = "xldfr0baMaxSerialNo",  xldfDsBySerialNo = "xldfr0baBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0BA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0BA")
public class XLDFR0BA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0BA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0baType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0baType domainObj;
     ...
     */
    public Xldfr0baType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0baType domainObj) {
