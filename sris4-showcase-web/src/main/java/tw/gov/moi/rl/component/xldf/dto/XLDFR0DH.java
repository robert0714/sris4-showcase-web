...
import tw.gov.moi.domain.Xldfr0dhType;
import tw.gov.moi.domain.Rldfr0dhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0dhType.class ,
        entityDsName = "rldfr0dhByKey" ,
        xldfEntityClass = Xldfr0dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0dhQuery", xldfDsByTrans = "xldfr0dhMaxSerialNo",  xldfDsBySerialNo = "xldfr0dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0DH")
public class XLDFR0DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0DH(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0dhType domainObj;
     ...
     */
    public Xldfr0dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0dhType domainObj) {
