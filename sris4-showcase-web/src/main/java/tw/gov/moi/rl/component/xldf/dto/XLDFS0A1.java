...
import tw.gov.moi.domain.Xldfs0a1Type;
import tw.gov.moi.domain.Rldfs0a1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a1Type.class ,
        entityDsName = "rldfs0a1ByKey" ,
        xldfEntityClass = Xldfs0a1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a1Query", xldfDsByTrans = "xldfs0a1MaxSerialNo",  xldfDsBySerialNo = "xldfs0a1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A1")
public class XLDFS0A1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a1Type domainObj;
     ...
     */
    public Xldfs0a1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a1Type domainObj) {
