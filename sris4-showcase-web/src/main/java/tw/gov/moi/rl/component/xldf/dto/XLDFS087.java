...
import tw.gov.moi.domain.Xldfs087Type;
import tw.gov.moi.domain.Rldfs087Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs087Type.class ,
        entityDsName = "rldfs087ByKey" ,
        xldfEntityClass = Xldfs087Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs087Query", xldfDsByTrans = "xldfs087MaxSerialNo",  xldfDsBySerialNo = "xldfs087BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS087", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS087")
public class XLDFS087 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS087(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs087Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs087Type domainObj;
     ...
     */
    public Xldfs087Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs087Type domainObj) {
