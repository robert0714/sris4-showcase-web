...
import tw.gov.moi.domain.Xldfs0c7bType;
import tw.gov.moi.domain.Rldfs0c7bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0c7bType.class ,
        entityDsName = "rldfs0c7bByKey" ,
        xldfEntityClass = Xldfs0c7bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0c7bQuery", xldfDsByTrans = "xldfs0c7bMaxSerialNo",  xldfDsBySerialNo = "xldfs0c7bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0C7B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0C7B")
public class XLDFS0C7B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0C7B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0c7bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0c7bType domainObj;
     ...
     */
    public Xldfs0c7bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0c7bType domainObj) {
