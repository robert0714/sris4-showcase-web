...
import tw.gov.moi.domain.Xldfy084mType;
import tw.gov.moi.domain.Rldfy084mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy084mType.class ,
        entityDsName = "rldfy084mByKey" ,
        xldfEntityClass = Xldfy084mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy084mQuery", xldfDsByTrans = "xldfy084mMaxSerialNo",  xldfDsBySerialNo = "xldfy084mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY084M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY084M")
public class XLDFY084M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY084M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy084mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy084mType domainObj;
     ...
     */
    public Xldfy084mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy084mType domainObj) {
