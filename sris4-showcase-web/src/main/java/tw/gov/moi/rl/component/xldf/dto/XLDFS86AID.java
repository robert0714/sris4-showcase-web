...
@XmlType(name = "XLDFS86A", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS86A") 
public class XLDFS86AID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS86A.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS86AID(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
