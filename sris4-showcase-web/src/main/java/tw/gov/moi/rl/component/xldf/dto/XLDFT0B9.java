...
import tw.gov.moi.domain.Xldft0b9Type;
import tw.gov.moi.domain.Rldft0b9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0b9Type.class ,
        entityDsName = "rldft0b9ByKey" ,
        xldfEntityClass = Xldft0b9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0b9Query", xldfDsByTrans = "xldft0b9MaxSerialNo",  xldfDsBySerialNo = "xldft0b9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0B9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0B9")
public class XLDFT0B9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0B9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0b9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0b9Type domainObj;
     ...
     */
    public Xldft0b9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0b9Type domainObj) {
