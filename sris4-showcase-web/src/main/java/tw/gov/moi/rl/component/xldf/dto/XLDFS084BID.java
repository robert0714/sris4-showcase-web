...
@XmlType(name = "XLDFS084B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS084B") 
public class XLDFS084BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS084B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS084BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
