...
@XmlType(name = "rl01330PersonNoteDTO", propOrder = { "PersonId", "PersonName", "Remark", "ClassType", "RegisterCode",
        "RegisterContent", "Note", "Selected", "SiteId"
})
@XmlRootElement(name = "Rl01330PersonNoteDTO")
public class Rl01330PersonNoteDTO implements Serializable, Comparable<Rl01330PersonNoteDTO> {
    /**
     * 
     */
    ...
    public String toString() {
        return "Rl01330PersonNoteDTO [personId=" + personId + ", personName=" + personName + ", remark=" + remark
                + ", classType=" + classType + ", registerCode=" + registerCode + ", registerContent="
                + registerContent + "]";
    }

    @Override
    public int compareTo(Rl01330PersonNoteDTO param) {
