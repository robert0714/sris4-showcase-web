...
import tw.gov.moi.domain.Xldfs099bType;
import tw.gov.moi.domain.Rldfs099bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs099bType.class ,
        entityDsName = "rldfs099bByKey" ,
        xldfEntityClass = Xldfs099bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs099bQuery", xldfDsByTrans = "xldfs099bMaxSerialNo",  xldfDsBySerialNo = "xldfs099bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS099B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS099B")
public class XLDFS099B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS099B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs099bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs099bType domainObj;
     ...
     */
    public Xldfs099bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs099bType domainObj) {
