...
import tw.gov.moi.domain.Xldfu005Type;
import tw.gov.moi.domain.Rldfu005Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfu005Type.class ,
        entityDsName = "rldfu005ByKey" ,
        xldfEntityClass = Xldfu005Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "serialNum" , length = 8),
            @XldfKeyMapping( name = "yyy" , length = 3)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfu005Query", xldfDsByTrans = "xldfu005MaxSerialNo",  xldfDsBySerialNo = "xldfu005BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFU005", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFU005")
public class XLDFU005 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFU005(String siteId ,String serialNum ,String yyy ) {
        super();
        this.domainObj = new Xldfu005Type();
        getDomainObj().setSiteId(siteId); 
        getDomainObj().setSerialNum(serialNum); 
        getDomainObj().setYyy(yyy); 
    ...
    @FieldName("XLDF領域物件")
    private Xldfu005Type domainObj;
     ...
     */
    public Xldfu005Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfu005Type domainObj) {
