 ...
 */
@RldfMappingEntity(
        value = Tldf001mType.class ,
        entityDsName = "tldf001mByKey" ,
        xldfEntityClass = Xldf001mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf001mtQuery", xldfDsByTrans = "xldf001mtMaxSerialNo",  xldfDsBySerialNo = "xldf001mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF001MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF001MT")
public class XLDF001MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF001MT(String householdHeadId ,String householdId ,String siteId ) {
        super();
        this.domainObj = new Xldf001mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf001mtType domainObj;
     ...
     */
    public Xldf001mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf001mtType domainObj) {
