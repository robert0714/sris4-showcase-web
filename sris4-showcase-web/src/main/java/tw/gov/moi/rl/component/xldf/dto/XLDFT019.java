...
import tw.gov.moi.domain.Xldft019Type;
import tw.gov.moi.domain.Rldft019Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft019Type.class ,
        entityDsName = "rldft019ByKey" ,
        xldfEntityClass = Xldft019Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft019Query", xldfDsByTrans = "xldft019MaxSerialNo",  xldfDsBySerialNo = "xldft019BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT019", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT019")
public class XLDFT019 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT019(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft019Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft019Type domainObj;
     ...
     */
    public Xldft019Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft019Type domainObj) {
