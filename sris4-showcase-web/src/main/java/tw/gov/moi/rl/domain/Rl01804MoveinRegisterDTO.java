...
public class Rl01804MoveinRegisterDTO implements Serializable {
    ...
    /** 挑選個人記事. */
    private List<Rl01804SelectRegisterDTO> personRegisterList = new ArrayList<Rl01804SelectRegisterDTO>();
     ...
     */
    public List<Rl01804SelectRegisterDTO> getPersonRegisterList() {
     ...
     */
    public void setPersonRegisterList(List<Rl01804SelectRegisterDTO> personRegisterList) {
