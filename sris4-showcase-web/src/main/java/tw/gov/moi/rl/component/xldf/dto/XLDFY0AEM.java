...
import tw.gov.moi.domain.Xldfy0aemType;
import tw.gov.moi.domain.Rldfy0aemType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0aemType.class ,
        entityDsName = "rldfy0aemByKey" ,
        xldfEntityClass = Xldfy0aemType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0aemQuery", xldfDsByTrans = "xldfy0aemMaxSerialNo",  xldfDsBySerialNo = "xldfy0aemBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0AEM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0AEM")
public class XLDFY0AEM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0AEM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0aemType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0aemType domainObj;
     ...
     */
    public Xldfy0aemType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0aemType domainObj) {
