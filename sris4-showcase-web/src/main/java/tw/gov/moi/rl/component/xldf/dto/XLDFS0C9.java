...
import tw.gov.moi.domain.Rldfs0c9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0c9Type.class ,
        entityDsName = "rldfs0c9ByKey" ,
        xldfEntityClass = Xldfs0c9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0c9Query", xldfDsByTrans = "xldfs0c9MaxSerialNo",  xldfDsBySerialNo = "xldfs0c9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0C9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0C9")
public class XLDFS0C9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0C9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0c9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0c9Type domainObj;
     ...
     */
    public Xldfs0c9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0c9Type domainObj) {
