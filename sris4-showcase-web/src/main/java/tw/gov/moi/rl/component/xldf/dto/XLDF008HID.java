...
public class XLDF008HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF008H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF008HID(String personId ,String removeYyymmdd ,String removeTime ,String specialCode ,String siteId ) {
        super();
