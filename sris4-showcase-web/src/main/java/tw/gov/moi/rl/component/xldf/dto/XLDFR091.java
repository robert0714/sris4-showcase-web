...
import tw.gov.moi.domain.Xldfr091Type;
import tw.gov.moi.domain.Rldfr091Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr091Type.class ,
        entityDsName = "rldfr091ByKey" ,
        xldfEntityClass = Xldfr091Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr091Query", xldfDsByTrans = "xldfr091MaxSerialNo",  xldfDsBySerialNo = "xldfr091BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR091", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR091")
public class XLDFR091 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR091(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr091Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr091Type domainObj;
     ...
     */
    public Xldfr091Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr091Type domainObj) {
