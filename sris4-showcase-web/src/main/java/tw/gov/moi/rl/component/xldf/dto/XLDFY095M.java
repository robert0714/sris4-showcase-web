...
import tw.gov.moi.domain.Xldfy095mType;
import tw.gov.moi.domain.Rldfy095mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy095mType.class ,
        entityDsName = "rldfy095mByKey" ,
        xldfEntityClass = Xldfy095mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy095mQuery", xldfDsByTrans = "xldfy095mMaxSerialNo",  xldfDsBySerialNo = "xldfy095mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY095M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY095M")
public class XLDFY095M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY095M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy095mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy095mType domainObj;
     ...
     */
    public Xldfy095mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy095mType domainObj) {
