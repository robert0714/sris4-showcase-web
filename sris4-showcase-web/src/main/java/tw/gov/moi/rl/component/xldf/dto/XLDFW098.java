...
import tw.gov.moi.domain.Xldfw098Type;
import tw.gov.moi.domain.Rldfw098Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw098Type.class ,
        entityDsName = "rldfw098ByKey" ,
        xldfEntityClass = Xldfw098Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw098Query", xldfDsByTrans = "xldfw098MaxSerialNo",  xldfDsBySerialNo = "xldfw098BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW098", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW098")
public class XLDFW098 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW098(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw098Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw098Type domainObj;
     ...
     */
    public Xldfw098Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw098Type domainObj) {
