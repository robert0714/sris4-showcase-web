...
import tw.gov.moi.domain.Xldfr065Type;
import tw.gov.moi.domain.Rldfr065Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr065Type.class ,
        entityDsName = "rldfr065ByKey" ,
        xldfEntityClass = Xldfr065Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr065Query", xldfDsByTrans = "xldfr065MaxSerialNo",  xldfDsBySerialNo = "xldfr065BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR065", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR065")
public class XLDFR065 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR065(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr065Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr065Type domainObj;
     ...
     */
    public Xldfr065Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr065Type domainObj) {
