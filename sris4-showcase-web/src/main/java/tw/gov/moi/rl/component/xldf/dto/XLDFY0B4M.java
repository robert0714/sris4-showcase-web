...
import tw.gov.moi.domain.Xldfy0b4mType;
import tw.gov.moi.domain.Rldfy0b4mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b4mType.class ,
        entityDsName = "rldfy0b4mByKey" ,
        xldfEntityClass = Xldfy0b4mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b4mQuery", xldfDsByTrans = "xldfy0b4mMaxSerialNo",  xldfDsBySerialNo = "xldfy0b4mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B4M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B4M")
public class XLDFY0B4M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B4M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b4mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b4mType domainObj;
     ...
     */
    public Xldfy0b4mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b4mType domainObj) {
