...
import tw.gov.moi.domain.Xldfs065Type;
import tw.gov.moi.domain.Rldfs065Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs065Type.class ,
        entityDsName = "rldfs065ByKey" ,
        xldfEntityClass = Xldfs065Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs065Query", xldfDsByTrans = "xldfs065MaxSerialNo",  xldfDsBySerialNo = "xldfs065BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS065", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS065")
public class XLDFS065 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS065(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs065Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs065Type domainObj;
     ...
     */
    public Xldfs065Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs065Type domainObj) {
