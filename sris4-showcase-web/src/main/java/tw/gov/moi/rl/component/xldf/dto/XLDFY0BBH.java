...
import tw.gov.moi.domain.Xldfy0bbhType;
import tw.gov.moi.domain.Rldfy0bbhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0bbhType.class ,
        entityDsName = "rldfy0bbhByKey" ,
        xldfEntityClass = Xldfy0bbhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0bbhQuery", xldfDsByTrans = "xldfy0bbhMaxSerialNo",  xldfDsBySerialNo = "xldfy0bbhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0BBH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0BBH")
public class XLDFY0BBH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0BBH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0bbhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0bbhType domainObj;
     ...
     */
    public Xldfy0bbhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0bbhType domainObj) {
