...
public class XLDF039SID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF039S.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF039SID(String siteId ,String statisticYyymm ,String village ,String inOutCode ,String registerTime ,String personId ,String applyTransactionId ) {
        super();
