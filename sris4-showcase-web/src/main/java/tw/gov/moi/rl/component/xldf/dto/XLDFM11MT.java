...
import tw.gov.moi.domain.Xldfm11mtType;
import tw.gov.moi.domain.Tldfm11mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm11mType.class ,
        entityDsName = "tldfm11mByKey" ,
        xldfEntityClass = Xldfm11mtType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "personId" , length = 10)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm11mtQuery", xldfDsByTrans = "xldfm11mtMaxSerialNo",  xldfDsBySerialNo = "xldfm11mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM11MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM11MT")
public class XLDFM11MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM11MT(String siteId ,String personId ) {
        super();
        this.domainObj = new Xldfm11mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm11mtType domainObj;
     ...
     */
    public Xldfm11mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm11mtType domainObj) {
