...
import tw.gov.moi.domain.Xldf058mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf058mType.class ,
        entityDsName = "rldf058mByKey" ,
        xldfEntityClass = Xldf058mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "siteId" , length = 8),
            @XldfKeyMapping( name = "birthNoticeNo" , length = 15),
            @XldfKeyMapping( name = "birthBeginYyymmdd" , length = 7)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf058mQuery", xldfDsByTrans = "xldf058mMaxSerialNo",  xldfDsBySerialNo = "xldf058mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF058M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF058M")
public class XLDF058M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF058M(String siteId ,String birthNoticeNo ,String birthBeginYyymmdd ) {
        super();
        this.domainObj = new Xldf058mType();
        getDomainObj().setSiteId(siteId); 
        getDomainObj().setBirthNoticeNo(birthNoticeNo); 
        getDomainObj().setBirthBeginYyymmdd(birthBeginYyymmdd); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf058mType domainObj;
     ...
     */
    public Xldf058mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf058mType domainObj) {
