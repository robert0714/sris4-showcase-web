...
import tw.gov.moi.domain.Xldfs018bType;
import tw.gov.moi.domain.Rldfs018bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs018bType.class ,
        entityDsName = "rldfs018bByKey" ,
        xldfEntityClass = Xldfs018bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs018bQuery", xldfDsByTrans = "xldfs018bMaxSerialNo",  xldfDsBySerialNo = "xldfs018bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS018B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS018B")
public class XLDFS018B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS018B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs018bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs018bType domainObj;
     ...
     */
    public Xldfs018bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs018bType domainObj) {
