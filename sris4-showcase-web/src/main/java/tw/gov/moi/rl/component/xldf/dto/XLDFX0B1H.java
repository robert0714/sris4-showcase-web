...
import tw.gov.moi.domain.Xldfx0b1hType;
import tw.gov.moi.domain.Rldfx0b1hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0b1hType.class ,
        entityDsName = "rldfx0b1hByKey" ,
        xldfEntityClass = Xldfx0b1hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0b1hQuery", xldfDsByTrans = "xldfx0b1hMaxSerialNo",  xldfDsBySerialNo = "xldfx0b1hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0B1H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0B1H")
public class XLDFX0B1H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0B1H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0b1hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0b1hType domainObj;
     ...
     */
    public Xldfx0b1hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0b1hType domainObj) {
