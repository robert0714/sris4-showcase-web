...
import tw.gov.moi.domain.Xldfs0diType;
import tw.gov.moi.domain.Rldfs0diType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0diType.class ,
        entityDsName = "rldfs0diByKey" ,
        xldfEntityClass = Xldfs0diType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0diQuery", xldfDsByTrans = "xldfs0diMaxSerialNo",  xldfDsBySerialNo = "xldfs0diBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DI")
public class XLDFS0DI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0diType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0diType domainObj;
     ...
     */
    public Xldfs0diType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0diType domainObj) {
