...
import tw.gov.moi.domain.Xldfw042Type;
import tw.gov.moi.domain.Rldfw042Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw042Type.class ,
        entityDsName = "rldfw042ByKey" ,
        xldfEntityClass = Xldfw042Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw042Query", xldfDsByTrans = "xldfw042MaxSerialNo",  xldfDsBySerialNo = "xldfw042BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW042", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW042")
public class XLDFW042 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW042(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw042Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw042Type domainObj;
     ...
     */
    public Xldfw042Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw042Type domainObj) {
