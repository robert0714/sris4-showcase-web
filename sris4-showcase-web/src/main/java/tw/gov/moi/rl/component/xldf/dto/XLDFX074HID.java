...
public class XLDFX074HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX074H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX074HID(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
