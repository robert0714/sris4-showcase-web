...
import tw.gov.moi.domain.Xldf022dType;
 ...
 */
@RldfMappingEntity(
        value = Rldf022dType.class ,
        entityDsName = "rldf022dByKey" ,
        xldfEntityClass = Xldf022dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf022dQuery", xldfDsByTrans = "xldf022dMaxSerialNo",  xldfDsBySerialNo = "xldf022dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF022D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF022D")
public class XLDF022D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF022D(String personId ,String siteId ,String applyYyymmdd ,String applyHhmmss ) {
        super();
        this.domainObj = new Xldf022dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf022dType domainObj;
     ...
     */
    public Xldf022dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf022dType domainObj) {
