...
import tw.gov.moi.domain.Xldfy0aehType;
import tw.gov.moi.domain.Rldfy0aehType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0aehType.class ,
        entityDsName = "rldfy0aehByKey" ,
        xldfEntityClass = Xldfy0aehType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0aehQuery", xldfDsByTrans = "xldfy0aehMaxSerialNo",  xldfDsBySerialNo = "xldfy0aehBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0AEH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0AEH")
public class XLDFY0AEH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0AEH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0aehType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0aehType domainObj;
     ...
     */
    public Xldfy0aehType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0aehType domainObj) {
