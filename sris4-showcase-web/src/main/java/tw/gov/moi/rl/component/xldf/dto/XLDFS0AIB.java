...
import tw.gov.moi.domain.Xldfs0aibType;
import tw.gov.moi.domain.Rldfs0aibType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0aibType.class ,
        entityDsName = "rldfs0aibByKey" ,
        xldfEntityClass = Xldfs0aibType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0aibQuery", xldfDsByTrans = "xldfs0aibMaxSerialNo",  xldfDsBySerialNo = "xldfs0aibBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AIB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AIB")
public class XLDFS0AIB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AIB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0aibType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0aibType domainObj;
     ...
     */
    public Xldfs0aibType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0aibType domainObj) {
