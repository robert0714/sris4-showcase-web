...
@XmlType(name = "XLDF2A10", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF2A10") 
public class XLDF2A10ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF2A10.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF2A10ID(String personId ,String siteId ) {
        super();
