...
import tw.gov.moi.domain.Xldfy09cmType;
import tw.gov.moi.domain.Rldfy09cmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09cmType.class ,
        entityDsName = "rldfy09cmByKey" ,
        xldfEntityClass = Xldfy09cmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09cmQuery", xldfDsByTrans = "xldfy09cmMaxSerialNo",  xldfDsBySerialNo = "xldfy09cmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09CM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09CM")
public class XLDFY09CM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09CM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09cmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09cmType domainObj;
     ...
     */
    public Xldfy09cmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09cmType domainObj) {
