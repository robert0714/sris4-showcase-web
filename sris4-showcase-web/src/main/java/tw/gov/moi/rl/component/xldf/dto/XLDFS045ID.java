...
@XmlType(name = "XLDFS045", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS045") 
public class XLDFS045ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS045.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS045ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
