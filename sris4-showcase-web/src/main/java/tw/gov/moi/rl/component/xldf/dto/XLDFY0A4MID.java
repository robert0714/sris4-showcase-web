...
public class XLDFY0A4MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0A4M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0A4MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
