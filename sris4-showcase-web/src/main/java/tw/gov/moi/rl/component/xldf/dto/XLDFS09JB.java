...
import tw.gov.moi.domain.Xldfs09jbType;
import tw.gov.moi.domain.Rldfs09jbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09jbType.class ,
        entityDsName = "rldfs09jbByKey" ,
        xldfEntityClass = Xldfs09jbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09jbQuery", xldfDsByTrans = "xldfs09jbMaxSerialNo",  xldfDsBySerialNo = "xldfs09jbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09JB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09JB")
public class XLDFS09JB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09JB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09jbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09jbType domainObj;
     ...
     */
    public Xldfs09jbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09jbType domainObj) {
