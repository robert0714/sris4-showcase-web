...
import tw.gov.moi.domain.Xldfs0a3bType;
import tw.gov.moi.domain.Rldfs0a3bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a3bType.class ,
        entityDsName = "rldfs0a3bByKey" ,
        xldfEntityClass = Xldfs0a3bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a3bQuery", xldfDsByTrans = "xldfs0a3bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a3bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A3B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A3B")
public class XLDFS0A3B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A3B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a3bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a3bType domainObj;
     ...
     */
    public Xldfs0a3bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a3bType domainObj) {
