...
import tw.gov.moi.domain.Xldfw0abType;
import tw.gov.moi.domain.Rldfw0abType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0abType.class ,
        entityDsName = "rldfw0abByKey" ,
        xldfEntityClass = Xldfw0abType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0abQuery", xldfDsByTrans = "xldfw0abMaxSerialNo",  xldfDsBySerialNo = "xldfw0abBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AB")
public class XLDFW0AB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0abType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0abType domainObj;
     ...
     */
    public Xldfw0abType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0abType domainObj) {
