...
public class XLDFM05HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM05H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM05HID(String personId ,String siteId ,String relationId ,String removeYyymmdd ,String removeTime ,String relationCode ) {
        super();
