...
import tw.gov.moi.domain.Xldfw024Type;
import tw.gov.moi.domain.Rldfw024Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw024Type.class ,
        entityDsName = "rldfw024ByKey" ,
        xldfEntityClass = Xldfw024Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw024Query", xldfDsByTrans = "xldfw024MaxSerialNo",  xldfDsBySerialNo = "xldfw024BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW024", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW024")
public class XLDFW024 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW024(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw024Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw024Type domainObj;
     ...
     */
    public Xldfw024Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw024Type domainObj) {
