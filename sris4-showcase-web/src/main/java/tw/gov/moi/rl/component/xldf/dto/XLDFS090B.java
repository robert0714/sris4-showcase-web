...
import tw.gov.moi.domain.Xldfs090bType;
import tw.gov.moi.domain.Rldfs090bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs090bType.class ,
        entityDsName = "rldfs090bByKey" ,
        xldfEntityClass = Xldfs090bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs090bQuery", xldfDsByTrans = "xldfs090bMaxSerialNo",  xldfDsBySerialNo = "xldfs090bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS090B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS090B")
public class XLDFS090B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS090B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs090bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs090bType domainObj;
     ...
     */
    public Xldfs090bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs090bType domainObj) {
