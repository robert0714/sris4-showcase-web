...
@XmlType(name = "XLDF030T", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF030T") 
public class XLDF030TID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF030T.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF030TID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
