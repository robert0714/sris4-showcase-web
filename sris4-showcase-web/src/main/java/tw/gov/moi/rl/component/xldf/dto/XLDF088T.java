...
import tw.gov.moi.domain.Xldf088tType;
 ...
 */
@RldfMappingEntity(
        value = Rldf088tType.class ,
        entityDsName = "rldf088tByKey" ,
        xldfEntityClass = Xldf088tType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf088tQuery", xldfDsByTrans = "xldf088tMaxSerialNo",  xldfDsBySerialNo = "xldf088tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF088T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF088T")
public class XLDF088T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF088T(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf088tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf088tType domainObj;
     ...
     */
    public Xldf088tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf088tType domainObj) {
