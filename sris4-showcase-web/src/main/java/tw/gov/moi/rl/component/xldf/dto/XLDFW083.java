...
import tw.gov.moi.domain.Xldfw083Type;
import tw.gov.moi.domain.Rldfw083Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw083Type.class ,
        entityDsName = "rldfw083ByKey" ,
        xldfEntityClass = Xldfw083Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw083Query", xldfDsByTrans = "xldfw083MaxSerialNo",  xldfDsBySerialNo = "xldfw083BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW083", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW083")
public class XLDFW083 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW083(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw083Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw083Type domainObj;
     ...
     */
    public Xldfw083Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw083Type domainObj) {
