...
public class XLDFR9EAID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFR9EA.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFR9EAID(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ,String noticeNo ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(personId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(transactionId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(sequenceId, StringUtils.EMPTY)));
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(noticeNo, StringUtils.EMPTY)));
