...
@XmlType(name = "XLDFY094M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY094M") 
public class XLDFY094MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY094M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY094MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
