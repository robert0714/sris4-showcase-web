...
public class XLDF087TID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF087T.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF087TID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
