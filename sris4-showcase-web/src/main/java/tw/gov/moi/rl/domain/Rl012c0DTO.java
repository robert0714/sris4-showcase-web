...
@XmlType(name = "rl012c0DTO", propOrder = { "nameRomanization", "openingOperationDTO", "warningMessgeList" })
@XmlRootElement(name = "Rl012c0DTO")
public class Rl012c0DTO implements Serializable {
