...
import tw.gov.moi.domain.Xldfs083bType;
import tw.gov.moi.domain.Rldfs083bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs083bType.class ,
        entityDsName = "rldfs083bByKey" ,
        xldfEntityClass = Xldfs083bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs083bQuery", xldfDsByTrans = "xldfs083bMaxSerialNo",  xldfDsBySerialNo = "xldfs083bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS083B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS083B")
public class XLDFS083B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS083B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs083bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs083bType domainObj;
     ...
     */
    public Xldfs083bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs083bType domainObj) {
