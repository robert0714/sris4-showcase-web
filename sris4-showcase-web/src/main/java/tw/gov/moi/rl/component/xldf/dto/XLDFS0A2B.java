...
import tw.gov.moi.domain.Xldfs0a2bType;
import tw.gov.moi.domain.Rldfs0a2bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a2bType.class ,
        entityDsName = "rldfs0a2bByKey" ,
        xldfEntityClass = Xldfs0a2bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a2bQuery", xldfDsByTrans = "xldfs0a2bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a2bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A2B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A2B")
public class XLDFS0A2B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A2B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a2bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a2bType domainObj;
     ...
     */
    public Xldfs0a2bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a2bType domainObj) {
