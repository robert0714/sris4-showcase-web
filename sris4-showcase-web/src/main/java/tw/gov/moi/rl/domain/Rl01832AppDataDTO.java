...
@XmlType(name = "rl01832AppDataDTO", propOrder = { "registerDate", "registerTime", "acceptAdminOfficeCode",
        ...
        "executorMOrgEducationMark", "revokeReason", "revokeYyymmdd", "certificateList", "otherCertificate",
        "bookFlag", "personForeignFlag", "fatherBookFlag", "fatherRole", "fatherBookFlag", "motherRole", "receiptId",
        "outliveCaseFlag", "educationApplySeq" })
@XmlRootElement(name = "Rl01832AppDataDTO")
public class Rl01832AppDataDTO implements Serializable {
