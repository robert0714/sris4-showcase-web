...
import tw.gov.moi.domain.Xldfw0dhType;
import tw.gov.moi.domain.Rldfw0dhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0dhType.class ,
        entityDsName = "rldfw0dhByKey" ,
        xldfEntityClass = Xldfw0dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0dhQuery", xldfDsByTrans = "xldfw0dhMaxSerialNo",  xldfDsBySerialNo = "xldfw0dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0DH")
public class XLDFW0DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0DH(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0dhType domainObj;
     ...
     */
    public Xldfw0dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0dhType domainObj) {
