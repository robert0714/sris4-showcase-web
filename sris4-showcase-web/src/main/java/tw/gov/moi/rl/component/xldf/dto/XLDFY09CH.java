...
import tw.gov.moi.domain.Xldfy09chType;
import tw.gov.moi.domain.Rldfy09chType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09chType.class ,
        entityDsName = "rldfy09chByKey" ,
        xldfEntityClass = Xldfy09chType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09chQuery", xldfDsByTrans = "xldfy09chMaxSerialNo",  xldfDsBySerialNo = "xldfy09chBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09CH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09CH")
public class XLDFY09CH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09CH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09chType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09chType domainObj;
     ...
     */
    public Xldfy09chType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09chType domainObj) {
