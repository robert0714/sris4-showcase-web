...
import tw.gov.moi.domain.Xldfr073Type;
import tw.gov.moi.domain.Rldfr073Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr073Type.class ,
        entityDsName = "rldfr073ByKey" ,
        xldfEntityClass = Xldfr073Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr073Query", xldfDsByTrans = "xldfr073MaxSerialNo",  xldfDsBySerialNo = "xldfr073BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR073", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR073")
public class XLDFR073 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR073(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr073Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr073Type domainObj;
     ...
     */
    public Xldfr073Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr073Type domainObj) {
