...
import tw.gov.moi.domain.Xldft027Type;
import tw.gov.moi.domain.Rldft027Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft027Type.class ,
        entityDsName = "rldft027ByKey" ,
        xldfEntityClass = Xldft027Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft027Query", xldfDsByTrans = "xldft027MaxSerialNo",  xldfDsBySerialNo = "xldft027BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT027", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT027")
public class XLDFT027 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT027(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft027Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft027Type domainObj;
     ...
     */
    public Xldft027Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft027Type domainObj) {
