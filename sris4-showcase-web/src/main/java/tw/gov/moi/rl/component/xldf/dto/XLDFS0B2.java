...
import tw.gov.moi.domain.Xldfs0b2Type;
import tw.gov.moi.domain.Rldfs0b2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b2Type.class ,
        entityDsName = "rldfs0b2ByKey" ,
        xldfEntityClass = Xldfs0b2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b2Query", xldfDsByTrans = "xldfs0b2MaxSerialNo",  xldfDsBySerialNo = "xldfs0b2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B2")
public class XLDFS0B2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0b2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b2Type domainObj;
     ...
     */
    public Xldfs0b2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b2Type domainObj) {
