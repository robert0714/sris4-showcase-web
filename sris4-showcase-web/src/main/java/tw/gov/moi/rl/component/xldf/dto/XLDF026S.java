...
import tw.gov.moi.domain.Xldf026sType;
import tw.gov.moi.domain.Rldf026sType;
 ...
 */
@RldfMappingEntity(
        value = Rldf026sType.class ,
        entityDsName = "rldf026sByKey" ,
        xldfEntityClass = Xldf026sType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf026sQuery", xldfDsByTrans = "xldf026sMaxSerialNo",  xldfDsBySerialNo = "xldf026sBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF026S", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF026S")
public class XLDF026S implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF026S(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldf026sType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf026sType domainObj;
     ...
     */
    public Xldf026sType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf026sType domainObj) {
