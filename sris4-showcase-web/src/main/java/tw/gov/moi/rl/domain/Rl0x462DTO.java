...
@XmlType(name = "rl0x462DTO", propOrder = { "mainDTO", "editResult", "quertDto", "selectData", "resutlts", "title",
        "reason", "commononType", "lockData", "verify", "checkCode", "unLockData", "rightData" })
@XmlRootElement(name = "Rl0x462DTO")
public class Rl0x462DTO implements Serializable {
    ...
    @FieldName("R檔預設值")
    private Rldft062Type commononType = null;
    ...
    @FieldName("右側的資料")
    private Rldft062Type rightData = null;
    ...
    public Rldft062Type getCommononType() {
        return commononType;
    }

    public void setCommononType(Rldft062Type commononType) {
    ...
    public Rldft062Type getRightData() {
        return rightData;
    }

    public void setRightData(Rldft062Type rightData) {
