...
/**
 * The Class Rl02730PersonDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl02730PersonDTO", propOrder = { "personId", "personName", "birthYyymmdd", "militaryCode", "father", "mother", "spouse", "birthOrderSex", "relationship", "personNoteDTOList", "siteId" })
@XmlRootElement(name = "Rl02730PersonDTO")
public class Rl02730PersonDTO implements Serializable {
