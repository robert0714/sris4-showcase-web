...
import tw.gov.moi.domain.Xldfm04hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm04hType.class ,
        entityDsName = "rldfm04hByKey" ,
        xldfEntityClass = Xldfm04hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm04hQuery", xldfDsByTrans = "xldfm04hMaxSerialNo",  xldfDsBySerialNo = "xldfm04hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM04H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM04H")
public class XLDFM04H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM04H(String personId ,String siteId ,String relationId ,String relationCode ,String updateDate ,String updateTime ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldfm04hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm04hType domainObj;
     ...
     */
    public Xldfm04hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm04hType domainObj) {
