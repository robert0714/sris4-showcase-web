...
import tw.gov.moi.domain.Xldfy099mType;
import tw.gov.moi.domain.Rldfy099mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy099mType.class ,
        entityDsName = "rldfy099mByKey" ,
        xldfEntityClass = Xldfy099mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy099mQuery", xldfDsByTrans = "xldfy099mMaxSerialNo",  xldfDsBySerialNo = "xldfy099mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY099M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY099M")
public class XLDFY099M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY099M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy099mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy099mType domainObj;
     ...
     */
    public Xldfy099mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy099mType domainObj) {
