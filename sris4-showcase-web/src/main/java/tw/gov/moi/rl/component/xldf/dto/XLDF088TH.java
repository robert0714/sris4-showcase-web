...
import tw.gov.moi.domain.Xldf088thType;
 ...
 */
@RldfMappingEntity(
        value = Rldf088thType.class ,
        entityDsName = "rldf088thByKey" ,
        xldfEntityClass = Xldf088thType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf088thQuery", xldfDsByTrans = "xldf088thMaxSerialNo",  xldfDsBySerialNo = "xldf088thBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF088TH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF088TH")
public class XLDF088TH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF088TH(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldf088thType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf088thType domainObj;
     ...
     */
    public Xldf088thType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf088thType domainObj) {
