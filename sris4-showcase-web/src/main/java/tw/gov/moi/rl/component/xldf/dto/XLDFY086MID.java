...
@XmlType(name = "XLDFY086M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY086M") 
public class XLDFY086MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY086M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY086MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
