...
import tw.gov.moi.domain.Xldfw095Type;
import tw.gov.moi.domain.Rldfw095Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw095Type.class ,
        entityDsName = "rldfw095ByKey" ,
        xldfEntityClass = Xldfw095Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw095Query", xldfDsByTrans = "xldfw095MaxSerialNo",  xldfDsBySerialNo = "xldfw095BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW095", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW095")
public class XLDFW095 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW095(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw095Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw095Type domainObj;
     ...
     */
    public Xldfw095Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw095Type domainObj) {
