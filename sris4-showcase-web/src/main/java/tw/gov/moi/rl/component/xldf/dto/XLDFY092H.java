...
import tw.gov.moi.domain.Xldfy092hType;
import tw.gov.moi.domain.Rldfy092hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy092hType.class ,
        entityDsName = "rldfy092hByKey" ,
        xldfEntityClass = Xldfy092hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy092hQuery", xldfDsByTrans = "xldfy092hMaxSerialNo",  xldfDsBySerialNo = "xldfy092hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY092H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY092H")
public class XLDFY092H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY092H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy092hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy092hType domainObj;
     ...
     */
    public Xldfy092hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy092hType domainObj) {
