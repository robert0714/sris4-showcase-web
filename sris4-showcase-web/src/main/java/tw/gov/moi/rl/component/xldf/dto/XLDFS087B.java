...
import tw.gov.moi.domain.Xldfs087bType;
import tw.gov.moi.domain.Rldfs087bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs087bType.class ,
        entityDsName = "rldfs087bByKey" ,
        xldfEntityClass = Xldfs087bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs087bQuery", xldfDsByTrans = "xldfs087bMaxSerialNo",  xldfDsBySerialNo = "xldfs087bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS087B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS087B")
public class XLDFS087B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS087B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs087bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs087bType domainObj;
     ...
     */
    public Xldfs087bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs087bType domainObj) {
