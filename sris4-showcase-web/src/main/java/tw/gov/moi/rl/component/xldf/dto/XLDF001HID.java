...
public class XLDF001HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF001H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF001HID(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String siteId ) {
        super();
