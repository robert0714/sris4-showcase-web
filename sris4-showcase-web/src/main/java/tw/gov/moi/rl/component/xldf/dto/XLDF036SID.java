...
public class XLDF036SID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF036S.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF036SID(String registerDate ,String registerTime ,String taskCode ,String applyTransactionId ,Integer applySequenceId ,Integer applySeq ,String siteId ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(taskCode, StringUtils.EMPTY)));
