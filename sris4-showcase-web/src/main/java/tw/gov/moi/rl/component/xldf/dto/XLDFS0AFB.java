...
import tw.gov.moi.domain.Xldfs0afbType;
import tw.gov.moi.domain.Rldfs0afbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0afbType.class ,
        entityDsName = "rldfs0afbByKey" ,
        xldfEntityClass = Xldfs0afbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0afbQuery", xldfDsByTrans = "xldfs0afbMaxSerialNo",  xldfDsBySerialNo = "xldfs0afbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AFB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AFB")
public class XLDFS0AFB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AFB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0afbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0afbType domainObj;
     ...
     */
    public Xldfs0afbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0afbType domainObj) {
