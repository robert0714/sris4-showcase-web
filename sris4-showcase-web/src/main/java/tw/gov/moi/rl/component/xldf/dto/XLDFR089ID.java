...
@XmlType(name = "XLDFR089", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFR089") 
public class XLDFR089ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFR089.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFR089ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
