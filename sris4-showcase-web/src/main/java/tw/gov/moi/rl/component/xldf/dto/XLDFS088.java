...
import tw.gov.moi.domain.Xldfs088Type;
import tw.gov.moi.domain.Rldfs088Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs088Type.class ,
        entityDsName = "rldfs088ByKey" ,
        xldfEntityClass = Xldfs088Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs088Query", xldfDsByTrans = "xldfs088MaxSerialNo",  xldfDsBySerialNo = "xldfs088BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS088", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS088")
public class XLDFS088 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS088(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs088Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs088Type domainObj;
     ...
     */
    public Xldfs088Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs088Type domainObj) {
