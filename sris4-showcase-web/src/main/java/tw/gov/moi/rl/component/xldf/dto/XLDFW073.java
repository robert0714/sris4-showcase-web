...
import tw.gov.moi.domain.Xldfw073Type;
import tw.gov.moi.domain.Rldfw073Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw073Type.class ,
        entityDsName = "rldfw073ByKey" ,
        xldfEntityClass = Xldfw073Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw073Query", xldfDsByTrans = "xldfw073MaxSerialNo",  xldfDsBySerialNo = "xldfw073BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW073", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW073")
public class XLDFW073 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW073(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw073Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw073Type domainObj;
     ...
     */
    public Xldfw073Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw073Type domainObj) {
