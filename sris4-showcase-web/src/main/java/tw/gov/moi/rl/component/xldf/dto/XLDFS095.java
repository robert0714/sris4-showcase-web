...
import tw.gov.moi.domain.Xldfs095Type;
import tw.gov.moi.domain.Rldfs095Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs095Type.class ,
        entityDsName = "rldfs095ByKey" ,
        xldfEntityClass = Xldfs095Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs095Query", xldfDsByTrans = "xldfs095MaxSerialNo",  xldfDsBySerialNo = "xldfs095BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS095", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS095")
public class XLDFS095 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS095(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs095Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs095Type domainObj;
     ...
     */
    public Xldfs095Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs095Type domainObj) {
