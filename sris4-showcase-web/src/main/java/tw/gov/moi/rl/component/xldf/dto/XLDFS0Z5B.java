...
import tw.gov.moi.domain.Xldfs0z5bType;
import tw.gov.moi.domain.Rldfs0z5bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0z5bType.class ,
        entityDsName = "rldfs0z5bByKey" ,
        xldfEntityClass = Xldfs0z5bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0z5bQuery", xldfDsByTrans = "xldfs0z5bMaxSerialNo",  xldfDsBySerialNo = "xldfs0z5bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0Z5B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0Z5B")
public class XLDFS0Z5B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0Z5B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0z5bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0z5bType domainObj;
     ...
     */
    public Xldfs0z5bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0z5bType domainObj) {
