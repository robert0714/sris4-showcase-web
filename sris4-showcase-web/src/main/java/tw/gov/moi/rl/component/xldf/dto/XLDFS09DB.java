...
import tw.gov.moi.domain.Xldfs09dbType;
import tw.gov.moi.domain.Rldfs09dbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09dbType.class ,
        entityDsName = "rldfs09dbByKey" ,
        xldfEntityClass = Xldfs09dbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09dbQuery", xldfDsByTrans = "xldfs09dbMaxSerialNo",  xldfDsBySerialNo = "xldfs09dbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09DB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09DB")
public class XLDFS09DB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09DB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09dbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09dbType domainObj;
     ...
     */
    public Xldfs09dbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09dbType domainObj) {
