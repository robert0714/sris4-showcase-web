...
@XmlType(name = "XLDFY0BDH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0BDH") 
public class XLDFY0BDHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0BDH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0BDHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
