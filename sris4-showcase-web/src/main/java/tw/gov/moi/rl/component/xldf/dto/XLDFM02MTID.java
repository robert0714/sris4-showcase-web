...
@XmlType(name = "XLDFM02MT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM02MT") 
public class XLDFM02MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM02MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM02MTID(String personId ,String siteId ,String spouseId ,String updateYyymmdd ,String updateHhmmss ) {
        super();
