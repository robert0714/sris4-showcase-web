 ...
 */
@RldfMappingEntity(
        value = Rldf009eType.class ,
        entityDsName = "rldf009eByKey" ,
        xldfEntityClass = Xldf009eType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "fineTransactionId" , length = 22),
            @XldfKeyMapping( name = "acceptSiteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf009eQuery", xldfDsByTrans = "xldf009eMaxSerialNo",  xldfDsBySerialNo = "xldf009eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF009E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF009E")
public class XLDF009E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF009E(String fineTransactionId ,String acceptSiteId ) {
        super();
        this.domainObj = new Xldf009eType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf009eType domainObj;
     ...
     */
    public Xldf009eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf009eType domainObj) {
