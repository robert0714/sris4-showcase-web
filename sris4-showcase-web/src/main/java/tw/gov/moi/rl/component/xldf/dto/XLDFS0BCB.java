...
import tw.gov.moi.domain.Xldfs0bcbType;
import tw.gov.moi.domain.Rldfs0bcbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0bcbType.class ,
        entityDsName = "rldfs0bcbByKey" ,
        xldfEntityClass = Xldfs0bcbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0bcbQuery", xldfDsByTrans = "xldfs0bcbMaxSerialNo",  xldfDsBySerialNo = "xldfs0bcbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BCB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BCB")
public class XLDFS0BCB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BCB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0bcbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0bcbType domainObj;
     ...
     */
    public Xldfs0bcbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0bcbType domainObj) {
