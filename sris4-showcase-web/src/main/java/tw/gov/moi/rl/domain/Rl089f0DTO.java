...
@XmlType(name = "Rl089f0DTO", propOrder = { "county", "fileURL", "initTime", "month", "reportFormat", "reportUrl",
        "town", "transactionId", "userId", "year" })
@XmlRootElement(name = "Rl089f0DTO")
public class Rl089f0DTO implements Serializable {
