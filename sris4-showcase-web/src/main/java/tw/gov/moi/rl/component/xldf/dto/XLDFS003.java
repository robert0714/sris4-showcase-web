...
import tw.gov.moi.domain.Xldfs003Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs003Type.class ,
        entityDsName = "rldfs003ByKey" ,
        xldfEntityClass = Xldfs003Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs003Query", xldfDsByTrans = "xldfs003MaxSerialNo",  xldfDsBySerialNo = "xldfs003BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS003", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS003")
public class XLDFS003 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS003(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs003Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs003Type domainObj;
     ...
     */
    public Xldfs003Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs003Type domainObj) {
