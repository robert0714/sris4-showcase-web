...
import tw.gov.moi.domain.Xldf006hType;
 ...
 */
@RldfMappingEntity(
        value = Rldf006hType.class ,
        entityDsName = "rldf006hByKey" ,
        xldfEntityClass = Xldf006hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf006hQuery", xldfDsByTrans = "xldf006hMaxSerialNo",  xldfDsBySerialNo = "xldf006hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF006H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF006H")
public class XLDF006H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF006H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf006hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf006hType domainObj;
     ...
     */
    public Xldf006hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf006hType domainObj) {
