...
import tw.gov.moi.domain.Xldfx09dhType;
import tw.gov.moi.domain.Rldfx09dhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09dhType.class ,
        entityDsName = "rldfx09dhByKey" ,
        xldfEntityClass = Xldfx09dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09dhQuery", xldfDsByTrans = "xldfx09dhMaxSerialNo",  xldfDsBySerialNo = "xldfx09dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09DH")
public class XLDFX09DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09DH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09dhType domainObj;
     ...
     */
    public Xldfx09dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09dhType domainObj) {
