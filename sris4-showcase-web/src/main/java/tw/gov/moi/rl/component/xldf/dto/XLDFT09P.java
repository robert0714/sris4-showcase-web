...
import tw.gov.moi.domain.Xldft09pType;
import tw.gov.moi.domain.Rldft09pType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09pType.class ,
        entityDsName = "rldft09pByKey" ,
        xldfEntityClass = Xldft09pType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09pQuery", xldfDsByTrans = "xldft09pMaxSerialNo",  xldfDsBySerialNo = "xldft09pBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09P", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09P")
public class XLDFT09P implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09P(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09pType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09pType domainObj;
     ...
     */
    public Xldft09pType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09pType domainObj) {
