...
import tw.gov.moi.domain.Xldfx074mType;
import tw.gov.moi.domain.Rldfx074mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx074mType.class ,
        entityDsName = "rldfx074mByKey" ,
        xldfEntityClass = Xldfx074mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx074mQuery", xldfDsByTrans = "xldfx074mMaxSerialNo",  xldfDsBySerialNo = "xldfx074mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX074M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX074M")
public class XLDFX074M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX074M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx074mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx074mType domainObj;
     ...
     */
    public Xldfx074mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx074mType domainObj) {
