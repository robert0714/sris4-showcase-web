 ...
 */
@RldfMappingEntity(
        value = Rldf001hType.class ,
        entityDsName = "rldf001hByKey" ,
        xldfEntityClass = Xldf001hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf001hQuery", xldfDsByTrans = "xldf001hMaxSerialNo",  xldfDsBySerialNo = "xldf001hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF001H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF001H")
public class XLDF001H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF001H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String siteId ) {
        super();
        this.domainObj = new Xldf001hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf001hType domainObj;
     ...
     */
    public Xldf001hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf001hType domainObj) {
