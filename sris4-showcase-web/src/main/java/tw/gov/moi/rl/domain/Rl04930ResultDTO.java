...
@XmlType(name = "Rl04930ResultDTO", propOrder = { "siteId", "adminOfficeCode", "regStreetDoor", "stdStreetDoor",
        "checkRange" })
@XmlRootElement(name = "Rl04930ResultDTO")
public class Rl04930ResultDTO implements Serializable {
