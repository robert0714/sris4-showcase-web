...
import tw.gov.moi.domain.Xldfm01mtType;
import tw.gov.moi.domain.Tldfm01mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm01mType.class ,
        entityDsName = "tldfm01mByKey" ,
        xldfEntityClass = Xldfm01mtType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm01mtQuery", xldfDsByTrans = "xldfm01mtMaxSerialNo",  xldfDsBySerialNo = "xldfm01mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM01MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM01MT")
public class XLDFM01MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM01MT(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm01mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm01mtType domainObj;
     ...
     */
    public Xldfm01mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm01mtType domainObj) {
