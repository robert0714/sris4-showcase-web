...
import tw.gov.moi.domain.Xldft073Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft073Type.class ,
        entityDsName = "rldft073ByKey" ,
        xldfEntityClass = Xldft073Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft073Query", xldfDsByTrans = "xldft073MaxSerialNo",  xldfDsBySerialNo = "xldft073BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT073", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT073")
public class XLDFT073 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT073(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft073Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft073Type domainObj;
     ...
     */
    public Xldft073Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft073Type domainObj) {
