...
import tw.gov.moi.domain.Xldf017dType;
 ...
 */
@RldfMappingEntity(
        value = Rldf017dType.class ,
        entityDsName = "rldf017dByKey" ,
        xldfEntityClass = Xldf017dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf017dQuery", xldfDsByTrans = "xldf017dMaxSerialNo",  xldfDsBySerialNo = "xldf017dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF017D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF017D")
public class XLDF017D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF017D(String personId ,String applyYyymmdd ,String applyHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf017dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf017dType domainObj;
     ...
     */
    public Xldf017dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf017dType domainObj) {
