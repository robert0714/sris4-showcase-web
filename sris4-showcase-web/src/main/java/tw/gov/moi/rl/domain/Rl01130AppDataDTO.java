...
/**
 * The Class Rl01130AppDataDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl01130AppDataDTO", propOrder = { "changeTitle", "registerDate", "registerTime",
...
@XmlRootElement(name = "Rl01130AppDataDTO")
public class Rl01130AppDataDTO implements Serializable {
