...
import tw.gov.moi.domain.Xldfw020Type;
import tw.gov.moi.domain.Rldfw020Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw020Type.class ,
        entityDsName = "rldfw020ByKey" ,
        xldfEntityClass = Xldfw020Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw020Query", xldfDsByTrans = "xldfw020MaxSerialNo",  xldfDsBySerialNo = "xldfw020BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW020", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW020")
public class XLDFW020 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW020(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw020Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw020Type domainObj;
     ...
     */
    public Xldfw020Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw020Type domainObj) {
