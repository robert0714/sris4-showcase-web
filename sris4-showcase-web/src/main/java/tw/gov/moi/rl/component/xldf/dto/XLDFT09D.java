...
import tw.gov.moi.domain.Xldft09dType;
import tw.gov.moi.domain.Rldft09dType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09dType.class ,
        entityDsName = "rldft09dByKey" ,
        xldfEntityClass = Xldft09dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09dQuery", xldfDsByTrans = "xldft09dMaxSerialNo",  xldfDsBySerialNo = "xldft09dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09D")
public class XLDFT09D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09D(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09dType domainObj;
     ...
     */
    public Xldft09dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09dType domainObj) {
