...
import tw.gov.moi.domain.Xldft0d1Type;
import tw.gov.moi.domain.Rldft0d1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0d1Type.class ,
        entityDsName = "rldft0d1ByKey" ,
        xldfEntityClass = Xldft0d1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0d1Query", xldfDsByTrans = "xldft0d1MaxSerialNo",  xldfDsBySerialNo = "xldft0d1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0D1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0D1")
public class XLDFT0D1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0D1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0d1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0d1Type domainObj;
     ...
     */
    public Xldft0d1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0d1Type domainObj) {
