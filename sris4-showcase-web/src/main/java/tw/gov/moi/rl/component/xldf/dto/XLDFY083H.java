...
import tw.gov.moi.domain.Xldfy083hType;
import tw.gov.moi.domain.Rldfy083hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy083hType.class ,
        entityDsName = "rldfy083hByKey" ,
        xldfEntityClass = Xldfy083hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy083hQuery", xldfDsByTrans = "xldfy083hMaxSerialNo",  xldfDsBySerialNo = "xldfy083hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY083H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY083H")
public class XLDFY083H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY083H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy083hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy083hType domainObj;
     ...
     */
    public Xldfy083hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy083hType domainObj) {
