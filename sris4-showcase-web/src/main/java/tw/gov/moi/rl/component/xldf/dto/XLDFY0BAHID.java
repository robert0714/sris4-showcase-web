...
@XmlType(name = "XLDFY0BAH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0BAH") 
public class XLDFY0BAHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0BAH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0BAHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
