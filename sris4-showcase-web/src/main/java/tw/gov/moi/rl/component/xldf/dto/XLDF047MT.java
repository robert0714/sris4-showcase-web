...
import tw.gov.moi.domain.Xldf047mtType;
 ...
 */
@RldfMappingEntity(
        value = Tldf047mType.class ,
        entityDsName = "tldf047mByKey" ,
        xldfEntityClass = Xldf047mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf047mtQuery", xldfDsByTrans = "xldf047mtMaxSerialNo",  xldfDsBySerialNo = "xldf047mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF047MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF047MT")
public class XLDF047MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF047MT(String personId ,String seqNo ,String siteId ) {
        super();
        this.domainObj = new Xldf047mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf047mtType domainObj;
     ...
     */
    public Xldf047mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf047mtType domainObj) {
