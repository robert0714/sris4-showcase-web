...
import tw.gov.moi.domain.Xldfr0caType;
import tw.gov.moi.domain.Rldfr0caType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0caType.class ,
        entityDsName = "rldfr0caByKey" ,
        xldfEntityClass = Xldfr0caType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0caQuery", xldfDsByTrans = "xldfr0caMaxSerialNo",  xldfDsBySerialNo = "xldfr0caBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0CA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0CA")
public class XLDFR0CA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0CA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0caType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0caType domainObj;
     ...
     */
    public Xldfr0caType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0caType domainObj) {
