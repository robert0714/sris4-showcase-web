...
import tw.gov.moi.domain.Xldfw0a5Type;
import tw.gov.moi.domain.Rldfw0a5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a5Type.class ,
        entityDsName = "rldfw0a5ByKey" ,
        xldfEntityClass = Xldfw0a5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a5Query", xldfDsByTrans = "xldfw0a5MaxSerialNo",  xldfDsBySerialNo = "xldfw0a5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A5")
public class XLDFW0A5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a5Type domainObj;
     ...
     */
    public Xldfw0a5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a5Type domainObj) {
