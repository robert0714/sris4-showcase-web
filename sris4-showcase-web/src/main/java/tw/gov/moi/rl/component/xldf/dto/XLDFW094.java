...
import tw.gov.moi.domain.Xldfw094Type;
import tw.gov.moi.domain.Rldfw094Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw094Type.class ,
        entityDsName = "rldfw094ByKey" ,
        xldfEntityClass = Xldfw094Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw094Query", xldfDsByTrans = "xldfw094MaxSerialNo",  xldfDsBySerialNo = "xldfw094BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW094", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW094")
public class XLDFW094 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW094(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw094Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw094Type domainObj;
     ...
     */
    public Xldfw094Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw094Type domainObj) {
