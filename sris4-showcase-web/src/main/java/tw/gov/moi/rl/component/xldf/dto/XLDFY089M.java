...
import tw.gov.moi.domain.Xldfy089mType;
import tw.gov.moi.domain.Rldfy089mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy089mType.class ,
        entityDsName = "rldfy089mByKey" ,
        xldfEntityClass = Xldfy089mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy089mQuery", xldfDsByTrans = "xldfy089mMaxSerialNo",  xldfDsBySerialNo = "xldfy089mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY089M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY089M")
public class XLDFY089M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY089M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy089mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy089mType domainObj;
     ...
     */
    public Xldfy089mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy089mType domainObj) {
