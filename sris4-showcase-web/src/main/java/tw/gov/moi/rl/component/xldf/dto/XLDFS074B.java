...
import tw.gov.moi.domain.Xldfs074bType;
import tw.gov.moi.domain.Rldfs074bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs074bType.class ,
        entityDsName = "rldfs074bByKey" ,
        xldfEntityClass = Xldfs074bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs074bQuery", xldfDsByTrans = "xldfs074bMaxSerialNo",  xldfDsBySerialNo = "xldfs074bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS074B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS074B")
public class XLDFS074B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS074B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs074bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs074bType domainObj;
     ...
     */
    public Xldfs074bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs074bType domainObj) {
