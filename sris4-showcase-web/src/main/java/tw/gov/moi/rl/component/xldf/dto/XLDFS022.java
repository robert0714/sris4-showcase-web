...
import tw.gov.moi.domain.Xldfs022Type;
import tw.gov.moi.domain.Rldfs022Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs022Type.class ,
        entityDsName = "rldfs022ByKey" ,
        xldfEntityClass = Xldfs022Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs022Query", xldfDsByTrans = "xldfs022MaxSerialNo",  xldfDsBySerialNo = "xldfs022BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS022", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS022")
public class XLDFS022 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS022(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs022Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs022Type domainObj;
     ...
     */
    public Xldfs022Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs022Type domainObj) {
