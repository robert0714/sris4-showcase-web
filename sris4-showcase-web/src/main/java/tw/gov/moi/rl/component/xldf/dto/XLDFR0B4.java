...
import tw.gov.moi.domain.Xldfr0b4Type;
import tw.gov.moi.domain.Rldfr0b4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0b4Type.class ,
        entityDsName = "rldfr0b4ByKey" ,
        xldfEntityClass = Xldfr0b4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0b4Query", xldfDsByTrans = "xldfr0b4MaxSerialNo",  xldfDsBySerialNo = "xldfr0b4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0B4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0B4")
public class XLDFR0B4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0B4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0b4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0b4Type domainObj;
     ...
     */
    public Xldfr0b4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0b4Type domainObj) {
