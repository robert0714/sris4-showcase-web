...
@XmlType(name = "XLDFS09BB", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS09BB") 
public class XLDFS09BBID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS09BB.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS09BBID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
