...
import tw.gov.moi.domain.Rldfs043Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs043Type.class ,
        entityDsName = "rldfs043ByKey" ,
        xldfEntityClass = Xldfs043Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs043Query", xldfDsByTrans = "xldfs043MaxSerialNo",  xldfDsBySerialNo = "xldfs043BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS043", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS043")
public class XLDFS043 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS043(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs043Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs043Type domainObj;
     ...
     */
    public Xldfs043Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs043Type domainObj) {
