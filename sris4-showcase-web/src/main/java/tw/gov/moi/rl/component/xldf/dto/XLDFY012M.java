...
import tw.gov.moi.domain.Xldfy012mType;
import tw.gov.moi.domain.Rldfy012mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy012mType.class ,
        entityDsName = "rldfy012mByKey" ,
        xldfEntityClass = Xldfy012mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy012mQuery", xldfDsByTrans = "xldfy012mMaxSerialNo",  xldfDsBySerialNo = "xldfy012mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY012M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY012M")
public class XLDFY012M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY012M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy012mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy012mType domainObj;
     ...
     */
    public Xldfy012mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy012mType domainObj) {
