...
import tw.gov.moi.domain.Xldfw09jType;
import tw.gov.moi.domain.Rldfw09jType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09jType.class ,
        entityDsName = "rldfw09jByKey" ,
        xldfEntityClass = Xldfw09jType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09jQuery", xldfDsByTrans = "xldfw09jMaxSerialNo",  xldfDsBySerialNo = "xldfw09jBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09J", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09J")
public class XLDFW09J implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09J(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09jType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09jType domainObj;
     ...
     */
    public Xldfw09jType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09jType domainObj) {
