...
import tw.gov.moi.domain.Xldfx094mType;
import tw.gov.moi.domain.Rldfx094mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx094mType.class ,
        entityDsName = "rldfx094mByKey" ,
        xldfEntityClass = Xldfx094mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx094mQuery", xldfDsByTrans = "xldfx094mMaxSerialNo",  xldfDsBySerialNo = "xldfx094mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX094M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX094M")
public class XLDFX094M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX094M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx094mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx094mType domainObj;
     ...
     */
    public Xldfx094mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx094mType domainObj) {
