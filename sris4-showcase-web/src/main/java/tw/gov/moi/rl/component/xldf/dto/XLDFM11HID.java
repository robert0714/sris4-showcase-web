...
@XmlType(name = "XLDFM11H", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM11H") 
public class XLDFM11HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM11H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM11HID(String siteId ,String removeYyymmdd ,String removeTime ,String personId ) {
        super();
