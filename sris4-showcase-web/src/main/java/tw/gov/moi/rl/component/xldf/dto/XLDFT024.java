...
import tw.gov.moi.domain.Xldft024Type;
import tw.gov.moi.domain.Rldft024Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft024Type.class ,
        entityDsName = "rldft024ByKey" ,
        xldfEntityClass = Xldft024Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft024Query", xldfDsByTrans = "xldft024MaxSerialNo",  xldfDsBySerialNo = "xldft024BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT024", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT024")
public class XLDFT024 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT024(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft024Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft024Type domainObj;
     ...
     */
    public Xldft024Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft024Type domainObj) {
