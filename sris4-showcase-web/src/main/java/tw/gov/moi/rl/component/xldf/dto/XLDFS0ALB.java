...
import tw.gov.moi.domain.Xldfs0albType;
import tw.gov.moi.domain.Rldfs0albType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0albType.class ,
        entityDsName = "rldfs0albByKey" ,
        xldfEntityClass = Xldfs0albType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0albQuery", xldfDsByTrans = "xldfs0albMaxSerialNo",  xldfDsBySerialNo = "xldfs0albBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0ALB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0ALB")
public class XLDFS0ALB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0ALB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0albType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0albType domainObj;
     ...
     */
    public Xldfs0albType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0albType domainObj) {
