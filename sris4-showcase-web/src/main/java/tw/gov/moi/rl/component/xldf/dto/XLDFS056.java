...
import tw.gov.moi.domain.Rldfs056Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs056Type.class ,
        entityDsName = "rldfs056ByKey" ,
        xldfEntityClass = Xldfs056Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs056Query", xldfDsByTrans = "xldfs056MaxSerialNo",  xldfDsBySerialNo = "xldfs056BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS056", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS056")
public class XLDFS056 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS056(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs056Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs056Type domainObj;
     ...
     */
    public Xldfs056Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs056Type domainObj) {
