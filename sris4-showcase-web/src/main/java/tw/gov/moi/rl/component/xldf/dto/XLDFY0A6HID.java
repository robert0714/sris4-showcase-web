...
@XmlType(name = "XLDFY0A6H", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0A6H") 
public class XLDFY0A6HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0A6H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0A6HID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
