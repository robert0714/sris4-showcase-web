 ...
 */
@RldfMappingEntity(
        value = Rldfm06mType.class ,
        entityDsName = "rldfm06mByKey" ,
        xldfEntityClass = Xldfm06mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm06mQuery", xldfDsByTrans = "xldfm06mMaxSerialNo",  xldfDsBySerialNo = "xldfm06mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM06M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM06M")
public class XLDFM06M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM06M(String trMode ,String applyMode ,String applyYyymmdd ,String applyHhmmss ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm06mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm06mType domainObj;
     ...
     */
    public Xldfm06mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm06mType domainObj) {
