...
import tw.gov.moi.domain.Xldf011mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf011mType.class ,
        entityDsName = "rldf011mByKey" ,
        xldfEntityClass = Xldf011mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf011mQuery", xldfDsByTrans = "xldf011mMaxSerialNo",  xldfDsBySerialNo = "xldf011mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF011M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF011M")
public class XLDF011M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF011M(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf011mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf011mType domainObj;
     ...
     */
    public Xldf011mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf011mType domainObj) {
