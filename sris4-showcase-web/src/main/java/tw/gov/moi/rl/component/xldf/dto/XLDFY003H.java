...
import tw.gov.moi.domain.Xldfy003hType;
import tw.gov.moi.domain.Rldfy003hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy003hType.class ,
        entityDsName = "rldfy003hByKey" ,
        xldfEntityClass = Xldfy003hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy003hQuery", xldfDsByTrans = "xldfy003hMaxSerialNo",  xldfDsBySerialNo = "xldfy003hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY003H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY003H")
public class XLDFY003H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY003H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy003hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy003hType domainObj;
     ...
     */
    public Xldfy003hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy003hType domainObj) {
