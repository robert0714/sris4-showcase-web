...
import tw.gov.moi.domain.Xldfy0a7hType;
import tw.gov.moi.domain.Rldfy0a7hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a7hType.class ,
        entityDsName = "rldfy0a7hByKey" ,
        xldfEntityClass = Xldfy0a7hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a7hQuery", xldfDsByTrans = "xldfy0a7hMaxSerialNo",  xldfDsBySerialNo = "xldfy0a7hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A7H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A7H")
public class XLDFY0A7H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A7H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a7hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a7hType domainObj;
     ...
     */
    public Xldfy0a7hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a7hType domainObj) {
