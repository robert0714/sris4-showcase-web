...
import tw.gov.moi.domain.Xldfy085hType;
import tw.gov.moi.domain.Rldfy085hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy085hType.class ,
        entityDsName = "rldfy085hByKey" ,
        xldfEntityClass = Xldfy085hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy085hQuery", xldfDsByTrans = "xldfy085hMaxSerialNo",  xldfDsBySerialNo = "xldfy085hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY085H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY085H")
public class XLDFY085H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY085H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy085hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy085hType domainObj;
     ...
     */
    public Xldfy085hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy085hType domainObj) {
