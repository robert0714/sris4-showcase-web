...
import tw.gov.moi.domain.Xldfr064Type;
import tw.gov.moi.domain.Rldfr064Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr064Type.class ,
        entityDsName = "rldfr064ByKey" ,
        xldfEntityClass = Xldfr064Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr064Query", xldfDsByTrans = "xldfr064MaxSerialNo",  xldfDsBySerialNo = "xldfr064BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR064", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR064")
public class XLDFR064 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR064(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr064Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr064Type domainObj;
     ...
     */
    public Xldfr064Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr064Type domainObj) {
