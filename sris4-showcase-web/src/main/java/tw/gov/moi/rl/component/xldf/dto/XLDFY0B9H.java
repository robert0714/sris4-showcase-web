...
import tw.gov.moi.domain.Xldfy0b9hType;
import tw.gov.moi.domain.Rldfy0b9hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b9hType.class ,
        entityDsName = "rldfy0b9hByKey" ,
        xldfEntityClass = Xldfy0b9hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b9hQuery", xldfDsByTrans = "xldfy0b9hMaxSerialNo",  xldfDsBySerialNo = "xldfy0b9hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B9H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B9H")
public class XLDFY0B9H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B9H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b9hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b9hType domainObj;
     ...
     */
    public Xldfy0b9hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b9hType domainObj) {
