...
import tw.gov.moi.domain.Xldfy0b2mType;
import tw.gov.moi.domain.Rldfy0b2mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b2mType.class ,
        entityDsName = "rldfy0b2mByKey" ,
        xldfEntityClass = Xldfy0b2mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b2mQuery", xldfDsByTrans = "xldfy0b2mMaxSerialNo",  xldfDsBySerialNo = "xldfy0b2mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B2M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B2M")
public class XLDFY0B2M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B2M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b2mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b2mType domainObj;
     ...
     */
    public Xldfy0b2mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b2mType domainObj) {
