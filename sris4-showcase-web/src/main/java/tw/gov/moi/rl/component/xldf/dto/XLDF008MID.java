...
@XmlType(name = "XLDF008M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF008M") 
public class XLDF008MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF008M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF008MID(String personId ,String specialCode ,String siteId ) {
        super();
