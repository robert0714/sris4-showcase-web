...
@XmlType(name = "Rl08f37DTO", propOrder = { "acceptSiteId", "directPrintMark", "initTime", "transactionId", "userId",
        "voterRollsInfoDTO" })
@XmlRootElement(name = "Rl08f37DTO")
public class Rl08f37DTO extends BaseITextReportParams implements Serializable {
