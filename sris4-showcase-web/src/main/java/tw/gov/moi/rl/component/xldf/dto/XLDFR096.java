...
import tw.gov.moi.domain.Xldfr096Type;
import tw.gov.moi.domain.Rldfr096Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr096Type.class ,
        entityDsName = "rldfr096ByKey" ,
        xldfEntityClass = Xldfr096Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr096Query", xldfDsByTrans = "xldfr096MaxSerialNo",  xldfDsBySerialNo = "xldfr096BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR096", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR096")
public class XLDFR096 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR096(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr096Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr096Type domainObj;
     ...
     */
    public Xldfr096Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr096Type domainObj) {
