...
import tw.gov.moi.domain.Xldfy09pmType;
import tw.gov.moi.domain.Rldfy09pmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09pmType.class ,
        entityDsName = "rldfy09pmByKey" ,
        xldfEntityClass = Xldfy09pmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09pmQuery", xldfDsByTrans = "xldfy09pmMaxSerialNo",  xldfDsBySerialNo = "xldfy09pmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09PM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09PM")
public class XLDFY09PM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09PM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09pmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09pmType domainObj;
     ...
     */
    public Xldfy09pmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09pmType domainObj) {
