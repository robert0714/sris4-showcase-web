...
import tw.gov.moi.domain.Xldfr062Type;
import tw.gov.moi.domain.Rldfr062Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr062Type.class ,
        entityDsName = "rldfr062ByKey" ,
        xldfEntityClass = Xldfr062Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr062Query", xldfDsByTrans = "xldfr062MaxSerialNo",  xldfDsBySerialNo = "xldfr062BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR062", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR062")
public class XLDFR062 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR062(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr062Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr062Type domainObj;
     ...
     */
    public Xldfr062Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr062Type domainObj) {
