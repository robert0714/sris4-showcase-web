...
import tw.gov.moi.domain.Xldfs0ahbType;
import tw.gov.moi.domain.Rldfs0ahbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0ahbType.class ,
        entityDsName = "rldfs0ahbByKey" ,
        xldfEntityClass = Xldfs0ahbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0ahbQuery", xldfDsByTrans = "xldfs0ahbMaxSerialNo",  xldfDsBySerialNo = "xldfs0ahbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AHB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AHB")
public class XLDFS0AHB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AHB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0ahbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0ahbType domainObj;
     ...
     */
    public Xldfs0ahbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0ahbType domainObj) {
