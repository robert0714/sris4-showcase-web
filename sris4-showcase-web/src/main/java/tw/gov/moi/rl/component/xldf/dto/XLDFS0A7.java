...
import tw.gov.moi.domain.Xldfs0a7Type;
import tw.gov.moi.domain.Rldfs0a7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a7Type.class ,
        entityDsName = "rldfs0a7ByKey" ,
        xldfEntityClass = Xldfs0a7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a7Query", xldfDsByTrans = "xldfs0a7MaxSerialNo",  xldfDsBySerialNo = "xldfs0a7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A7")
public class XLDFS0A7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a7Type domainObj;
     ...
     */
    public Xldfs0a7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a7Type domainObj) {
