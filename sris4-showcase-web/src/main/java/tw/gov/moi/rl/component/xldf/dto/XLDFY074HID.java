...
@XmlType(name = "XLDFY074H", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY074H") 
public class XLDFY074HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY074H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY074HID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
