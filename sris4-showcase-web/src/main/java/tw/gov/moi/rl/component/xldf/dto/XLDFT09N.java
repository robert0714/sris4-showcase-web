...
import tw.gov.moi.domain.Xldft09nType;
import tw.gov.moi.domain.Rldft09nType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09nType.class ,
        entityDsName = "rldft09nByKey" ,
        xldfEntityClass = Xldft09nType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09nQuery", xldfDsByTrans = "xldft09nMaxSerialNo",  xldfDsBySerialNo = "xldft09nBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09N", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09N")
public class XLDFT09N implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09N(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09nType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09nType domainObj;
     ...
     */
    public Xldft09nType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09nType domainObj) {
