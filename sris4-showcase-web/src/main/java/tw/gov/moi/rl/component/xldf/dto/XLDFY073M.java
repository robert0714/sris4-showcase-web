...
import tw.gov.moi.domain.Xldfy073mType;
import tw.gov.moi.domain.Rldfy073mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy073mType.class ,
        entityDsName = "rldfy073mByKey" ,
        xldfEntityClass = Xldfy073mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy073mQuery", xldfDsByTrans = "xldfy073mMaxSerialNo",  xldfDsBySerialNo = "xldfy073mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY073M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY073M")
public class XLDFY073M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY073M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy073mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy073mType domainObj;
     ...
     */
    public Xldfy073mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy073mType domainObj) {
