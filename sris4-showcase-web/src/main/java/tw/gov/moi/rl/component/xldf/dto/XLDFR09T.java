...
import tw.gov.moi.domain.Xldfr09tType;
import tw.gov.moi.domain.Rldfr09tType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09tType.class ,
        entityDsName = "rldfr09tByKey" ,
        xldfEntityClass = Xldfr09tType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09tQuery", xldfDsByTrans = "xldfr09tMaxSerialNo",  xldfDsBySerialNo = "xldfr09tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09T")
public class XLDFR09T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09T(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09tType domainObj;
     ...
     */
    public Xldfr09tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09tType domainObj) {
