...
public class XLDFS0AIID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS0AI.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS0AIID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
