...
@XmlType(name = "XLDFY092M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY092M") 
public class XLDFY092MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY092M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY092MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
