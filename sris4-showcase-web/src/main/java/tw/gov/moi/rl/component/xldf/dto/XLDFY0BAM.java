...
import tw.gov.moi.domain.Xldfy0bamType;
import tw.gov.moi.domain.Rldfy0bamType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0bamType.class ,
        entityDsName = "rldfy0bamByKey" ,
        xldfEntityClass = Xldfy0bamType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0bamQuery", xldfDsByTrans = "xldfy0bamMaxSerialNo",  xldfDsBySerialNo = "xldfy0bamBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0BAM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0BAM")
public class XLDFY0BAM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0BAM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0bamType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0bamType domainObj;
     ...
     */
    public Xldfy0bamType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0bamType domainObj) {
