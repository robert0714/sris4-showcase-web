...
import tw.gov.moi.domain.Xldfs092bType;
import tw.gov.moi.domain.Rldfs092bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs092bType.class ,
        entityDsName = "rldfs092bByKey" ,
        xldfEntityClass = Xldfs092bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs092bQuery", xldfDsByTrans = "xldfs092bMaxSerialNo",  xldfDsBySerialNo = "xldfs092bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS092B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS092B")
public class XLDFS092B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS092B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs092bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs092bType domainObj;
     ...
     */
    public Xldfs092bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs092bType domainObj) {
