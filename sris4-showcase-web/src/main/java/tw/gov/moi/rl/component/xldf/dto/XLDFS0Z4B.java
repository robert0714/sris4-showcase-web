...
import tw.gov.moi.domain.Xldfs0z4bType;
import tw.gov.moi.domain.Rldfs0z4bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0z4bType.class ,
        entityDsName = "rldfs0z4bByKey" ,
        xldfEntityClass = Xldfs0z4bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0z4bQuery", xldfDsByTrans = "xldfs0z4bMaxSerialNo",  xldfDsBySerialNo = "xldfs0z4bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0Z4B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0Z4B")
public class XLDFS0Z4B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0Z4B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0z4bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0z4bType domainObj;
     ...
     */
    public Xldfs0z4bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0z4bType domainObj) {
