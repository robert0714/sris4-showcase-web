...
import tw.gov.moi.domain.Xldft09uType;
import tw.gov.moi.domain.Rldft09uType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09uType.class ,
        entityDsName = "rldft09uByKey" ,
        xldfEntityClass = Xldft09uType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09uQuery", xldfDsByTrans = "xldft09uMaxSerialNo",  xldfDsBySerialNo = "xldft09uBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09U", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09U")
public class XLDFT09U implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09U(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09uType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09uType domainObj;
     ...
     */
    public Xldft09uType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09uType domainObj) {
