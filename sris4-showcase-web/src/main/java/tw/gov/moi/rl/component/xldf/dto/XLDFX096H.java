...
import tw.gov.moi.domain.Xldfx096hType;
import tw.gov.moi.domain.Rldfx096hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx096hType.class ,
        entityDsName = "rldfx096hByKey" ,
        xldfEntityClass = Xldfx096hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx096hQuery", xldfDsByTrans = "xldfx096hMaxSerialNo",  xldfDsBySerialNo = "xldfx096hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX096H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX096H")
public class XLDFX096H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX096H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx096hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx096hType domainObj;
     ...
     */
    public Xldfx096hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx096hType domainObj) {
