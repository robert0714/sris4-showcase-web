...
import tw.gov.moi.domain.Xldfw005Type;
import tw.gov.moi.domain.Rldfw005Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw005Type.class ,
        entityDsName = "rldfw005ByKey" ,
        xldfEntityClass = Xldfw005Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw005Query", xldfDsByTrans = "xldfw005MaxSerialNo",  xldfDsBySerialNo = "xldfw005BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW005", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW005")
public class XLDFW005 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW005(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw005Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw005Type domainObj;
     ...
     */
    public Xldfw005Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw005Type domainObj) {
