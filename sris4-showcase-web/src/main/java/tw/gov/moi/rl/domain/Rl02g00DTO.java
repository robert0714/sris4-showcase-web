...
import tw.gov.moi.rl.domain.Rl02g00AppDataDTO.Rl02g00ResultDTO;
...
@XmlType(name = "rl02g00DTO", propOrder = { "apply1", "apply2", "delegated", "openingOperationDTO", "enforceMode",
        "xldfefaplcType", "xldfPersonDataDomainObject", "xldfPersonDataDomainObjectByHousehold",
        "xldfHouseholdDataDomainObject", "appDataDTO", "registerFlag", "changeTitle" })
@XmlRootElement(name = "Rl02g00DTO")
public class Rl02g00DTO implements Serializable {
    ...
    @FieldName("個人記事清單")
    private List<Rl02g00ResultDTO> resultList = new ArrayList<Rl02g00ResultDTO>();

    /** 更正個人記事申請資料 DTO. */
    @XmlElement(name = "AppDataDto")
    @FieldName("更正個人記事申請資料 DTO")
    private Rl02g00AppDataDTO appDataDTO = new Rl02g00AppDataDTO();
    ...
    /** 是否有當事人資料. */
    @XmlElement(name = "DataBtn")
    @FieldName("是否有當事人資料")
    private boolean dataBtn = true;
    ...
    public List<Rl02g00ResultDTO> getResultList() {
        return resultList;
    }

    public void setResultList(List<Rl02g00ResultDTO> resultList) {
        this.resultList = resultList;
    }

    public Rl02g00AppDataDTO getAppDataDTO() {
        return appDataDTO;
    }

    public void setAppDataDTO(Rl02g00AppDataDTO appDataDTO) {
    ...
    public boolean isDataBtn() {
        return dataBtn;
    }

    public void setDataBtn(boolean dataBtn) {
