...
import tw.gov.moi.domain.Xldfr080Type;
import tw.gov.moi.domain.Rldfr080Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr080Type.class ,
        entityDsName = "rldfr080ByKey" ,
        xldfEntityClass = Xldfr080Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr080Query", xldfDsByTrans = "xldfr080MaxSerialNo",  xldfDsBySerialNo = "xldfr080BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR080", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR080")
public class XLDFR080 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR080(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr080Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr080Type domainObj;
     ...
     */
    public Xldfr080Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr080Type domainObj) {
