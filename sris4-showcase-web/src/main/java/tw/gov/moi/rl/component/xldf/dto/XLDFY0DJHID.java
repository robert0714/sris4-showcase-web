...
@XmlType(name = "XLDFY0DJH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0DJH") 
public class XLDFY0DJHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0DJH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0DJHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
