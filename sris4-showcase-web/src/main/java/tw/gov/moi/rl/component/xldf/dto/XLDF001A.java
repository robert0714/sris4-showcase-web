...
import tw.gov.moi.domain.Rldf001aType;
 ...
 */
@RldfMappingEntity(
        value = Rldf001aType.class ,
        entityDsName = "rldf001aByKey" ,
        xldfEntityClass = Xldf001aType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf001aQuery", xldfDsByTrans = "xldf001aMaxSerialNo",  xldfDsBySerialNo = "xldf001aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF001A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF001A")
public class XLDF001A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF001A(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf001aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf001aType domainObj;
     ...
     */
    public Xldf001aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf001aType domainObj) {
