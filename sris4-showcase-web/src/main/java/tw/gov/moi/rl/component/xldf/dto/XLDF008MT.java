...
import tw.gov.moi.domain.Xldf008mtType;
 ...
 */
@RldfMappingEntity(
        value = Tldf008mType.class ,
        entityDsName = "tldf008mByKey" ,
        xldfEntityClass = Xldf008mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf008mtQuery", xldfDsByTrans = "xldf008mtMaxSerialNo",  xldfDsBySerialNo = "xldf008mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF008MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF008MT")
public class XLDF008MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF008MT(String personId ,String specialCode ,String siteId ) {
        super();
        this.domainObj = new Xldf008mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf008mtType domainObj;
     ...
     */
    public Xldf008mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf008mtType domainObj) {
