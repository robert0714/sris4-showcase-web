...
import tw.gov.moi.domain.Xldfw0c8Type;
import tw.gov.moi.domain.Rldfw0c8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0c8Type.class ,
        entityDsName = "rldfw0c8ByKey" ,
        xldfEntityClass = Xldfw0c8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0c8Query", xldfDsByTrans = "xldfw0c8MaxSerialNo",  xldfDsBySerialNo = "xldfw0c8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0C8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0C8")
public class XLDFW0C8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0C8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0c8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0c8Type domainObj;
     ...
     */
    public Xldfw0c8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0c8Type domainObj) {
