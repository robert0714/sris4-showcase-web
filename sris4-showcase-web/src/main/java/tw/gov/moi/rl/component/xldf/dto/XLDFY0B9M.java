...
import tw.gov.moi.domain.Xldfy0b9mType;
import tw.gov.moi.domain.Rldfy0b9mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b9mType.class ,
        entityDsName = "rldfy0b9mByKey" ,
        xldfEntityClass = Xldfy0b9mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b9mQuery", xldfDsByTrans = "xldfy0b9mMaxSerialNo",  xldfDsBySerialNo = "xldfy0b9mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B9M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B9M")
public class XLDFY0B9M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B9M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b9mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b9mType domainObj;
     ...
     */
    public Xldfy0b9mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b9mType domainObj) {
