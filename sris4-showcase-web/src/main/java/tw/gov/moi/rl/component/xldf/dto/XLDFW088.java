...
import tw.gov.moi.domain.Xldfw088Type;
import tw.gov.moi.domain.Rldfw088Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw088Type.class ,
        entityDsName = "rldfw088ByKey" ,
        xldfEntityClass = Xldfw088Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw088Query", xldfDsByTrans = "xldfw088MaxSerialNo",  xldfDsBySerialNo = "xldfw088BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW088", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW088")
public class XLDFW088 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW088(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw088Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw088Type domainObj;
     ...
     */
    public Xldfw088Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw088Type domainObj) {
