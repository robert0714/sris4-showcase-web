...
@XmlType(name = "Rl01832DTO", propOrder = { "openingOperationDTO", "person", "rl01832AppData", "personHousehold", "apply1", "apply2", "delegated", "mustApply1", "mustApply2", "foreignPerson", "householdHead", "householdNoteList", "personNoteList", "personRole", "enforcedApplicant", "father", "fatherHousehold", "fatherForeignPerson", "mother", "motherHousehold", "motherForeignPerson", "warningMessgeList", "fineDTO", "fineQueryDTO", "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication", "initSuccess", "activeIndex", "fatherMemoryPerson", "motherMemoryPerson", "isOther", "fatherXldfm05m", "motherXldfm05m" })
@XmlRootElement(name = "Rl01832DTO")
public class Rl01832DTO implements Serializable {
    ...
    /** 當事人-申請資料 */
    @FieldName("當事人-申請資料")
    @XmlElement(name = "Rl01832AppData", required = false)
    private Rl01832AppDataDTO rl01832AppData = new Rl01832AppDataDTO();
    ...
    public Rl01832AppDataDTO getRl01832AppData() {
        return rl01832AppData;
    }
    ...
    public void setRl01832AppData(Rl01832AppDataDTO rl01832AppData) {
        this.rl01832AppData = rl01832AppData;
    }
