...
import tw.gov.moi.domain.Xldfy0a2mType;
import tw.gov.moi.domain.Rldfy0a2mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a2mType.class ,
        entityDsName = "rldfy0a2mByKey" ,
        xldfEntityClass = Xldfy0a2mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a2mQuery", xldfDsByTrans = "xldfy0a2mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a2mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A2M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A2M")
public class XLDFY0A2M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A2M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a2mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a2mType domainObj;
     ...
     */
    public Xldfy0a2mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a2mType domainObj) {
