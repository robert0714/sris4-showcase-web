...
import tw.gov.moi.domain.Xldfm01mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm01mType.class ,
        entityDsName = "rldfm01mByKey" ,
        xldfEntityClass = Xldfm01mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldfm01mQuery", xldfDsByTrans = "xldfm01mMaxSerialNo",  xldfDsBySerialNo = "xldfm01mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM01M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM01M")
public class XLDFM01M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM01M(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm01mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm01mType domainObj;
     ...
     */
    public Xldfm01mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm01mType domainObj) {
