...
@XmlType(name = "XLDFY064M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY064M") 
public class XLDFY064MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY064M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY064MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
