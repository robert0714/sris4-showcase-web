...
import tw.gov.moi.domain.Xldfw018Type;
import tw.gov.moi.domain.Rldfw018Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw018Type.class ,
        entityDsName = "rldfw018ByKey" ,
        xldfEntityClass = Xldfw018Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw018Query", xldfDsByTrans = "xldfw018MaxSerialNo",  xldfDsBySerialNo = "xldfw018BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW018", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW018")
public class XLDFW018 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW018(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw018Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw018Type domainObj;
     ...
     */
    public Xldfw018Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw018Type domainObj) {
