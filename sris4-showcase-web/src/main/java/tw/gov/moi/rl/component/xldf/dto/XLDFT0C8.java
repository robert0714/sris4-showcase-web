...
import tw.gov.moi.domain.Xldft0c8Type;
import tw.gov.moi.domain.Rldft0c8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0c8Type.class ,
        entityDsName = "rldft0c8ByKey" ,
        xldfEntityClass = Xldft0c8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0c8Query", xldfDsByTrans = "xldft0c8MaxSerialNo",  xldfDsBySerialNo = "xldft0c8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0C8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0C8")
public class XLDFT0C8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0C8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0c8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0c8Type domainObj;
     ...
     */
    public Xldft0c8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0c8Type domainObj) {
