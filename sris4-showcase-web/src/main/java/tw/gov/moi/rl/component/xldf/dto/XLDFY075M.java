...
import tw.gov.moi.domain.Xldfy075mType;
import tw.gov.moi.domain.Rldfy075mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy075mType.class ,
        entityDsName = "rldfy075mByKey" ,
        xldfEntityClass = Xldfy075mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy075mQuery", xldfDsByTrans = "xldfy075mMaxSerialNo",  xldfDsBySerialNo = "xldfy075mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY075M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY075M")
public class XLDFY075M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY075M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy075mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy075mType domainObj;
     ...
     */
    public Xldfy075mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy075mType domainObj) {
