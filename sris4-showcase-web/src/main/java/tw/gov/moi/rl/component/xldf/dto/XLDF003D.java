...
import tw.gov.moi.domain.Xldf003dType;
 ...
 */
@RldfMappingEntity(
        value = Rldf003dType.class ,
        entityDsName = "rldf003dByKey" ,
        xldfEntityClass = Xldf003dType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "expireYyymmdd" , length = 7),
            @XldfKeyMapping( name = "expireHhmmss" , length = 6),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf003dQuery", xldfDsByTrans = "xldf003dMaxSerialNo",  xldfDsBySerialNo = "xldf003dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF003D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF003D")
public class XLDF003D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF003D(String personId ,String expireYyymmdd ,String expireHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf003dType();
        getDomainObj().setPersonId(personId); 
        getDomainObj().setExpireYyymmdd(expireYyymmdd); 
        getDomainObj().setExpireHhmmss(expireHhmmss); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf003dType domainObj;
     ...
     */
    public Xldf003dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf003dType domainObj) {
