...
import tw.gov.moi.domain.Xldfy097mType;
import tw.gov.moi.domain.Rldfy097mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy097mType.class ,
        entityDsName = "rldfy097mByKey" ,
        xldfEntityClass = Xldfy097mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy097mQuery", xldfDsByTrans = "xldfy097mMaxSerialNo",  xldfDsBySerialNo = "xldfy097mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY097M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY097M")
public class XLDFY097M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY097M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy097mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy097mType domainObj;
     ...
     */
    public Xldfy097mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy097mType domainObj) {
