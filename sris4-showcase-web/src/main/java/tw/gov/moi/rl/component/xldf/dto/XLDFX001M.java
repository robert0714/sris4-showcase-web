...
import tw.gov.moi.domain.Xldfx001mType;
import tw.gov.moi.domain.Rldfx001mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx001mType.class ,
        entityDsName = "rldfx001mByKey" ,
        xldfEntityClass = Xldfx001mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx001mQuery", xldfDsByTrans = "xldfx001mMaxSerialNo",  xldfDsBySerialNo = "xldfx001mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX001M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX001M")
public class XLDFX001M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX001M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx001mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx001mType domainObj;
     ...
     */
    public Xldfx001mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx001mType domainObj) {
