...
import tw.gov.moi.domain.Xldfs075bType;
import tw.gov.moi.domain.Rldfs075bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs075bType.class ,
        entityDsName = "rldfs075bByKey" ,
        xldfEntityClass = Xldfs075bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs075bQuery", xldfDsByTrans = "xldfs075bMaxSerialNo",  xldfDsBySerialNo = "xldfs075bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS075B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS075B")
public class XLDFS075B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS075B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs075bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs075bType domainObj;
     ...
     */
    public Xldfs075bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs075bType domainObj) {
