...
import tw.gov.moi.domain.Xldfw0a2Type;
import tw.gov.moi.domain.Rldfw0a2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a2Type.class ,
        entityDsName = "rldfw0a2ByKey" ,
        xldfEntityClass = Xldfw0a2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a2Query", xldfDsByTrans = "xldfw0a2MaxSerialNo",  xldfDsBySerialNo = "xldfw0a2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A2")
public class XLDFW0A2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a2Type domainObj;
     ...
     */
    public Xldfw0a2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a2Type domainObj) {
