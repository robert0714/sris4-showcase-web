...
import tw.gov.moi.domain.Xldfs0b9Type;
import tw.gov.moi.domain.Rldfs0b9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b9Type.class ,
        entityDsName = "rldfs0b9ByKey" ,
        xldfEntityClass = Xldfs0b9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b9Query", xldfDsByTrans = "xldfs0b9MaxSerialNo",  xldfDsBySerialNo = "xldfs0b9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B9")
public class XLDFS0B9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0b9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b9Type domainObj;
     ...
     */
    public Xldfs0b9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b9Type domainObj) {
