...
@XmlType(name = "XLDFY091M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY091M") 
public class XLDFY091MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY091M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY091MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
