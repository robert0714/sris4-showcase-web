...
import tw.gov.moi.domain.Xldfy09shType;
import tw.gov.moi.domain.Rldfy09shType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09shType.class ,
        entityDsName = "rldfy09shByKey" ,
        xldfEntityClass = Xldfy09shType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09shQuery", xldfDsByTrans = "xldfy09shMaxSerialNo",  xldfDsBySerialNo = "xldfy09shBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09SH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09SH")
public class XLDFY09SH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09SH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09shType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09shType domainObj;
     ...
     */
    public Xldfy09shType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09shType domainObj) {
