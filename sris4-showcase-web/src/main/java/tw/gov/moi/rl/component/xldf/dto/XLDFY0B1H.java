...
import tw.gov.moi.domain.Xldfy0b1hType;
import tw.gov.moi.domain.Rldfy0b1hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b1hType.class ,
        entityDsName = "rldfy0b1hByKey" ,
        xldfEntityClass = Xldfy0b1hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b1hQuery", xldfDsByTrans = "xldfy0b1hMaxSerialNo",  xldfDsBySerialNo = "xldfy0b1hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B1H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B1H")
public class XLDFY0B1H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B1H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b1hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b1hType domainObj;
     ...
     */
    public Xldfy0b1hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b1hType domainObj) {
