...
import tw.gov.moi.domain.Xldfr082Type;
import tw.gov.moi.domain.Rldfr082Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr082Type.class ,
        entityDsName = "rldfr082ByKey" ,
        xldfEntityClass = Xldfr082Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr082Query", xldfDsByTrans = "xldfr082MaxSerialNo",  xldfDsBySerialNo = "xldfr082BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR082", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR082")
public class XLDFR082 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR082(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr082Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr082Type domainObj;
     ...
     */
    public Xldfr082Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr082Type domainObj) {
