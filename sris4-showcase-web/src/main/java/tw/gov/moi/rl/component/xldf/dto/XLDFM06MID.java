...
public class XLDFM06MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM06M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM06MID(String trMode ,String applyMode ,String applyYyymmdd ,String applyHhmmss ,String personId ,String siteId ) {
        super();
