...
public class XLDF010MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF010M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF010MID(String personId ,String siteId ,String specialCode ) {
        super();
