 ...
 */
@RldfMappingEntity(
        value = Rldf005hType.class ,
        entityDsName = "rldf005hByKey" ,
        xldfEntityClass = Xldf005hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf005hQuery", xldfDsByTrans = "xldf005hMaxSerialNo",  xldfDsBySerialNo = "xldf005hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF005H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF005H")
public class XLDF005H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF005H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf005hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf005hType domainObj;
     ...
     */
    public Xldf005hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf005hType domainObj) {
