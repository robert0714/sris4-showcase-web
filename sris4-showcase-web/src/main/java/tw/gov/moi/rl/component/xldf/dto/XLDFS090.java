...
import tw.gov.moi.domain.Xldfs090Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs090Type.class ,
        entityDsName = "rldfs090ByKey" ,
        xldfEntityClass = Xldfs090Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs090Query", xldfDsByTrans = "xldfs090MaxSerialNo",  xldfDsBySerialNo = "xldfs090BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS090", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS090")
public class XLDFS090 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS090(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs090Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs090Type domainObj;
     ...
     */
    public Xldfs090Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs090Type domainObj) {
