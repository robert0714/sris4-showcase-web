...
import tw.gov.moi.domain.Xldfs025Type;
import tw.gov.moi.domain.Rldfs025Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs025Type.class ,
        entityDsName = "rldfs025ByKey" ,
        xldfEntityClass = Xldfs025Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs025Query", xldfDsByTrans = "xldfs025MaxSerialNo",  xldfDsBySerialNo = "xldfs025BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS025", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS025")
public class XLDFS025 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS025(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs025Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs025Type domainObj;
     ...
     */
    public Xldfs025Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs025Type domainObj) {
