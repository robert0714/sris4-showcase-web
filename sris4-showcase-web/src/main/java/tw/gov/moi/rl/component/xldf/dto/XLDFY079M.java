...
import tw.gov.moi.domain.Xldfy079mType;
import tw.gov.moi.domain.Rldfy079mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy079mType.class ,
        entityDsName = "rldfy079mByKey" ,
        xldfEntityClass = Xldfy079mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy079mQuery", xldfDsByTrans = "xldfy079mMaxSerialNo",  xldfDsBySerialNo = "xldfy079mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY079M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY079M")
public class XLDFY079M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY079M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy079mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy079mType domainObj;
     ...
     */
    public Xldfy079mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy079mType domainObj) {
