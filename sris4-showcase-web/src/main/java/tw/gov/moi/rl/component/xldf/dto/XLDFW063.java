...
import tw.gov.moi.domain.Xldfw063Type;
import tw.gov.moi.domain.Rldfw063Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw063Type.class ,
        entityDsName = "rldfw063ByKey" ,
        xldfEntityClass = Xldfw063Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw063Query", xldfDsByTrans = "xldfw063MaxSerialNo",  xldfDsBySerialNo = "xldfw063BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW063", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW063")
public class XLDFW063 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW063(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw063Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw063Type domainObj;
     ...
     */
    public Xldfw063Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw063Type domainObj) {
