...
import tw.gov.moi.domain.Xldfs001bType;
import tw.gov.moi.domain.Rldfs001bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs001bType.class ,
        entityDsName = "rldfs001bByKey" ,
        xldfEntityClass = Xldfs001bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs001bQuery", xldfDsByTrans = "xldfs001bMaxSerialNo",  xldfDsBySerialNo = "xldfs001bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS001B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS001B")
public class XLDFS001B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS001B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs001bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs001bType domainObj;
     ...
     */
    public Xldfs001bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs001bType domainObj) {
