...
import tw.gov.moi.domain.Xldfw0aeType;
import tw.gov.moi.domain.Rldfw0aeType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0aeType.class ,
        entityDsName = "rldfw0aeByKey" ,
        xldfEntityClass = Xldfw0aeType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0aeQuery", xldfDsByTrans = "xldfw0aeMaxSerialNo",  xldfDsBySerialNo = "xldfw0aeBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AE", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AE")
public class XLDFW0AE implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AE(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0aeType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0aeType domainObj;
     ...
     */
    public Xldfw0aeType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0aeType domainObj) {
