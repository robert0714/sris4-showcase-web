...
import tw.gov.moi.domain.Xldfs0a6bType;
import tw.gov.moi.domain.Rldfs0a6bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a6bType.class ,
        entityDsName = "rldfs0a6bByKey" ,
        xldfEntityClass = Xldfs0a6bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a6bQuery", xldfDsByTrans = "xldfs0a6bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a6bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A6B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A6B")
public class XLDFS0A6B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A6B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a6bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a6bType domainObj;
     ...
     */
    public Xldfs0a6bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a6bType domainObj) {
