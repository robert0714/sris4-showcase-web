...
import tw.gov.moi.domain.Xldfw035Type;
import tw.gov.moi.domain.Rldfw035Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw035Type.class ,
        entityDsName = "rldfw035ByKey" ,
        xldfEntityClass = Xldfw035Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw035Query", xldfDsByTrans = "xldfw035MaxSerialNo",  xldfDsBySerialNo = "xldfw035BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW035", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW035")
public class XLDFW035 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW035(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw035Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw035Type domainObj;
     ...
     */
    public Xldfw035Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw035Type domainObj) {
