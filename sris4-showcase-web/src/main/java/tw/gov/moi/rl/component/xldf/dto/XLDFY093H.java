...
import tw.gov.moi.domain.Xldfy093hType;
import tw.gov.moi.domain.Rldfy093hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy093hType.class ,
        entityDsName = "rldfy093hByKey" ,
        xldfEntityClass = Xldfy093hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy093hQuery", xldfDsByTrans = "xldfy093hMaxSerialNo",  xldfDsBySerialNo = "xldfy093hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY093H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY093H")
public class XLDFY093H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY093H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy093hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy093hType domainObj;
     ...
     */
    public Xldfy093hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy093hType domainObj) {
