...
/**
 * Rl01803SelectRegisterDTO
 * 
 * @author Stanley.Li
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl01803SelectRegisterDTO", propOrder = { "selectRegister", "note" })
@XmlRootElement(name = "Rl01803SelectRegisterDTO")
public class Rl01803SelectRegisterDTO implements Serializable {
