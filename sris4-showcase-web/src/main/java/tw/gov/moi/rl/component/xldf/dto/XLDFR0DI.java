...
import tw.gov.moi.domain.Xldfr0diType;
import tw.gov.moi.domain.Rldfr0diType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0diType.class ,
        entityDsName = "rldfr0diByKey" ,
        xldfEntityClass = Xldfr0diType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0diQuery", xldfDsByTrans = "xldfr0diMaxSerialNo",  xldfDsBySerialNo = "xldfr0diBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0DI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0DI")
public class XLDFR0DI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0DI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0diType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0diType domainObj;
     ...
     */
    public Xldfr0diType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0diType domainObj) {
