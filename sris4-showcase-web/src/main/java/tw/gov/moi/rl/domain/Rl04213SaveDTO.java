...
/**
 * The Class Rl04213SaveDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl04213SaveDTO", propOrder = { "Serial", "HouseholdHeadId", "HouseholdId", "ModifyStreetDoor",
        "newStreet", "newSection", "newLane", "newAlley", "newAlley1", "newAlley2", "newArea", "newAreaSite",
        "newDoorNo", "newFloorNo" })
@XmlRootElement(name = "Rl04213SaveDTO")
public class Rl04213SaveDTO implements Serializable {
