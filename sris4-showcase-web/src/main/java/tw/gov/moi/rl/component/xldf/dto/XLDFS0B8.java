...
import tw.gov.moi.domain.Xldfs0b8Type;
import tw.gov.moi.domain.Rldfs0b8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b8Type.class ,
        entityDsName = "rldfs0b8ByKey" ,
        xldfEntityClass = Xldfs0b8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b8Query", xldfDsByTrans = "xldfs0b8MaxSerialNo",  xldfDsBySerialNo = "xldfs0b8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B8")
public class XLDFS0B8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0b8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b8Type domainObj;
     ...
     */
    public Xldfs0b8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b8Type domainObj) {
