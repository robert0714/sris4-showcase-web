...
public class XLDFM07MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM07MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM07MTID(String personId ,String siteId ,String registerYyymmdd ,String registerHhmmss ) {
        super();
