...
import tw.gov.moi.domain.Xldfs0djbType;
import tw.gov.moi.domain.Rldfs0djbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0djbType.class ,
        entityDsName = "rldfs0djbByKey" ,
        xldfEntityClass = Xldfs0djbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0djbQuery", xldfDsByTrans = "xldfs0djbMaxSerialNo",  xldfDsBySerialNo = "xldfs0djbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DJB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DJB")
public class XLDFS0DJB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DJB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0djbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0djbType domainObj;
     ...
     */
    public Xldfs0djbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0djbType domainObj) {
