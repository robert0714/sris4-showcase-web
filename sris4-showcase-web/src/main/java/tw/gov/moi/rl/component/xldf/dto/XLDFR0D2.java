...
import tw.gov.moi.domain.Xldfr0d2Type;
import tw.gov.moi.domain.Rldfr0d2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0d2Type.class ,
        entityDsName = "rldfr0d2ByKey" ,
        xldfEntityClass = Xldfr0d2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0d2Query", xldfDsByTrans = "xldfr0d2MaxSerialNo",  xldfDsBySerialNo = "xldfr0d2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0D2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0D2")
public class XLDFR0D2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0D2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0d2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0d2Type domainObj;
     ...
     */
    public Xldfr0d2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0d2Type domainObj) {
