...
import tw.gov.moi.domain.Xldfx09jmType;
import tw.gov.moi.domain.Rldfx09jmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09jmType.class ,
        entityDsName = "rldfx09jmByKey" ,
        xldfEntityClass = Xldfx09jmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09jmQuery", xldfDsByTrans = "xldfx09jmMaxSerialNo",  xldfDsBySerialNo = "xldfx09jmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09JM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09JM")
public class XLDFX09JM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09JM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09jmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09jmType domainObj;
     ...
     */
    public Xldfx09jmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09jmType domainObj) {
