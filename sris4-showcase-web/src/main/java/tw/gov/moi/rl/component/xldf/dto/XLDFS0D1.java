...
import tw.gov.moi.domain.Xldfs0d1Type;
import tw.gov.moi.domain.Rldfs0d1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0d1Type.class ,
        entityDsName = "rldfs0d1ByKey" ,
        xldfEntityClass = Xldfs0d1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0d1Query", xldfDsByTrans = "xldfs0d1MaxSerialNo",  xldfDsBySerialNo = "xldfs0d1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0D1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0D1")
public class XLDFS0D1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0D1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0d1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0d1Type domainObj;
     ...
     */
    public Xldfs0d1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0d1Type domainObj) {
