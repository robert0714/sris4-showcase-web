...
import tw.gov.moi.domain.Xldfs024bType;
import tw.gov.moi.domain.Rldfs024bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs024bType.class ,
        entityDsName = "rldfs024bByKey" ,
        xldfEntityClass = Xldfs024bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs024bQuery", xldfDsByTrans = "xldfs024bMaxSerialNo",  xldfDsBySerialNo = "xldfs024bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS024B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS024B")
public class XLDFS024B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS024B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs024bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs024bType domainObj;
     ...
     */
    public Xldfs024bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs024bType domainObj) {
