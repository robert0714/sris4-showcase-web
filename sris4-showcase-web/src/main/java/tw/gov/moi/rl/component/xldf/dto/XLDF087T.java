...
import tw.gov.moi.domain.Xldf087tType;
 ...
 */
@RldfMappingEntity(
        value = Rldf087tType.class ,
        entityDsName = "rldf087tByKey" ,
        xldfEntityClass = Xldf087tType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf087tQuery", xldfDsByTrans = "xldf087tMaxSerialNo",  xldfDsBySerialNo = "xldf087tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF087T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF087T")
public class XLDF087T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF087T(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf087tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf087tType domainObj;
     ...
     */
    public Xldf087tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf087tType domainObj) {
