...
@XmlType(name = "XLDFM11M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFM11M") 
public class XLDFM11MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM11M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM11MID(String siteId ,String personId ) {
        super();
