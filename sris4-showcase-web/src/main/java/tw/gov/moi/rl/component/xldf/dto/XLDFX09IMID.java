...
@XmlType(name = "XLDFX09IM", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX09IM") 
public class XLDFX09IMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX09IM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX09IMID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
