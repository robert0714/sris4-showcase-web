...
import tw.gov.moi.domain.Xldfx082mType;
import tw.gov.moi.domain.Rldfx082mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx082mType.class ,
        entityDsName = "rldfx082mByKey" ,
        xldfEntityClass = Xldfx082mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx082mQuery", xldfDsByTrans = "xldfx082mMaxSerialNo",  xldfDsBySerialNo = "xldfx082mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX082M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX082M")
public class XLDFX082M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX082M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx082mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx082mType domainObj;
     ...
     */
    public Xldfx082mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx082mType domainObj) {
