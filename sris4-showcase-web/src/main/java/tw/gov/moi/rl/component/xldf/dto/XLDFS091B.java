...
import tw.gov.moi.domain.Xldfs091bType;
import tw.gov.moi.domain.Rldfs091bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs091bType.class ,
        entityDsName = "rldfs091bByKey" ,
        xldfEntityClass = Xldfs091bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs091bQuery", xldfDsByTrans = "xldfs091bMaxSerialNo",  xldfDsBySerialNo = "xldfs091bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS091B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS091B")
public class XLDFS091B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS091B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs091bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs091bType domainObj;
     ...
     */
    public Xldfs091bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs091bType domainObj) {
