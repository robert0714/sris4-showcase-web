...
import tw.gov.moi.domain.Xldfs0abType;
import tw.gov.moi.domain.Rldfs0abType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0abType.class ,
        entityDsName = "rldfs0abByKey" ,
        xldfEntityClass = Xldfs0abType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0abQuery", xldfDsByTrans = "xldfs0abMaxSerialNo",  xldfDsBySerialNo = "xldfs0abBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AB")
public class XLDFS0AB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0abType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0abType domainObj;
     ...
     */
    public Xldfs0abType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0abType domainObj) {
