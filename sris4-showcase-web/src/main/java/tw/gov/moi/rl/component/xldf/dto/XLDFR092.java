...
import tw.gov.moi.domain.Xldfr092Type;
import tw.gov.moi.domain.Rldfr092Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr092Type.class ,
        entityDsName = "rldfr092ByKey" ,
        xldfEntityClass = Xldfr092Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr092Query", xldfDsByTrans = "xldfr092MaxSerialNo",  xldfDsBySerialNo = "xldfr092BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR092", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR092")
public class XLDFR092 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR092(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr092Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr092Type domainObj;
     ...
     */
    public Xldfr092Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr092Type domainObj) {
