...
import tw.gov.moi.domain.Xldfw0agType;
import tw.gov.moi.domain.Rldfw0agType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0agType.class ,
        entityDsName = "rldfw0agByKey" ,
        xldfEntityClass = Xldfw0agType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0agQuery", xldfDsByTrans = "xldfw0agMaxSerialNo",  xldfDsBySerialNo = "xldfw0agBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AG", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AG")
public class XLDFW0AG implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AG(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0agType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0agType domainObj;
     ...
     */
    public Xldfw0agType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0agType domainObj) {
