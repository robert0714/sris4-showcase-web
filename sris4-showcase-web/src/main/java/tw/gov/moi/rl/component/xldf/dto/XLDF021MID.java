...
public class XLDF021MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF021M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF021MID(String householdId ,String siteId ) {
        super();
