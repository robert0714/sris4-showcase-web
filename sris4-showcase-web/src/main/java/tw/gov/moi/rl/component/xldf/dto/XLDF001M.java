 ...
 */
@RldfMappingEntity(
        value = Rldf001mType.class ,
        entityDsName = "rldf001mByKey" ,
        xldfEntityClass = Xldf001mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf001mQuery", xldfDsByTrans = "xldf001mMaxSerialNo",  xldfDsBySerialNo = "xldf001mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF001M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF001M")
public class XLDF001M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF001M(String householdHeadId ,String householdId ,String siteId ) {
        super();
        this.domainObj = new Xldf001mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf001mType domainObj;
     ...
     */
    public Xldf001mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf001mType domainObj) {
