...
import tw.gov.moi.domain.Xldfy065mType;
import tw.gov.moi.domain.Rldfy065mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy065mType.class ,
        entityDsName = "rldfy065mByKey" ,
        xldfEntityClass = Xldfy065mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy065mQuery", xldfDsByTrans = "xldfy065mMaxSerialNo",  xldfDsBySerialNo = "xldfy065mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY065M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY065M")
public class XLDFY065M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY065M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy065mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy065mType domainObj;
     ...
     */
    public Xldfy065mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy065mType domainObj) {
