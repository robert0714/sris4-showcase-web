...
import tw.gov.moi.domain.Xldfy091mType;
import tw.gov.moi.domain.Rldfy091mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy091mType.class ,
        entityDsName = "rldfy091mByKey" ,
        xldfEntityClass = Xldfy091mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy091mQuery", xldfDsByTrans = "xldfy091mMaxSerialNo",  xldfDsBySerialNo = "xldfy091mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY091M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY091M")
public class XLDFY091M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY091M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy091mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy091mType domainObj;
     ...
     */
    public Xldfy091mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy091mType domainObj) {
