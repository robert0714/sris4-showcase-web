...
public class XLDFM09MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM09M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM09MID(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ) {
        super();
