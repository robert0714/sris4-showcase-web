...
import tw.gov.moi.rl.domain.Rl02e00AppDataDTO.Rl02e00ResultDTO;
...
@XmlType(name = "rl02e00DTO", propOrder = { "apply1", "apply2", "delegated", "openingOperationDTO", "enforceMode",
...
@XmlRootElement(name = "Rl02e00DTO")
public class Rl02e00DTO implements Serializable {
    ...
    @FieldName("個人記事清單")
    private List<Rl02e00ResultDTO> resultList = new ArrayList<Rl02e00ResultDTO>();

    /** 更正個人記事申請資料 DTO. */
    @XmlElement(name = "AppDataDto")
    @FieldName("更正個人記事申請資料 DTO")
    private Rl02e00AppDataDTO appDataDTO = new Rl02e00AppDataDTO();
    ...
    public Rl02e00AppDataDTO getAppDataDTO() {
        return appDataDTO;
    }

    public void setAppDataDTO(Rl02e00AppDataDTO appDataDTO) {
        this.appDataDTO = appDataDTO;
    }

    public List<Rl02e00ResultDTO> getResultList() {
        return resultList;
    }

    public void setResultList(List<Rl02e00ResultDTO> resultList) {
