...
@XmlType(name = "XLDF006MT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF006MT") 
public class XLDF006MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF006MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF006MTID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
