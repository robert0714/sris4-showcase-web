...
import tw.gov.moi.domain.Xldfs022bType;
import tw.gov.moi.domain.Rldfs022bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs022bType.class ,
        entityDsName = "rldfs022bByKey" ,
        xldfEntityClass = Xldfs022bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs022bQuery", xldfDsByTrans = "xldfs022bMaxSerialNo",  xldfDsBySerialNo = "xldfs022bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS022B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS022B")
public class XLDFS022B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS022B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs022bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs022bType domainObj;
     ...
     */
    public Xldfs022bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs022bType domainObj) {
