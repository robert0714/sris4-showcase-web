...
import tw.gov.moi.domain.Xldfy0a7mType;
import tw.gov.moi.domain.Rldfy0a7mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a7mType.class ,
        entityDsName = "rldfy0a7mByKey" ,
        xldfEntityClass = Xldfy0a7mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a7mQuery", xldfDsByTrans = "xldfy0a7mMaxSerialNo",  xldfDsBySerialNo = "xldfy0a7mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A7M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A7M")
public class XLDFY0A7M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A7M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a7mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a7mType domainObj;
     ...
     */
    public Xldfy0a7mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a7mType domainObj) {
