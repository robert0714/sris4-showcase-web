...
/**
 * The Class Rl0171eDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl0171eDTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl0171eAppDataDTO" })
@XmlRootElement(name = "Rl0171eDTO")
public class Rl0171eDTO implements Serializable {
    ...
    /** 出生日期更正登記 AppDataDTO. */
    @XmlElement(name = "Rl0171eAppDataDTO")
    @FieldName("出生日期更正登記 AppDataDTO")
    private Rl0171eAppDataDTO rl0171eAppDataDTO = new Rl0171eAppDataDTO();
    ...
    /**
     * Gets the rl0171e app data dto.
     * 
     * @return the rl0171e app data dto
     */
    public Rl0171eAppDataDTO getRl0171eAppDataDTO() {
        return rl0171eAppDataDTO;
    }

    /**
     * Sets the rl0171e app data dto.
     * 
     * @param rl0171eAppDataDTO
     *            the new rl0171e app data dto
     */
    public void setRl0171eAppDataDTO(Rl0171eAppDataDTO rl0171eAppDataDTO) {
        this.rl0171eAppDataDTO = rl0171eAppDataDTO;
    }
