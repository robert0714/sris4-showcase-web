...
import tw.gov.moi.domain.Xldfr0a9Type;
import tw.gov.moi.domain.Rldfr0a9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a9Type.class ,
        entityDsName = "rldfr0a9ByKey" ,
        xldfEntityClass = Xldfr0a9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a9Query", xldfDsByTrans = "xldfr0a9MaxSerialNo",  xldfDsBySerialNo = "xldfr0a9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A9")
public class XLDFR0A9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a9Type domainObj;
     ...
     */
    public Xldfr0a9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a9Type domainObj) {
