...
import tw.gov.moi.domain.Xldfs085bType;
import tw.gov.moi.domain.Rldfs085bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs085bType.class ,
        entityDsName = "rldfs085bByKey" ,
        xldfEntityClass = Xldfs085bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs085bQuery", xldfDsByTrans = "xldfs085bMaxSerialNo",  xldfDsBySerialNo = "xldfs085bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS085B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS085B")
public class XLDFS085B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS085B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs085bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs085bType domainObj;
     ...
     */
    public Xldfs085bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs085bType domainObj) {
