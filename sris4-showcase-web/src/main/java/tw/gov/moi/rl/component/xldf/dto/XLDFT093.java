...
import tw.gov.moi.domain.Xldft093Type;
import tw.gov.moi.domain.Rldft093Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft093Type.class ,
        entityDsName = "rldft093ByKey" ,
        xldfEntityClass = Xldft093Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft093Query", xldfDsByTrans = "xldft093MaxSerialNo",  xldfDsBySerialNo = "xldft093BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT093", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT093")
public class XLDFT093 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT093(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft093Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft093Type domainObj;
     ...
     */
    public Xldft093Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft093Type domainObj) {
