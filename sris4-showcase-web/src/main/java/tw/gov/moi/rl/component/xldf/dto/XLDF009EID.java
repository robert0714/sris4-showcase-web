...
@XmlType(name = "XLDF009E", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF009E") 
public class XLDF009EID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF009E.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF009EID(String fineTransactionId ,String acceptSiteId ) {
        super();
