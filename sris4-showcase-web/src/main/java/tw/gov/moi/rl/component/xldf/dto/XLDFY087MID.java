...
public class XLDFY087MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY087M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY087MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
