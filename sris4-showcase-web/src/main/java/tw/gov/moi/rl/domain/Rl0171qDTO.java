...
@XmlType(name = "rl0171qDTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl0171iAppDataDTO" })
@XmlRootElement(name = "Rl0171qDTO")
public class Rl0171qDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -4576539610519366296L;
    ...
    /** 養父姓名更正登記 app data dto. */
    @XmlElement(name = "Rl0171qAppDataDTO")
    @FieldName("養父姓名更正登記 app data dto")
    private Rl0171qAppDataDTO rl0171qAppDataDTO = new Rl0171qAppDataDTO();
    ...
    /**
     * Gets the rl0171q app data dto.
     * 
     * @return the rl0171q app data dto
     */
    public Rl0171qAppDataDTO getRl0171qAppDataDTO() {
        return rl0171qAppDataDTO;
    }

    /**
     * Sets the rl0171q app data dto.
     * 
     * @param rl0171qAppDataDTO
     *            the new rl0171q app data dto
     */
    public void setRl0171qAppDataDTO(final Rl0171qAppDataDTO rl0171qAppDataDTO) {
        this.rl0171qAppDataDTO = rl0171qAppDataDTO;
    }
}
