...
import tw.gov.moi.domain.Xldfx09jhType;
import tw.gov.moi.domain.Rldfx09jhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09jhType.class ,
        entityDsName = "rldfx09jhByKey" ,
        xldfEntityClass = Xldfx09jhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09jhQuery", xldfDsByTrans = "xldfx09jhMaxSerialNo",  xldfDsBySerialNo = "xldfx09jhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09JH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09JH")
public class XLDFX09JH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09JH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09jhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09jhType domainObj;
     ...
     */
    public Xldfx09jhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09jhType domainObj) {
