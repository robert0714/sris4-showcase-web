...
import tw.gov.moi.domain.Xldft0alType;
import tw.gov.moi.domain.Rldft0alType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0alType.class ,
        entityDsName = "rldft0alByKey" ,
        xldfEntityClass = Xldft0alType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0alQuery", xldfDsByTrans = "xldft0alMaxSerialNo",  xldfDsBySerialNo = "xldft0alBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AL", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AL")
public class XLDFT0AL implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AL(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0alType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0alType domainObj;
     ...
     */
    public Xldft0alType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0alType domainObj) {
