...
import tw.gov.moi.domain.Xldft079Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft079Type.class ,
        entityDsName = "rldft079ByKey" ,
        xldfEntityClass = Xldft079Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft079Query", xldfDsByTrans = "xldft079MaxSerialNo",  xldfDsBySerialNo = "xldft079BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT079", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT079")
public class XLDFT079 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT079(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft079Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft079Type domainObj;
     ...
     */
    public Xldft079Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft079Type domainObj) {
