...
import tw.gov.moi.domain.Xldfm02mtType;
import tw.gov.moi.domain.Tldfm02mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm02mType.class ,
        entityDsName = "tldfm02mByKey" ,
        xldfEntityClass = Xldfm02mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm02mtQuery", xldfDsByTrans = "xldfm02mtMaxSerialNo",  xldfDsBySerialNo = "xldfm02mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM02MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM02MT")
public class XLDFM02MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM02MT(String personId ,String siteId ,String spouseId ,String updateYyymmdd ,String updateHhmmss ) {
        super();
        this.domainObj = new Xldfm02mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm02mtType domainObj;
     ...
     */
    public Xldfm02mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm02mtType domainObj) {
