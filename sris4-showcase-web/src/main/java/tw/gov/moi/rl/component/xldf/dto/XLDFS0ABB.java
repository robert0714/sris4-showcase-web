...
import tw.gov.moi.domain.Xldfs0abbType;
import tw.gov.moi.domain.Rldfs0abbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0abbType.class ,
        entityDsName = "rldfs0abbByKey" ,
        xldfEntityClass = Xldfs0abbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0abbQuery", xldfDsByTrans = "xldfs0abbMaxSerialNo",  xldfDsBySerialNo = "xldfs0abbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0ABB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0ABB")
public class XLDFS0ABB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0ABB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0abbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0abbType domainObj;
     ...
     */
    public Xldfs0abbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0abbType domainObj) {
