...
public class XLDFM13MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM13M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM13MID(String personId ,String siteId ) {
        super();
