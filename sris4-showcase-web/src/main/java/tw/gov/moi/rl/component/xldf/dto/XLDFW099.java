...
import tw.gov.moi.domain.Xldfw099Type;
import tw.gov.moi.domain.Rldfw099Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw099Type.class ,
        entityDsName = "rldfw099ByKey" ,
        xldfEntityClass = Xldfw099Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw099Query", xldfDsByTrans = "xldfw099MaxSerialNo",  xldfDsBySerialNo = "xldfw099BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW099", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW099")
public class XLDFW099 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW099(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw099Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw099Type domainObj;
     ...
     */
    public Xldfw099Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw099Type domainObj) {
