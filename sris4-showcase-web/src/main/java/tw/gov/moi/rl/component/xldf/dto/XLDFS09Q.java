...
import tw.gov.moi.domain.Xldfs09qType;
import tw.gov.moi.domain.Rldfs09qType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09qType.class ,
        entityDsName = "rldfs09qByKey" ,
        xldfEntityClass = Xldfs09qType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09qQuery", xldfDsByTrans = "xldfs09qMaxSerialNo",  xldfDsBySerialNo = "xldfs09qBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09Q", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09Q")
public class XLDFS09Q implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09Q(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09qType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09qType domainObj;
     ...
     */
    public Xldfs09qType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09qType domainObj) {
