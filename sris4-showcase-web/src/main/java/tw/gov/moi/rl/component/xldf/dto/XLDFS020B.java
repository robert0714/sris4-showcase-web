...
import tw.gov.moi.domain.Xldfs020bType;
import tw.gov.moi.domain.Rldfs020bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs020bType.class ,
        entityDsName = "rldfs020bByKey" ,
        xldfEntityClass = Xldfs020bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs020bQuery", xldfDsByTrans = "xldfs020bMaxSerialNo",  xldfDsBySerialNo = "xldfs020bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS020B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS020B")
public class XLDFS020B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS020B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs020bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs020bType domainObj;
     ...
     */
    public Xldfs020bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs020bType domainObj) {
