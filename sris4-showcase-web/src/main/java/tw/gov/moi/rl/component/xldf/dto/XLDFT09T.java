...
import tw.gov.moi.domain.Xldft09tType;
import tw.gov.moi.domain.Rldft09tType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09tType.class ,
        entityDsName = "rldft09tByKey" ,
        xldfEntityClass = Xldft09tType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09tQuery", xldfDsByTrans = "xldft09tMaxSerialNo",  xldfDsBySerialNo = "xldft09tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09T")
public class XLDFT09T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09T(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09tType domainObj;
     ...
     */
    public Xldft09tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09tType domainObj) {
