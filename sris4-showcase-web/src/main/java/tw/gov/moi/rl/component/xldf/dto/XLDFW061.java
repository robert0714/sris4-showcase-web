...
import tw.gov.moi.domain.Xldfw061Type;
import tw.gov.moi.domain.Rldfw061Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw061Type.class ,
        entityDsName = "rldfw061ByKey" ,
        xldfEntityClass = Xldfw061Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw061Query", xldfDsByTrans = "xldfw061MaxSerialNo",  xldfDsBySerialNo = "xldfw061BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW061", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW061")
public class XLDFW061 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW061(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw061Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw061Type domainObj;
     ...
     */
    public Xldfw061Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw061Type domainObj) {
