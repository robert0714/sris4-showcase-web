...
/**
 * The Class Rl082a0DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Rl082a0DTO", propOrder = { "catalog", "printType", "reportFormat", "fileURL", "reportURL", "year" })
@XmlRootElement(name = "Rl082a0DTO")
public class Rl082a0DTO implements Serializable {
