...
import tw.gov.moi.domain.Xldft0a8Type;
import tw.gov.moi.domain.Rldft0a8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a8Type.class ,
        entityDsName = "rldft0a8ByKey" ,
        xldfEntityClass = Xldft0a8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a8Query", xldfDsByTrans = "xldft0a8MaxSerialNo",  xldfDsBySerialNo = "xldft0a8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A8")
public class XLDFT0A8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a8Type domainObj;
     ...
     */
    public Xldft0a8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a8Type domainObj) {
