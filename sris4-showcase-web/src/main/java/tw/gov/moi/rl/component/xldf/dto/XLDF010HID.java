...
public class XLDF010HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF010H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF010HID(String personId ,String removeYyymmdd ,String removeTime ,String siteId ,String specialCode ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(specialCode, StringUtils.EMPTY)));
