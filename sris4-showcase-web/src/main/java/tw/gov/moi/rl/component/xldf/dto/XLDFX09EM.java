...
import tw.gov.moi.domain.Xldfx09emType;
import tw.gov.moi.domain.Rldfx09emType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09emType.class ,
        entityDsName = "rldfx09emByKey" ,
        xldfEntityClass = Xldfx09emType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09emQuery", xldfDsByTrans = "xldfx09emMaxSerialNo",  xldfDsBySerialNo = "xldfx09emBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09EM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09EM")
public class XLDFX09EM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09EM(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09emType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09emType domainObj;
     ...
     */
    public Xldfx09emType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09emType domainObj) {
