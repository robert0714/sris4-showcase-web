...
import tw.gov.moi.domain.Xldft09fType;
import tw.gov.moi.domain.Rldft09fType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09fType.class ,
        entityDsName = "rldft09fByKey" ,
        xldfEntityClass = Xldft09fType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09fQuery", xldfDsByTrans = "xldft09fMaxSerialNo",  xldfDsBySerialNo = "xldft09fBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09F", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09F")
public class XLDFT09F implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09F(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09fType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09fType domainObj;
     ...
     */
    public Xldft09fType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09fType domainObj) {
