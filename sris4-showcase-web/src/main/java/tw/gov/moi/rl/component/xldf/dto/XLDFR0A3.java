...
import tw.gov.moi.domain.Xldfr0a3Type;
import tw.gov.moi.domain.Rldfr0a3Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a3Type.class ,
        entityDsName = "rldfr0a3ByKey" ,
        xldfEntityClass = Xldfr0a3Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a3Query", xldfDsByTrans = "xldfr0a3MaxSerialNo",  xldfDsBySerialNo = "xldfr0a3BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A3", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A3")
public class XLDFR0A3 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A3(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a3Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a3Type domainObj;
     ...
     */
    public Xldfr0a3Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a3Type domainObj) {
