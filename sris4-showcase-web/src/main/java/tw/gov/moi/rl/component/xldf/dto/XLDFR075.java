...
import tw.gov.moi.domain.Xldfr075Type;
import tw.gov.moi.domain.Rldfr075Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr075Type.class ,
        entityDsName = "rldfr075ByKey" ,
        xldfEntityClass = Xldfr075Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr075Query", xldfDsByTrans = "xldfr075MaxSerialNo",  xldfDsBySerialNo = "xldfr075BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR075", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR075")
public class XLDFR075 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR075(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr075Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr075Type domainObj;
     ...
     */
    public Xldfr075Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr075Type domainObj) {
