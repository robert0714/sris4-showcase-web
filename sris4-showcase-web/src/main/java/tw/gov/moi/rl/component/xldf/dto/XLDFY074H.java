...
import tw.gov.moi.domain.Xldfy074hType;
import tw.gov.moi.domain.Rldfy074hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy074hType.class ,
        entityDsName = "rldfy074hByKey" ,
        xldfEntityClass = Xldfy074hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy074hQuery", xldfDsByTrans = "xldfy074hMaxSerialNo",  xldfDsBySerialNo = "xldfy074hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY074H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY074H")
public class XLDFY074H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY074H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy074hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy074hType domainObj;
     ...
     */
    public Xldfy074hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy074hType domainObj) {
