...
import tw.gov.moi.domain.Xldfw0bdType;
import tw.gov.moi.domain.Rldfw0bdType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0bdType.class ,
        entityDsName = "rldfw0bdByKey" ,
        xldfEntityClass = Xldfw0bdType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0bdQuery", xldfDsByTrans = "xldfw0bdMaxSerialNo",  xldfDsBySerialNo = "xldfw0bdBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0BD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0BD")
public class XLDFW0BD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0BD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0bdType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0bdType domainObj;
     ...
     */
    public Xldfw0bdType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0bdType domainObj) {
