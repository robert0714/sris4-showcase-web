...
@XmlType(name = "XLDFY0ABM", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0ABM") 
public class XLDFY0ABMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0ABM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0ABMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
