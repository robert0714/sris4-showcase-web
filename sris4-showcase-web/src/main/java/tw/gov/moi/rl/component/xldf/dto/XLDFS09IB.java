...
import tw.gov.moi.domain.Xldfs09ibType;
import tw.gov.moi.domain.Rldfs09ibType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09ibType.class ,
        entityDsName = "rldfs09ibByKey" ,
        xldfEntityClass = Xldfs09ibType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09ibQuery", xldfDsByTrans = "xldfs09ibMaxSerialNo",  xldfDsBySerialNo = "xldfs09ibBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09IB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09IB")
public class XLDFS09IB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09IB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09ibType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09ibType domainObj;
     ...
     */
    public Xldfs09ibType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09ibType domainObj) {
