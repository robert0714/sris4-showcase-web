...
import tw.gov.moi.domain.Xldfr079Type;
import tw.gov.moi.domain.Rldfr079Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr079Type.class ,
        entityDsName = "rldfr079ByKey" ,
        xldfEntityClass = Xldfr079Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr079Query", xldfDsByTrans = "xldfr079MaxSerialNo",  xldfDsBySerialNo = "xldfr079BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR079", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR079")
public class XLDFR079 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR079(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr079Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr079Type domainObj;
     ...
     */
    public Xldfr079Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr079Type domainObj) {
