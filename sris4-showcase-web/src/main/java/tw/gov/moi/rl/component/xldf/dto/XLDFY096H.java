...
import tw.gov.moi.domain.Xldfy096hType;
import tw.gov.moi.domain.Rldfy096hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy096hType.class ,
        entityDsName = "rldfy096hByKey" ,
        xldfEntityClass = Xldfy096hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy096hQuery", xldfDsByTrans = "xldfy096hMaxSerialNo",  xldfDsBySerialNo = "xldfy096hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY096H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY096H")
public class XLDFY096H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY096H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy096hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy096hType domainObj;
     ...
     */
    public Xldfy096hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy096hType domainObj) {
