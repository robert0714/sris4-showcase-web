...
import tw.gov.moi.domain.Xldfs035Type;
import tw.gov.moi.domain.Rldfs035Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs035Type.class ,
        entityDsName = "rldfs035ByKey" ,
        xldfEntityClass = Xldfs035Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs035Query", xldfDsByTrans = "xldfs035MaxSerialNo",  xldfDsBySerialNo = "xldfs035BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS035", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS035")
public class XLDFS035 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS035(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs035Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs035Type domainObj;
     ...
     */
    public Xldfs035Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs035Type domainObj) {
