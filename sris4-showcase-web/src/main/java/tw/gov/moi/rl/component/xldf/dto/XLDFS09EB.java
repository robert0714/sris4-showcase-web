...
import tw.gov.moi.domain.Xldfs09ebType;
import tw.gov.moi.domain.Rldfs09ebType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09ebType.class ,
        entityDsName = "rldfs09ebByKey" ,
        xldfEntityClass = Xldfs09ebType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09ebQuery", xldfDsByTrans = "xldfs09ebMaxSerialNo",  xldfDsBySerialNo = "xldfs09ebBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09EB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09EB")
public class XLDFS09EB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09EB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09ebType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09ebType domainObj;
     ...
     */
    public Xldfs09ebType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09ebType domainObj) {
