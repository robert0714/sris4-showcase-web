...
import tw.gov.moi.domain.Xldfs0b5Type;
import tw.gov.moi.domain.Rldfs0b5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b5Type.class ,
        entityDsName = "rldfs0b5ByKey" ,
        xldfEntityClass = Xldfs0b5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b5Query", xldfDsByTrans = "xldfs0b5MaxSerialNo",  xldfDsBySerialNo = "xldfs0b5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B5")
public class XLDFS0B5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0b5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b5Type domainObj;
     ...
     */
    public Xldfs0b5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b5Type domainObj) {
