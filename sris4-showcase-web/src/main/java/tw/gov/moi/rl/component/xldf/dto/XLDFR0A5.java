...
import tw.gov.moi.domain.Xldfr0a5Type;
import tw.gov.moi.domain.Rldfr0a5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a5Type.class ,
        entityDsName = "rldfr0a5ByKey" ,
        xldfEntityClass = Xldfr0a5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a5Query", xldfDsByTrans = "xldfr0a5MaxSerialNo",  xldfDsBySerialNo = "xldfr0a5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A5")
public class XLDFR0A5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a5Type domainObj;
     ...
     */
    public Xldfr0a5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a5Type domainObj) {
