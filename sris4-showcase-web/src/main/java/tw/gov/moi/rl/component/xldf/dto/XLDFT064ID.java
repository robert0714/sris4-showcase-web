...
@XmlType(name = "XLDFT064", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFT064") 
public class XLDFT064ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFT064.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFT064ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
