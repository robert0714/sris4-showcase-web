...
import tw.gov.moi.domain.Xldfs081Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs081Type.class ,
        entityDsName = "rldfs081ByKey" ,
        xldfEntityClass = Xldfs081Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs081Query", xldfDsByTrans = "xldfs081MaxSerialNo",  xldfDsBySerialNo = "xldfs081BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS081", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS081")
public class XLDFS081 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS081(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs081Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs081Type domainObj;
     ...
     */
    public Xldfs081Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs081Type domainObj) {
