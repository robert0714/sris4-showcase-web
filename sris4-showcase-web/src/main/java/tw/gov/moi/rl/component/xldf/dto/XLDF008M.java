 ...
 */
@RldfMappingEntity(
        value = Rldf008mType.class ,
        entityDsName = "rldf008mByKey" ,
        xldfEntityClass = Xldf008mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf008mQuery", xldfDsByTrans = "xldf008mMaxSerialNo",  xldfDsBySerialNo = "xldf008mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF008M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF008M")
public class XLDF008M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF008M(String personId ,String specialCode ,String siteId ) {
        super();
        this.domainObj = new Xldf008mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf008mType domainObj;
     ...
     */
    public Xldf008mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf008mType domainObj) {
