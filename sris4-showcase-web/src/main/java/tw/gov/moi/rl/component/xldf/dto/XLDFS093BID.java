...
@XmlType(name = "XLDFS093B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS093B") 
public class XLDFS093BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS093B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS093BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
