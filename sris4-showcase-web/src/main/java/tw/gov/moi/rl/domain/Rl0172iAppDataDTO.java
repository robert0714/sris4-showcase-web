...
@XmlType(name = "rl0172iAppDataDTO", propOrder = { "beforeFosterFather", "beforeFosterFatherLastName",
...
@XmlRootElement(name = "Rl0172iAppDataDTO")
public class Rl0172iAppDataDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -6693631044249085650L;
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Rl0172iAppDataDTO other = (Rl0172iAppDataDTO) obj;
