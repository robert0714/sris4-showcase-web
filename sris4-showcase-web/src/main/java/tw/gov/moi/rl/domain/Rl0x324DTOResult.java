...
@XmlType(name = "rl0x324DTOResult", propOrder = { "streetDoorplate", "street", "section", "lane", "alley", "alley1",
        "alley2", "area", "areaSite", "doorNo", "floorNo" })
@XmlRootElement(name = "Rl0x324DTOResult")
public class Rl0x324DTOResult implements Serializable {
