...
import tw.gov.moi.domain.Xldfw0caType;
import tw.gov.moi.domain.Rldfw0caType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0caType.class ,
        entityDsName = "rldfw0caByKey" ,
        xldfEntityClass = Xldfw0caType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0caQuery", xldfDsByTrans = "xldfw0caMaxSerialNo",  xldfDsBySerialNo = "xldfw0caBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0CA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0CA")
public class XLDFW0CA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0CA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0caType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0caType domainObj;
     ...
     */
    public Xldfw0caType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0caType domainObj) {
