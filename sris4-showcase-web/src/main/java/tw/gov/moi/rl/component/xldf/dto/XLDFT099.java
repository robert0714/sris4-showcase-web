...
import tw.gov.moi.domain.Xldft099Type;
import tw.gov.moi.domain.Rldft099Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft099Type.class ,
        entityDsName = "rldft099ByKey" ,
        xldfEntityClass = Xldft099Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft099Query", xldfDsByTrans = "xldft099MaxSerialNo",  xldfDsBySerialNo = "xldft099BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT099", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT099")
public class XLDFT099 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT099(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft099Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft099Type domainObj;
     ...
     */
    public Xldft099Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft099Type domainObj) {
