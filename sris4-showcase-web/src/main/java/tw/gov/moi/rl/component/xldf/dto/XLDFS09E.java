...
import tw.gov.moi.domain.Xldfs09eType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09eType.class ,
        entityDsName = "rldfs09eByKey" ,
        xldfEntityClass = Xldfs09eType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09eQuery", xldfDsByTrans = "xldfs09eMaxSerialNo",  xldfDsBySerialNo = "xldfs09eBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09E", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09E")
public class XLDFS09E implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09E(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09eType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09eType domainObj;
     ...
     */
    public Xldfs09eType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09eType domainObj) {
