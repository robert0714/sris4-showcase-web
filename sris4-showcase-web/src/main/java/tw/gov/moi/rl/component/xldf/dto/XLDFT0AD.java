...
import tw.gov.moi.domain.Xldft0adType;
import tw.gov.moi.domain.Rldft0adType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0adType.class ,
        entityDsName = "rldft0adByKey" ,
        xldfEntityClass = Xldft0adType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0adQuery", xldfDsByTrans = "xldft0adMaxSerialNo",  xldfDsBySerialNo = "xldft0adBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AD")
public class XLDFT0AD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0adType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0adType domainObj;
     ...
     */
    public Xldft0adType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0adType domainObj) {
