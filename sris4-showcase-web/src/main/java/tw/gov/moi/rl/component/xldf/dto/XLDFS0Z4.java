...
import tw.gov.moi.domain.Xldfs0z4Type;
import tw.gov.moi.domain.Rldfs0z4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0z4Type.class ,
        entityDsName = "rldfs0z4ByKey" ,
        xldfEntityClass = Xldfs0z4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0z4Query", xldfDsByTrans = "xldfs0z4MaxSerialNo",  xldfDsBySerialNo = "xldfs0z4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0Z4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0Z4")
public class XLDFS0Z4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0Z4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0z4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0z4Type domainObj;
     ...
     */
    public Xldfs0z4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0z4Type domainObj) {
