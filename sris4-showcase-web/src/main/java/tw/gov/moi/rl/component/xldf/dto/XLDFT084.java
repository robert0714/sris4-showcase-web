...
import tw.gov.moi.domain.Xldft084Type;
import tw.gov.moi.domain.Rldft084Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft084Type.class ,
        entityDsName = "rldft084ByKey" ,
        xldfEntityClass = Xldft084Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft084Query", xldfDsByTrans = "xldft084MaxSerialNo",  xldfDsBySerialNo = "xldft084BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT084", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT084")
public class XLDFT084 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT084(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft084Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft084Type domainObj;
     ...
     */
    public Xldft084Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft084Type domainObj) {
