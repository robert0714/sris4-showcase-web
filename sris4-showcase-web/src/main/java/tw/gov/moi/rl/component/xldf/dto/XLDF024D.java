...
import tw.gov.moi.domain.Xldf024dType;
import tw.gov.moi.domain.Rldf024dType;
 ...
 */
@RldfMappingEntity(
        value = Rldf024dType.class ,
        entityDsName = "rldf024dByKey" ,
        xldfEntityClass = Xldf024dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf024dQuery", xldfDsByTrans = "xldf024dMaxSerialNo",  xldfDsBySerialNo = "xldf024dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF024D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF024D")
public class XLDF024D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF024D(String personId ,String specialCode ,String siteId ) {
        super();
        this.domainObj = new Xldf024dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf024dType domainObj;
     ...
     */
    public Xldf024dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf024dType domainObj) {
