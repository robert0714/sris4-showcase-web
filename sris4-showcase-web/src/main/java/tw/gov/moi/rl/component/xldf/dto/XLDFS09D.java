...
import tw.gov.moi.domain.Xldfs09dType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09dType.class ,
        entityDsName = "rldfs09dByKey" ,
        xldfEntityClass = Xldfs09dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09dQuery", xldfDsByTrans = "xldfs09dMaxSerialNo",  xldfDsBySerialNo = "xldfs09dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09D")
public class XLDFS09D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09D(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09dType domainObj;
     ...
     */
    public Xldfs09dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09dType domainObj) {
