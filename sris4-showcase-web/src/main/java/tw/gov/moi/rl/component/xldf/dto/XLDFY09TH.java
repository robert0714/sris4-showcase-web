...
import tw.gov.moi.domain.Xldfy09thType;
import tw.gov.moi.domain.Rldfy09thType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09thType.class ,
        entityDsName = "rldfy09thByKey" ,
        xldfEntityClass = Xldfy09thType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09thQuery", xldfDsByTrans = "xldfy09thMaxSerialNo",  xldfDsBySerialNo = "xldfy09thBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09TH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09TH")
public class XLDFY09TH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09TH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09thType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09thType domainObj;
     ...
     */
    public Xldfy09thType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09thType domainObj) {
