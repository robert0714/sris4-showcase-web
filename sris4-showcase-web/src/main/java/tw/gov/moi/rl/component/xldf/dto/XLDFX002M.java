...
import tw.gov.moi.domain.Xldfx002mType;
import tw.gov.moi.domain.Rldfx002mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx002mType.class ,
        entityDsName = "rldfx002mByKey" ,
        xldfEntityClass = Xldfx002mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx002mQuery", xldfDsByTrans = "xldfx002mMaxSerialNo",  xldfDsBySerialNo = "xldfx002mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX002M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX002M")
public class XLDFX002M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX002M(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx002mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx002mType domainObj;
     ...
     */
    public Xldfx002mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx002mType domainObj) {
