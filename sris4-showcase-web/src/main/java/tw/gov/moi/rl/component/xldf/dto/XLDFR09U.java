...
import tw.gov.moi.domain.Xldfr09uType;
import tw.gov.moi.domain.Rldfr09uType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09uType.class ,
        entityDsName = "rldfr09uByKey" ,
        xldfEntityClass = Xldfr09uType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09uQuery", xldfDsByTrans = "xldfr09uMaxSerialNo",  xldfDsBySerialNo = "xldfr09uBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09U", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09U")
public class XLDFR09U implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09U(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09uType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09uType domainObj;
     ...
     */
    public Xldfr09uType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09uType domainObj) {
