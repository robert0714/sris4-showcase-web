...
import tw.gov.moi.domain.Xldft065Type;
import tw.gov.moi.domain.Rldft065Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft065Type.class ,
        entityDsName = "rldft065ByKey" ,
        xldfEntityClass = Xldft065Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft065Query", xldfDsByTrans = "xldft065MaxSerialNo",  xldfDsBySerialNo = "xldft065BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT065", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT065")
public class XLDFT065 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT065(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft065Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft065Type domainObj;
     ...
     */
    public Xldft065Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft065Type domainObj) {
