...
import tw.gov.moi.domain.Xldfy09fmType;
import tw.gov.moi.domain.Rldfy09fmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09fmType.class ,
        entityDsName = "rldfy09fmByKey" ,
        xldfEntityClass = Xldfy09fmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09fmQuery", xldfDsByTrans = "xldfy09fmMaxSerialNo",  xldfDsBySerialNo = "xldfy09fmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09FM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09FM")
public class XLDFY09FM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09FM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09fmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09fmType domainObj;
     ...
     */
    public Xldfy09fmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09fmType domainObj) {
