...
import tw.gov.moi.domain.Xldfs091Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs091Type.class ,
        entityDsName = "rldfs091ByKey" ,
        xldfEntityClass = Xldfs091Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs091Query", xldfDsByTrans = "xldfs091MaxSerialNo",  xldfDsBySerialNo = "xldfs091BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS091", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS091")
public class XLDFS091 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS091(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs091Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs091Type domainObj;
     ...
     */
    public Xldfs091Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs091Type domainObj) {
