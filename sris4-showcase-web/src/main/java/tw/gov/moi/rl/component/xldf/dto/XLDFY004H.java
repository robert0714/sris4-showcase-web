...
import tw.gov.moi.domain.Xldfy004hType;
import tw.gov.moi.domain.Rldfy004hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy004hType.class ,
        entityDsName = "rldfy004hByKey" ,
        xldfEntityClass = Xldfy004hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy004hQuery", xldfDsByTrans = "xldfy004hMaxSerialNo",  xldfDsBySerialNo = "xldfy004hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY004H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY004H")
public class XLDFY004H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY004H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy004hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy004hType domainObj;
     ...
     */
    public Xldfy004hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy004hType domainObj) {
