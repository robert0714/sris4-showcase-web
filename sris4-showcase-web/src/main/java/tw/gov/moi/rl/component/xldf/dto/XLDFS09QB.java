...
import tw.gov.moi.domain.Xldfs09qbType;
import tw.gov.moi.domain.Rldfs09qbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09qbType.class ,
        entityDsName = "rldfs09qbByKey" ,
        xldfEntityClass = Xldfs09qbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09qbQuery", xldfDsByTrans = "xldfs09qbMaxSerialNo",  xldfDsBySerialNo = "xldfs09qbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09QB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09QB")
public class XLDFS09QB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09QB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09qbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09qbType domainObj;
     ...
     */
    public Xldfs09qbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09qbType domainObj) {
