...
import tw.gov.moi.domain.Xldfy09dhType;
import tw.gov.moi.domain.Rldfy09dhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09dhType.class ,
        entityDsName = "rldfy09dhByKey" ,
        xldfEntityClass = Xldfy09dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09dhQuery", xldfDsByTrans = "xldfy09dhMaxSerialNo",  xldfDsBySerialNo = "xldfy09dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09DH")
public class XLDFY09DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09DH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09dhType domainObj;
     ...
     */
    public Xldfy09dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09dhType domainObj) {
