...
import tw.gov.moi.domain.Xldfy09nmType;
import tw.gov.moi.domain.Rldfy09nmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09nmType.class ,
        entityDsName = "rldfy09nmByKey" ,
        xldfEntityClass = Xldfy09nmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09nmQuery", xldfDsByTrans = "xldfy09nmMaxSerialNo",  xldfDsBySerialNo = "xldfy09nmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09NM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09NM")
public class XLDFY09NM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09NM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09nmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09nmType domainObj;
     ...
     */
    public Xldfy09nmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09nmType domainObj) {
