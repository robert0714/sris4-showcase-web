...
import tw.gov.moi.domain.Rldfs211Type;
...
public class Rl0x311DTO implements Serializable {
    ...
    @FieldName("來源資料")
    private Rldf007mType selectData = new Rldf007mType();

    @XmlElement(name = "Resutlts")
    @FieldName("查詢結果")
    private List<Rldf007mType> resutlts = new ArrayList<Rldf007mType>();

    @XmlElement(name = "Recored")
    @FieldName("修改紀錄")
    private Rldfs211Type recored = new Rldfs211Type();
    ...
    @XmlElement(name = "old_approve_date")
    @FieldName("old_approve_date")
    private String old_approve_date = StringUtils.EMPTY;

    @XmlElement(name = "old_approve_docu_no")
    @FieldName("old_approve_docu_no")
    private String old_approve_docu_no = StringUtils.EMPTY;
    ...
    @XmlElement(name = "new_approve_date")
    @FieldName("new_approve_date")
    private String new_approve_date = StringUtils.EMPTY;

    @XmlElement(name = "new_approve_docu_no")
    @FieldName("new_approve_docu_no")
    private String new_approve_docu_no = StringUtils.EMPTY;
    ...
    @FieldName("愈鎖定之資料")
    private Rldf007mType lockData = null;

    @XmlElement(name = "unLockData")
    @FieldName("愈解鎖之鎖定之資料")
    private Rldf007mType unLockData = null;
    ...
    @FieldName("是否")
    private String checkApprove = "F";

    @XmlElement(name = "CommononType")
    @FieldName("R檔預設值")
    private Rldf007mType commononType = null;
    ...
    public Rldf007mType getSelectData() {
        return selectData;
    }

    public void setSelectData(Rldf007mType selectData) {
        this.selectData = selectData;
    }

    public List<Rldf007mType> getResutlts() {
        return resutlts;
    }

    public void setResutlts(List<Rldf007mType> resutlts) {
        this.resutlts = resutlts;
    }

    public Rldfs211Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs211Type recored) {
    ...
    public Rldf007mType getCommononType() {
        return commononType;
    }

    public void setCommononType(Rldf007mType commononType) {
        this.commononType = commononType;
    }

    public Rldf007mType getLockData() {
        return lockData;
    }

    public void setLockData(Rldf007mType lockData) {
        this.lockData = lockData;
    }

    public Rldf007mType getUnLockData() {
        return unLockData;
    }

    public void setUnLockData(Rldf007mType unLockData) {
        this.unLockData = unLockData;
    }

    public String getNew_approve_date() {
        return new_approve_date;
    }

    public void setNew_approve_date(String new_approve_date) {
        this.new_approve_date = new_approve_date;
    }

    public String getNew_approve_docu_no() {
        return new_approve_docu_no;
    }

    public void setNew_approve_docu_no(String new_approve_docu_no) {
        this.new_approve_docu_no = new_approve_docu_no;
    }

    public String getOld_approve_date() {
        return old_approve_date;
    }

    public void setOld_approve_date(String old_approve_date) {
        this.old_approve_date = old_approve_date;
    }

    public String getOld_approve_docu_no() {
        return old_approve_docu_no;
    }

    public void setOld_approve_docu_no(String old_approve_docu_no) {
        this.old_approve_docu_no = old_approve_docu_no;
    }
