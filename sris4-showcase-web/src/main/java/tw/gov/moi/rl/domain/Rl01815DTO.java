...
import tw.gov.moi.rl.component.xldf.dto.XLDFY09EH;
import tw.gov.moi.rl.component.xldf.dto.XLDFY09EM;
...
@XmlType(name = "rl01815DTO", propOrder = { "lockMode", "birthKind", "mainPersonHouseholdData", "mainPersonData", "mainHouseholdheadPersonData", "mainPersonRole", "mainPersonSiteId", "mainPersonBookFlag", "mainPersonOrgEducationMark", "mainPersonForeignPersonData", "fatherPersonId", "fatherSiteId", "fatherRemoveYyymmdd", "fatherRemoveTime", "fatherHouseholdData", "fatherPersonData", "fatherRole", "fatherBookFlag", "fatherOrgEducationMark", "fatherForeignPersonData", "fatherMemoryPerson", "motherPersonId", "motherSiteId", "motherRemoveYyymmdd", "motherRemoveTime", "motherHouseholdData", "motherPersonData", "motherRole", "motherBookFlag", "motherOrgEducationMark", "motherForeignPersonData", "motherMemoryPerson", "orgHouseholdMemberList", "newHouseholdMemberList", "newHouseholdChiefPersonData", "lastNewHouseholdChiefPersonId", "orgRelationshipMap", "cancelDate", "originalRegister", "cancelReason", "certificate", "certificateList", "otherCertificate", "registerContent", "needFineFlag", "doM10MCheckFlag", "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication", "apply1", "apply2", "delegated", "householdNoteList", "personNoteList", "householdNoteDetailList", "personNoteDetailList", "removedPersonNoteDetailList", "previousDoFineCheckFlag", "previousFineEventDate", "receiptId", "doFineCheckFlag", "fineEventDate", "fineFreeFlag", "removeFeeReason", "fineDTO", "deleteFineDTOFlag", "finePerson", "systemDate", "systemTime", "openingOperationDTO", "warningMessgeList", "crossSiteEnabled", "enforcedFlag", "outliveCase", "relatedOutliveCase", "enforcedApplicant", "acceptAdminOfficeCode", "otherCertificateCode", "otherCertificateShow", "saveButtonShow", "fineButtonShow", "doFineCheckFlagOpen", "transactionId", "applySequenceId", "applySeq", "applyCaseNo", "operationCode", "initSuccess", "activeIndex", "styleForPersonId", "styleForSiteId", "ellipsisStyleForFirstName", "ellipsisStyleForLastName", "ellipsisStyleForPersonName" })
@XmlRootElement(name = "Rl01815DTO")
public class Rl01815DTO implements Serializable {
    ...
    /** 原戶下人員清單 */
    @XmlElement(name = "OrgHouseholdMemberList", required = true)
    @FieldName("原戶下人員清單")
    private List<XLDFPersonDataDomainObject> orgHouseholdMemberList = new ArrayList<XLDFPersonDataDomainObject>();

    /** 新戶下人員清單 */
    @XmlElement(name = "NewHouseholdMemberList", required = true)
    @FieldName("新戶下人員清單")
    private List<XLDFPersonDataDomainObject> newHouseholdMemberList = new ArrayList<XLDFPersonDataDomainObject>();

    /** 新戶長-個人基本資料 */
    @XmlElement(name = "NewHouseholdChiefPersonData", required = true)
    @FieldName("新戶長-個人基本資料")
    private XLDFPersonDataDomainObject newHouseholdChiefPersonData;

    /** 上一次選取之新戶長統號 */
    @XmlElement(name = "LastNewHouseholdChiefPersonId", required = true)
    @FieldName("上一次選取之新戶長統號")
    private String lastNewHouseholdChiefPersonId;

    /** 原戶下人員清單之稱謂 */
    @XmlElement(name = "OrgRelationshipMap", required = true)
    @FieldName("原戶下人員清單之稱謂")
    private Map<String, String> orgRelationshipMap = new HashMap<String, String>();
    ...
    /** 原登記事項 */
    @XmlElement(name = "OriginalRegister", required = true)
    @FieldName("原登記事項")
    private String originalRegister;
    ...
    @FieldName("個人記事欄位化清單")
    private List<XLDFY09EM> personNoteDetailList = new ArrayList<XLDFY09EM>();

    /** 除戶個人記事欄位化清單 */
    @XmlElement(name = "RemovedPersonNoteDetailList", required = true)
    @FieldName("除戶個人記事欄位化清單")
    private List<XLDFY09EH> removedPersonNoteDetailList = new ArrayList<XLDFY09EH>();
     ...
     * @return 原戶下人員清單
     */
    public List<XLDFPersonDataDomainObject> getOrgHouseholdMemberList() {
        return orgHouseholdMemberList;
    }

    /**
     * 設定原戶下人員清單
     * 
     * @param orgHouseholdMemberList
     *            原戶下人員清單
     */
    public void setOrgHouseholdMemberList(final List<XLDFPersonDataDomainObject> orgHouseholdMemberList) {
        this.orgHouseholdMemberList = orgHouseholdMemberList;
    }
     ...
     * @return 新戶下人員清單
     */
    public List<XLDFPersonDataDomainObject> getNewHouseholdMemberList() {
        return newHouseholdMemberList;
    }

    /**
     * 設定新戶下人員清單
     * 
     * @param newHouseholdMemberList
     *            新戶下人員清單
     */
    public void setNewHouseholdMemberList(final List<XLDFPersonDataDomainObject> newHouseholdMemberList) {
        this.newHouseholdMemberList = newHouseholdMemberList;
    }
     ...
     * @return 新戶長-個人基本資料
     */
    public XLDFPersonDataDomainObject getNewHouseholdChiefPersonData() {
        return newHouseholdChiefPersonData;
    }

    /**
     * 設定新戶長-個人基本資料
     * 
     * @param newHouseholdChiefPersonData
     *            新戶長-個人基本資料
     */
    public void setNewHouseholdChiefPersonData(final XLDFPersonDataDomainObject newHouseholdChiefPersonData) {
        this.newHouseholdChiefPersonData = newHouseholdChiefPersonData;
    }
     ...
     * @return 上一次選取之新戶長統號
     */
    public String getLastNewHouseholdChiefPersonId() {
        return lastNewHouseholdChiefPersonId;
    }

    /**
     * 設定上一次選取之新戶長統號
     * 
     * @param lastNewHouseholdChiefPersonId
     *            上一次選取之新戶長統號
     */
    public void setLastNewHouseholdChiefPersonId(final String lastNewHouseholdChiefPersonId) {
        this.lastNewHouseholdChiefPersonId = lastNewHouseholdChiefPersonId;
    }
     ...
     * @return 原戶下人員清單之稱謂
     */
    public Map<String, String> getOrgRelationshipMap() {
     ...
     * 設定原戶下人員清單之稱謂
     * 
     * @param orgRelationshipMap
     *            原戶下人員清單之稱謂
     */
    public void setOrgRelationshipMap(final Map<String, String> orgRelationshipMap) {
        this.orgRelationshipMap = orgRelationshipMap;
    }
     ...
     * @return 原登記事項
     */
    public String getOriginalRegister() {
     ...
     * 設定原登記事項
     * 
     * @param originalRegister
     *            原登記事項
     */
    public void setOriginalRegister(final String originalRegister) {
     ...
     * @return 個人記事欄位化清單
     */
    public List<XLDFY09EM> getPersonNoteDetailList() {
     ...
     *            個人記事欄位化清單
     */
    public void setPersonNoteDetailList(final List<XLDFY09EM> personNoteDetailList) {
     ...
     * @return 除戶個人記事欄位化清單
     */
    public List<XLDFY09EH> getRemovedPersonNoteDetailList() {
     ...
     *            除戶個人記事欄位化清單
     */
    public void setRemovedPersonNoteDetailList(final List<XLDFY09EH> removedPersonNoteDetailList) {
