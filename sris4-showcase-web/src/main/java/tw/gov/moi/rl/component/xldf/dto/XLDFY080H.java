...
import tw.gov.moi.domain.Xldfy080hType;
import tw.gov.moi.domain.Rldfy080hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy080hType.class ,
        entityDsName = "rldfy080hByKey" ,
        xldfEntityClass = Xldfy080hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy080hQuery", xldfDsByTrans = "xldfy080hMaxSerialNo",  xldfDsBySerialNo = "xldfy080hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY080H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY080H")
public class XLDFY080H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY080H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy080hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy080hType domainObj;
     ...
     */
    public Xldfy080hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy080hType domainObj) {
