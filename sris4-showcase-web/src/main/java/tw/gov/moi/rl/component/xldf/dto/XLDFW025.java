...
import tw.gov.moi.domain.Xldfw025Type;
import tw.gov.moi.domain.Rldfw025Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw025Type.class ,
        entityDsName = "rldfw025ByKey" ,
        xldfEntityClass = Xldfw025Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw025Query", xldfDsByTrans = "xldfw025MaxSerialNo",  xldfDsBySerialNo = "xldfw025BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW025", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW025")
public class XLDFW025 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW025(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw025Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw025Type domainObj;
     ...
     */
    public Xldfw025Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw025Type domainObj) {
