...
import tw.gov.moi.domain.Xldfs0a5Type;
import tw.gov.moi.domain.Rldfs0a5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a5Type.class ,
        entityDsName = "rldfs0a5ByKey" ,
        xldfEntityClass = Xldfs0a5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a5Query", xldfDsByTrans = "xldfs0a5MaxSerialNo",  xldfDsBySerialNo = "xldfs0a5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A5")
public class XLDFS0A5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a5Type domainObj;
     ...
     */
    public Xldfs0a5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a5Type domainObj) {
