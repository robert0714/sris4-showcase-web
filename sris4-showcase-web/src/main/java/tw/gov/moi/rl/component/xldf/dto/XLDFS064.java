...
import tw.gov.moi.domain.Xldfs064Type;
import tw.gov.moi.domain.Rldfs064Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs064Type.class ,
        entityDsName = "rldfs064ByKey" ,
        xldfEntityClass = Xldfs064Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs064Query", xldfDsByTrans = "xldfs064MaxSerialNo",  xldfDsBySerialNo = "xldfs064BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS064", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS064")
public class XLDFS064 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS064(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs064Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs064Type domainObj;
     ...
     */
    public Xldfs064Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs064Type domainObj) {
