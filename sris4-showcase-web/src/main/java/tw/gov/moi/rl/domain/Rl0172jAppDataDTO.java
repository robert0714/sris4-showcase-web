...
@XmlType(name = "rl0172jAppDataDTO", propOrder = { "beforeFosterMother", "beforeFosterMotherLastName",
...
@XmlRootElement(name = "Rl0172jAppDataDTO")
public class Rl0172jAppDataDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 3224725208381723428L;
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Rl0172jAppDataDTO other = (Rl0172jAppDataDTO) obj;
