...
import tw.gov.moi.domain.Rldfs047bType;
import tw.gov.moi.domain.Xldfs047bType;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfs047bType.class, entityDsName = "rldfs047bByKey", xldfEntityClass = Xldfs047bType.class, keys = {
        ...
        @XldfKeyMapping(name = "applySeq", length = 12), @XldfKeyMapping(name = "certificateCode", length = 3)

})
@XldfDsNameMaping(xldfDsName = "xldfs047bQuery", xldfDsByTrans = "xldfs047bMaxSerialNo", xldfDsBySerialNo = "xldfs047bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS047B", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFS047B")
public class XLDFS047B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS047B(String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq,
            String certificateCode) {
        super();
        this.domainObj = new Xldfs047bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs047bType domainObj;
     ...
     */
    public Xldfs047bType getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfs047bType domainObj) {
