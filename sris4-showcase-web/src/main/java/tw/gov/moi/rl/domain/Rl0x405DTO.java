...
import tw.gov.moi.domain.Rldfs105Type;
import tw.gov.moi.domain.Rldft005Type;

@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl0x405DTO", propOrder = { "mainDTO", "editResult", "quertDto", "selectData", "resutlts", "recored",
        "reason", "isVerify", "commononType", "lockData", "unLockData" })
@XmlRootElement(name = "Rl0x405DTO")
public class Rl0x405DTO implements Serializable {
    ...
    @FieldName("修改紀錄")
    private Rldfs105Type recored = new Rldfs105Type();
    ...
    @FieldName("R檔預設值")
    private Rldft005Type commononType = null;
    ...
    public Rldfs105Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs105Type recored) {
    ...
    public Rldft005Type getCommononType() {
        return commononType;
    }

    public void setCommononType(Rldft005Type commononType) {
