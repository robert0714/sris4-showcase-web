...
import tw.gov.moi.domain.Xldfs09cType;
import tw.gov.moi.domain.Rldfs09cType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09cType.class ,
        entityDsName = "rldfs09cByKey" ,
        xldfEntityClass = Xldfs09cType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09cQuery", xldfDsByTrans = "xldfs09cMaxSerialNo",  xldfDsBySerialNo = "xldfs09cBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09C", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09C")
public class XLDFS09C implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09C(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs09cType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09cType domainObj;
     ...
     */
    public Xldfs09cType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09cType domainObj) {
