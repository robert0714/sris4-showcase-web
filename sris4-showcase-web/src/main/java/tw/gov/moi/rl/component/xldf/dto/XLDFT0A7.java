...
import tw.gov.moi.domain.Xldft0a7Type;
import tw.gov.moi.domain.Rldft0a7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a7Type.class ,
        entityDsName = "rldft0a7ByKey" ,
        xldfEntityClass = Xldft0a7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a7Query", xldfDsByTrans = "xldft0a7MaxSerialNo",  xldfDsBySerialNo = "xldft0a7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A7")
public class XLDFT0A7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a7Type domainObj;
     ...
     */
    public Xldft0a7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a7Type domainObj) {
