...
import tw.gov.moi.domain.Xldfs0aebType;
import tw.gov.moi.domain.Rldfs0aebType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0aebType.class ,
        entityDsName = "rldfs0aebByKey" ,
        xldfEntityClass = Xldfs0aebType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0aebQuery", xldfDsByTrans = "xldfs0aebMaxSerialNo",  xldfDsBySerialNo = "xldfs0aebBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AEB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AEB")
public class XLDFS0AEB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AEB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0aebType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0aebType domainObj;
     ...
     */
    public Xldfs0aebType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0aebType domainObj) {
