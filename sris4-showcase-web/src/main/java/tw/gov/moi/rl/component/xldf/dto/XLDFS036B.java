...
import tw.gov.moi.domain.Xldfs036bType;
import tw.gov.moi.domain.Rldfs036bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs036bType.class ,
        entityDsName = "rldfs036bByKey" ,
        xldfEntityClass = Xldfs036bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs036bQuery", xldfDsByTrans = "xldfs036bMaxSerialNo",  xldfDsBySerialNo = "xldfs036bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS036B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS036B")
public class XLDFS036B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS036B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs036bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs036bType domainObj;
     ...
     */
    public Xldfs036bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs036bType domainObj) {
