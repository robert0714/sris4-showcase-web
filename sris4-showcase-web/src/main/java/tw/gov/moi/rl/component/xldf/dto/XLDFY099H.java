...
import tw.gov.moi.domain.Xldfy099hType;
import tw.gov.moi.domain.Rldfy099hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy099hType.class ,
        entityDsName = "rldfy099hByKey" ,
        xldfEntityClass = Xldfy099hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy099hQuery", xldfDsByTrans = "xldfy099hMaxSerialNo",  xldfDsBySerialNo = "xldfy099hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY099H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY099H")
public class XLDFY099H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY099H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy099hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy099hType domainObj;
     ...
     */
    public Xldfy099hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy099hType domainObj) {
