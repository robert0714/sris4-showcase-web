...
@XmlType(name = "rl0x479DTO", propOrder = { "mainDTO", "editResult", "quertDto", "selectData", "resutlts", "title",
        "reason", "commononType", "lockData", "verify", "checkCode", "unLockData" })
@XmlRootElement(name = "Rl0x479DTO")
public class Rl0x479DTO implements Serializable {
