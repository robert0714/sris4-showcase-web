...
import tw.gov.moi.domain.Xldf1440Type;
import tw.gov.moi.domain.Xldf1440Type;
 ...
 */
@RldfMappingEntity(
        value = Xldf1440Type.class ,
        entityDsName = "xldf1440ByKey" ,
        xldfEntityClass = Xldf1440Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf1440Query", xldfDsByTrans = "xldf1440MaxSerialNo",  xldfDsBySerialNo = "xldf1440BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF1440", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF1440")
public class XLDF1440 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF1440(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf1440Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldf1440Type domainObj;
     ...
     */
    public Xldf1440Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf1440Type domainObj) {
