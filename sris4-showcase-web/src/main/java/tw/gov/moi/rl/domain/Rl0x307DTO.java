...
import tw.gov.moi.domain.Rldfs207Type;
...
public class Rl0x307DTO implements Serializable {
    ...
    @FieldName("來源資料")
    private Rldf005mType selectData = new Rldf005mType();

    // 來源資料
    @XmlElement(name = "AddData")
    @FieldName("新增資料")
    private Rldf005mType addData = new Rldf005mType();

    // 來源資料
    @XmlElement(name = "AddData")
    @FieldName("新增資料")
    private Rldf005mType queryData = new Rldf005mType();
    ...
    @FieldName("修改紀錄")
    private Rldfs207Type recored = new Rldfs207Type();
    ...
    @XmlElement(name = "woman2Rlde808wType")
    @FieldName("查詢結果 ")
    private Rldf005mType commononType = null;
    ...
    public Rldf005mType getSelectData() {
        return selectData;
    }

    public void setSelectData(Rldf005mType selectData) {
    ...
    public Rldfs207Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs207Type recored) {
    ...
    public Rldf005mType getAddData() {
        return addData;
    }

    public void setAddData(Rldf005mType addData) {
        this.addData = addData;
    }

    public Rldf005mType getQueryData() {
        return queryData;
    }

    public void setQueryData(Rldf005mType queryData) {
    ...
    public Rldf005mType getCommononType() {
        return commononType;
    }

    public void setCommononType(Rldf005mType commononType) {
