...
import tw.gov.moi.domain.Xldfs075Type;
import tw.gov.moi.domain.Rldfs075Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs075Type.class ,
        entityDsName = "rldfs075ByKey" ,
        xldfEntityClass = Xldfs075Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs075Query", xldfDsByTrans = "xldfs075MaxSerialNo",  xldfDsBySerialNo = "xldfs075BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS075", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS075")
public class XLDFS075 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS075(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs075Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs075Type domainObj;
     ...
     */
    public Xldfs075Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs075Type domainObj) {
