...
import tw.gov.moi.domain.Xldfy0a5hType;
import tw.gov.moi.domain.Rldfy0a5hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a5hType.class ,
        entityDsName = "rldfy0a5hByKey" ,
        xldfEntityClass = Xldfy0a5hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a5hQuery", xldfDsByTrans = "xldfy0a5hMaxSerialNo",  xldfDsBySerialNo = "xldfy0a5hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A5H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A5H")
public class XLDFY0A5H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A5H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a5hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a5hType domainObj;
     ...
     */
    public Xldfy0a5hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a5hType domainObj) {
