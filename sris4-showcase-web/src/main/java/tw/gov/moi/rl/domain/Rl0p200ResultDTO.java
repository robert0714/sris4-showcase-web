...
@XmlType(name = "rl0200ResultDTO", propOrder = { "start_date", "end_date", "area_code", "admin_officce_code",
...
public class Rl0p200ResultDTO implements Serializable {
    ...
    @FieldName("查詢顯示結果 ")
    private List<Rldfp100Type> rldfp100LockList;
