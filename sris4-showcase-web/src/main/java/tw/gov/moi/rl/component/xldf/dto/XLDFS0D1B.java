...
import tw.gov.moi.domain.Xldfs0d1bType;
import tw.gov.moi.domain.Rldfs0d1bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0d1bType.class ,
        entityDsName = "rldfs0d1bByKey" ,
        xldfEntityClass = Xldfs0d1bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0d1bQuery", xldfDsByTrans = "xldfs0d1bMaxSerialNo",  xldfDsBySerialNo = "xldfs0d1bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0D1B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0D1B")
public class XLDFS0D1B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0D1B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0d1bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0d1bType domainObj;
     ...
     */
    public Xldfs0d1bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0d1bType domainObj) {
