...
import tw.gov.moi.domain.Xldfw093Type;
import tw.gov.moi.domain.Rldfw093Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw093Type.class ,
        entityDsName = "rldfw093ByKey" ,
        xldfEntityClass = Xldfw093Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw093Query", xldfDsByTrans = "xldfw093MaxSerialNo",  xldfDsBySerialNo = "xldfw093BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW093", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW093")
public class XLDFW093 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW093(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw093Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw093Type domainObj;
     ...
     */
    public Xldfw093Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw093Type domainObj) {
