...
import tw.gov.moi.domain.Xldfw092Type;
import tw.gov.moi.domain.Rldfw092Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw092Type.class ,
        entityDsName = "rldfw092ByKey" ,
        xldfEntityClass = Xldfw092Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw092Query", xldfDsByTrans = "xldfw092MaxSerialNo",  xldfDsBySerialNo = "xldfw092BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW092", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW092")
public class XLDFW092 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW092(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw092Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw092Type domainObj;
     ...
     */
    public Xldfw092Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw092Type domainObj) {
