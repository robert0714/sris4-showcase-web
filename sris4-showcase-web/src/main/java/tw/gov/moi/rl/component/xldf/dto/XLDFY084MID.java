...
public class XLDFY084MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY084M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY084MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
