...
import tw.gov.moi.domain.Xldfs86aType;
import tw.gov.moi.domain.Rldfs86aType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs86aType.class ,
        entityDsName = "rldfs86aByKey" ,
        xldfEntityClass = Xldfs86aType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs86aQuery", xldfDsByTrans = "xldfs86aMaxSerialNo",  xldfDsBySerialNo = "xldfs86aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS86A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS86A")
public class XLDFS86A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS86A(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
        this.domainObj = new Xldfs86aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs86aType domainObj;
     ...
     */
    public Xldfs86aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs86aType domainObj) {
