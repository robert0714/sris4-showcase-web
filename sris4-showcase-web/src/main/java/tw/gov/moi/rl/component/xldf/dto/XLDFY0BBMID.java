...
public class XLDFY0BBMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0BBM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0BBMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
