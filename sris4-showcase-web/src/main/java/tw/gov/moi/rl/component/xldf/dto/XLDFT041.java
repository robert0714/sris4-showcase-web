...
import tw.gov.moi.domain.Xldft041Type;
import tw.gov.moi.domain.Rldft041Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft041Type.class ,
        entityDsName = "rldft041ByKey" ,
        xldfEntityClass = Xldft041Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft041Query", xldfDsByTrans = "xldft041MaxSerialNo",  xldfDsBySerialNo = "xldft041BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT041", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT041")
public class XLDFT041 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT041(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft041Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft041Type domainObj;
     ...
     */
    public Xldft041Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft041Type domainObj) {
