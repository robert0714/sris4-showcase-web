...
import tw.gov.moi.domain.Xldfs09sbType;
import tw.gov.moi.domain.Rldfs09sbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09sbType.class ,
        entityDsName = "rldfs09sbByKey" ,
        xldfEntityClass = Xldfs09sbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09sbQuery", xldfDsByTrans = "xldfs09sbMaxSerialNo",  xldfDsBySerialNo = "xldfs09sbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09SB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09SB")
public class XLDFS09SB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09SB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09sbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09sbType domainObj;
     ...
     */
    public Xldfs09sbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09sbType domainObj) {
