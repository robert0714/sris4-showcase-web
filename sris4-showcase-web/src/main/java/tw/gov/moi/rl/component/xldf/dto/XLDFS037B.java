...
import tw.gov.moi.domain.Xldfs037bType;
import tw.gov.moi.domain.Rldfs037bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs037bType.class ,
        entityDsName = "rldfs037bByKey" ,
        xldfEntityClass = Xldfs037bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs037bQuery", xldfDsByTrans = "xldfs037bMaxSerialNo",  xldfDsBySerialNo = "xldfs037bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS037B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS037B")
public class XLDFS037B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS037B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs037bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs037bType domainObj;
     ...
     */
    public Xldfs037bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs037bType domainObj) {
