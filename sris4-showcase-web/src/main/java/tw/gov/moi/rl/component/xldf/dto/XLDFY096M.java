...
import tw.gov.moi.domain.Xldfy096mType;
import tw.gov.moi.domain.Rldfy096mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy096mType.class ,
        entityDsName = "rldfy096mByKey" ,
        xldfEntityClass = Xldfy096mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy096mQuery", xldfDsByTrans = "xldfy096mMaxSerialNo",  xldfDsBySerialNo = "xldfy096mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY096M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY096M")
public class XLDFY096M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY096M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy096mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy096mType domainObj;
     ...
     */
    public Xldfy096mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy096mType domainObj) {
