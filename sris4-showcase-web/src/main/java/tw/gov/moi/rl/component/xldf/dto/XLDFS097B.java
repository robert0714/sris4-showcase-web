...
import tw.gov.moi.domain.Xldfs097bType;
import tw.gov.moi.domain.Rldfs097bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs097bType.class ,
        entityDsName = "rldfs097bByKey" ,
        xldfEntityClass = Xldfs097bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs097bQuery", xldfDsByTrans = "xldfs097bMaxSerialNo",  xldfDsBySerialNo = "xldfs097bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS097B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS097B")
public class XLDFS097B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS097B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs097bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs097bType domainObj;
     ...
     */
    public Xldfs097bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs097bType domainObj) {
