...
import tw.gov.moi.domain.Xldft026Type;
import tw.gov.moi.domain.Rldft026Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft026Type.class ,
        entityDsName = "rldft026ByKey" ,
        xldfEntityClass = Xldft026Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft026Query", xldfDsByTrans = "xldft026MaxSerialNo",  xldfDsBySerialNo = "xldft026BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT026", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT026")
public class XLDFT026 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT026(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft026Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft026Type domainObj;
     ...
     */
    public Xldft026Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft026Type domainObj) {
