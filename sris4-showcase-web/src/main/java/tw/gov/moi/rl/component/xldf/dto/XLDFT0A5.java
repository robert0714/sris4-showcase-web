...
import tw.gov.moi.domain.Xldft0a5Type;
import tw.gov.moi.domain.Rldft0a5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0a5Type.class ,
        entityDsName = "rldft0a5ByKey" ,
        xldfEntityClass = Xldft0a5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0a5Query", xldfDsByTrans = "xldft0a5MaxSerialNo",  xldfDsBySerialNo = "xldft0a5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0A5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0A5")
public class XLDFT0A5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0A5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0a5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0a5Type domainObj;
     ...
     */
    public Xldft0a5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0a5Type domainObj) {
