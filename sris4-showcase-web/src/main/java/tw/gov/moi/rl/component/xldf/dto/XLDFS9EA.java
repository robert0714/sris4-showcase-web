...
import tw.gov.moi.domain.Xldfs9eaType;
import tw.gov.moi.domain.Rldfs9eaType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs9eaType.class ,
        entityDsName = "rldfs9eaByKey" ,
        xldfEntityClass = Xldfs9eaType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs9eaQuery", xldfDsByTrans = "xldfs9eaMaxSerialNo",  xldfDsBySerialNo = "xldfs9eaBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS9EA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS9EA")
public class XLDFS9EA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS9EA(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
        this.domainObj = new Xldfs9eaType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs9eaType domainObj;
     ...
     */
    public Xldfs9eaType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs9eaType domainObj) {
