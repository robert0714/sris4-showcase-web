...
import tw.gov.moi.domain.Xldfs001Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs001Type.class ,
        entityDsName = "rldfs001ByKey" ,
        xldfEntityClass = Xldfs001Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs001Query", xldfDsByTrans = "xldfs001MaxSerialNo",  xldfDsBySerialNo = "xldfs001BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS001", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS001")
public class XLDFS001 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS001(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs001Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs001Type domainObj;
     ...
     */
    public Xldfs001Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs001Type domainObj) {
