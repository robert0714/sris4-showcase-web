...
@XmlType(name = "XLDFW0A6", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW0A6") 
public class XLDFW0A6ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW0A6.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW0A6ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
