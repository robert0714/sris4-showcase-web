...
import tw.gov.moi.domain.Xldfs010bType;
import tw.gov.moi.domain.Rldfs010bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs010bType.class ,
        entityDsName = "rldfs010bByKey" ,
        xldfEntityClass = Xldfs010bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs010bQuery", xldfDsByTrans = "xldfs010bMaxSerialNo",  xldfDsBySerialNo = "xldfs010bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS010B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS010B")
public class XLDFS010B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS010B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs010bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs010bType domainObj;
     ...
     */
    public Xldfs010bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs010bType domainObj) {
