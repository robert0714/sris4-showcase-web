...
@XmlType(name = "XLDFY0AAM", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0AAM") 
public class XLDFY0AAMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0AAM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0AAMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
