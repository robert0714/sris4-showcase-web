...
import tw.gov.moi.domain.Xldfy0a2hType;
import tw.gov.moi.domain.Rldfy0a2hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a2hType.class ,
        entityDsName = "rldfy0a2hByKey" ,
        xldfEntityClass = Xldfy0a2hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a2hQuery", xldfDsByTrans = "xldfy0a2hMaxSerialNo",  xldfDsBySerialNo = "xldfy0a2hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A2H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A2H")
public class XLDFY0A2H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A2H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a2hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a2hType domainObj;
     ...
     */
    public Xldfy0a2hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a2hType domainObj) {
