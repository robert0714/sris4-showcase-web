...
@XmlType(name = "XLDFY0BAM", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0BAM") 
public class XLDFY0BAMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0BAM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0BAMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
