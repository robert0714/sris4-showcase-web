...
import tw.gov.moi.domain.Xldfr0b9Type;
import tw.gov.moi.domain.Rldfr0b9Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0b9Type.class ,
        entityDsName = "rldfr0b9ByKey" ,
        xldfEntityClass = Xldfr0b9Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0b9Query", xldfDsByTrans = "xldfr0b9MaxSerialNo",  xldfDsBySerialNo = "xldfr0b9BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0B9", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0B9")
public class XLDFR0B9 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0B9(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0b9Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0b9Type domainObj;
     ...
     */
    public Xldfr0b9Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0b9Type domainObj) {
