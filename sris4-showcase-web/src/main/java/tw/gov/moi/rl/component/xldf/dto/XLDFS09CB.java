...
import tw.gov.moi.domain.Xldfs09cbType;
import tw.gov.moi.domain.Rldfs09cbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09cbType.class ,
        entityDsName = "rldfs09cbByKey" ,
        xldfEntityClass = Xldfs09cbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09cbQuery", xldfDsByTrans = "xldfs09cbMaxSerialNo",  xldfDsBySerialNo = "xldfs09cbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09CB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09CB")
public class XLDFS09CB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09CB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09cbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09cbType domainObj;
     ...
     */
    public Xldfs09cbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09cbType domainObj) {
