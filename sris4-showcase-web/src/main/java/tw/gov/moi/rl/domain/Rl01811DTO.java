...
@XmlType(name = "Rl01811DTO", propOrder = { "householdOperationDTO", "householdAppDataDTO", "rl01811AppDataDTO",
        "m10mList", "viewM10m", "viewPostiveApplication", "selectedM10m", "selectedPostiveApplication" })
@XmlRootElement(name = "Rl01811DTO")
public class Rl01811DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 1602340159022221373L;
    ...
    /** 出生別更正撤銷登記AppDataDTO. */
    @XmlElement(name = "Rl01811AppDataDTO")
    @FieldName("出生別更正撤銷登記AppDataDTO")
    private Rl01811AppDataDTO rl01811AppDataDTO = new Rl01811AppDataDTO();
    ...
    /**
     * Gets the rl01811 app data dto.
     * 
     * @return the rl01811 app data dto
     */
    public Rl01811AppDataDTO getRl01811AppDataDTO() {
        return rl01811AppDataDTO;
    }

    /**
     * Sets the rl01811 app data dto.
     * 
     * @param rl01811AppDataDTO
     *            the new rl01811 app data dto
     */
    public void setRl01811AppDataDTO(final Rl01811AppDataDTO rl01811AppDataDTO) {
        this.rl01811AppDataDTO = rl01811AppDataDTO;
    }
