...
import tw.gov.moi.domain.Rldfs054Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs054Type.class ,
        entityDsName = "rldfs054ByKey" ,
        xldfEntityClass = Xldfs054Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs054Query", xldfDsByTrans = "xldfs054MaxSerialNo",  xldfDsBySerialNo = "xldfs054BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS054", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS054")
public class XLDFS054 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS054(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs054Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs054Type domainObj;
     ...
     */
    public Xldfs054Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs054Type domainObj) {
