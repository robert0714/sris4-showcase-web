...
public class XLDFY0BDMID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0BDM.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0BDMID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
