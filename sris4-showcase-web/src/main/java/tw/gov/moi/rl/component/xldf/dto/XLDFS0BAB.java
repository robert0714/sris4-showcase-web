...
import tw.gov.moi.domain.Xldfs0babType;
import tw.gov.moi.domain.Rldfs0babType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0babType.class ,
        entityDsName = "rldfs0babByKey" ,
        xldfEntityClass = Xldfs0babType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0babQuery", xldfDsByTrans = "xldfs0babMaxSerialNo",  xldfDsBySerialNo = "xldfs0babBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0BAB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0BAB")
public class XLDFS0BAB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0BAB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0babType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0babType domainObj;
     ...
     */
    public Xldfs0babType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0babType domainObj) {
