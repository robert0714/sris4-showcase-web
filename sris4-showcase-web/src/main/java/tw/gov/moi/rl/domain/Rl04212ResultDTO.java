...
@XmlType(name = "rl04212ResultDTO", propOrder = { "dataIndex", "oldStreetDoor", "newStreetDoor", "formatStreetDoor",
        ...
        "oldFloorNo" })
@XmlRootElement(name = "Rl04212ResultDTO")
public class Rl04212ResultDTO implements Serializable {

    private static final long serialVersionUID = -3449121421930422377L;
