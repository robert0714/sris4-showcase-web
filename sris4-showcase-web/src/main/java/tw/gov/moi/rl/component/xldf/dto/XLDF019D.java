...
import tw.gov.moi.domain.Xldf019dType;
 ...
 */
@RldfMappingEntity(
        value = Rldf019dType.class ,
        entityDsName = "rldf019dByKey" ,
        xldfEntityClass = Xldf019dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf019dQuery", xldfDsByTrans = "xldf019dMaxSerialNo",  xldfDsBySerialNo = "xldf019dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF019D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF019D")
public class XLDF019D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF019D(String trMode ,String applyMode ,String applyYyymmdd ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf019dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf019dType domainObj;
     ...
     */
    public Xldf019dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf019dType domainObj) {
