...
/**
 * 個人基本資料 for 1310 遷入登記
 * 
 * @author Marcus Chen
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl01310PersonDTO", propOrder = { "personId", "siteId", "personName", "birthYyymmdd",
        "householdHeadId", "moveinDate", "relationShip", "educationMark", "idCardLostApplyMark", "idCardLostApplyDate",
        "idCardLostApplyTime", "gender", "removeDate", "removeTime", "sourceSiteId", "sourceSiteId", "correctYyy",
        "specialMark", "oriRelationship" })
@XmlRootElement(name = "Rl01310PersonDTO")
public class Rl01310PersonDTO implements Serializable {
    ...
    /**
     * @param correctYyy
     *            the correctYyy to set
     */
    public void setCorrectYyy(String correctYyy) {
