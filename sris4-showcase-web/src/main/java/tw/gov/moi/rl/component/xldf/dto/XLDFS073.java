...
import tw.gov.moi.domain.Xldfs073Type;
import tw.gov.moi.domain.Rldfs073Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs073Type.class ,
        entityDsName = "rldfs073ByKey" ,
        xldfEntityClass = Xldfs073Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs073Query", xldfDsByTrans = "xldfs073MaxSerialNo",  xldfDsBySerialNo = "xldfs073BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS073", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS073")
public class XLDFS073 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS073(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs073Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs073Type domainObj;
     ...
     */
    public Xldfs073Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs073Type domainObj) {
