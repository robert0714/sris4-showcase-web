...
import tw.gov.moi.domain.Xldfy0alhType;
import tw.gov.moi.domain.Rldfy0alhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0alhType.class ,
        entityDsName = "rldfy0alhByKey" ,
        xldfEntityClass = Xldfy0alhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0alhQuery", xldfDsByTrans = "xldfy0alhMaxSerialNo",  xldfDsBySerialNo = "xldfy0alhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0ALH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0ALH")
public class XLDFY0ALH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0ALH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0alhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0alhType domainObj;
     ...
     */
    public Xldfy0alhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0alhType domainObj) {
