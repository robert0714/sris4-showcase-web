...
import tw.gov.moi.domain.Xldfr005Type;
import tw.gov.moi.domain.Rldfr005Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr005Type.class ,
        entityDsName = "rldfr005ByKey" ,
        xldfEntityClass = Xldfr005Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr005Query", xldfDsByTrans = "xldfr005MaxSerialNo",  xldfDsBySerialNo = "xldfr005BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR005", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR005")
public class XLDFR005 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR005(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr005Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr005Type domainObj;
     ...
     */
    public Xldfr005Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr005Type domainObj) {
