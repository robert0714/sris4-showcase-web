...
@XmlType(name = "XLDFS046B", propOrder = { "keys", "xldfClass" })
@XmlRootElement(name = "XLDFS046B")
public class XLDFS046BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS046B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS046BID(String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq,
