...
import tw.gov.moi.domain.Xldfr0z5Type;
import tw.gov.moi.domain.Rldfr0z5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0z5Type.class ,
        entityDsName = "rldfr0z5ByKey" ,
        xldfEntityClass = Xldfr0z5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0z5Query", xldfDsByTrans = "xldfr0z5MaxSerialNo",  xldfDsBySerialNo = "xldfr0z5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0Z5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0Z5")
public class XLDFR0Z5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0Z5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0z5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0z5Type domainObj;
     ...
     */
    public Xldfr0z5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0z5Type domainObj) {
