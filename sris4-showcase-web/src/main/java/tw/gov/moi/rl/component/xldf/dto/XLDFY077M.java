...
import tw.gov.moi.domain.Xldfy077mType;
import tw.gov.moi.domain.Rldfy077mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy077mType.class ,
        entityDsName = "rldfy077mByKey" ,
        xldfEntityClass = Xldfy077mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy077mQuery", xldfDsByTrans = "xldfy077mMaxSerialNo",  xldfDsBySerialNo = "xldfy077mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY077M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY077M")
public class XLDFY077M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY077M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy077mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy077mType domainObj;
     ...
     */
    public Xldfy077mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy077mType domainObj) {
