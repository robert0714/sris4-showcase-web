...
public class XLDF019DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF019D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF019DID(String trMode ,String applyMode ,String applyYyymmdd ,String personId ,String siteId ) {
        super();
