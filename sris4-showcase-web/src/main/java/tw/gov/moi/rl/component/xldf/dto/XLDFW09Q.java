...
import tw.gov.moi.domain.Xldfw09qType;
import tw.gov.moi.domain.Rldfw09qType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09qType.class ,
        entityDsName = "rldfw09qByKey" ,
        xldfEntityClass = Xldfw09qType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09qQuery", xldfDsByTrans = "xldfw09qMaxSerialNo",  xldfDsBySerialNo = "xldfw09qBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09Q", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09Q")
public class XLDFW09Q implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09Q(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09qType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09qType domainObj;
     ...
     */
    public Xldfw09qType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09qType domainObj) {
