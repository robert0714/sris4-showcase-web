...
import tw.gov.moi.domain.Xldfy09phType;
import tw.gov.moi.domain.Rldfy09phType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09phType.class ,
        entityDsName = "rldfy09phByKey" ,
        xldfEntityClass = Xldfy09phType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09phQuery", xldfDsByTrans = "xldfy09phMaxSerialNo",  xldfDsBySerialNo = "xldfy09phBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09PH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09PH")
public class XLDFY09PH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09PH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09phType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09phType domainObj;
     ...
     */
    public Xldfy09phType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09phType domainObj) {
