...
import tw.gov.moi.domain.Xldft095Type;
import tw.gov.moi.domain.Rldft095Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft095Type.class ,
        entityDsName = "rldft095ByKey" ,
        xldfEntityClass = Xldft095Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft095Query", xldfDsByTrans = "xldft095MaxSerialNo",  xldfDsBySerialNo = "xldft095BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT095", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT095")
public class XLDFT095 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT095(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft095Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft095Type domainObj;
     ...
     */
    public Xldft095Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft095Type domainObj) {
