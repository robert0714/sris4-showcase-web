...
@XmlType(name = "XLDFS045B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS045B") 
public class XLDFS045BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS045B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS045BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
