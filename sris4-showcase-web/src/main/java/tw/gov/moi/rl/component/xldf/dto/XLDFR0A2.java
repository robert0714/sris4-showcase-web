...
import tw.gov.moi.domain.Xldfr0a2Type;
import tw.gov.moi.domain.Rldfr0a2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a2Type.class ,
        entityDsName = "rldfr0a2ByKey" ,
        xldfEntityClass = Xldfr0a2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a2Query", xldfDsByTrans = "xldfr0a2MaxSerialNo",  xldfDsBySerialNo = "xldfr0a2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A2")
public class XLDFR0A2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a2Type domainObj;
     ...
     */
    public Xldfr0a2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a2Type domainObj) {
