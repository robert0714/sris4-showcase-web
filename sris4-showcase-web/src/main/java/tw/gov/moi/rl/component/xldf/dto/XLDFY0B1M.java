...
import tw.gov.moi.domain.Xldfy0b1mType;
import tw.gov.moi.domain.Rldfy0b1mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b1mType.class ,
        entityDsName = "rldfy0b1mByKey" ,
        xldfEntityClass = Xldfy0b1mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b1mQuery", xldfDsByTrans = "xldfy0b1mMaxSerialNo",  xldfDsBySerialNo = "xldfy0b1mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B1M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B1M")
public class XLDFY0B1M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B1M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b1mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b1mType domainObj;
     ...
     */
    public Xldfy0b1mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b1mType domainObj) {
