...
/**
 * The Class Rl08240DTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl08240DTO", propOrder = { "catalog", "printType", "reportFormat", "fileURL", "reportURL" })
@XmlRootElement(name = "Rl08240DTO")
public class Rl08240DTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -6909706585195360209L;
