...
import tw.gov.moi.domain.Xldfw002Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw002Type.class ,
        entityDsName = "rldfw002ByKey" ,
        xldfEntityClass = Xldfw002Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw002Query", xldfDsByTrans = "xldfw002MaxSerialNo",  xldfDsBySerialNo = "xldfw002BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW002", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW002")
public class XLDFW002 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW002(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw002Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw002Type domainObj;
     ...
     */
    public Xldfw002Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw002Type domainObj) {
