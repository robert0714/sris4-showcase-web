...
import tw.gov.moi.domain.Xldfy005mType;
import tw.gov.moi.domain.Rldfy005mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy005mType.class ,
        entityDsName = "rldfy005mByKey" ,
        xldfEntityClass = Xldfy005mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy005mQuery", xldfDsByTrans = "xldfy005mMaxSerialNo",  xldfDsBySerialNo = "xldfy005mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY005M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY005M")
public class XLDFY005M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY005M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy005mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy005mType domainObj;
     ...
     */
    public Xldfy005mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy005mType domainObj) {
