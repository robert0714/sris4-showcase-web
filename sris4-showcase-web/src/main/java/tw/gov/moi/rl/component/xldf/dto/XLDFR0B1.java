...
import tw.gov.moi.domain.Xldfr0b1Type;
import tw.gov.moi.domain.Rldfr0b1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0b1Type.class ,
        entityDsName = "rldfr0b1ByKey" ,
        xldfEntityClass = Xldfr0b1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0b1Query", xldfDsByTrans = "xldfr0b1MaxSerialNo",  xldfDsBySerialNo = "xldfr0b1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0B1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0B1")
public class XLDFR0B1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0B1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0b1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0b1Type domainObj;
     ...
     */
    public Xldfr0b1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0b1Type domainObj) {
