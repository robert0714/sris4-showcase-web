...
import tw.gov.moi.domain.Xldfs0a1bType;
import tw.gov.moi.domain.Rldfs0a1bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a1bType.class ,
        entityDsName = "rldfs0a1bByKey" ,
        xldfEntityClass = Xldfs0a1bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a1bQuery", xldfDsByTrans = "xldfs0a1bMaxSerialNo",  xldfDsBySerialNo = "xldfs0a1bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A1B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A1B")
public class XLDFS0A1B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A1B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0a1bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a1bType domainObj;
     ...
     */
    public Xldfs0a1bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a1bType domainObj) {
