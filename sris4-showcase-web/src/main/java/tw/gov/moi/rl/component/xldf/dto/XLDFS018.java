...
import tw.gov.moi.domain.Xldfs018Type;
import tw.gov.moi.domain.Rldfs018Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs018Type.class ,
        entityDsName = "rldfs018ByKey" ,
        xldfEntityClass = Xldfs018Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs018Query", xldfDsByTrans = "xldfs018MaxSerialNo",  xldfDsBySerialNo = "xldfs018BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS018", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS018")
public class XLDFS018 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS018(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs018Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs018Type domainObj;
     ...
     */
    public Xldfs018Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs018Type domainObj) {
