...
public class XLDFW0Z4ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW0Z4.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW0Z4ID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String personId ) {
        super();
