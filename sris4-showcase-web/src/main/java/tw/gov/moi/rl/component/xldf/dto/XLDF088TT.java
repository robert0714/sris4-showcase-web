...
import tw.gov.moi.domain.Xldf088ttType;
import tw.gov.moi.domain.Tldf088tType;
 ...
 */
@RldfMappingEntity(
        value = Tldf088tType.class ,
        entityDsName = "tldf088tByKey" ,
        xldfEntityClass = Xldf088ttType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf088ttQuery", xldfDsByTrans = "xldf088ttMaxSerialNo",  xldfDsBySerialNo = "xldf088ttBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF088TT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF088TT")
public class XLDF088TT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF088TT(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf088ttType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf088ttType domainObj;
     ...
     */
    public Xldf088ttType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf088ttType domainObj) {
