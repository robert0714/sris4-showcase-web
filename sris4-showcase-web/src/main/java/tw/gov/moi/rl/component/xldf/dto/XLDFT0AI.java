...
import tw.gov.moi.domain.Xldft0aiType;
import tw.gov.moi.domain.Rldft0aiType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0aiType.class ,
        entityDsName = "rldft0aiByKey" ,
        xldfEntityClass = Xldft0aiType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0aiQuery", xldfDsByTrans = "xldft0aiMaxSerialNo",  xldfDsBySerialNo = "xldft0aiBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AI")
public class XLDFT0AI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0aiType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0aiType domainObj;
     ...
     */
    public Xldft0aiType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0aiType domainObj) {
