...
import tw.gov.moi.domain.Xldft0djType;
import tw.gov.moi.domain.Rldft0djType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0djType.class ,
        entityDsName = "rldft0djByKey" ,
        xldfEntityClass = Xldft0djType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0djQuery", xldfDsByTrans = "xldft0djMaxSerialNo",  xldfDsBySerialNo = "xldft0djBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0DJ", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0DJ")
public class XLDFT0DJ implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0DJ(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0djType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0djType domainObj;
     ...
     */
    public Xldft0djType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0djType domainObj) {
