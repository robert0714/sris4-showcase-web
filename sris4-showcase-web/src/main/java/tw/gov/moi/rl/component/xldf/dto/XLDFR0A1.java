...
import tw.gov.moi.domain.Xldfr0a1Type;
import tw.gov.moi.domain.Rldfr0a1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0a1Type.class ,
        entityDsName = "rldfr0a1ByKey" ,
        xldfEntityClass = Xldfr0a1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0a1Query", xldfDsByTrans = "xldfr0a1MaxSerialNo",  xldfDsBySerialNo = "xldfr0a1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0A1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0A1")
public class XLDFR0A1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0A1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0a1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0a1Type domainObj;
     ...
     */
    public Xldfr0a1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0a1Type domainObj) {
