...
import tw.gov.moi.domain.Xldfr0b2Type;
import tw.gov.moi.domain.Rldfr0b2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0b2Type.class ,
        entityDsName = "rldfr0b2ByKey" ,
        xldfEntityClass = Xldfr0b2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0b2Query", xldfDsByTrans = "xldfr0b2MaxSerialNo",  xldfDsBySerialNo = "xldfr0b2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0B2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0B2")
public class XLDFR0B2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0B2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0b2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0b2Type domainObj;
     ...
     */
    public Xldfr0b2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0b2Type domainObj) {
