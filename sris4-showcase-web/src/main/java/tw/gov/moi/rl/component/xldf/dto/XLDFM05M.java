...
import tw.gov.moi.domain.Xldfm05mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfm05mType.class ,
        entityDsName = "rldfm05mByKey" ,
        xldfEntityClass = Xldfm05mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm05mQuery", xldfDsByTrans = "xldfm05mMaxSerialNo",  xldfDsBySerialNo = "xldfm05mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM05M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM05M")
public class XLDFM05M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM05M(String personId ,String siteId ,String relationId ,String relationCode ) {
        super();
        this.domainObj = new Xldfm05mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm05mType domainObj;
     ...
     */
    public Xldfm05mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm05mType domainObj) {
