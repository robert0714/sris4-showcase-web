...
@XmlType(name = "XLDFS0AD", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS0AD") 
public class XLDFS0ADID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS0AD.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS0ADID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
