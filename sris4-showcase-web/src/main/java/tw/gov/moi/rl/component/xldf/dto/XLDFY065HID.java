...
@XmlType(name = "XLDFY065H", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY065H") 
public class XLDFY065HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY065H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY065HID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
