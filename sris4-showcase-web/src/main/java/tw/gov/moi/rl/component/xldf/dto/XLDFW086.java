...
import tw.gov.moi.domain.Xldfw086Type;
import tw.gov.moi.domain.Rldfw086Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw086Type.class ,
        entityDsName = "rldfw086ByKey" ,
        xldfEntityClass = Xldfw086Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw086Query", xldfDsByTrans = "xldfw086MaxSerialNo",  xldfDsBySerialNo = "xldfw086BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW086", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW086")
public class XLDFW086 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW086(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw086Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw086Type domainObj;
     ...
     */
    public Xldfw086Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw086Type domainObj) {
