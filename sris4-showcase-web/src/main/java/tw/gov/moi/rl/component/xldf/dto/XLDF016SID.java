...
@XmlType(name = "XLDF016S", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF016S") 
public class XLDF016SID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF016S.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF016SID(String applyTransactionId ,Integer applySequenceId ,String registrationId ,String acceptSiteId ,String registerDate ,String registerTime ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(registrationId, StringUtils.EMPTY)));
