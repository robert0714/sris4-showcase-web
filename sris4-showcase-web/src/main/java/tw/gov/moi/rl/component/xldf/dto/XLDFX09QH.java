...
import tw.gov.moi.domain.Xldfx09qhType;
import tw.gov.moi.domain.Rldfx09qhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx09qhType.class ,
        entityDsName = "rldfx09qhByKey" ,
        xldfEntityClass = Xldfx09qhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx09qhQuery", xldfDsByTrans = "xldfx09qhMaxSerialNo",  xldfDsBySerialNo = "xldfx09qhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX09QH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX09QH")
public class XLDFX09QH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX09QH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx09qhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx09qhType domainObj;
     ...
     */
    public Xldfx09qhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx09qhType domainObj) {
