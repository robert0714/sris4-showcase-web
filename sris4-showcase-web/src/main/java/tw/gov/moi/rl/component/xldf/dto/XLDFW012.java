...
import tw.gov.moi.domain.Xldfw012Type;
import tw.gov.moi.domain.Rldfw012Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw012Type.class ,
        entityDsName = "rldfw012ByKey" ,
        xldfEntityClass = Xldfw012Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw012Query", xldfDsByTrans = "xldfw012MaxSerialNo",  xldfDsBySerialNo = "xldfw012BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW012", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW012")
public class XLDFW012 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW012(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw012Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw012Type domainObj;
     ...
     */
    public Xldfw012Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw012Type domainObj) {
