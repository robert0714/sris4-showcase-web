...
import tw.gov.moi.domain.Xldfy065hType;
import tw.gov.moi.domain.Rldfy065hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy065hType.class ,
        entityDsName = "rldfy065hByKey" ,
        xldfEntityClass = Xldfy065hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy065hQuery", xldfDsByTrans = "xldfy065hMaxSerialNo",  xldfDsBySerialNo = "xldfy065hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY065H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY065H")
public class XLDFY065H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY065H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy065hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy065hType domainObj;
     ...
     */
    public Xldfy065hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy065hType domainObj) {
