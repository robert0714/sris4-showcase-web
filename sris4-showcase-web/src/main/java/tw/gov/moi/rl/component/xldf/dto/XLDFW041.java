...
import tw.gov.moi.domain.Xldfw041Type;
import tw.gov.moi.domain.Rldfw041Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw041Type.class ,
        entityDsName = "rldfw041ByKey" ,
        xldfEntityClass = Xldfw041Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw041Query", xldfDsByTrans = "xldfw041MaxSerialNo",  xldfDsBySerialNo = "xldfw041BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW041", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW041")
public class XLDFW041 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW041(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw041Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw041Type domainObj;
     ...
     */
    public Xldfw041Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw041Type domainObj) {
