...
import tw.gov.moi.domain.Xldfr026Type;
import tw.gov.moi.domain.Rldfr026Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr026Type.class ,
        entityDsName = "rldfr026ByKey" ,
        xldfEntityClass = Xldfr026Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr026Query", xldfDsByTrans = "xldfr026MaxSerialNo",  xldfDsBySerialNo = "xldfr026BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR026", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR026")
public class XLDFR026 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR026(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr026Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr026Type domainObj;
     ...
     */
    public Xldfr026Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr026Type domainObj) {
