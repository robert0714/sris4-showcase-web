...
import tw.gov.moi.domain.Xldfs041bType;
import tw.gov.moi.domain.Rldfs041bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs041bType.class ,
        entityDsName = "rldfs041bByKey" ,
        xldfEntityClass = Xldfs041bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs041bQuery", xldfDsByTrans = "xldfs041bMaxSerialNo",  xldfDsBySerialNo = "xldfs041bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS041B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS041B")
public class XLDFS041B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS041B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs041bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs041bType domainObj;
     ...
     */
    public Xldfs041bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs041bType domainObj) {
