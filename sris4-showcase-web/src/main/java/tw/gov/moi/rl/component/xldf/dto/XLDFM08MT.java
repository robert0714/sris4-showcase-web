...
import tw.gov.moi.domain.Xldfm08mtType;
import tw.gov.moi.domain.Tldfm08mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm08mType.class ,
        entityDsName = "tldfm08mByKey" ,
        xldfEntityClass = Xldfm08mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm08mtQuery", xldfDsByTrans = "xldfm08mtMaxSerialNo",  xldfDsBySerialNo = "xldfm08mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM08MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM08MT")
public class XLDFM08MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM08MT(String personId ,String siteId ,String relationId ,String relationCode ,String updateDate ,String updateTime ) {
        super();
        this.domainObj = new Xldfm08mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm08mtType domainObj;
     ...
     */
    public Xldfm08mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm08mtType domainObj) {
