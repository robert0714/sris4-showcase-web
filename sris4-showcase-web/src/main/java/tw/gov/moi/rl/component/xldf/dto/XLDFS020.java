...
import tw.gov.moi.domain.Xldfs020Type;
import tw.gov.moi.domain.Rldfs020Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs020Type.class ,
        entityDsName = "rldfs020ByKey" ,
        xldfEntityClass = Xldfs020Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs020Query", xldfDsByTrans = "xldfs020MaxSerialNo",  xldfDsBySerialNo = "xldfs020BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS020", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS020")
public class XLDFS020 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS020(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs020Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs020Type domainObj;
     ...
     */
    public Xldfs020Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs020Type domainObj) {
