...
import tw.gov.moi.domain.Xldft0b5Type;
import tw.gov.moi.domain.Rldft0b5Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0b5Type.class ,
        entityDsName = "rldft0b5ByKey" ,
        xldfEntityClass = Xldft0b5Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0b5Query", xldfDsByTrans = "xldft0b5MaxSerialNo",  xldfDsBySerialNo = "xldft0b5BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0B5", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0B5")
public class XLDFT0B5 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0B5(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0b5Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0b5Type domainObj;
     ...
     */
    public Xldft0b5Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0b5Type domainObj) {
