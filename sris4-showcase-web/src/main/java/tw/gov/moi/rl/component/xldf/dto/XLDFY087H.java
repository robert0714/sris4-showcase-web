...
import tw.gov.moi.domain.Xldfy087hType;
import tw.gov.moi.domain.Rldfy087hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy087hType.class ,
        entityDsName = "rldfy087hByKey" ,
        xldfEntityClass = Xldfy087hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy087hQuery", xldfDsByTrans = "xldfy087hMaxSerialNo",  xldfDsBySerialNo = "xldfy087hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY087H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY087H")
public class XLDFY087H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY087H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy087hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy087hType domainObj;
     ...
     */
    public Xldfy087hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy087hType domainObj) {
