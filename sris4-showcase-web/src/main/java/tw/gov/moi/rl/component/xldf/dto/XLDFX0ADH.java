...
import tw.gov.moi.domain.Xldfx0adhType;
import tw.gov.moi.domain.Rldfx0adhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0adhType.class ,
        entityDsName = "rldfx0adhByKey" ,
        xldfEntityClass = Xldfx0adhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0adhQuery", xldfDsByTrans = "xldfx0adhMaxSerialNo",  xldfDsBySerialNo = "xldfx0adhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0ADH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0ADH")
public class XLDFX0ADH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0ADH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0adhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0adhType domainObj;
     ...
     */
    public Xldfx0adhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0adhType domainObj) {
