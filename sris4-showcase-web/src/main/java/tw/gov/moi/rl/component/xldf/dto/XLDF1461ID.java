...
public class XLDF1461ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF1461.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF1461ID(String personId ,String siteId ) {
        super();
