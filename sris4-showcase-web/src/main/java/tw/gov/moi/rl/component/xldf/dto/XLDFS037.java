...
import tw.gov.moi.domain.Xldfs037Type;
import tw.gov.moi.domain.Rldfs037Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs037Type.class ,
        entityDsName = "rldfs037ByKey" ,
        xldfEntityClass = Xldfs037Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs037Query", xldfDsByTrans = "xldfs037MaxSerialNo",  xldfDsBySerialNo = "xldfs037BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS037", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS037")
public class XLDFS037 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS037(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs037Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs037Type domainObj;
     ...
     */
    public Xldfs037Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs037Type domainObj) {
