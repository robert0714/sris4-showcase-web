...
import tw.gov.moi.domain.Xldfs0c9bType;
import tw.gov.moi.domain.Rldfs0c9bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0c9bType.class ,
        entityDsName = "rldfs0c9bByKey" ,
        xldfEntityClass = Xldfs0c9bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0c9bQuery", xldfDsByTrans = "xldfs0c9bMaxSerialNo",  xldfDsBySerialNo = "xldfs0c9bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0C9B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0C9B")
public class XLDFS0C9B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0C9B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0c9bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0c9bType domainObj;
     ...
     */
    public Xldfs0c9bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0c9bType domainObj) {
