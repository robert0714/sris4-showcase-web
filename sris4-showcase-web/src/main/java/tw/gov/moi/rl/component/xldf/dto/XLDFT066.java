...
import tw.gov.moi.domain.Xldft066Type;
import tw.gov.moi.domain.Rldft066Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft066Type.class ,
        entityDsName = "rldft066ByKey" ,
        xldfEntityClass = Xldft066Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft066Query", xldfDsByTrans = "xldft066MaxSerialNo",  xldfDsBySerialNo = "xldft066BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT066", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT066")
public class XLDFT066 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT066(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft066Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft066Type domainObj;
     ...
     */
    public Xldft066Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft066Type domainObj) {
