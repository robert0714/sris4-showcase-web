...
import tw.gov.moi.domain.Xldfs0a8Type;
import tw.gov.moi.domain.Rldfs0a8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0a8Type.class ,
        entityDsName = "rldfs0a8ByKey" ,
        xldfEntityClass = Xldfs0a8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0a8Query", xldfDsByTrans = "xldfs0a8MaxSerialNo",  xldfDsBySerialNo = "xldfs0a8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0A8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0A8")
public class XLDFS0A8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0A8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0a8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0a8Type domainObj;
     ...
     */
    public Xldfs0a8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0a8Type domainObj) {
