...
import tw.gov.moi.domain.Xldf087thType;
 ...
 */
@RldfMappingEntity(
        value = Rldf087thType.class ,
        entityDsName = "rldf087thByKey" ,
        xldfEntityClass = Xldf087thType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf087thQuery", xldfDsByTrans = "xldf087thMaxSerialNo",  xldfDsBySerialNo = "xldf087thBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF087TH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF087TH")
public class XLDF087TH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF087TH(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
        this.domainObj = new Xldf087thType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf087thType domainObj;
     ...
     */
    public Xldf087thType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf087thType domainObj) {
