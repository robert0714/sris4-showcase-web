...
import tw.gov.moi.domain.Xldft0c7Type;
import tw.gov.moi.domain.Rldft0c7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft0c7Type.class ,
        entityDsName = "rldft0c7ByKey" ,
        xldfEntityClass = Xldft0c7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0c7Query", xldfDsByTrans = "xldft0c7MaxSerialNo",  xldfDsBySerialNo = "xldft0c7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0C7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0C7")
public class XLDFT0C7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0C7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0c7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0c7Type domainObj;
     ...
     */
    public Xldft0c7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0c7Type domainObj) {
