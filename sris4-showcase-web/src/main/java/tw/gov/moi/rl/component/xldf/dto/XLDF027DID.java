...
public class XLDF027DID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF027D.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF027DID(String personId ,String applyYyymmdd ,String applyHhmmss ,String siteId ) {
        super();
