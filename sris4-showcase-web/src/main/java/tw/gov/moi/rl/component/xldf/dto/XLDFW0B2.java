...
import tw.gov.moi.domain.Xldfw0b2Type;
import tw.gov.moi.domain.Rldfw0b2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0b2Type.class ,
        entityDsName = "rldfw0b2ByKey" ,
        xldfEntityClass = Xldfw0b2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0b2Query", xldfDsByTrans = "xldfw0b2MaxSerialNo",  xldfDsBySerialNo = "xldfw0b2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0B2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0B2")
public class XLDFW0B2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0B2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0b2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0b2Type domainObj;
     ...
     */
    public Xldfw0b2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0b2Type domainObj) {
