...
import tw.gov.moi.domain.Xldfy074mType;
import tw.gov.moi.domain.Rldfy074mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy074mType.class ,
        entityDsName = "rldfy074mByKey" ,
        xldfEntityClass = Xldfy074mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy074mQuery", xldfDsByTrans = "xldfy074mMaxSerialNo",  xldfDsBySerialNo = "xldfy074mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY074M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY074M")
public class XLDFY074M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY074M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy074mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy074mType domainObj;
     ...
     */
    public Xldfy074mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy074mType domainObj) {
