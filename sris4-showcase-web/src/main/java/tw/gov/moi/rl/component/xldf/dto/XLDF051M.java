...
import tw.gov.moi.domain.Xldf051mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf051mType.class ,
        entityDsName = "rldf051mByKey" ,
        xldfEntityClass = Xldf051mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf051mQuery", xldfDsByTrans = "xldf051mMaxSerialNo",  xldfDsBySerialNo = "xldf051mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF051M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF051M")
public class XLDF051M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF051M(String siteId ,String birthNoticeNo ,String birthBeginYyymmdd ) {
        super();
        this.domainObj = new Xldf051mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf051mType domainObj;
     ...
     */
    public Xldf051mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf051mType domainObj) {
