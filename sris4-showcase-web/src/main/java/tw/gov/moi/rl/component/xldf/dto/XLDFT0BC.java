...
import tw.gov.moi.domain.Xldft0bcType;
import tw.gov.moi.domain.Rldft0bcType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0bcType.class ,
        entityDsName = "rldft0bcByKey" ,
        xldfEntityClass = Xldft0bcType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0bcQuery", xldfDsByTrans = "xldft0bcMaxSerialNo",  xldfDsBySerialNo = "xldft0bcBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0BC", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0BC")
public class XLDFT0BC implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0BC(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0bcType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0bcType domainObj;
     ...
     */
    public Xldft0bcType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0bcType domainObj) {
