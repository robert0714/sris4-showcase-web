...
@XmlType(name = "XLDFS0AHB", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS0AHB") 
public class XLDFS0AHBID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS0AHB.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS0AHBID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
