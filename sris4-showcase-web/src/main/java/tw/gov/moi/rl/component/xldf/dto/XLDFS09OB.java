...
import tw.gov.moi.domain.Xldfs09obType;
import tw.gov.moi.domain.Rldfs09obType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09obType.class ,
        entityDsName = "rldfs09obByKey" ,
        xldfEntityClass = Xldfs09obType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09obQuery", xldfDsByTrans = "xldfs09obMaxSerialNo",  xldfDsBySerialNo = "xldfs09obBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09OB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09OB")
public class XLDFS09OB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09OB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09obType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09obType domainObj;
     ...
     */
    public Xldfs09obType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09obType domainObj) {
