...
import tw.gov.moi.domain.Xldf005mtType;
 ...
 */
@RldfMappingEntity(
        value = Tldf005mType.class ,
        entityDsName = "tldf005mByKey" ,
        xldfEntityClass = Xldf005mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf005mtQuery", xldfDsByTrans = "xldf005mtMaxSerialNo",  xldfDsBySerialNo = "xldf005mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF005MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF005MT")
public class XLDF005MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF005MT(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf005mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf005mtType domainObj;
     ...
     */
    public Xldf005mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf005mtType domainObj) {
