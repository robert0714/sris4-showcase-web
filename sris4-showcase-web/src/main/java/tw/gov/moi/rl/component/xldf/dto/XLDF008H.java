...
import tw.gov.moi.domain.Xldf008hType;
 ...
 */
@RldfMappingEntity(
        value = Rldf008hType.class ,
        entityDsName = "rldf008hByKey" ,
        xldfEntityClass = Xldf008hType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "removeYyymmdd" , length = 7),
            @XldfKeyMapping( name = "removeTime" , length = 6),
            @XldfKeyMapping( name = "specialCode" , length = 1),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf008hQuery", xldfDsByTrans = "xldf008hMaxSerialNo",  xldfDsBySerialNo = "xldf008hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF008H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF008H")
public class XLDF008H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF008H(String personId ,String removeYyymmdd ,String removeTime ,String specialCode ,String siteId ) {
        super();
        this.domainObj = new Xldf008hType();
        getDomainObj().setPersonId(personId); 
        getDomainObj().setRemoveYyymmdd(removeYyymmdd); 
        getDomainObj().setRemoveTime(removeTime); 
        getDomainObj().setSpecialCode(specialCode); 
    ...
    @FieldName("XLDF領域物件")
    private Xldf008hType domainObj;
     ...
     */
    public Xldf008hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf008hType domainObj) {
