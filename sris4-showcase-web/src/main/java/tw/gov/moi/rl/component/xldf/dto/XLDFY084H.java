...
import tw.gov.moi.domain.Xldfy084hType;
import tw.gov.moi.domain.Rldfy084hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy084hType.class ,
        entityDsName = "rldfy084hByKey" ,
        xldfEntityClass = Xldfy084hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy084hQuery", xldfDsByTrans = "xldfy084hMaxSerialNo",  xldfDsBySerialNo = "xldfy084hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY084H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY084H")
public class XLDFY084H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY084H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy084hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy084hType domainObj;
     ...
     */
    public Xldfy084hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy084hType domainObj) {
