...
@XmlType(name = "XLDFW066", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW066") 
public class XLDFW066ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW066.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW066ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
