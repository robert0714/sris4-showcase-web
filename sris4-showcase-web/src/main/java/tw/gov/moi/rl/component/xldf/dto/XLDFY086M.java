...
import tw.gov.moi.domain.Xldfy086mType;
import tw.gov.moi.domain.Rldfy086mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy086mType.class ,
        entityDsName = "rldfy086mByKey" ,
        xldfEntityClass = Xldfy086mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy086mQuery", xldfDsByTrans = "xldfy086mMaxSerialNo",  xldfDsBySerialNo = "xldfy086mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY086M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY086M")
public class XLDFY086M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY086M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy086mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy086mType domainObj;
     ...
     */
    public Xldfy086mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy086mType domainObj) {
