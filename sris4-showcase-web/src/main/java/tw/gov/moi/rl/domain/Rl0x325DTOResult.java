...
@XmlType(name = "rl0x325DTOResult", propOrder = { "streetDoorplate", "street", "section", "lane", "alley", "alley1",
        "alley2", "area", "areaSite", "doorNo", "floorNo" })
@XmlRootElement(name = "Rl0x325DTOResult")
public class Rl0x325DTOResult implements Serializable {
