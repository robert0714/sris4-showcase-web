...
@XmlType(name = "XLDFS0AG", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS0AG") 
public class XLDFS0AGID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS0AG.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS0AGID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
