...
import tw.gov.moi.domain.Rldfw047Type;
import tw.gov.moi.domain.Xldfw047Type;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfw047Type.class, entityDsName = "rldfw047ByKey", xldfEntityClass = Xldfw047Type.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfw047Query", xldfDsByTrans = "xldfw047MaxSerialNo", xldfDsBySerialNo = "xldfw047BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW047", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFW047")
public class XLDFW047 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW047(String personId, String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq) {
        super();
        this.domainObj = new Xldfw047Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw047Type domainObj;
     ...
     */
    public Xldfw047Type getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfw047Type domainObj) {
