...
import tw.gov.moi.domain.Xldfm06mtType;
import tw.gov.moi.domain.Tldfm06mType;
 ...
 */
@RldfMappingEntity(
        value = Tldfm06mType.class ,
        entityDsName = "tldfm06mByKey" ,
        xldfEntityClass = Xldfm06mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfm06mtQuery", xldfDsByTrans = "xldfm06mtMaxSerialNo",  xldfDsBySerialNo = "xldfm06mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFM06MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFM06MT")
public class XLDFM06MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFM06MT(String trMode ,String applyMode ,String applyYyymmdd ,String applyHhmmss ,String personId ,String siteId ) {
        super();
        this.domainObj = new Xldfm06mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfm06mtType domainObj;
     ...
     */
    public Xldfm06mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfm06mtType domainObj) {
