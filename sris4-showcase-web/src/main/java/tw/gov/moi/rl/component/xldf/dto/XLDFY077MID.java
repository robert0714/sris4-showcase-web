...
@XmlType(name = "XLDFY077M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY077M") 
public class XLDFY077MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY077M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY077MID(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
