...
import tw.gov.moi.domain.Xldfw0djType;
import tw.gov.moi.domain.Rldfw0djType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0djType.class ,
        entityDsName = "rldfw0djByKey" ,
        xldfEntityClass = Xldfw0djType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0djQuery", xldfDsByTrans = "xldfw0djMaxSerialNo",  xldfDsBySerialNo = "xldfw0djBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0DJ", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0DJ")
public class XLDFW0DJ implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0DJ(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0djType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0djType domainObj;
     ...
     */
    public Xldfw0djType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0djType domainObj) {
