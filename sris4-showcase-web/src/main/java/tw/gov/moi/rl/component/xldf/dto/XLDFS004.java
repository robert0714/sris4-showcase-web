...
import tw.gov.moi.domain.Xldfs004Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs004Type.class ,
        entityDsName = "rldfs004ByKey" ,
        xldfEntityClass = Xldfs004Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs004Query", xldfDsByTrans = "xldfs004MaxSerialNo",  xldfDsBySerialNo = "xldfs004BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS004", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS004")
public class XLDFS004 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS004(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs004Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs004Type domainObj;
     ...
     */
    public Xldfs004Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs004Type domainObj) {
