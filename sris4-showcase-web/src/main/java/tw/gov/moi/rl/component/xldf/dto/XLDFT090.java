...
import tw.gov.moi.domain.Xldft090Type;
import tw.gov.moi.domain.Rldft090Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft090Type.class ,
        entityDsName = "rldft090ByKey" ,
        xldfEntityClass = Xldft090Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft090Query", xldfDsByTrans = "xldft090MaxSerialNo",  xldfDsBySerialNo = "xldft090BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT090", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT090")
public class XLDFT090 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT090(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft090Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft090Type domainObj;
     ...
     */
    public Xldft090Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft090Type domainObj) {
