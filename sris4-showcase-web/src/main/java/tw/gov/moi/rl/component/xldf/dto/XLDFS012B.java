...
import tw.gov.moi.domain.Xldfs012bType;
import tw.gov.moi.domain.Rldfs012bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs012bType.class ,
        entityDsName = "rldfs012bByKey" ,
        xldfEntityClass = Xldfs012bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs012bQuery", xldfDsByTrans = "xldfs012bMaxSerialNo",  xldfDsBySerialNo = "xldfs012bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS012B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS012B")
public class XLDFS012B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS012B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs012bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs012bType domainObj;
     ...
     */
    public Xldfs012bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs012bType domainObj) {
