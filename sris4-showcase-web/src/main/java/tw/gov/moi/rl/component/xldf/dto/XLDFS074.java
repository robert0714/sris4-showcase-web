...
import tw.gov.moi.domain.Xldfs074Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs074Type.class ,
        entityDsName = "rldfs074ByKey" ,
        xldfEntityClass = Xldfs074Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs074Query", xldfDsByTrans = "xldfs074MaxSerialNo",  xldfDsBySerialNo = "xldfs074BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS074", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS074")
public class XLDFS074 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS074(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs074Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs074Type domainObj;
     ...
     */
    public Xldfs074Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs074Type domainObj) {
