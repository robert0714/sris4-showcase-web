...
import tw.gov.moi.domain.Xldft09qType;
import tw.gov.moi.domain.Rldft09qType;
 ...
 */
@RldfMappingEntity(
        value = Rldft09qType.class ,
        entityDsName = "rldft09qByKey" ,
        xldfEntityClass = Xldft09qType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft09qQuery", xldfDsByTrans = "xldft09qMaxSerialNo",  xldfDsBySerialNo = "xldft09qBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT09Q", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT09Q")
public class XLDFT09Q implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT09Q(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft09qType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft09qType domainObj;
     ...
     */
    public Xldft09qType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft09qType domainObj) {
