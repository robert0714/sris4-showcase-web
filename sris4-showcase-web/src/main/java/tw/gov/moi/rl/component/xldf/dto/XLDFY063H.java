...
import tw.gov.moi.domain.Xldfy063hType;
import tw.gov.moi.domain.Rldfy063hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy063hType.class ,
        entityDsName = "rldfy063hByKey" ,
        xldfEntityClass = Xldfy063hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy063hQuery", xldfDsByTrans = "xldfy063hMaxSerialNo",  xldfDsBySerialNo = "xldfy063hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY063H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY063H")
public class XLDFY063H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY063H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy063hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy063hType domainObj;
     ...
     */
    public Xldfy063hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy063hType domainObj) {
