...
import tw.gov.moi.domain.Rldfs052Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs052Type.class ,
        entityDsName = "rldfs052ByKey" ,
        xldfEntityClass = Xldfs052Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs052Query", xldfDsByTrans = "xldfs052MaxSerialNo",  xldfDsBySerialNo = "xldfs052BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS052", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS052")
public class XLDFS052 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS052(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs052Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs052Type domainObj;
     ...
     */
    public Xldfs052Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs052Type domainObj) {
