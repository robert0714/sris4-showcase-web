...
import tw.gov.moi.domain.Xldfw0aiType;
import tw.gov.moi.domain.Rldfw0aiType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0aiType.class ,
        entityDsName = "rldfw0aiByKey" ,
        xldfEntityClass = Xldfw0aiType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0aiQuery", xldfDsByTrans = "xldfw0aiMaxSerialNo",  xldfDsBySerialNo = "xldfw0aiBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AI", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AI")
public class XLDFW0AI implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AI(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0aiType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0aiType domainObj;
     ...
     */
    public Xldfw0aiType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0aiType domainObj) {
