...
import tw.gov.moi.domain.Xldfr025Type;
import tw.gov.moi.domain.Rldfr025Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr025Type.class ,
        entityDsName = "rldfr025ByKey" ,
        xldfEntityClass = Xldfr025Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr025Query", xldfDsByTrans = "xldfr025MaxSerialNo",  xldfDsBySerialNo = "xldfr025BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR025", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR025")
public class XLDFR025 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR025(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr025Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr025Type domainObj;
     ...
     */
    public Xldfr025Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr025Type domainObj) {
