...
import tw.gov.moi.domain.Xldfw010Type;
import tw.gov.moi.domain.Rldfw010Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw010Type.class ,
        entityDsName = "rldfw010ByKey" ,
        xldfEntityClass = Xldfw010Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw010Query", xldfDsByTrans = "xldfw010MaxSerialNo",  xldfDsBySerialNo = "xldfw010BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW010", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW010")
public class XLDFW010 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW010(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw010Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw010Type domainObj;
     ...
     */
    public Xldfw010Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw010Type domainObj) {
