...
import tw.gov.moi.domain.Rldfs046bType;
import tw.gov.moi.domain.Xldfs046bType;
 ...
 * @author JL
 */
@RldfMappingEntity(value = Rldfs046bType.class, entityDsName = "rldfs046bByKey", xldfEntityClass = Xldfs046bType.class, keys = {
...
@XldfDsNameMaping(xldfDsName = "xldfs046bQuery", xldfDsByTrans = "xldfs046bMaxSerialNo", xldfDsBySerialNo = "xldfs046bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS046B", propOrder = { "domainObj" })
@XmlRootElement(name = "XLDFS046B")
public class XLDFS046B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS046B(String applyTransactionId, Integer applySequenceId, String siteId, Integer applySeq,
            String certificateCode) {
        super();
        this.domainObj = new Xldfs046bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs046bType domainObj;
     ...
     */
    public Xldfs046bType getDomainObj() {
        return domainObj;
    }
     ...
     *            the new domain obj
     */
    public void setDomainObj(Xldfs046bType domainObj) {
