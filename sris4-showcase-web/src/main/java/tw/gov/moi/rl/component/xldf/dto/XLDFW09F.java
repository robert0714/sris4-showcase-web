...
import tw.gov.moi.domain.Xldfw09fType;
import tw.gov.moi.domain.Rldfw09fType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09fType.class ,
        entityDsName = "rldfw09fByKey" ,
        xldfEntityClass = Xldfw09fType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09fQuery", xldfDsByTrans = "xldfw09fMaxSerialNo",  xldfDsBySerialNo = "xldfw09fBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09F", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09F")
public class XLDFW09F implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09F(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09fType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09fType domainObj;
     ...
     */
    public Xldfw09fType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09fType domainObj) {
