...
public class XLDF001MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF001M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF001MID(String householdHeadId ,String householdId ,String siteId ) {
        super();
