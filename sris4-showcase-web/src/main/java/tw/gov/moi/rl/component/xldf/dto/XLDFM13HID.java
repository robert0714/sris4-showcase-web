...
public class XLDFM13HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM13H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM13HID(String removeYyymmdd ,String removeTime ,String personId ,String siteId ) {
        super();
