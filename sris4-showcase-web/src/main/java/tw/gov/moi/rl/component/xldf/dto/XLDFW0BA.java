...
import tw.gov.moi.domain.Xldfw0baType;
import tw.gov.moi.domain.Rldfw0baType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0baType.class ,
        entityDsName = "rldfw0baByKey" ,
        xldfEntityClass = Xldfw0baType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0baQuery", xldfDsByTrans = "xldfw0baMaxSerialNo",  xldfDsBySerialNo = "xldfw0baBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0BA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0BA")
public class XLDFW0BA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0BA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0baType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0baType domainObj;
     ...
     */
    public Xldfw0baType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0baType domainObj) {
