...
public class XLDFM09HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM09H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM09HID(String personId ,String siteId ,String changeYyymmdd ,String changeHhmmss ,String removeYyymmdd ,String removeTime ) {
        super();
