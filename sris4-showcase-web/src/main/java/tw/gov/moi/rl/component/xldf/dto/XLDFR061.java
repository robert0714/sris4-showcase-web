...
import tw.gov.moi.domain.Xldfr061Type;
import tw.gov.moi.domain.Rldfr061Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr061Type.class ,
        entityDsName = "rldfr061ByKey" ,
        xldfEntityClass = Xldfr061Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr061Query", xldfDsByTrans = "xldfr061MaxSerialNo",  xldfDsBySerialNo = "xldfr061BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR061", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR061")
public class XLDFR061 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR061(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr061Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr061Type domainObj;
     ...
     */
    public Xldfr061Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr061Type domainObj) {
