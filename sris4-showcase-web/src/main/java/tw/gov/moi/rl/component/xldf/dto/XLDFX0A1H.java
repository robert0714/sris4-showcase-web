...
import tw.gov.moi.domain.Xldfx0a1hType;
import tw.gov.moi.domain.Rldfx0a1hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0a1hType.class ,
        entityDsName = "rldfx0a1hByKey" ,
        xldfEntityClass = Xldfx0a1hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0a1hQuery", xldfDsByTrans = "xldfx0a1hMaxSerialNo",  xldfDsBySerialNo = "xldfx0a1hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0A1H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0A1H")
public class XLDFX0A1H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0A1H(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0a1hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0a1hType domainObj;
     ...
     */
    public Xldfx0a1hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0a1hType domainObj) {
