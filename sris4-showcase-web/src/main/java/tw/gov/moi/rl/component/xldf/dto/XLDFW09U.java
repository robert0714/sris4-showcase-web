...
import tw.gov.moi.domain.Xldfw09uType;
import tw.gov.moi.domain.Rldfw09uType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09uType.class ,
        entityDsName = "rldfw09uByKey" ,
        xldfEntityClass = Xldfw09uType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09uQuery", xldfDsByTrans = "xldfw09uMaxSerialNo",  xldfDsBySerialNo = "xldfw09uBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09U", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09U")
public class XLDFW09U implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09U(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09uType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09uType domainObj;
     ...
     */
    public Xldfw09uType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09uType domainObj) {
