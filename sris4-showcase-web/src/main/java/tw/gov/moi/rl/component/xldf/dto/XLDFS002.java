...
import tw.gov.moi.domain.Xldfs002Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs002Type.class ,
        entityDsName = "rldfs002ByKey" ,
        xldfEntityClass = Xldfs002Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs002Query", xldfDsByTrans = "xldfs002MaxSerialNo",  xldfDsBySerialNo = "xldfs002BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS002", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS002")
public class XLDFS002 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS002(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs002Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs002Type domainObj;
     ...
     */
    public Xldfs002Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs002Type domainObj) {
