...
import tw.gov.moi.domain.Xldfr0b8Type;
import tw.gov.moi.domain.Rldfr0b8Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0b8Type.class ,
        entityDsName = "rldfr0b8ByKey" ,
        xldfEntityClass = Xldfr0b8Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0b8Query", xldfDsByTrans = "xldfr0b8MaxSerialNo",  xldfDsBySerialNo = "xldfr0b8BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0B8", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0B8")
public class XLDFR0B8 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0B8(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0b8Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0b8Type domainObj;
     ...
     */
    public Xldfr0b8Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0b8Type domainObj) {
