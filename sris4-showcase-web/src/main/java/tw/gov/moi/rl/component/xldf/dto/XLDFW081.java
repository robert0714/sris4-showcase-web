...
import tw.gov.moi.domain.Xldfw081Type;
import tw.gov.moi.domain.Rldfw081Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw081Type.class ,
        entityDsName = "rldfw081ByKey" ,
        xldfEntityClass = Xldfw081Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw081Query", xldfDsByTrans = "xldfw081MaxSerialNo",  xldfDsBySerialNo = "xldfw081BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW081", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW081")
public class XLDFW081 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW081(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw081Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw081Type domainObj;
     ...
     */
    public Xldfw081Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw081Type domainObj) {
