...
import tw.gov.moi.domain.Xldft0aeType;
import tw.gov.moi.domain.Rldft0aeType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0aeType.class ,
        entityDsName = "rldft0aeByKey" ,
        xldfEntityClass = Xldft0aeType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0aeQuery", xldfDsByTrans = "xldft0aeMaxSerialNo",  xldfDsBySerialNo = "xldft0aeBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AE", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AE")
public class XLDFT0AE implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AE(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0aeType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0aeType domainObj;
     ...
     */
    public Xldft0aeType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0aeType domainObj) {
