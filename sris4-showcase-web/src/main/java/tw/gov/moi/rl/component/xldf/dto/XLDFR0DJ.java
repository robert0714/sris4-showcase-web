...
import tw.gov.moi.domain.Xldfr0djType;
import tw.gov.moi.domain.Rldfr0djType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0djType.class ,
        entityDsName = "rldfr0djByKey" ,
        xldfEntityClass = Xldfr0djType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0djQuery", xldfDsByTrans = "xldfr0djMaxSerialNo",  xldfDsBySerialNo = "xldfr0djBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0DJ", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0DJ")
public class XLDFR0DJ implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0DJ(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0djType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0djType domainObj;
     ...
     */
    public Xldfr0djType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0djType domainObj) {
