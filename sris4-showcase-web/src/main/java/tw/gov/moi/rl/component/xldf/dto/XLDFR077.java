...
import tw.gov.moi.domain.Xldfr077Type;
import tw.gov.moi.domain.Rldfr077Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr077Type.class ,
        entityDsName = "rldfr077ByKey" ,
        xldfEntityClass = Xldfr077Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr077Query", xldfDsByTrans = "xldfr077MaxSerialNo",  xldfDsBySerialNo = "xldfr077BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR077", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR077")
public class XLDFR077 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR077(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr077Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr077Type domainObj;
     ...
     */
    public Xldfr077Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr077Type domainObj) {
