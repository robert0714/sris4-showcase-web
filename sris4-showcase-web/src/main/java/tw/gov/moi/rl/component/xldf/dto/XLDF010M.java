...
import tw.gov.moi.domain.Xldf010mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf010mType.class ,
        entityDsName = "rldf010mByKey" ,
        xldfEntityClass = Xldf010mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf010mQuery", xldfDsByTrans = "xldf010mMaxSerialNo",  xldfDsBySerialNo = "xldf010mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF010M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF010M")
public class XLDF010M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF010M(String personId ,String siteId ,String specialCode ) {
        super();
        this.domainObj = new Xldf010mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf010mType domainObj;
     ...
     */
    public Xldf010mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf010mType domainObj) {
