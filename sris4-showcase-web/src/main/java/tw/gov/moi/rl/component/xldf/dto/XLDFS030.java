...
import tw.gov.moi.domain.Xldfs030Type;
import tw.gov.moi.domain.Rldfs030Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs030Type.class ,
        entityDsName = "rldfs030ByKey" ,
        xldfEntityClass = Xldfs030Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs030Query", xldfDsByTrans = "xldfs030MaxSerialNo",  xldfDsBySerialNo = "xldfs030BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS030", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS030")
public class XLDFS030 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS030(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs030Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs030Type domainObj;
     ...
     */
    public Xldfs030Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs030Type domainObj) {
