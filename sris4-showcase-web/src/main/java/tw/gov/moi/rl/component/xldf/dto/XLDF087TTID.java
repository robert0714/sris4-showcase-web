...
public class XLDF087TTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF087TT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF087TTID(String applyTransactionId ,Integer applySequenceId ,String personId ,String siteId ) {
        super();
