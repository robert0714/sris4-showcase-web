...
import tw.gov.moi.domain.Xldft0dhType;
import tw.gov.moi.domain.Rldft0dhType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0dhType.class ,
        entityDsName = "rldft0dhByKey" ,
        xldfEntityClass = Xldft0dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0dhQuery", xldfDsByTrans = "xldft0dhMaxSerialNo",  xldfDsBySerialNo = "xldft0dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0DH")
public class XLDFT0DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0DH(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0dhType domainObj;
     ...
     */
    public Xldft0dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0dhType domainObj) {
