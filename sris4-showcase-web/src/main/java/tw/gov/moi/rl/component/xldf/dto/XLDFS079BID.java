...
@XmlType(name = "XLDFS079B", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFS079B") 
public class XLDFS079BID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS079B.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS079BID(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
