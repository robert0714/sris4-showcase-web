...
import tw.gov.moi.domain.Xldfw09dType;
import tw.gov.moi.domain.Rldfw09dType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09dType.class ,
        entityDsName = "rldfw09dByKey" ,
        xldfEntityClass = Xldfw09dType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09dQuery", xldfDsByTrans = "xldfw09dMaxSerialNo",  xldfDsBySerialNo = "xldfw09dBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09D", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09D")
public class XLDFW09D implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09D(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09dType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09dType domainObj;
     ...
     */
    public Xldfw09dType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09dType domainObj) {
