 ...
 */
@RldfMappingEntity(
        value = Rldf008aType.class ,
        entityDsName = "rldf008aByKey" ,
        xldfEntityClass = Xldf008aType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf008aQuery", xldfDsByTrans = "xldf008aMaxSerialNo",  xldfDsBySerialNo = "xldf008aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF008A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF008A")
public class XLDF008A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF008A(String siteId ) {
        super();
        this.domainObj = new Xldf008aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf008aType domainObj;
     ...
     */
    public Xldf008aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf008aType domainObj) {
