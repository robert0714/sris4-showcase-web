...
@XmlType(name = "XLDFY0DAH", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFY0DAH") 
public class XLDFY0DAHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY0DAH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY0DAHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
