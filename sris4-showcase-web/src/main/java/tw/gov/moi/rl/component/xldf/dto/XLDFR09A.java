...
import tw.gov.moi.domain.Xldfr09aType;
import tw.gov.moi.domain.Rldfr09aType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr09aType.class ,
        entityDsName = "rldfr09aByKey" ,
        xldfEntityClass = Xldfr09aType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr09aQuery", xldfDsByTrans = "xldfr09aMaxSerialNo",  xldfDsBySerialNo = "xldfr09aBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR09A", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR09A")
public class XLDFR09A implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR09A(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr09aType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr09aType domainObj;
     ...
     */
    public Xldfr09aType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr09aType domainObj) {
