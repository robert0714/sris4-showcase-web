...
import tw.gov.moi.domain.Xldfs0dhType;
import tw.gov.moi.domain.Rldfs0dhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0dhType.class ,
        entityDsName = "rldfs0dhByKey" ,
        xldfEntityClass = Xldfs0dhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0dhQuery", xldfDsByTrans = "xldfs0dhMaxSerialNo",  xldfDsBySerialNo = "xldfs0dhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0DH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0DH")
public class XLDFS0DH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0DH(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0dhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0dhType domainObj;
     ...
     */
    public Xldfs0dhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0dhType domainObj) {
