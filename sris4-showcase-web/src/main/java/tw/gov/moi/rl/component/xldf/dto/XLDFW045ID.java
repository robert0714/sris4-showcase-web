...
@XmlType(name = "XLDFW045", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW045") 
public class XLDFW045ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW045.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW045ID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
