...
import tw.gov.moi.domain.Xldf030tType;
 ...
 */
@RldfMappingEntity(
        value = Rldf030tType.class ,
        entityDsName = "rldf030tByKey" ,
        xldfEntityClass = Xldf030tType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf030tQuery", xldfDsByTrans = "xldf030tMaxSerialNo",  xldfDsBySerialNo = "xldf030tBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF030T", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF030T")
public class XLDF030T implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF030T(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldf030tType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf030tType domainObj;
     ...
     */
    public Xldf030tType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf030tType domainObj) {
