...
import tw.gov.moi.domain.Xldfx0bchType;
import tw.gov.moi.domain.Rldfx0bchType;
 ...
 */
@RldfMappingEntity(
        value = Rldfx0bchType.class ,
        entityDsName = "rldfx0bchByKey" ,
        xldfEntityClass = Xldfx0bchType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfx0bchQuery", xldfDsByTrans = "xldfx0bchMaxSerialNo",  xldfDsBySerialNo = "xldfx0bchBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFX0BCH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFX0BCH")
public class XLDFX0BCH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFX0BCH(String householdHeadId ,String householdId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfx0bchType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfx0bchType domainObj;
     ...
     */
    public Xldfx0bchType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfx0bchType domainObj) {
