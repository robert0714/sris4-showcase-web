...
import tw.gov.moi.domain.Xldft0caType;
import tw.gov.moi.domain.Rldft0caType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0caType.class ,
        entityDsName = "rldft0caByKey" ,
        xldfEntityClass = Xldft0caType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0caQuery", xldfDsByTrans = "xldft0caMaxSerialNo",  xldfDsBySerialNo = "xldft0caBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0CA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0CA")
public class XLDFT0CA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0CA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0caType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0caType domainObj;
     ...
     */
    public Xldft0caType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0caType domainObj) {
