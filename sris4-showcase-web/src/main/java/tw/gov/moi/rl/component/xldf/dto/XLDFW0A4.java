...
import tw.gov.moi.domain.Xldfw0a4Type;
import tw.gov.moi.domain.Rldfw0a4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a4Type.class ,
        entityDsName = "rldfw0a4ByKey" ,
        xldfEntityClass = Xldfw0a4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a4Query", xldfDsByTrans = "xldfw0a4MaxSerialNo",  xldfDsBySerialNo = "xldfw0a4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A4")
public class XLDFW0A4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a4Type domainObj;
     ...
     */
    public Xldfw0a4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a4Type domainObj) {
