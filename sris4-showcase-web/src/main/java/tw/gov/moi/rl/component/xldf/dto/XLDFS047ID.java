...
@XmlType(name = "XLDFS047", propOrder = { "keys", "xldfClass" })
@XmlRootElement(name = "XLDFS047")
public class XLDFS047ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS047.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS047ID(String personId, String applyTransactionId, Integer applySequenceId, String siteId,
            Integer applySeq) {
        super();
