...
import tw.gov.moi.domain.Xldfs0y1Type;
import tw.gov.moi.domain.Rldfs0y1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0y1Type.class ,
        entityDsName = "rldfs0y1ByKey" ,
        xldfEntityClass = Xldfs0y1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0y1Query", xldfDsByTrans = "xldfs0y1MaxSerialNo",  xldfDsBySerialNo = "xldfs0y1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0Y1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0Y1")
public class XLDFS0Y1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0Y1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0y1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0y1Type domainObj;
     ...
     */
    public Xldfs0y1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0y1Type domainObj) {
