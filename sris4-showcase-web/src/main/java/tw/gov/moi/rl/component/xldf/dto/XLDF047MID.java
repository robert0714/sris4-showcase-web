...
public class XLDF047MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF047M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF047MID(String personId ,String seqNo ,String siteId ) {
        super();
