...
import tw.gov.moi.domain.Xldfs0afType;
import tw.gov.moi.domain.Rldfs0afType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0afType.class ,
        entityDsName = "rldfs0afByKey" ,
        xldfEntityClass = Xldfs0afType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0afQuery", xldfDsByTrans = "xldfs0afMaxSerialNo",  xldfDsBySerialNo = "xldfs0afBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AF", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AF")
public class XLDFS0AF implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AF(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0afType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0afType domainObj;
     ...
     */
    public Xldfs0afType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0afType domainObj) {
