...
import tw.gov.moi.domain.Xldft0abType;
import tw.gov.moi.domain.Rldft0abType;
 ...
 */
@RldfMappingEntity(
        value = Rldft0abType.class ,
        entityDsName = "rldft0abByKey" ,
        xldfEntityClass = Xldft0abType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft0abQuery", xldfDsByTrans = "xldft0abMaxSerialNo",  xldfDsBySerialNo = "xldft0abBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT0AB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT0AB")
public class XLDFT0AB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT0AB(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft0abType();
    ...
    @FieldName("XLDF領域物件")
    private Xldft0abType domainObj;
     ...
     */
    public Xldft0abType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft0abType domainObj) {
