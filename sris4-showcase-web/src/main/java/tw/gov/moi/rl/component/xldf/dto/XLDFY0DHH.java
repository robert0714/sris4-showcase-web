...
import tw.gov.moi.domain.Xldfy0dhhType;
import tw.gov.moi.domain.Rldfy0dhhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0dhhType.class ,
        entityDsName = "rldfy0dhhByKey" ,
        xldfEntityClass = Xldfy0dhhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0dhhQuery", xldfDsByTrans = "xldfy0dhhMaxSerialNo",  xldfDsBySerialNo = "xldfy0dhhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0DHH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0DHH")
public class XLDFY0DHH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0DHH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0dhhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0dhhType domainObj;
     ...
     */
    public Xldfy0dhhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0dhhType domainObj) {
