...
import tw.gov.moi.domain.Xldfy064hType;
import tw.gov.moi.domain.Rldfy064hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy064hType.class ,
        entityDsName = "rldfy064hByKey" ,
        xldfEntityClass = Xldfy064hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy064hQuery", xldfDsByTrans = "xldfy064hMaxSerialNo",  xldfDsBySerialNo = "xldfy064hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY064H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY064H")
public class XLDFY064H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY064H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy064hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy064hType domainObj;
     ...
     */
    public Xldfy064hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy064hType domainObj) {
