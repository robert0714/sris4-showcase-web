...
public class XLDF020MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF020M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF020MID(String siteId ,String village ,String neighbor ,String streetDoorplate ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(neighbor, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(streetDoorplate, StringUtils.EMPTY)));
