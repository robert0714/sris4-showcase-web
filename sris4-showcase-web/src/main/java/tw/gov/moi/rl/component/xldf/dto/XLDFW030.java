...
import tw.gov.moi.domain.Xldfw030Type;
import tw.gov.moi.domain.Rldfw030Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw030Type.class ,
        entityDsName = "rldfw030ByKey" ,
        xldfEntityClass = Xldfw030Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw030Query", xldfDsByTrans = "xldfw030MaxSerialNo",  xldfDsBySerialNo = "xldfw030BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW030", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW030")
public class XLDFW030 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW030(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw030Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw030Type domainObj;
     ...
     */
    public Xldfw030Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw030Type domainObj) {
