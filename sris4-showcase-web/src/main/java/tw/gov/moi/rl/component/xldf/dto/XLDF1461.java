...
import tw.gov.moi.domain.Xldf1461Type;
import tw.gov.moi.domain.Xldf1461Type;
 ...
 */
@RldfMappingEntity(
        value = Xldf1461Type.class ,
        entityDsName = "xldf1461ByKey" ,
        xldfEntityClass = Xldf1461Type.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf1461Query", xldfDsByTrans = "xldf1461MaxSerialNo",  xldfDsBySerialNo = "xldf1461BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF1461", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF1461")
public class XLDF1461 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF1461(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf1461Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldf1461Type domainObj;
     ...
     */
    public Xldf1461Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf1461Type domainObj) {
