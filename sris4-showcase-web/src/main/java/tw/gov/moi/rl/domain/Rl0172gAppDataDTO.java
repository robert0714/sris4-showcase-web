...
@XmlType(name = "rl0172gAppDataDTO", propOrder = { "beforeFather", "beforeFatherLastName", "beforeFatherFirstName",
...
@XmlRootElement(name = "Rl0172gAppDataDTO")
public class Rl0172gAppDataDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 278067528594988312L;
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Rl0172gAppDataDTO other = (Rl0172gAppDataDTO) obj;
        if (afterFather == null) {
