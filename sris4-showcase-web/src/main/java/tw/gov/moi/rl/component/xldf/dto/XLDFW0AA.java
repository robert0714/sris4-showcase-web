...
import tw.gov.moi.domain.Xldfw0aaType;
import tw.gov.moi.domain.Rldfw0aaType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0aaType.class ,
        entityDsName = "rldfw0aaByKey" ,
        xldfEntityClass = Xldfw0aaType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0aaQuery", xldfDsByTrans = "xldfw0aaMaxSerialNo",  xldfDsBySerialNo = "xldfw0aaBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0AA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0AA")
public class XLDFW0AA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0AA(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0aaType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0aaType domainObj;
     ...
     */
    public Xldfw0aaType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0aaType domainObj) {
