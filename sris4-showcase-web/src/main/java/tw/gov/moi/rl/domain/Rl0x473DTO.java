...
import tw.gov.moi.domain.Rldfs173Type;
...
@XmlType(name = "rl0x473DTO", propOrder = { "MainDTO", "EditResult", "QuertDto", "SelectData", "Resutlts", "Recored",
        "IsVerify", "CommononType", "lockData", "LockData", "Title", "CheckCode" })
@XmlRootElement(name = "Rl0x473DTO")
public class Rl0x473DTO implements Serializable {
    ...
    @FieldName("來源資料")
    private Object selectData = new Rldft073Type();
    ...
    @FieldName("修改紀錄")
    private Rldfs173Type recored = new Rldfs173Type();
    ...
    @FieldName("R檔預設值")
    private Rldft073Type commononType = null;
    ...
    public Rldft073Type getCommononType() {
        return commononType;
    }

    public void setCommononType(Rldft073Type commononType) {
    ...
    public Rldfs173Type getRecored() {
        return recored;
    }

    public void setRecored(Rldfs173Type recored) {
    ...
    public String toString() {
        return "Rl0x473DTO [mainDTO=" + mainDTO + ", editResult=" + editResult + ", quertDto=" + quertDto
