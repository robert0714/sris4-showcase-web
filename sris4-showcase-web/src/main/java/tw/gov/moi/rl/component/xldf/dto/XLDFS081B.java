...
import tw.gov.moi.domain.Xldfs081bType;
import tw.gov.moi.domain.Rldfs081bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs081bType.class ,
        entityDsName = "rldfs081bByKey" ,
        xldfEntityClass = Xldfs081bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs081bQuery", xldfDsByTrans = "xldfs081bMaxSerialNo",  xldfDsBySerialNo = "xldfs081bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS081B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS081B")
public class XLDFS081B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS081B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs081bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs081bType domainObj;
     ...
     */
    public Xldfs081bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs081bType domainObj) {
