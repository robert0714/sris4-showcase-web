...
import tw.gov.moi.domain.Xldfw09bType;
import tw.gov.moi.domain.Rldfw09bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfw09bType.class ,
        entityDsName = "rldfw09bByKey" ,
        xldfEntityClass = Xldfw09bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw09bQuery", xldfDsByTrans = "xldfw09bMaxSerialNo",  xldfDsBySerialNo = "xldfw09bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW09B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW09B")
public class XLDFW09B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW09B(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw09bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw09bType domainObj;
     ...
     */
    public Xldfw09bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw09bType domainObj) {
