...
import tw.gov.moi.domain.Xldfy09tmType;
import tw.gov.moi.domain.Rldfy09tmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09tmType.class ,
        entityDsName = "rldfy09tmByKey" ,
        xldfEntityClass = Xldfy09tmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09tmQuery", xldfDsByTrans = "xldfy09tmMaxSerialNo",  xldfDsBySerialNo = "xldfy09tmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09TM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09TM")
public class XLDFY09TM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09TM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09tmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09tmType domainObj;
     ...
     */
    public Xldfy09tmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09tmType domainObj) {
