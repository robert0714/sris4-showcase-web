...
import tw.gov.moi.domain.Xldfy09fhType;
import tw.gov.moi.domain.Rldfy09fhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09fhType.class ,
        entityDsName = "rldfy09fhByKey" ,
        xldfEntityClass = Xldfy09fhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09fhQuery", xldfDsByTrans = "xldfy09fhMaxSerialNo",  xldfDsBySerialNo = "xldfy09fhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09FH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09FH")
public class XLDFY09FH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09FH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09fhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09fhType domainObj;
     ...
     */
    public Xldfy09fhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09fhType domainObj) {
