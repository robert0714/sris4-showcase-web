...
public class XLDFS017ID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFS017.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFS017ID(String personId ,String transactionId ,Integer sequenceId ,Integer applySeq ,String siteId ) {
        super();
