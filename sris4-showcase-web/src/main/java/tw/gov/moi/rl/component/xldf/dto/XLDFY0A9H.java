...
import tw.gov.moi.domain.Xldfy0a9hType;
import tw.gov.moi.domain.Rldfy0a9hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0a9hType.class ,
        entityDsName = "rldfy0a9hByKey" ,
        xldfEntityClass = Xldfy0a9hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0a9hQuery", xldfDsByTrans = "xldfy0a9hMaxSerialNo",  xldfDsBySerialNo = "xldfy0a9hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0A9H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0A9H")
public class XLDFY0A9H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0A9H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0a9hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0a9hType domainObj;
     ...
     */
    public Xldfy0a9hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0a9hType domainObj) {
