...
import tw.gov.moi.domain.Xldfw037Type;
import tw.gov.moi.domain.Rldfw037Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw037Type.class ,
        entityDsName = "rldfw037ByKey" ,
        xldfEntityClass = Xldfw037Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw037Query", xldfDsByTrans = "xldfw037MaxSerialNo",  xldfDsBySerialNo = "xldfw037BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW037", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW037")
public class XLDFW037 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW037(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw037Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw037Type domainObj;
     ...
     */
    public Xldfw037Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw037Type domainObj) {
