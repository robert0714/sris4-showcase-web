...
public class XLDF007HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF007H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF007HID(String personId ,String modifyYyymmdd ,String modifyTime ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(personId, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(modifyYyymmdd, StringUtils.EMPTY)));
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(modifyTime, StringUtils.EMPTY)));
