...
import tw.gov.moi.domain.Xldfy09rhType;
import tw.gov.moi.domain.Rldfy09rhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09rhType.class ,
        entityDsName = "rldfy09rhByKey" ,
        xldfEntityClass = Xldfy09rhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09rhQuery", xldfDsByTrans = "xldfy09rhMaxSerialNo",  xldfDsBySerialNo = "xldfy09rhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09RH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09RH")
public class XLDFY09RH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09RH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09rhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09rhType domainObj;
     ...
     */
    public Xldfy09rhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09rhType domainObj) {
