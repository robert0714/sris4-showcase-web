...
import tw.gov.moi.domain.Xldfy087mType;
import tw.gov.moi.domain.Rldfy087mType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy087mType.class ,
        entityDsName = "rldfy087mByKey" ,
        xldfEntityClass = Xldfy087mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy087mQuery", xldfDsByTrans = "xldfy087mMaxSerialNo",  xldfDsBySerialNo = "xldfy087mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY087M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY087M")
public class XLDFY087M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY087M(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy087mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy087mType domainObj;
     ...
     */
    public Xldfy087mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy087mType domainObj) {
