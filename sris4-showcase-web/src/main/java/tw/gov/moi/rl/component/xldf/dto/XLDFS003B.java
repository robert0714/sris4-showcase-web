...
import tw.gov.moi.domain.Xldfs003bType;
import tw.gov.moi.domain.Rldfs003bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs003bType.class ,
        entityDsName = "rldfs003bByKey" ,
        xldfEntityClass = Xldfs003bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs003bQuery", xldfDsByTrans = "xldfs003bMaxSerialNo",  xldfDsBySerialNo = "xldfs003bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS003B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS003B")
public class XLDFS003B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS003B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs003bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs003bType domainObj;
     ...
     */
    public Xldfs003bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs003bType domainObj) {
