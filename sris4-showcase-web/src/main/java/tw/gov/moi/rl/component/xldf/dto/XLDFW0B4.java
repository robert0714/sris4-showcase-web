...
import tw.gov.moi.domain.Xldfw0b4Type;
import tw.gov.moi.domain.Rldfw0b4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0b4Type.class ,
        entityDsName = "rldfw0b4ByKey" ,
        xldfEntityClass = Xldfw0b4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0b4Query", xldfDsByTrans = "xldfw0b4MaxSerialNo",  xldfDsBySerialNo = "xldfw0b4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0B4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0B4")
public class XLDFW0B4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0B4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0b4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0b4Type domainObj;
     ...
     */
    public Xldfw0b4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0b4Type domainObj) {
