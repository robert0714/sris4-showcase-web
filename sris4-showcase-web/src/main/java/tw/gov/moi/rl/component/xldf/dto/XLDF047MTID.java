...
@XmlType(name = "XLDF047MT", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDF047MT") 
public class XLDF047MTID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDF047MT.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDF047MTID(String personId ,String seqNo ,String siteId ) {
        super();
