...
import tw.gov.moi.domain.Xldfs0b4Type;
import tw.gov.moi.domain.Rldfs0b4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b4Type.class ,
        entityDsName = "rldfs0b4ByKey" ,
        xldfEntityClass = Xldfs0b4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b4Query", xldfDsByTrans = "xldfs0b4MaxSerialNo",  xldfDsBySerialNo = "xldfs0b4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B4")
public class XLDFS0B4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B4(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0b4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b4Type domainObj;
     ...
     */
    public Xldfs0b4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b4Type domainObj) {
