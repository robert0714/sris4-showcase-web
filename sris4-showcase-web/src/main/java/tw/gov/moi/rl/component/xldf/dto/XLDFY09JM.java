...
import tw.gov.moi.domain.Xldfy09jmType;
import tw.gov.moi.domain.Rldfy09jmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09jmType.class ,
        entityDsName = "rldfy09jmByKey" ,
        xldfEntityClass = Xldfy09jmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09jmQuery", xldfDsByTrans = "xldfy09jmMaxSerialNo",  xldfDsBySerialNo = "xldfy09jmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09JM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09JM")
public class XLDFY09JM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09JM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09jmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09jmType domainObj;
     ...
     */
    public Xldfy09jmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09jmType domainObj) {
