...
import tw.gov.moi.domain.Xldfy090hType;
import tw.gov.moi.domain.Rldfy090hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy090hType.class ,
        entityDsName = "rldfy090hByKey" ,
        xldfEntityClass = Xldfy090hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy090hQuery", xldfDsByTrans = "xldfy090hMaxSerialNo",  xldfDsBySerialNo = "xldfy090hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY090H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY090H")
public class XLDFY090H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY090H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy090hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy090hType domainObj;
     ...
     */
    public Xldfy090hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy090hType domainObj) {
