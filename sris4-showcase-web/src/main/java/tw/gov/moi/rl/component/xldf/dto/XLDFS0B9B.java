...
import tw.gov.moi.domain.Xldfs0b9bType;
import tw.gov.moi.domain.Rldfs0b9bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b9bType.class ,
        entityDsName = "rldfs0b9bByKey" ,
        xldfEntityClass = Xldfs0b9bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b9bQuery", xldfDsByTrans = "xldfs0b9bMaxSerialNo",  xldfDsBySerialNo = "xldfs0b9bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B9B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B9B")
public class XLDFS0B9B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B9B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0b9bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b9bType domainObj;
     ...
     */
    public Xldfs0b9bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b9bType domainObj) {
