...
/**
 * The Class Rl0172qDTO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rl0172qDTO", propOrder = { "openingOperationDTO", "fatherPersonData", "xldfHouseholdHeadPersonData",
        "xldfHouseholdData", "applicant1", "applicant2", "delegatedPerson", "xldfefaplcType", "registerDate",
        "registerTime", "acceptAdminOfficeCode", "enforcedFlag", "rl0172qAppDataDTOList", "rl0172qAppDataDTO",
        "initializationFlag" })
@XmlRootElement(name = "Rl0172qDTO")
public class Rl0172qDTO implements Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -6976113308537992997L;
    ...
    /** 子女資料清單. */
    @XmlElement(name = "Rl0172qAppDataDTOList")
    @FieldName("子女資料清單")
    private List<RlChangeNameAppDataDTO> rl0172qAppDataDTOList = new ArrayList<RlChangeNameAppDataDTO>();

    /** 子女資料. */
    @XmlElement(name = "Rl0172qAppDataDTO")
    @FieldName("子女資料")
    private RlChangeNameAppDataDTO rl0172qAppDataDTO;
    ...
    /**
     * Gets the rl0172q app data dto list.
     * 
     * @return the rl0172q app data dto list
     */
    public List<RlChangeNameAppDataDTO> getRl0172qAppDataDTOList() {
        return rl0172qAppDataDTOList;
    }

    /**
     * Sets the rl0172q app data dto list.
     * 
     * @param rl0172qAppDataDTOList
     *            the new rl0172q app data dto list
     */
    public void setRl0172qAppDataDTOList(List<RlChangeNameAppDataDTO> rl0172qAppDataDTOList) {
        this.rl0172qAppDataDTOList = rl0172qAppDataDTOList;
    }

    /**
     * Gets the rl0172q app data dto.
     * 
     * @return the rl0172q app data dto
     */
    public RlChangeNameAppDataDTO getRl0172qAppDataDTO() {
        return rl0172qAppDataDTO;
    }

    /**
     * Sets the rl0172q app data dto.
     * 
     * @param rl0172qAppDataDTO
     *            the new rl0172q app data dto
     */
    public void setRl0172qAppDataDTO(RlChangeNameAppDataDTO rl0172qAppDataDTO) {
        this.rl0172qAppDataDTO = rl0172qAppDataDTO;
    }
