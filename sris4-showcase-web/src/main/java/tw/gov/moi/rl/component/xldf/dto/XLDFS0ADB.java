...
import tw.gov.moi.domain.Xldfs0adbType;
import tw.gov.moi.domain.Rldfs0adbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0adbType.class ,
        entityDsName = "rldfs0adbByKey" ,
        xldfEntityClass = Xldfs0adbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0adbQuery", xldfDsByTrans = "xldfs0adbMaxSerialNo",  xldfDsBySerialNo = "xldfs0adbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0ADB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0ADB")
public class XLDFS0ADB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0ADB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0adbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0adbType domainObj;
     ...
     */
    public Xldfs0adbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0adbType domainObj) {
