...
import tw.gov.moi.domain.Xldfy061hType;
import tw.gov.moi.domain.Rldfy061hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy061hType.class ,
        entityDsName = "rldfy061hByKey" ,
        xldfEntityClass = Xldfy061hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy061hQuery", xldfDsByTrans = "xldfy061hMaxSerialNo",  xldfDsBySerialNo = "xldfy061hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY061H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY061H")
public class XLDFY061H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY061H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy061hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy061hType domainObj;
     ...
     */
    public Xldfy061hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy061hType domainObj) {
