...
import tw.gov.moi.domain.Xldf022mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf022mType.class ,
        entityDsName = "rldf022mByKey" ,
        xldfEntityClass = Xldf022mType.class ,        
        keys  = { 
            @XldfKeyMapping( name = "personId" , length = 10),
            @XldfKeyMapping( name = "siteId" , length = 8)

        }) 
@XldfDsNameMaping(xldfDsName = "xldf022mQuery", xldfDsByTrans = "xldf022mMaxSerialNo",  xldfDsBySerialNo = "xldf022mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF022M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF022M")
public class XLDF022M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF022M(String personId ,String siteId ) {
        super();
        this.domainObj = new Xldf022mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf022mType domainObj;
     ...
     */
    public Xldf022mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf022mType domainObj) {
