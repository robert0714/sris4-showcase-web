...
import tw.gov.moi.domain.Xldf007mType;
 ...
 */
@RldfMappingEntity(
        value = Rldf007mType.class ,
        entityDsName = "rldf007mByKey" ,
        xldfEntityClass = Xldf007mType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf007mQuery", xldfDsByTrans = "xldf007mMaxSerialNo",  xldfDsBySerialNo = "xldf007mBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF007M", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF007M")
public class XLDF007M implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF007M(String personId ,String modifyYyymmdd ,String modifyTime ,String siteId ) {
        super();
        this.domainObj = new Xldf007mType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf007mType domainObj;
     ...
     */
    public Xldf007mType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf007mType domainObj) {
