...
public class XLDFM10MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM10M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM10MID(String personId ,String siteId ,String dataSiteId ,String applyTransactionId ,Integer applySequenceId ,Integer applySeq ,String applyType ,String applyCode ,String registerDate ,String registerTime ) {
        super();
