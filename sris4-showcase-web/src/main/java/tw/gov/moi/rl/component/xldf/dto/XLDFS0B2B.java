...
import tw.gov.moi.domain.Xldfs0b2bType;
import tw.gov.moi.domain.Rldfs0b2bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0b2bType.class ,
        entityDsName = "rldfs0b2bByKey" ,
        xldfEntityClass = Xldfs0b2bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0b2bQuery", xldfDsByTrans = "xldfs0b2bMaxSerialNo",  xldfDsBySerialNo = "xldfs0b2bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0B2B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0B2B")
public class XLDFS0B2B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0B2B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0b2bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0b2bType domainObj;
     ...
     */
    public Xldfs0b2bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0b2bType domainObj) {
