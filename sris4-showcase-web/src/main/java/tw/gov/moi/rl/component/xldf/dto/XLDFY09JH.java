...
import tw.gov.moi.domain.Xldfy09jhType;
import tw.gov.moi.domain.Rldfy09jhType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09jhType.class ,
        entityDsName = "rldfy09jhByKey" ,
        xldfEntityClass = Xldfy09jhType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09jhQuery", xldfDsByTrans = "xldfy09jhMaxSerialNo",  xldfDsBySerialNo = "xldfy09jhBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09JH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09JH")
public class XLDFY09JH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09JH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09jhType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09jhType domainObj;
     ...
     */
    public Xldfy09jhType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09jhType domainObj) {
