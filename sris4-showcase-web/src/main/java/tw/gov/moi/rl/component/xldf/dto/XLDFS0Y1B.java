...
import tw.gov.moi.domain.Xldfs0y1bType;
import tw.gov.moi.domain.Rldfs0y1bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0y1bType.class ,
        entityDsName = "rldfs0y1bByKey" ,
        xldfEntityClass = Xldfs0y1bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0y1bQuery", xldfDsByTrans = "xldfs0y1bMaxSerialNo",  xldfDsBySerialNo = "xldfs0y1bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0Y1B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0Y1B")
public class XLDFS0Y1B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0Y1B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs0y1bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0y1bType domainObj;
     ...
     */
    public Xldfs0y1bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0y1bType domainObj) {
