...
import tw.gov.moi.domain.Xldft042Type;
import tw.gov.moi.domain.Rldft042Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft042Type.class ,
        entityDsName = "rldft042ByKey" ,
        xldfEntityClass = Xldft042Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft042Query", xldfDsByTrans = "xldft042MaxSerialNo",  xldfDsBySerialNo = "xldft042BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT042", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT042")
public class XLDFT042 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT042(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft042Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft042Type domainObj;
     ...
     */
    public Xldft042Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft042Type domainObj) {
