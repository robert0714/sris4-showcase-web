...
import tw.gov.moi.domain.Xldfy09ehType;
import tw.gov.moi.domain.Rldfy09ehType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09ehType.class ,
        entityDsName = "rldfy09ehByKey" ,
        xldfEntityClass = Xldfy09ehType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09ehQuery", xldfDsByTrans = "xldfy09ehMaxSerialNo",  xldfDsBySerialNo = "xldfy09ehBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09EH", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09EH")
public class XLDFY09EH implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09EH(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09ehType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09ehType domainObj;
     ...
     */
    public Xldfy09ehType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09ehType domainObj) {
