...
import tw.gov.moi.domain.Xldfs09ubType;
import tw.gov.moi.domain.Rldfs09ubType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09ubType.class ,
        entityDsName = "rldfs09ubByKey" ,
        xldfEntityClass = Xldfs09ubType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09ubQuery", xldfDsByTrans = "xldfs09ubMaxSerialNo",  xldfDsBySerialNo = "xldfs09ubBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09UB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09UB")
public class XLDFS09UB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09UB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09ubType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09ubType domainObj;
     ...
     */
    public Xldfs09ubType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09ubType domainObj) {
