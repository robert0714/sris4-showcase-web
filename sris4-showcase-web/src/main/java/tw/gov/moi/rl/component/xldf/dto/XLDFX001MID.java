...
@XmlType(name = "XLDFX001M", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFX001M") 
public class XLDFX001MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFX001M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFX001MID(String householdHeadId ,String householdId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
