...
@XmlType(name = "XLDFW09C", propOrder = {
        "keys","xldfClass"
})
@XmlRootElement(name = "XLDFW09C") 
public class XLDFW09CID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFW09C.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFW09CID(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
