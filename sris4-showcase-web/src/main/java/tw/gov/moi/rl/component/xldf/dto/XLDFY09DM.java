...
import tw.gov.moi.domain.Xldfy09dmType;
import tw.gov.moi.domain.Rldfy09dmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09dmType.class ,
        entityDsName = "rldfy09dmByKey" ,
        xldfEntityClass = Xldfy09dmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09dmQuery", xldfDsByTrans = "xldfy09dmMaxSerialNo",  xldfDsBySerialNo = "xldfy09dmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09DM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09DM")
public class XLDFY09DM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09DM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09dmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09dmType domainObj;
     ...
     */
    public Xldfy09dmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09dmType domainObj) {
