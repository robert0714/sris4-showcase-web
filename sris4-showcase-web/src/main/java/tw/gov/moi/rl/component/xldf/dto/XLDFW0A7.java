...
import tw.gov.moi.domain.Xldfw0a7Type;
import tw.gov.moi.domain.Rldfw0a7Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0a7Type.class ,
        entityDsName = "rldfw0a7ByKey" ,
        xldfEntityClass = Xldfw0a7Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0a7Query", xldfDsByTrans = "xldfw0a7MaxSerialNo",  xldfDsBySerialNo = "xldfw0a7BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0A7", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0A7")
public class XLDFW0A7 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0A7(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0a7Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0a7Type domainObj;
     ...
     */
    public Xldfw0a7Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0a7Type domainObj) {
