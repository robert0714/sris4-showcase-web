...
import tw.gov.moi.domain.Xldfs0aeType;
import tw.gov.moi.domain.Rldfs0aeType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs0aeType.class ,
        entityDsName = "rldfs0aeByKey" ,
        xldfEntityClass = Xldfs0aeType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs0aeQuery", xldfDsByTrans = "xldfs0aeMaxSerialNo",  xldfDsBySerialNo = "xldfs0aeBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS0AE", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS0AE")
public class XLDFS0AE implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS0AE(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs0aeType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs0aeType domainObj;
     ...
     */
    public Xldfs0aeType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs0aeType domainObj) {
