...
import tw.gov.moi.domain.Xldfs096bType;
import tw.gov.moi.domain.Rldfs096bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs096bType.class ,
        entityDsName = "rldfs096bByKey" ,
        xldfEntityClass = Xldfs096bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs096bQuery", xldfDsByTrans = "xldfs096bMaxSerialNo",  xldfDsBySerialNo = "xldfs096bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS096B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS096B")
public class XLDFS096B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS096B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs096bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs096bType domainObj;
     ...
     */
    public Xldfs096bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs096bType domainObj) {
