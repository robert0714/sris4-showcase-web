...
import tw.gov.moi.domain.Xldfw0b1Type;
import tw.gov.moi.domain.Rldfw0b1Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0b1Type.class ,
        entityDsName = "rldfw0b1ByKey" ,
        xldfEntityClass = Xldfw0b1Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0b1Query", xldfDsByTrans = "xldfw0b1MaxSerialNo",  xldfDsBySerialNo = "xldfw0b1BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0B1", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0B1")
public class XLDFW0B1 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0B1(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0b1Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0b1Type domainObj;
     ...
     */
    public Xldfw0b1Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0b1Type domainObj) {
