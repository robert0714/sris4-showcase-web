...
import tw.gov.moi.domain.Xldfy09rmType;
import tw.gov.moi.domain.Rldfy09rmType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy09rmType.class ,
        entityDsName = "rldfy09rmByKey" ,
        xldfEntityClass = Xldfy09rmType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy09rmQuery", xldfDsByTrans = "xldfy09rmMaxSerialNo",  xldfDsBySerialNo = "xldfy09rmBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY09RM", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY09RM")
public class XLDFY09RM implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY09RM(String personId ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy09rmType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy09rmType domainObj;
     ...
     */
    public Xldfy09rmType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy09rmType domainObj) {
