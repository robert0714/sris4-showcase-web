...
public class XLDFM05MID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM05M.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM05MID(String personId ,String siteId ,String relationId ,String relationCode ) {
        super();
