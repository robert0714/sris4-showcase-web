...
import tw.gov.moi.domain.Xldfy091hType;
import tw.gov.moi.domain.Rldfy091hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy091hType.class ,
        entityDsName = "rldfy091hByKey" ,
        xldfEntityClass = Xldfy091hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy091hQuery", xldfDsByTrans = "xldfy091hMaxSerialNo",  xldfDsBySerialNo = "xldfy091hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY091H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY091H")
public class XLDFY091H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY091H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy091hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy091hType domainObj;
     ...
     */
    public Xldfy091hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy091hType domainObj) {
