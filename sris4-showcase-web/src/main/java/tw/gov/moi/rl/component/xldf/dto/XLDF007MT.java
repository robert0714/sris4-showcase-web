...
import tw.gov.moi.domain.Xldf007mtType;
 ...
 */
@RldfMappingEntity(
        value = Tldf007mType.class ,
        entityDsName = "tldf007mByKey" ,
        xldfEntityClass = Xldf007mtType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldf007mtQuery", xldfDsByTrans = "xldf007mtMaxSerialNo",  xldfDsBySerialNo = "xldf007mtBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDF007MT", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDF007MT")
public class XLDF007MT implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDF007MT(String personId ,String modifyYyymmdd ,String modifyTime ,String siteId ) {
        super();
        this.domainObj = new Xldf007mtType();
    ...
    @FieldName("XLDF領域物件")
    private Xldf007mtType domainObj;
     ...
     */
    public Xldf007mtType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldf007mtType domainObj) {
