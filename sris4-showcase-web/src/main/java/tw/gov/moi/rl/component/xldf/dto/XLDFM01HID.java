...
public class XLDFM01HID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFM01H.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFM01HID(String personId ,String siteId ,String removeYyymmdd ,String removeTime ) {
        super();
