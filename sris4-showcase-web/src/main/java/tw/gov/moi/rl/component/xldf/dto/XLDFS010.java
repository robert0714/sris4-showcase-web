...
import tw.gov.moi.domain.Xldfs010Type;
import tw.gov.moi.domain.Rldfs010Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs010Type.class ,
        entityDsName = "rldfs010ByKey" ,
        xldfEntityClass = Xldfs010Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs010Query", xldfDsByTrans = "xldfs010MaxSerialNo",  xldfDsBySerialNo = "xldfs010BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS010", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS010")
public class XLDFS010 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS010(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs010Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs010Type domainObj;
     ...
     */
    public Xldfs010Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs010Type domainObj) {
