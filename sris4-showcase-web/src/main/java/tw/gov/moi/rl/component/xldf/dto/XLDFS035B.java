...
import tw.gov.moi.domain.Xldfs035bType;
import tw.gov.moi.domain.Rldfs035bType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs035bType.class ,
        entityDsName = "rldfs035bByKey" ,
        xldfEntityClass = Xldfs035bType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs035bQuery", xldfDsByTrans = "xldfs035bMaxSerialNo",  xldfDsBySerialNo = "xldfs035bBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS035B", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS035B")
public class XLDFS035B implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS035B(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs035bType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs035bType domainObj;
     ...
     */
    public Xldfs035bType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs035bType domainObj) {
