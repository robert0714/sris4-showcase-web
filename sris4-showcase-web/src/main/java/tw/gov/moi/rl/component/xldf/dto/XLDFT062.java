...
import tw.gov.moi.domain.Xldft062Type;
import tw.gov.moi.domain.Rldft062Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft062Type.class ,
        entityDsName = "rldft062ByKey" ,
        xldfEntityClass = Xldft062Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft062Query", xldfDsByTrans = "xldft062MaxSerialNo",  xldfDsBySerialNo = "xldft062BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT062", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT062")
public class XLDFT062 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT062(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft062Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft062Type domainObj;
     ...
     */
    public Xldft062Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft062Type domainObj) {
