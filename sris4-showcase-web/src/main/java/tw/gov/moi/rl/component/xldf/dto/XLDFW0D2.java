...
import tw.gov.moi.domain.Xldfw0d2Type;
import tw.gov.moi.domain.Rldfw0d2Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw0d2Type.class ,
        entityDsName = "rldfw0d2ByKey" ,
        xldfEntityClass = Xldfw0d2Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw0d2Query", xldfDsByTrans = "xldfw0d2MaxSerialNo",  xldfDsBySerialNo = "xldfw0d2BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW0D2", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW0D2")
public class XLDFW0D2 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW0D2(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw0d2Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw0d2Type domainObj;
     ...
     */
    public Xldfw0d2Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw0d2Type domainObj) {
