...
import tw.gov.moi.domain.Xldfr0adType;
import tw.gov.moi.domain.Rldfr0adType;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0adType.class ,
        entityDsName = "rldfr0adByKey" ,
        xldfEntityClass = Xldfr0adType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0adQuery", xldfDsByTrans = "xldfr0adMaxSerialNo",  xldfDsBySerialNo = "xldfr0adBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0AD", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0AD")
public class XLDFR0AD implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0AD(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfr0adType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0adType domainObj;
     ...
     */
    public Xldfr0adType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0adType domainObj) {
