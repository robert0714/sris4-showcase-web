...
import tw.gov.moi.domain.Xldft043Type;
import tw.gov.moi.domain.Rldft043Type;
 ...
 */
@RldfMappingEntity(
        value = Rldft043Type.class ,
        entityDsName = "rldft043ByKey" ,
        xldfEntityClass = Xldft043Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldft043Query", xldfDsByTrans = "xldft043MaxSerialNo",  xldfDsBySerialNo = "xldft043BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFT043", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFT043")
public class XLDFT043 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFT043(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldft043Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldft043Type domainObj;
     ...
     */
    public Xldft043Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldft043Type domainObj) {
