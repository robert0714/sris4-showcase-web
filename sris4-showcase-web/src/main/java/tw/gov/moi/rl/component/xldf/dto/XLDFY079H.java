...
import tw.gov.moi.domain.Xldfy079hType;
import tw.gov.moi.domain.Rldfy079hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy079hType.class ,
        entityDsName = "rldfy079hByKey" ,
        xldfEntityClass = Xldfy079hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy079hQuery", xldfDsByTrans = "xldfy079hMaxSerialNo",  xldfDsBySerialNo = "xldfy079hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY079H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY079H")
public class XLDFY079H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY079H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy079hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy079hType domainObj;
     ...
     */
    public Xldfy079hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy079hType domainObj) {
