...
import tw.gov.moi.domain.Xldfs9maType;
import tw.gov.moi.domain.Rldfs9maType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs9maType.class ,
        entityDsName = "rldfs9maByKey" ,
        xldfEntityClass = Xldfs9maType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs9maQuery", xldfDsByTrans = "xldfs9maMaxSerialNo",  xldfDsBySerialNo = "xldfs9maBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS9MA", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS9MA")
public class XLDFS9MA implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS9MA(String personId ,String transactionId ,Integer sequenceId ,String acceptAdminOfficeCode ,String registerDate ) {
        super();
        this.domainObj = new Xldfs9maType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs9maType domainObj;
     ...
     */
    public Xldfs9maType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs9maType domainObj) {
