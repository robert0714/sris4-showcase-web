...
import tw.gov.moi.domain.Xldfs098Type;
import tw.gov.moi.domain.Rldfs098Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfs098Type.class ,
        entityDsName = "rldfs098ByKey" ,
        xldfEntityClass = Xldfs098Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs098Query", xldfDsByTrans = "xldfs098MaxSerialNo",  xldfDsBySerialNo = "xldfs098BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS098", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS098")
public class XLDFS098 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS098(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfs098Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs098Type domainObj;
     ...
     */
    public Xldfs098Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs098Type domainObj) {
