...
import tw.gov.moi.domain.Xldfw019Type;
import tw.gov.moi.domain.Rldfw019Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfw019Type.class ,
        entityDsName = "rldfw019ByKey" ,
        xldfEntityClass = Xldfw019Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfw019Query", xldfDsByTrans = "xldfw019MaxSerialNo",  xldfDsBySerialNo = "xldfw019BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFW019", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFW019")
public class XLDFW019 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFW019(String personId ,String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ) {
        super();
        this.domainObj = new Xldfw019Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfw019Type domainObj;
     ...
     */
    public Xldfw019Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfw019Type domainObj) {
