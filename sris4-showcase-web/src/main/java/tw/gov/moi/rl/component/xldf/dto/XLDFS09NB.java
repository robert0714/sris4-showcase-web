...
import tw.gov.moi.domain.Xldfs09nbType;
import tw.gov.moi.domain.Rldfs09nbType;
 ...
 */
@RldfMappingEntity(
        value = Rldfs09nbType.class ,
        entityDsName = "rldfs09nbByKey" ,
        xldfEntityClass = Xldfs09nbType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfs09nbQuery", xldfDsByTrans = "xldfs09nbMaxSerialNo",  xldfDsBySerialNo = "xldfs09nbBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFS09NB", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFS09NB")
public class XLDFS09NB implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFS09NB(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String certificateCode ) {
        super();
        this.domainObj = new Xldfs09nbType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfs09nbType domainObj;
     ...
     */
    public Xldfs09nbType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfs09nbType domainObj) {
