...
import tw.gov.moi.domain.Xldfr0z4Type;
import tw.gov.moi.domain.Rldfr0z4Type;
 ...
 */
@RldfMappingEntity(
        value = Rldfr0z4Type.class ,
        entityDsName = "rldfr0z4ByKey" ,
        xldfEntityClass = Xldfr0z4Type.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfr0z4Query", xldfDsByTrans = "xldfr0z4MaxSerialNo",  xldfDsBySerialNo = "xldfr0z4BySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFR0Z4", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFR0Z4")
public class XLDFR0Z4 implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFR0Z4(String applyTransactionId ,Integer applySequenceId ,String siteId ,Integer applySeq ,String personId ) {
        super();
        this.domainObj = new Xldfr0z4Type();
    ...
    @FieldName("XLDF領域物件")
    private Xldfr0z4Type domainObj;
     ...
     */
    public Xldfr0z4Type getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfr0z4Type domainObj) {
