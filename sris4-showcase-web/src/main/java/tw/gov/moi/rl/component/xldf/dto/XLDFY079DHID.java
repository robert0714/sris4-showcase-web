...
public class XLDFY079DHID implements XLDFDomainKey, java.io.Serializable {
    ...
    @FieldName("xldf型別變數")
    private Class<? extends XLDFDomainObject> xldfClass = XLDFY079DH.class;

    /**
     * Instantiates a new obj
     * 
     */
    public XLDFY079DHID(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ,String relatedPersonId ) {
        super();
        ...
        keys.add(String.valueOf(ObjectUtils.defaultIfNull(relatedPersonId, StringUtils.EMPTY)));
