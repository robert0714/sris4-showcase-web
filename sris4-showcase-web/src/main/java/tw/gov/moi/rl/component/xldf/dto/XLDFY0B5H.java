...
import tw.gov.moi.domain.Xldfy0b5hType;
import tw.gov.moi.domain.Rldfy0b5hType;
 ...
 */
@RldfMappingEntity(
        value = Rldfy0b5hType.class ,
        entityDsName = "rldfy0b5hByKey" ,
        xldfEntityClass = Xldfy0b5hType.class ,        
        keys  = { 
...
@XldfDsNameMaping(xldfDsName = "xldfy0b5hQuery", xldfDsByTrans = "xldfy0b5hMaxSerialNo",  xldfDsBySerialNo = "xldfy0b5hBySerialNo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XLDFY0B5H", propOrder = {
        "domainObj"
})
@XmlRootElement(name = "XLDFY0B5H")
public class XLDFY0B5H implements XLDFDomainObject, java.io.Serializable {
    ...
    public XLDFY0B5H(String personId ,String removeYyymmdd ,String removeTime ,String registerYyymmdd ,String registerHhmmss ,String siteId ) {
        super();
        this.domainObj = new Xldfy0b5hType();
    ...
    @FieldName("XLDF領域物件")
    private Xldfy0b5hType domainObj;
     ...
     */
    public Xldfy0b5hType getDomainObj() {
        return domainObj;
    }
     ...
     */
    public void setDomainObj(Xldfy0b5hType domainObj) {
